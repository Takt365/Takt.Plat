 ...
 * 对应前端 ProfitCenterChangeLog
 * @description 对应后端 TaktProfitCenterChangeLogDto
 */
export interface ProfitCenterChangeLog extends CompanyDtoBase {
  /**
 ...
 * 继承 TaktPagedQuery
 * 对应前端 ProfitCenterChangeLogQuery
 * @description 对应后端 TaktProfitCenterChangeLogQueryDto
 */
 ...
 * 对应前端 ProfitCenterChangeLogCreate
 * @description 对应后端 TaktProfitCenterChangeLogCreateDto
 */
 ...
 * 对应前端 ProfitCenterChangeLogUpdate
 * @description 对应后端 TaktProfitCenterChangeLogUpdateDto
 */
 ...
 * 对应前端 ProfitCenterChangeLogExport
 * @description 对应后端 TaktProfitCenterChangeLogExportDto
 */
export interface ProfitCenterChangeLogExport {
  /**
