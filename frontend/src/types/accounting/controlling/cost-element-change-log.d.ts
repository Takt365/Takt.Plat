 ...
 * 对应前端 CostElementChangeLog
 * @description 对应后端 TaktCostElementChangeLogDto
 */
export interface CostElementChangeLog extends CompanyDtoBase {
  /**
 ...
 * 继承 TaktPagedQuery
 * 对应前端 CostElementChangeLogQuery
 * @description 对应后端 TaktCostElementChangeLogQueryDto
 */
 ...
 * 对应前端 CostElementChangeLogCreate
 * @description 对应后端 TaktCostElementChangeLogCreateDto
 */
 ...
 * 对应前端 CostElementChangeLogUpdate
 * @description 对应后端 TaktCostElementChangeLogUpdateDto
 */
 ...
 * 对应前端 CostElementChangeLogExport
 * @description 对应后端 TaktCostElementChangeLogExportDto
 */
export interface CostElementChangeLogExport {
  /**
