 ...
 * 继承 TaktPagedQuery
 * 对应前端 TrackingLogQuery
 * @description 对应后端 TaktTrackingLogQueryDto
 */
export interface TrackingLogQuery extends TaktPagedQuery {
  /**
   * 租户编码
   */
  tenantCode?: string;
...
/**
 * 创建TrackingLog DTO
 * 对应前端 TrackingLogCreate
 * @description 对应后端 TaktTrackingLogCreateDto
 */
export interface TrackingLogCreate {
  /**
