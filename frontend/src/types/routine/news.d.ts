...
export interface News extends ApprovalDtoBase {
  ...
  /**
   * 新闻附件列表 （子表：TaktNewsAttachment）
   */
  attachments?: NewsAttachment[];

  /**
   * 新闻评论列表 （子表：TaktNewsComment）
   */
  comments?: NewsComment[];

  /**
   * 新闻点赞记录列表 （子表：TaktNewsLike）
   */
  likes?: NewsLike[];

  /**
   * 新闻阅读记录列表 （子表：TaktNewsRead）
   */
  reads?: NewsRead[];

  /**
   * 新闻收藏记录列表 （子表：TaktNewsFavorite）
   */
  favorites?: NewsFavorite[];

  /**
   * 新闻分享记录列表 （子表：TaktNewsShare）
   */
  shares?: NewsShare[];
