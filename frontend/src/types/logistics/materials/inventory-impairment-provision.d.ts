...
// 文件名称：inventory-impairment-provision.d.ts
// 创建时间：2026-07-18
 ...
 * 对应前端 InventoryImpairmentProvision
 * @description 对应后端 TaktInventoryImpairmentProvisionDto
 */
export interface InventoryImpairmentProvision extends CompanyDtoBase {
  /**
   * InventoryImpairmentProvisionID（适配实体 Id，序列化为 string 以避免 Javascript 精度问题）
   */
  inventoryImpairmentProvisionId: string;
 ...
 * 继承 TaktPagedQuery
 * 对应前端 InventoryImpairmentProvisionQuery
 * @description 对应后端 TaktInventoryImpairmentProvisionQueryDto
 */
export interface InventoryImpairmentProvisionQuery extends TaktPagedQuery {
  /**
   * 租户编码
   */
  tenantCode?: string;
 ...
 * 对应前端 InventoryImpairmentProvisionCreate
 * @description 对应后端 TaktInventoryImpairmentProvisionCreateDto
 */
export interface InventoryImpairmentProvisionCreate {
  /**
 ...
 * 对应前端 InventoryImpairmentProvisionUpdate
 * @description 对应后端 TaktInventoryImpairmentProvisionUpdateDto
 */
export interface InventoryImpairmentProvisionUpdate extends InventoryImpairmentProvisionCreate {
  /**
 ...
 * 对应前端 InventoryImpairmentProvisionStatus
 * @description 对应后端 TaktInventoryImpairmentProvisionStatusDto
 */
export interface InventoryImpairmentProvisionStatus {
  /**
 ...
 * 对应前端 InventoryImpairmentProvisionSort
 * @description 对应后端 TaktInventoryImpairmentProvisionSortDto
 */
export interface InventoryImpairmentProvisionSort {
  /**
   * InventoryImpairmentProvisionID
   */
  inventoryImpairmentProvisionId: string;
 ...
 * 对应前端 InventoryImpairmentProvisionTemplate
 * @description 对应后端 TaktInventoryImpairmentProvisionTemplateDto
 */
export interface InventoryImpairmentProvisionTemplate {
  /**
   * 租户编码（登录上下文注入，对应请求头 X-Tenant-Code）
   */
  tenantCode?: string;
 ...
 * 对应前端 InventoryImpairmentProvisionImport
 * @description 对应后端 TaktInventoryImpairmentProvisionImportDto
 */
export interface InventoryImpairmentProvisionImport {
  /**
   * 租户编码（登录上下文注入，对应请求头 X-Tenant-Code）
   */
  tenantCode?: string;
 ...
 * 对应前端 InventoryImpairmentProvisionExport
 * @description 对应后端 TaktInventoryImpairmentProvisionExportDto
 */
export interface InventoryImpairmentProvisionExport {
  /**
   * InventoryImpairmentProvisionID
   */
  inventoryImpairmentProvisionId: string;
