 ...
 * 对应前端 PurchasePriceChangeLog
 * @description 对应后端 TaktPurchasePriceChangeLogDto
 */
export interface PurchasePriceChangeLog extends CompanyDtoBase {
  /**
 ...
 * 继承 TaktPagedQuery
 * 对应前端 PurchasePriceChangeLogQuery
 * @description 对应后端 TaktPurchasePriceChangeLogQueryDto
 */
 ...
 * 对应前端 PurchasePriceChangeLogCreate
 * @description 对应后端 TaktPurchasePriceChangeLogCreateDto
 */
 ...
 * 对应前端 PurchasePriceChangeLogUpdate
 * @description 对应后端 TaktPurchasePriceChangeLogUpdateDto
 */
 ...
 * 对应前端 PurchasePriceChangeLogExport
 * @description 对应后端 TaktPurchasePriceChangeLogExportDto
 */
export interface PurchasePriceChangeLogExport {
  /**
