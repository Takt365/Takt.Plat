 ...
 * 继承 TaktPagedQuery
 * 对应前端 QualityAssuranceOutgoingQuery
 * @description 对应后端 TaktQualityAssuranceOutgoingQueryDto
 */
export interface QualityAssuranceOutgoingQuery extends TaktPagedQuery {
  /**
   * 租户编码
   */
  tenantCode?: string;
 ...
 * 对应前端 QualityAssuranceOutgoingCreate
 * @description 对应后端 TaktQualityAssuranceOutgoingCreateDto
 */
export interface QualityAssuranceOutgoingCreate {
  /**
 ...
 * 对应前端 QualityAssuranceOutgoingUpdate
 * @description 对应后端 TaktQualityAssuranceOutgoingUpdateDto
 */
export interface QualityAssuranceOutgoingUpdate extends QualityAssuranceOutgoingCreate {
  /**
...
/**
 * QualityAssuranceOutgoing 作废/撤销作废 DTO
 * 对应前端 QualityAssuranceOutgoingObsolete
 * @description 对应后端 TaktQualityAssuranceOutgoingObsoleteDto
 */
export interface QualityAssuranceOutgoingObsolete {
  /**
 ...
 * 对应前端 QualityAssuranceOutgoingTemplate
 * @description 对应后端 TaktQualityAssuranceOutgoingTemplateDto
 */
export interface QualityAssuranceOutgoingTemplate {
  /**
   * 租户编码（登录上下文注入，对应请求头 X-Tenant-Code）
   */
  tenantCode?: string;
 ...
 * 对应前端 QualityAssuranceOutgoingImport
 * @description 对应后端 TaktQualityAssuranceOutgoingImportDto
 */
export interface QualityAssuranceOutgoingImport {
  /**
   * 租户编码（登录上下文注入，对应请求头 X-Tenant-Code）
   */
  tenantCode?: string;
