 ...
 * 对应前端 QualityAssuranceCustomerResponseObsolete
 * @description 对应后端 TaktQualityAssuranceCustomerResponseObsoleteDto
 */
export interface QualityAssuranceCustomerResponseObsolete {
  /**
