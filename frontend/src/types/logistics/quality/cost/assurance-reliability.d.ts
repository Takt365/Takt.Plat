 ...
 * 对应前端 QualityAssuranceReliabilityObsolete
 * @description 对应后端 TaktQualityAssuranceReliabilityObsoleteDto
 */
export interface QualityAssuranceReliabilityObsolete {
  /**
