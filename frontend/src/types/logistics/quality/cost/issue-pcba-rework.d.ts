...
/**
 * QualityIssuePcbaRework 作废/撤销作废 DTO
 * 对应前端 QualityIssuePcbaReworkObsolete
 * @description 对应后端 TaktQualityIssuePcbaReworkObsoleteDto
 */
export interface QualityIssuePcbaReworkObsolete {
  /**
