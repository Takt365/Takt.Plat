 ...
 * 对应前端 QualityOperationOther
 * @description 对应后端 TaktQualityOperationOtherDto
 */
export interface QualityOperationOther extends CompanyDtoBase {
  /**
 ...
 * 继承 TaktPagedQuery
 * 对应前端 QualityOperationOtherQuery
 * @description 对应后端 TaktQualityOperationOtherQueryDto
 */
 ...
 * 对应前端 QualityOperationOtherCreate
 * @description 对应后端 TaktQualityOperationOtherCreateDto
 */
 ...
 * 对应前端 QualityOperationOtherUpdate
 * @description 对应后端 TaktQualityOperationOtherUpdateDto
 */
 ...
 * 对应前端 QualityOperationOtherTemplate
 * @description 对应后端 TaktQualityOperationOtherTemplateDto
 */
export interface QualityOperationOtherTemplate {
  /**
   * 租户编码（登录上下文注入，对应请求头 X-Tenant-Code）
   */
  tenantCode?: string;
 ...
 * 对应前端 QualityOperationOtherImport
 * @description 对应后端 TaktQualityOperationOtherImportDto
 */
export interface QualityOperationOtherImport {
  /**
   * 租户编码（登录上下文注入，对应请求头 X-Tenant-Code）
   */
  tenantCode?: string;
 ...
 * 对应前端 QualityOperationOtherExport
 * @description 对应后端 TaktQualityOperationOtherExportDto
 */
export interface QualityOperationOtherExport {
  /**
