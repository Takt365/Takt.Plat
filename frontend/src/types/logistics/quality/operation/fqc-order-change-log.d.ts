 ...
 * 对应前端 FqcOrderChangeLog
 * @description 对应后端 TaktFqcOrderChangeLogDto
 */
export interface FqcOrderChangeLog extends CompanyDtoBase {
  /**
 ...
 * 继承 TaktPagedQuery
 * 对应前端 FqcOrderChangeLogQuery
 * @description 对应后端 TaktFqcOrderChangeLogQueryDto
 */
 ...
 * 对应前端 FqcOrderChangeLogCreate
 * @description 对应后端 TaktFqcOrderChangeLogCreateDto
 */
 ...
 * 对应前端 FqcOrderChangeLogUpdate
 * @description 对应后端 TaktFqcOrderChangeLogUpdateDto
 */
 ...
 * 对应前端 FqcOrderChangeLogExport
 * @description 对应后端 TaktFqcOrderChangeLogExportDto
 */
export interface FqcOrderChangeLogExport {
  /**
   * FqcOrderChangeLogID
   */
  fqcOrderChangeLogId: string;
