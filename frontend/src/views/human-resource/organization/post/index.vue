...
<!-- 文件名称：index.vue -->
<!-- 功能描述：岗位实体 代表组织架构中的岗位/职位 参照 SAP Position管理页面，含查询、增删改，由 generate-vue-from-api 根据 types/api 自动生成 -->
...
<template>
  <div class="human-resource-organization-post">
    ...
    <TaktModal
      ...
      :title="t('common.page.button.import') + t('entity.post._self')"
      :width="600"
      :footer="null"
...
/**
 * 岗位实体 代表组织架构中的岗位/职位 参照 SAP Position管理页 · 由 generate-vue-from-api 根据 types/api 生成
...
function handleCreate() {
  formTitle.value = t('common.page.button.create') + t('entity.post._self')
  formData.value = {}
  formVisible.value = true
}
function handleEdit(record: Post) {
  formTitle.value = t('common.page.button.edit') + t('entity.post._self')
