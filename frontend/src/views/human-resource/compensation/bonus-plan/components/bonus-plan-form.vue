...
<!-- 命名空间：@/views/human-resource/compensation/bonus-plan/components -->
<!-- 文件名称：bonus-plan-form.vue -->
<!-- 功能描述：奖金方案维护弹窗内嵌表单。由 generate-vue-crud-from-api.cjs 根据 types/api 自动生成；defineExpose 提供 validate、getValues、resetFields -->
      ...
      >
        <div :class="formContentClass">
          <a-row :gutter="24">
            ...
            <a-col :span="12">
              <a-form-item
                :label="t('entity.bonusplan.plancode')"
                name="planCode"
              >
                <a-input
            ...
            <a-col :span="12">
              <a-form-item
                :label="t('entity.bonusplan.planname')"
                name="planName"
              >
                <a-input
            ...
            <a-col :span="12">
              <a-form-item
                :label="t('entity.bonusplan.bonustype')"
                name="bonusType"
              >
                <TaktSelect
            ...
            <a-col :span="12">
              <a-form-item
                :label="t('entity.bonusplan.calcmethod')"
                name="calcMethod"
              >
                <TaktSelect
            ...
            <a-col :span="12">
              <a-form-item
                :label="t('entity.bonusplan.salaryformulaid')"
            ...
            <a-col :span="12">
              <a-form-item
                :label="t('entity.bonusplan.defaultamount')"
                name="defaultAmount"
              >
                <a-input-number
            ...
            <a-col :span="12">
              <a-form-item
                :label="t('entity.bonusplan.effectivedate')"
                name="effectiveDate"
              >
                <a-date-picker
      ...
      >
        <div :class="formContentClass">
          <a-row :gutter="24">
            ...
            <a-col :span="24">
              <a-form-item
                :label="t('entity.bonusplan.description')"
                name="description"
              >
                <a-textarea
...
const formFields = ["tenantCode","companyCode","companyDefaultCulture","planCode","planName","bonusType","calcMethod","salaryFormulaId","defaultAmount","effectiveDate","planStatus","description","relatedPlant","extFieldJson","remark"]


/** 父级传入的编辑 DTO；新增时为 undefined 或空对象 */
interface Props {
  formData?: Partial<BonusPlanCreate & { bonusPlanId?: string }> | null
  /** 父级提交 loading，禁用表单项 */
  loading?: boolean
}
...
const rules = computed<Record<string, Rule[]>>(() => ({
  planCode: [
    {
      required: true,
      message: t('common.page.form.placeholder.required', { field: t('entity.bonusplan.plancode') }),
      trigger: 'blur'
    }
  ],
  planName: [
    {
      required: true,
      message: t('common.page.form.placeholder.required', { field: t('entity.bonusplan.planname') }),
      trigger: 'blur'
    }
  ],
  bonusType: [
  ...
  effectiveDate: [
    {
      required: true,
      message: t('common.page.form.placeholder.select', { field: t('entity.bonusplan.effectivedate') }),
      trigger: 'change'
    }
  ],
  planStatus: [
