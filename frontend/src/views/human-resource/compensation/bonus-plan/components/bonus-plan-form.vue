...
const formFields = ["tenantCode","companyCode","cultureCode","planCode","planName","bonusType","calcMethod","salaryFormulaId","defaultAmount","effectiveDate","planStatus","description","plantCode","extField","remark"]
