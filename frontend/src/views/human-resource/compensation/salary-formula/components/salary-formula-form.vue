...
const formFields = ["tenantCode","companyCode","cultureCode","setCode","setName","payrollId","formulaCode","formulaName","formulaStep","targetField","formulaExpression","stepDescription","effectiveDate","expiryDate","formulaStatus","plantCode","extField","remark"]
