...
const formFields = ["tenantCode","companyCode","cultureCode","payrollCode","payrollName","payScaleId","formulaSetCode","effectiveDate","expiryDate","payrollStatus","description","plantCode","extField","remark"]
