...
<!-- 命名空间：@/views/human-resource/compensation/pay-scale/components -->
<!-- 文件名称：pay-scale-form.vue -->
<!-- 功能描述：薪级薪等维护弹窗内嵌表单。由 generate-vue-crud-from-api.cjs 根据 types/api 自动生成；defineExpose 提供 validate、getValues、resetFields -->
      ...
      >
        <div :class="formContentClass">
          <a-row :gutter="24">
            ...
            <a-col :span="12">
              <a-form-item
                :label="t('entity.payscale.scalecode')"
                name="scaleCode"
              >
                <a-input
            ...
            <a-col :span="12">
              <a-form-item
                :label="t('entity.payscale.scalename')"
                name="scaleName"
              >
                <a-input
            ...
            <a-col :span="12">
              <a-form-item
                :label="t('entity.payscale.gradelevel')"
                name="gradeLevel"
              >
                <a-input-number
            ...
            <a-col :span="12">
              <a-form-item
                :label="t('entity.payscale.minsalary')"
                name="minSalary"
              >
                <a-input-number
            ...
            <a-col :span="12">
              <a-form-item
                :label="t('entity.payscale.midsalary')"
                name="midSalary"
              >
                <a-input-number
            ...
            <a-col :span="12">
              <a-form-item
                :label="t('entity.payscale.maxsalary')"
                name="maxSalary"
              >
                <a-input-number
...
const formFields = ["tenantCode","companyCode","cultureCode","scaleCode","scaleName","gradeLevel","minSalary","midSalary","maxSalary","scaleStatus","plantCode","extField","remark"]

/** 父级传入的编辑 DTO；新增时为 undefined 或空对象 */
interface Props {
  formData?: Partial<PayScaleCreate & { payScaleId?: string }> | null
  /** 父级提交 loading，禁用表单项 */
  loading?: boolean
}
...
const rules = computed<Record<string, Rule[]>>(() => ({
  scaleCode: [
    {
      required: true,
      message: t('common.page.form.placeholder.required', { field: t('entity.payscale.scalecode') }),
      trigger: 'blur'
    }
  ],
  scaleName: [
    {
      required: true,
      message: t('common.page.form.placeholder.required', { field: t('entity.payscale.scalename') }),
      trigger: 'blur'
    }
  ],
  gradeLevel: [{
