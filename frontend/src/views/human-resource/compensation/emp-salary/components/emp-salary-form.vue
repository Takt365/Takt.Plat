...
<!-- 功能描述：员工薪酬档案维护弹窗内嵌表单。由 generate-vue-crud-from-api.cjs 根据 types/api 自动生成；defineExpose 提供 validate、getValues、resetFields -->
      ...
      >
        <div :class="formContentClass">
          <a-row :gutter="24">
            ...
            <a-col :span="12">
              <a-form-item
                :label="t('entity.empsalary.employeeid')"
                name="employeeId"
              >
                <a-input
            ...
            <a-col :span="12">
              <a-form-item
                :label="t('entity.empsalary.employeename')"
                name="employeeName"
              >
                <a-input
            ...
            <a-col :span="12">
              <a-form-item
                :label="t('entity.empsalary.payscaleid')"
                name="payScaleId"
              >
                <a-input
            ...
            <a-col :span="12">
              <a-form-item
                :label="t('entity.empsalary.basesalary')"
                name="baseSalary"
              >
                <a-input-number
            ...
            <a-col :span="12">
              <a-form-item
                :label="t('entity.empsalary.positionsalary')"
                name="positionSalary"
              >
                <a-input-number
            ...
            <a-col :span="12">
              <a-form-item
                :label="t('entity.empsalary.allowancetotal')"
                name="allowanceTotal"
              >
                <a-input-number
...
const formFields = ["tenantCode","companyCode","companyDefaultCulture","employeeId","employeeName","PayrollId","payScaleId","baseSalary","positionSalary","allowanceTotal","salaryItemId","shareCount","effectiveDate","empSalaryStatus","relatedPlant","extFieldJson","remark"]


/** 父级传入的编辑 DTO；新增时为 undefined 或空对象 */
interface Props {
  formData?: Partial<EmpSalaryCreate & { empSalaryId?: string }> | null
  /** 父级提交 loading，禁用表单项 */
  loading?: boolean
}
...
const rules = computed<Record<string, Rule[]>>(() => ({
  employeeId: [
    {
      required: true,
      message: t('common.page.form.placeholder.required', { field: t('entity.empsalary.employeeid') }),
      trigger: 'blur'
    }
  ],
  employeeName: [
    {
      required: true,
      message: t('common.page.form.placeholder.required', { field: t('entity.empsalary.employeename') }),
      trigger: 'blur'
    }
  ],
  baseSalary: [
  ...
  effectiveDate: [
    {
      required: true,
      message: t('common.page.form.placeholder.select', { field: t('entity.empsalary.effectivedate') }),
      trigger: 'change'
    }
  ],
  empSalaryStatus: [
