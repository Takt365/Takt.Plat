...
<!-- 命名空间：@/views/human-resource/talent/job-posting/components -->
<!-- 文件名称：job-posting-form.vue -->
<!-- 功能描述：职位发布维护弹窗内嵌表单。由 generate-vue-crud-from-api.cjs 根据 types/api 自动生成；defineExpose 提供 validate、getValues、resetFields -->
...
/**
 * 职位发布维护表单 · 由 generate-vue-crud-from-api.cjs 根据 types/api 生成
 * @module views/human-resource/talent/job-posting/components
 */
