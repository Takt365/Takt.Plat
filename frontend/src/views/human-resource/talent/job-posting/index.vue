...
const queryFieldsMeta = computed(() => [
  ...
  { key: 'publishDateStart', label: t('common.page.entity.createdatstart').replace(t('common.page.entity.createdat'), t('entity.talentjobposting.publishdate')) },
  { key: 'publishDateEnd', label: t('common.page.entity.createdatend').replace(t('common.page.entity.createdat'), t('entity.talentjobposting.publishdate')) },
  { key: 'openDateStart', label: t('common.page.entity.createdatstart').replace(t('common.page.entity.createdat'), t('entity.talentjobposting.opendate')) },
  { key: 'openDateEnd', label: t('common.page.entity.createdatend').replace(t('common.page.entity.createdat'), t('entity.talentjobposting.opendate')) },
  { key: 'closeDateStart', label: t('common.page.entity.createdatstart').replace(t('common.page.entity.createdat'), t('entity.talentjobposting.closedate')) },
  { key: 'closeDateEnd', label: t('common.page.entity.createdatend').replace(t('common.page.entity.createdat'), t('entity.talentjobposting.closedate')) },
...
function buildListQuery(overrides?: Partial<TalentJobPostingQuery>): TalentJobPostingQuery {
  ...
  assignTrimmed('staffingRequirementId', form.staffingRequirementId)
  assignTrimmed('postingCode', form.postingCode)
  assignTrimmed('title', form.title)
  if (form.postingStatus !== undefined && form.postingStatus !== null) {
    query.postingStatus = form.postingStatus
  }
  assignTrimmed('publishDateStart', form.publishDateStart)
  assignTrimmed('publishDateEnd', form.publishDateEnd)
  assignTrimmed('openDateStart', form.openDateStart)
  assignTrimmed('openDateEnd', form.openDateEnd)
  assignTrimmed('closeDateStart', form.closeDateStart)
  assignTrimmed('closeDateEnd', form.closeDateEnd)
  if (form.publishChannel !== undefined && form.publishChannel !== null) {
    query.publishChannel = form.publishChannel
  }
...
const columns = computed<TableColumnsType>(() => [
  ...
  {
    title: t('entity.talentjobposting.staffingrequirement'),
    dataIndex: 'staffingRequirement',
    key: 'staffingRequirement',
    width: 120,
    resizable: true,
    ellipsis: true,
    customRender: ({ record }: { record: any }) => getTalentJobPostingField(record, 'staffingRequirement') ?? ''
  },
  CreateActionColumn({
    actions: [
      {
