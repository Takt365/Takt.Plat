...
const formFields = ["tenantCode","companyCode","companyDefaultCulture","jobPostingId","offerNo","hireDate","employeeId","deptId","deptName","postId","postName","reason","extField","remark"]
