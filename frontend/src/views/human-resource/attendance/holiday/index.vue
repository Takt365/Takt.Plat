...
const queryFieldsMeta = computed(() => [
  ...
  { key: 'startDateStart', label: t('entity.holiday.startdatestart') },
  { key: 'startDateEnd', label: t('entity.holiday.startdateend') },
  { key: 'endDateStart', label: t('entity.holiday.enddatestart') },
  { key: 'endDateEnd', label: t('entity.holiday.enddateend') },
