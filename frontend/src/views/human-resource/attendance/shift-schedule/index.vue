...
<!-- 文件名称：index.vue -->
<!-- 功能描述：排班计划管理页面，含查询、增删改，由 generate-vue-from-api 根据 types/api 自动生成 -->
...
/**
 * 排班计划管理页 · 由 generate-vue-from-api 根据 types/api 生成
...
function handleCreate() {
  formTitle.value = t('common.page.button.create') + t('entity.shiftSchedule._self')
  formData.value = {}
  formVisible.value = true
}
function handleEdit(record: ShiftSchedule) {
  formTitle.value = t('common.page.button.edit') + t('entity.shiftSchedule._self')
