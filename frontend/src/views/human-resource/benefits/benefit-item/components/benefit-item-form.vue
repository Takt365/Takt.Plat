...
const formFields = ["tenantCode","companyCode","companyDefaultCulture","itemCode","itemName","benefitCategory","benefitType","paymentCycle","defaultAmount","maxAmount","employerRatio","employeeRatio","isMandatory","itemStatus","relatedPlant","extField","remark"]
