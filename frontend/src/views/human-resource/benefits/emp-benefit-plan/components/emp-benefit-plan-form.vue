...
const formFields = ["tenantCode","companyCode","companyDefaultCulture","employeeId","employeeName","benefitItemId","planCode","enrollmentDate","expiryDate","empBenefitStatus","relatedPlant","extFieldJson","remark"]
...
const rules = computed<Record<string, Rule[]>>(() => ({
  ...
  empBenefitStatus: [
    {
      required: true,
      message: t('common.page.form.placeholder.select', { field: t('entity.empbenefitplan.empbenefitstatus') }),
      trigger: 'change'
    }
  ],
}))
