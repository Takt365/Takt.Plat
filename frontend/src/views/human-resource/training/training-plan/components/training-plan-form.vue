...
const formFields = ["tenantCode","companyCode","companyDefaultCulture","planCode","planName","planYear","planType","applicableDepartment","startDate","endDate","trainingObjectives","plannedHeadcount","trainingBudget","description","trainingPlanStatus","relatedPlant","ExtField","remark"]
