    ...
    >
      ...
      <template #detail>
        <EmployeeOnboardingPanel
          ref="employeeOnboardingPanelRef"
...
import EmployeeOnboardingPanel from './components/employee-onboarding-panel.vue'
...
const employeeOnboardingPanelRef = ref<InstanceType<typeof EmployeeOnboardingPanel> | null>(null)
...
async function handleFormSubmit() {
  ...
  employeeOnboardingPanelRef.value?.reload?.()
    }
    loadData()
  } finally {
    formLoading.value = false
