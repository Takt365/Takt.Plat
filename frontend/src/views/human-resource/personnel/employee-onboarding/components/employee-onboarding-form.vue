...
<!-- 功能描述：入职待办维护弹窗内嵌表单。由 generate-vue-crud-from-api.cjs 根据 types/api 自动生成；defineExpose 提供 validate、getValues、resetFields -->
...
function getValues(): Record<string, any> {
  ...
  if ('todoStatus' in payload) {
    ...
    payload.todoStatus = typeof rawtodoStatus === 'number' ? rawtodoStatus : Number(rawtodoStatus)
  }
