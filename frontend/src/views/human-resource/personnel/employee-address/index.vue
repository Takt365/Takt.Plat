...
<!-- 命名空间：@/views/human-resource/personnel/employee-address -->
<!-- 文件名称：index.vue -->
...
<template>
  <div class="p-4 flex flex-col min-h-0 h-full">
    ...
    <TaktQueryDrawer
      ...
      :storage-key="'takt-query-fields-human-resource-personnel-employee-address'"
 ...
 * @module views/human-resource/personnel/employee-address
 */
