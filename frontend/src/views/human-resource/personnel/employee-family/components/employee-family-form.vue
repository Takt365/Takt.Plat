...
const formFields = ["tenantCode","companyCode","companyDefaultCulture","employeeId","memberName","relationType","phoneNumber","workUnit","jobTitle","birthDate","isEmergencyContact","ExtField","remark"]
