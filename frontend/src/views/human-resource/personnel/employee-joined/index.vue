...
import EmployeeJoinedPanel from './components/employee-joined-panel.vue'
...
const employeeJoinedPanelRef = ref<InstanceType<typeof EmployeeJoinedPanel> | null>(null)
...
async function handleFormSubmit() {
  ...
  employeeJoinedPanelRef.value?.reload?.()
    }
    loadData()
  } finally {
    formLoading.value = false
