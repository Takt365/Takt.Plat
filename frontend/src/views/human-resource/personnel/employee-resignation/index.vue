...
<!-- 文件名称：index.vue -->
<!-- 功能描述：员工离职办理记录管理页面，含查询、增删改，由 generate-vue-from-api 根据 types/api 自动生成 -->
...
<template>
  <div class="human-resource-personnel-employee-resignation">
    ...
    >
      ...
      <a-form-item :label="t('entity.employeeResignation.handovernotes')">
        <a-input
          ...
          :placeholder="t('common.page.form.placeholder.required', { field: t('entity.employeeResignation.handovernotes') })"
          allow-clear
        />
      </a-form-item>
    ...
    <TaktModal
      ...
      :title="t('common.page.button.import') + t('entity.employeeResignation._self')"
      :width="600"
      :footer="null"
...
/**
 * 员工离职办理记录管理页 · 由 generate-vue-from-api 根据 types/api 生成
...
function handleCreate() {
  formTitle.value = t('common.page.button.create') + t('entity.employeeResignation._self')
  formData.value = {}
  formVisible.value = true
}
function handleEdit(record: EmployeeResignation) {
  formTitle.value = t('common.page.button.edit') + t('entity.employeeResignation._self')
