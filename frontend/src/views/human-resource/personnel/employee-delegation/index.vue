    ...
    >
      ...
      <template #detail>
        <EmployeeDelegationPanel
          ref="employeeDelegationPanelRef"
...
import EmployeeDelegationPanel from './components/employee-delegation-panel.vue'
...
const employeeDelegationPanelRef = ref<InstanceType<typeof EmployeeDelegationPanel> | null>(null)
...
async function handleFormSubmit() {
  ...
  employeeDelegationPanelRef.value?.reload?.()
    }
    loadData()
  } finally {
    formLoading.value = false
