...
<!-- 文件名称：index.vue -->
<!-- 功能描述：员工代理关系实体 独立记录所有代理场景管理页面，含查询、增删改，由 generate-vue-crud-from-api.cjs 根据 types/api 自动生成 -->
...
<template>
  <div class="p-4">
    ...
    <TaktQueryDrawer
      ...
      :storage-key="'takt-query-fields-human-resource-personnel-employee-delegation'"
