...
const formFields = ["tenantCode","companyCode","cultureCode","proxyEmployeeId","originalEmployeeId","delegationType","scopeType","scopeId","reason","startDate","endDate","extField","remark"]
