...
const formFields = ["tenantCode","companyCode","companyDefaultCulture","employeeId","schoolName","educationLevel","degreeLevel","majorName","certificateNo","startDate","endDate","isHighest","extFieldJson","remark"]
...
const rules = computed<Record<string, Rule[]>>(() => ({
  ...
  isHighest: [
    {
      required: true,
      message: t('common.page.form.placeholder.select', { field: t('entity.employeeEducation.ishighest') }),
      trigger: 'change'
    }
  ],
}))
