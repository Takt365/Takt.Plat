...
<!-- 功能描述：员工教育经历维护弹窗内嵌表单。由 generate-vue-from-api 根据 types/api 自动生成；defineExpose 提供 validate、getValues、resetFields -->
...
/**
 * 员工教育经历维护表单 · 由 generate-vue-from-api 根据 types/api 生成
