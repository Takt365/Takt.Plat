...
<template>
  <div class="p-4 flex flex-col min-h-0 h-full">
    ...
    >
      ...
      <template #detail>
        <EmployeeReassignmentPanel
          ref="employeeReassignmentPanelRef"
...
import EmployeeReassignmentPanel from './components/employee-reassignment-panel.vue'
...
const employeeReassignmentPanelRef = ref<InstanceType<typeof EmployeeReassignmentPanel> | null>(null)
...
async function handleFormSubmit() {
  ...
  employeeReassignmentPanelRef.value?.reload?.()
    }
    loadData()
  } finally {
    formLoading.value = false
