...
<!-- 文件名称：index.vue -->
<!-- 功能描述：员工外部工作经历管理页面，含查询、增删改，由 generate-vue-crud-from-api.cjs 根据 types/api 自动生成 -->
...
<template>
  <div class="human-resource-personnel-employee-experience">
    ...
    <TaktQueryDrawer
      ...
      :storage-key="'takt-query-fields-human-resource-personnel-employee-experience'"
