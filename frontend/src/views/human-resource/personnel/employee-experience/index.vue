    ...
    >
      ...
      <template #detail>
        <EmployeeExperiencePanel
          ref="employeeExperiencePanelRef"
...
import EmployeeExperiencePanel from './components/employee-experience-panel.vue'
...
const employeeExperiencePanelRef = ref<InstanceType<typeof EmployeeExperiencePanel> | null>(null)
...
async function handleFormSubmit() {
  ...
  employeeExperiencePanelRef.value?.reload?.()
    }
    loadData()
  } finally {
    formLoading.value = false
