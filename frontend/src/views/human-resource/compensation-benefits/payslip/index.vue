...
<!-- 命名空间：@/views/human-resource/compensation-benefits/payslip -->
<!-- 文件名称：index.vue -->
<!-- 功能描述：员工薪资条管理页面，含查询、增删改，由 generate-vue-from-api 根据 types/api 自动生成 -->
<!-- 版权信息：Copyright (c) 2025 Takt  All rights reserved. -->
<!-- 免责声明：此软件使用 MIT License，作者不承担任何使用风险。 -->
<!-- ======================================== -->

<template>
  <div class="human-resource-compensation-benefits-payslip">
    <!-- 查询栏 -->
    <TaktQueryBar
    ...
    <!-- 工具栏 -->
    <TaktToolsBar
      create-permission="humanresource:compensationbenefits:payslip:create"
      update-permission="humanresource:compensationbenefits:payslip:update"
      delete-permission="humanresource:compensationbenefits:payslip:delete"
      import-permission="humanresource:compensationbenefits:payslip:import"
      export-permission="humanresource:compensationbenefits:payslip:export"
      :show-create="true"
      :show-update="true"
      :show-delete="true"
      :show-import="true"
    ...
    <TaktModal
      ...
      :title="t('common.page.button.import') + t('entity.payslip._self')"
      :width="600"
      :footer="null"
...
/**
 * 员工薪资条管理页 · 由 generate-vue-from-api 根据 types/api 生成
 * @module views/human-resource/compensation-benefits/payslip
 */
    ...
    actions: [
      {
        ...
        shape: 'plain',
        icon: RiEditLine,
        permission: 'humanresource:compensationbenefits:payslip:update',
      ...
      },
      {
        ...
        permission: 'humanresource:compensationbenefits:payslip:delete',
...
function handleCreate() {
  formTitle.value = t('common.page.button.create') + t('entity.payslip._self')
  formData.value = {}
  formVisible.value = true
}
function handleEdit(record: Payslip) {
  formTitle.value = t('common.page.button.edit') + t('entity.payslip._self')
...
.human-resource-compensation-benefits-payslip {
  padding: 16px;
  display: flex;
