...
<!-- 文件名称：index.vue -->
<!-- 功能描述：薪资核算批次管理页面，含查询、增删改，由 generate-vue-from-api 根据 types/api 自动生成 -->
...
<template>
  <div class="human-resource-compensation-benefits-salary-calc">
    ...
    <TaktModal
      ...
      :title="t('common.page.button.import') + t('entity.salaryCalc._self')"
      :width="600"
      :footer="null"
...
/**
 * 薪资核算批次管理页 · 由 generate-vue-from-api 根据 types/api 生成
...
function handleCreate() {
  formTitle.value = t('common.page.button.create') + t('entity.salaryCalc._self')
  formData.value = {}
  formVisible.value = true
}
function handleEdit(record: SalaryCalc) {
  formTitle.value = t('common.page.button.edit') + t('entity.salaryCalc._self')
