...
<!-- 功能描述：个税计算规则维护弹窗内嵌表单。由 generate-vue-crud-from-api.cjs 根据 types/api 自动生成；defineExpose 提供 validate、getValues、resetFields -->
...
/**
 * 个税计算规则维护表单 · 由 generate-vue-crud-from-api.cjs 根据 types/api 生成
