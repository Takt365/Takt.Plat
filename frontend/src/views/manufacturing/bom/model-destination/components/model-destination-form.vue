...
<!-- 命名空间：@/views/manufacturing/bom/model-destination/components -->
<!-- 文件名称：model-destination-form.vue -->
<!-- 功能描述：Takt型号目的地实体维护弹窗内嵌表单。由 generate-vue-from-api 根据 types/api 自动生成；defineExpose 提供 validate、getValues、resetFields -->
...
/**
 * Takt型号目的地实体维护表单 · 由 generate-vue-from-api 根据 types/api 生成
 * @module views/manufacturing/bom/model-destination/components
 */
...
interface Props {
  formData?: Partial<ModelDestinationCreate & { modelDestinationId?: string }> | null
  loading?: boolean
}
