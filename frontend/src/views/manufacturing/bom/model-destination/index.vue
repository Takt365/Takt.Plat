...
<!-- 命名空间：@/views/manufacturing/bom/model-destination -->
<!-- 文件名称：index.vue -->
...
<template>
  <div class="manufacturing-bom-model-destination">
    <!-- 查询栏 -->
    <TaktQueryBar
    ...
    <!-- 工具栏 -->
    <TaktToolsBar
      create-permission="manufacturing:bom:modeldestination:create"
      update-permission="manufacturing:bom:modeldestination:update"
      delete-permission="manufacturing:bom:modeldestination:delete"
      import-permission="manufacturing:bom:modeldestination:import"
      export-permission="manufacturing:bom:modeldestination:export"
      :show-create="true"
      :show-update="true"
      :show-delete="true"
      :show-import="true"
 ...
 * @module views/manufacturing/bom/model-destination
 */
    ...
    actions: [
      {
        ...
        shape: 'plain',
        icon: RiEditLine,
        permission: 'manufacturing:bom:modeldestination:update',
      ...
      },
      {
        ...
        permission: 'manufacturing:bom:modeldestination:delete',
...
.manufacturing-bom-model-destination {
  padding: 16px;
  display: flex;
