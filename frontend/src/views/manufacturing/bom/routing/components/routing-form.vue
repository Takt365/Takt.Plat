...
<!-- 命名空间：@/views/manufacturing/bom/routing/components -->
<!-- 文件名称：routing-form.vue -->
<!-- 功能描述：工艺路线主表实体维护弹窗内嵌表单。由 generate-vue-from-api 根据 types/api 自动生成；defineExpose 提供 validate、getValues、resetFields -->
      ...
      >
        <div :class="formContentClass">
          <a-row :gutter="24">
            ...
            <a-col :span="12">
              <a-form-item
                :label="t('entity.routing.items')"
                name="items"
              >
                <a-input
                  v-model:value="formState.items"
                  :placeholder="t('common.page.form.placeholder.required', { field: t('entity.routing.items') })"
                  size="small"
                  allow-clear
                />
              </a-form-item>
            ...
            <a-col :span="12">
              <a-form-item
                :label="t('entity.routing.changelogs')"
                name="changeLogs"
              >
                <a-input
                  v-model:value="formState.changeLogs"
                  :placeholder="t('common.page.form.placeholder.required', { field: t('entity.routing.changelogs') })"
                  size="small"
                  allow-clear
                />
              </a-form-item>
...
/**
 * 工艺路线主表实体维护表单 · 由 generate-vue-from-api 根据 types/api 生成
 * @module views/manufacturing/bom/routing/components
 */
...
const formFields = ["tenantCode","companyCode","companyDefaultCulture","plantCode","workCenter","routingCode","routingName","purpose","materialCode","version","routingStatus","effectiveDate","expiryDate","routingDescription","items","changeLogs","extFieldJson","remark"]
