...
<!-- 功能描述：来访接待主实体维护弹窗内嵌表单。由 generate-vue-from-api 根据 types/api 自动生成；defineExpose 提供 validate、getValues、resetFields -->
      ...
      >
        <div :class="formContentClass">
          <a-row :gutter="24">
            ...
            <a-col :span="12">
              <a-form-item
                :label="t('entity.visitor.companions')"
                name="companions"
              >
                <a-input
                  v-model:value="formState.companions"
                  :placeholder="t('common.page.form.placeholder.required', { field: t('entity.visitor.companions') })"
                  size="small"
                  allow-clear
                />
              </a-form-item>
...
/**
 * 来访接待主实体维护表单 · 由 generate-vue-from-api 根据 types/api 生成
...
const formFields = ["tenantCode","companyCode","companyDefaultCulture","visitorCompanyName","visitStartTime","visitEndTime","companions","extFieldJson","remark"]
