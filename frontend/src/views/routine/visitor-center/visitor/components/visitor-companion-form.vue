...
<!-- 功能描述：来访接待主实体子表 visitorCompanion 独立 CRUD 弹窗表单；defineExpose validate/getValues/resetFields。由 generate-vue-master-detail-from-api.cjs 生成，风格与主表 *-form 一致 -->
...
<template>
  <a-form
    ref="formRef"
    class="takt-generated-form visitor-companion-form flex flex-col min-h-0"
    :model="formState"
    :rules="rules"
    layout="horizontal"
    label-align="right"
...
/**
 * 来访接待主实体子表 visitorCompanion 维护表单 · 由 generate-vue-master-detail-from-api.cjs 生成
...
/** 映射为 Create/Update DTO（含主表外键 visitorId） */
