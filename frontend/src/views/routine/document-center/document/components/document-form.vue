...
const formFields = ["tenantCode","companyCode","cultureCode","documentCode","title","documentCategory","documentStatus","confidentialLevel","version","content","summary","tags","fileId","fileName","filePath","fileSize","fileType","fileExtension","effectiveTime","expireTime","publishTime","publisherId","publisherName","deptId","deptName","isTop","viewCount","downloadCount","targetScope","targetDepartments","targetUsers","extField","remark"]
