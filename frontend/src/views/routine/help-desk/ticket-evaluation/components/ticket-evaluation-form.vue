...
<!-- 功能描述：工单服务评价维护弹窗内嵌表单。由 generate-vue-crud-from-api.cjs 根据 types/api 自动生成；defineExpose 提供 validate、getValues、resetFields -->
...
/**
 * 工单服务评价维护表单 · 由 generate-vue-crud-from-api.cjs 根据 types/api 生成
...
const formFields = ["tenantCode","companyCode","cultureCode","ticketId","score","comment","evaluatorId","evaluatorName","evaluatedAt","extField","remark"]
