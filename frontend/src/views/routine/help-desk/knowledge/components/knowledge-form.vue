...
const formFields = ["tenantCode","companyCode","cultureCode","title","content","summary","categoryCode","tags","attachments","knowledgeStatus","viewCount","helpfulCount","unhelpfulCount","isPublished","version","publishedAt","revisedAt","extField","remark"]
