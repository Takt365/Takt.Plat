...
<!-- 功能描述：服务台知识库实体维护弹窗内嵌表单。由 generate-vue-crud-from-api.cjs 根据 types/api 自动生成；defineExpose 提供 validate、getValues、resetFields -->
      ...
      >
        <div :class="formContentClass">
          <a-row :gutter="24">
            ...
            <a-col :span="24">
              <a-form-item
                :label="t('entity.knowledge.attachments')"
                name="attachments"
              >
                <a-textarea
...
/**
 * 服务台知识库实体维护表单 · 由 generate-vue-crud-from-api.cjs 根据 types/api 生成
...
const formFields = ["tenantCode","companyCode","companyDefaultCulture","title","content","summary","categoryCode","tags","attachments","knowledgeStatus","viewCount","helpfulCount","unhelpfulCount","isPublished","version","publishedAt","revisedAt","extField","remark"]
