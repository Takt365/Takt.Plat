...
<!-- 功能描述：服务台知识库实体维护弹窗内嵌表单。由 generate-vue-from-api 根据 types/api 自动生成；defineExpose 提供 validate、getValues、resetFields -->
      ...
      >
        <div :class="formContentClass">
          <a-row :gutter="24">
            ...
            <a-col :span="12">
              <a-form-item
                :label="t('entity.knowledge.changelogs')"
                name="changeLogs"
              >
                <a-input
                  v-model:value="formState.changeLogs"
                  :placeholder="t('common.page.form.placeholder.required', { field: t('entity.knowledge.changelogs') })"
                  size="small"
                  allow-clear
                />
              </a-form-item>
...
/**
 * 服务台知识库实体维护表单 · 由 generate-vue-from-api 根据 types/api 生成
...
const formFields = ["tenantCode","companyCode","companyDefaultCulture","title","content","summary","categoryCode","tags","knowledgeStatus","sortOrder","viewCount","helpfulCount","unhelpfulCount","isPublished","version","publishedAt","revisedAt","changeLogs","extFieldJson","remark"]
