...
const formFields = ["tenantCode","companyCode","cultureCode","assetCode","warrantyType","warrantyStartDate","warrantyExpiryDate","warrantyProvider","warrantyContractCode","serviceHotline","serviceEmail","maintenanceExpiryDate","lastMaintenanceDate","nextMaintenanceDate","warrantyRemark","extField","remark"]
