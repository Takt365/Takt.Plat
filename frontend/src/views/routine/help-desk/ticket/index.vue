...
<!-- 文件名称：index.vue -->
<!-- 功能描述：Takt工单实体管理页面，含查询、增删改，由 generate-vue-from-api 根据 types/api 自动生成 -->
...
<template>
  <div class="routine-help-desk-ticket">
    ...
    >
      ...
      <a-form-item :label="t('entity.ticket.content')">
        <a-input
          ...
          :placeholder="t('common.page.form.placeholder.required', { field: t('entity.ticket.content') })"
          allow-clear
        />
      </a-form-item>
    ...
    <TaktModal
      ...
      :title="t('common.page.button.import') + t('entity.ticket._self')"
      :width="600"
      :footer="null"
...
/**
 * Takt工单实体管理页 · 由 generate-vue-from-api 根据 types/api 生成
...
function handleCreate() {
  formTitle.value = t('common.page.button.create') + t('entity.ticket._self')
  formData.value = {}
  formVisible.value = true
}
function handleEdit(record: Ticket) {
  formTitle.value = t('common.page.button.edit') + t('entity.ticket._self')
