...
const formFields = ["tenantCode","companyCode","companyDefaultCulture","newsId","parentId","userId","userName","userAvatar","replyToUserId","replyToUserName","commentContent","commentTime","likeCount","replyCount","commentLevel","commentStatus","extField","remark"]
