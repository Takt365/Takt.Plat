...
<!-- 文件名称：index.vue -->
<!-- 功能描述：新闻中心主实体 支持分类、置顶、推荐、社交统计管理页面，含查询、增删改，由 generate-vue-from-api 根据 types/api 自动生成 -->
...
<template>
  <div class="routine-news-center-news">
    ...
    >
      ...
      <a-form-item :label="t('entity.news.content')">
        <a-input
          ...
          :placeholder="t('common.page.form.placeholder.required', { field: t('entity.news.content') })"
          allow-clear
        />
      </a-form-item>
    ...
    <TaktModal
      ...
      :title="t('common.page.button.import') + t('entity.news._self')"
      :width="600"
      :footer="null"
...
/**
 * 新闻中心主实体 支持分类、置顶、推荐、社交统计管理页 · 由 generate-vue-from-api 根据 types/api 生成
...
function handleCreate() {
  formTitle.value = t('common.page.button.create') + t('entity.news._self')
  formData.value = {}
  formVisible.value = true
}
function handleEdit(record: News) {
  formTitle.value = t('common.page.button.edit') + t('entity.news._self')
