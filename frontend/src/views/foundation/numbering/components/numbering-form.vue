...
const formFields = ["tenantCode","companyCode","companyDefaultCulture","ruleCode","ruleName","documentType","deptCode","prefixCode","dateFormat","sequenceLength","sequenceStep","suffixCode","resetPeriod","currentSequence","exampleCode","separator","isBuiltIn","status","description","extField","remark"]
