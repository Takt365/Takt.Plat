...
<!-- 功能描述：系统设置实体 存储系统的各种配置参数维护弹窗内嵌表单。由 generate-vue-from-api 根据 types/api 自动生成；defineExpose 提供 validate、getValues、resetFields -->
...
/**
 * 系统设置实体 存储系统的各种配置参数维护表单 · 由 generate-vue-from-api 根据 types/api 生成
