...
<!-- 功能描述：差异日志实体维护弹窗内嵌表单。由 generate-vue-from-api 根据 types/api 自动生成；defineExpose 提供 validate、getValues、resetFields -->
...
/**
 * 差异日志实体维护表单 · 由 generate-vue-from-api 根据 types/api 生成
