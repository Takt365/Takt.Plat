      ...
      >
        <div :class="formContentClass">
          <a-row :gutter="24">
            <a-col :span="12">
              <a-form-item
                :label="pi.label('backupKind')"
                name="backupKind"
              >
                <a-input
                  v-model:value="formState.backupKind"
                  :placeholder="pi.ph('backupKind')"
                  show-count
                  :maxlength="40"
                  allow-clear
                />
            ...
            <a-col :span="12">
              <a-form-item
                :label="pi.label('sourceId')"
                name="sourceId"
              >
                <a-input
                  v-model:value="formState.sourceId"
                  :placeholder="pi.ph('sourceId')"
                  show-count
                  :maxlength="40"
                  allow-clear
                />
            ...
            <a-col :span="12">
              ...
              >
                <a-input
                  ...
                  :maxlength="40"
                  allow-clear
                  :disabled="!!formData?.backupLogId"
                />
              </a-form-item>
            </a-col>
            <a-col :span="12">
              <a-form-item
                :label="pi.label('targetName')"
                name="targetName"
              >
                <a-input
                  v-model:value="formState.targetName"
                  :placeholder="pi.ph('targetName')"
                  show-count
                  :maxlength="200"
                  allow-clear
                />
            ...
            <a-col :span="12">
              <a-form-item
                :label="pi.label('syncMode')"
                name="syncMode"
              >
                <a-input-number
                  v-model:value="formState.syncMode"
                  :placeholder="pi.ph('syncMode')"
                  style="width: 100%"
                />
              </a-form-item>
            </a-col>
            <a-col :span="12">
              <a-form-item
                :label="pi.label('executeMode')"
                name="executeMode"
              >
                <a-input-number
                  v-model:value="formState.executeMode"
                  :placeholder="pi.ph('executeMode')"
                  style="width: 100%"
                />
              </a-form-item>
            </a-col>
            <a-col :span="12">
              <a-form-item
                :label="pi.label('pathType')"
                name="pathType"
              >
                <a-input-number
                  v-model:value="formState.pathType"
                  :placeholder="pi.ph('pathType')"
                  style="width: 100%"
                />
              </a-form-item>
            </a-col>
            <a-col :span="12">
              <a-form-item
                :label="pi.label('resultPath')"
                name="resultPath"
              >
                <a-input
                  v-model:value="formState.resultPath"
                  :placeholder="pi.ph('resultPath')"
                  show-count
                  :maxlength="500"
                  allow-clear
                />
            ...
            <a-col :span="12">
              <a-form-item
                :label="pi.label('fileSizeBytes')"
                name="fileSizeBytes"
              >
                <a-input
                  v-model:value="formState.fileSizeBytes"
                  :placeholder="pi.ph('fileSizeBytes')"
                  show-count
                  :maxlength="20"
                  allow-clear
                />
      ...
      >
        <div :class="formContentClass">
          <a-row :gutter="24">
            ...
            <a-col :span="24">
              <a-form-item
                :label="pi.label('errorMessage')"
                name="errorMessage"
              >
                <a-input
                  v-model:value="formState.errorMessage"
                  :placeholder="pi.ph('errorMessage')"
                  show-count
                  :maxlength="2000"
                  allow-clear
                />
            ...
            <a-col :span="24">
              <a-form-item
                :label="pi.label('finishedAt')"
                name="finishedAt"
              >
                <a-date-picker
                  v-model:value="formState.finishedAt"
                  :placeholder="pi.ph('finishedAt')"
                  value-format="YYYY-MM-DD"
                  style="width: 100%"
                />
              </a-form-item>
