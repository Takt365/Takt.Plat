...
<!-- 命名空间：@/views/logistics/sales/price-change-log -->
<!-- 文件名称：index.vue -->
...
<template>
  <div class="p-4 flex flex-col min-h-0 h-full">
    ...
    >
      ...
      <template #detail>
        <SalesPriceChangeLogPanel
          ref="salesPriceChangeLogPanelRef"
    ...
    <TaktQueryDrawer
      ...
      :storage-key="'takt-query-fields-logistics-sales-price-change-log'"
 ...
 * @module views/logistics/sales/price-change-log
 */
...
import SalesPriceChangeLogPanel from './components/price-change-log-panel.vue'
...
const salesPriceChangeLogPanelRef = ref<InstanceType<typeof SalesPriceChangeLogPanel> | null>(null)
...
async function handleFormSubmit() {
  ...
  salesPriceChangeLogPanelRef.value?.reload?.()
    }
    loadData()
  } finally {
    formLoading.value = false
