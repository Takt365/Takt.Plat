...
<template>
  <div class="p-4 flex flex-col min-h-0 h-full">
    ...
    >
      ...
      <template #bodyCell="{ column, record }">
        <template v-if="column.key === 'priceStatus'">
          <a-switch
            :checked="getSalesPriceField(record, 'priceStatus') === 1"
    ...
    >
      ...
      <a-form-item :label="t('entity.salesprice.extfield')">
        <a-textarea
...
import { provideSalesPriceMasterContext } from './composables/use-price-master-context'
...
const queryFieldsMeta = computed(() => [
  ...
  { key: 'effectiveStartDateStart', label: t('common.page.entity.createdatstart').replace(t('common.page.entity.createdat'), t('entity.salesprice.effectivestartdate')) },
  { key: 'effectiveStartDateEnd', label: t('common.page.entity.createdatend').replace(t('common.page.entity.createdat'), t('entity.salesprice.effectivestartdate')) },
  { key: 'effectiveEndDateStart', label: t('common.page.entity.createdatstart').replace(t('common.page.entity.createdat'), t('entity.salesprice.effectiveenddate')) },
  { key: 'effectiveEndDateEnd', label: t('common.page.entity.createdatend').replace(t('common.page.entity.createdat'), t('entity.salesprice.effectiveenddate')) },
  { key: 'priceStatus', label: t('entity.salesprice.pricestatus') },
  { key: 'createdAtStart', label: t('common.page.entity.createdatstart') },
  { key: 'createdAtEnd', label: t('common.page.entity.createdatend') },
  { key: 'ExtField', label: t('entity.salesprice.extfield') },
...
function buildListQuery(overrides?: Partial<SalesPriceQuery>): SalesPriceQuery {
  ...
  assignTrimmed('salesPriceCode', form.salesPriceCode)
...
function syncMasterSelection(record: SalesPrice | null) {
...
function handleMasterSelect(record: Record<string, unknown>) {
  const row = record as unknown as SalesPrice
 ...
 * @param checked 是否启用
 */
async function handlePriceStatusChange(record: SalesPrice, checked: boolean) {
  const newVal = checked ? 1 : 0
  const oldVal = getSalesPriceField(record, 'priceStatus')
  const id = getSalesPriceId(record)
