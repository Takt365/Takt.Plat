...
export type SalesOrderQueryField =
  ...
  | 'totalQuantity' | 'totalAmount' | 'discountAmount' | 'taxAmount' | 'actualAmount' | 'shippedQuantity' | 'shippedAmount' | 'receivedAmount' | 'deliveryMethod' | 'paymentMethod' | 'orderStatus' | 'deliveryStatus'
