...
<!-- 文件名称：model-trend-query-form.vue -->
...
import {
  getSalesModelTrendCustomerOptionsUrl,
  getSalesModelTrendMaterialOptionsUrl,
  getSalesModelTrendPlantOptionsUrl,
  getSalesModelTrendPriceTypeOptionsUrl,
...
const plantOptionsUrl = getSalesModelTrendPlantOptionsUrl()
const priceTypeOptionsUrl = getSalesModelTrendPriceTypeOptionsUrl()
const customerOptionsUrl = getSalesModelTrendCustomerOptionsUrl()
const materialOptionsUrl = getSalesModelTrendMaterialOptionsUrl()
...
.model-trend-query-bar__control--plant {
  width: 10rem;
  min-width: 8rem;
}

.model-trend-query-bar__control--period {
  width: 16rem;
  min-width: 14rem;
}

.model-trend-query-bar__control--price-type {
  width: 10rem;
  min-width: 8rem;
}

.model-trend-query-bar__control--customer {
  width: 12rem;
  min-width: 9rem;
}

.model-trend-query-bar__control--material {
  width: 12rem;
  min-width: 9rem;
}
