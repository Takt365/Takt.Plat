...
<!-- 命名空间：@/views/logistics/sales/quotation-change-log -->
<!-- 文件名称：index.vue -->
...
<template>
  <div class="p-4 flex flex-col min-h-0 h-full">
    ...
    >
      ...
      <template #detail>
        <SalesQuotationChangeLogPanel
          ref="salesQuotationChangeLogPanelRef"
    ...
    <TaktQueryDrawer
      ...
      :storage-key="'takt-query-fields-logistics-sales-quotation-change-log'"
 ...
 * @module views/logistics/sales/quotation-change-log
 */
...
import SalesQuotationChangeLogPanel from './components/quotation-change-log-panel.vue'
...
const salesQuotationChangeLogPanelRef = ref<InstanceType<typeof SalesQuotationChangeLogPanel> | null>(null)
...
async function handleFormSubmit() {
  ...
  salesQuotationChangeLogPanelRef.value?.reload?.()
    }
    loadData()
  } finally {
    formLoading.value = false
