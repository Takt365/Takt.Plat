      ...
      >
        <div :class="formContentClass">
          <a-row :gutter="24">
            <a-col :span="12">
              <a-form-item
                :label="t('entity.salesinvoiceitem.linenumber')"
                name="lineNumber"
              >
                <a-input-number
            ...
            <a-col :span="12">
              <a-form-item
                :label="t('entity.salesinvoiceitem.materialcode')"
                name="materialCode"
              >
                <a-input
            ...
            <a-col :span="12">
              <a-form-item
                :label="t('entity.salesinvoiceitem.materialname')"
                name="materialName"
              >
                <a-input
            ...
            <a-col :span="12">
              <a-form-item
                :label="t('entity.salesinvoiceitem.materialspecification')"
            ...
            <a-col :span="12">
              <a-form-item
                :label="t('entity.salesinvoiceitem.salesunit')"
                name="salesUnit"
              >
                <a-input
            ...
            <a-col :span="12">
              <a-form-item
                :label="t('entity.salesinvoiceitem.invoicequantity')"
            ...
            <a-col :span="12">
              <a-form-item
                :label="t('entity.salesinvoiceitem.unitprice')"
                name="unitPrice"
              >
                <a-input-number
            ...
            <a-col :span="12">
              <a-form-item
                :label="t('entity.salesinvoiceitem.discountrate')"
                name="discountRate"
              >
                <a-input-number
...
const formFields = ["lineNumber","materialCode","materialName","materialSpecification","salesUnit","invoiceQuantity","unitPrice","discountRate"]
...
const rules = computed<Record<string, Rule[]>>(() => ({
  lineNumber: [{
    validator: async (_rule, value) => {
      if (value === undefined || value === null || value === '') {
        return Promise.reject(t('common.page.form.placeholder.select', { field: t('entity.salesinvoiceitem.linenumber') }))
      }
  ...
  materialCode: [
    {
      required: true,
      message: t('common.page.form.placeholder.required', { field: t('entity.salesinvoiceitem.materialcode') }),
      trigger: 'blur'
    }
  ],
  materialName: [
    {
      required: true,
      message: t('common.page.form.placeholder.required', { field: t('entity.salesinvoiceitem.materialname') }),
      trigger: 'blur'
    }
  ],
  salesUnit: [
    {
      required: true,
      message: t('common.page.form.placeholder.required', { field: t('entity.salesinvoiceitem.salesunit') }),
      trigger: 'blur'
    }
  ],
  invoiceQuantity: [{
    validator: async (_rule, value) => {
      if (value === undefined || value === null || value === '') {
        return Promise.reject(t('common.page.form.placeholder.select', { field: t('entity.salesinvoiceitem.invoicequantity') }))
      }
      const num = typeof value === 'number' ? value : Number(value)
      if (!Number.isFinite(num)) {
        return Promise.reject(t('common.page.form.placeholder.select', { field: t('entity.salesinvoiceitem.invoicequantity') }))
  ...
  unitPrice: [{
    validator: async (_rule, value) => {
      if (value === undefined || value === null || value === '') {
        return Promise.reject(t('common.page.form.placeholder.select', { field: t('entity.salesinvoiceitem.unitprice') }))
      }
      const num = typeof value === 'number' ? value : Number(value)
      if (!Number.isFinite(num)) {
        return Promise.reject(t('common.page.form.placeholder.select', { field: t('entity.salesinvoiceitem.unitprice') }))
  ...
  discountRate: [{
    validator: async (_rule, value) => {
      if (value === undefined || value === null || value === '') {
        return Promise.reject(t('common.page.form.placeholder.select', { field: t('entity.salesinvoiceitem.discountrate') }))
      }
      const num = typeof value === 'number' ? value : Number(value)
      if (!Number.isFinite(num)) {
        return Promise.reject(t('common.page.form.placeholder.select', { field: t('entity.salesinvoiceitem.discountrate') }))
