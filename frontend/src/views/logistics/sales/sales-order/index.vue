...
<!-- 文件名称：index.vue -->
<!-- 功能描述：Takt销售订单实体管理页面，含查询、增删改，由 generate-vue-from-api 根据 types/api 自动生成 -->
...
<template>
  <div class="logistics-sales-sales-order">
    ...
    <TaktModal
      ...
      :title="t('common.page.button.import') + t('entity.salesOrder._self')"
      :width="600"
      :footer="null"
...
/**
 * Takt销售订单实体管理页 · 由 generate-vue-from-api 根据 types/api 生成
...
function handleCreate() {
  formTitle.value = t('common.page.button.create') + t('entity.salesOrder._self')
  formData.value = {}
  formVisible.value = true
}
function handleEdit(record: SalesOrder) {
  formTitle.value = t('common.page.button.edit') + t('entity.salesOrder._self')
