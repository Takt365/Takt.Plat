...
import type { PurchasePrice } from '@/types/logistics/procurement/price'
...
const purchasePriceMasterContextKey: InjectionKey<PurchasePriceMasterContext> = Symbol('priceMasterContext')
...
export function usePurchasePriceMasterContext(): PurchasePriceMasterContext {
  ...
  if (!ctx) {
    throw new Error('usePurchasePriceMasterContext must be used within price index')
  }
  return ctx
}
