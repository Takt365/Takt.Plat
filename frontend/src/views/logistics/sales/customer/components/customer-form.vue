...
<!-- 功能描述：Takt客户信息实体维护弹窗内嵌表单。由 generate-vue-from-api 根据 types/api 自动生成；defineExpose 提供 validate、getValues、resetFields -->
      ...
      >
        <div :class="formContentClass">
          <a-row :gutter="24">
            ...
            <a-col :span="12">
              <a-form-item
                :label="t('entity.customer.plantcode')"
                name="plantCode"
              >
                <a-input
            ...
            <a-col :span="12">
              <a-form-item
                :label="t('entity.customer.shortname')"
            ...
            <a-col :span="12">
              <a-form-item
                :label="t('entity.customer.industrysector')"
                name="industrySector"
              >
                <a-input
            ...
            <a-col :span="12">
              <a-form-item
                :label="t('entity.customer.taxnumber')"
      ...
      >
        <div :class="formContentClass">
          <a-row :gutter="24">
            <a-col :span="12">
              <a-form-item
                :label="t('entity.customer.registrationcountry')"
            ...
            <a-col :span="24">
              <a-form-item
                :label="t('entity.customer.registrationaddress1')"
            ...
            <a-col :span="24">
              <a-form-item
                :label="t('entity.customer.registrationaddress2')"
            ...
            <a-col :span="24">
              <a-form-item
                :label="t('entity.customer.registrationaddress3')"
            ...
            <a-col :span="12">
              <a-form-item
                :label="t('entity.customer.website')"
            ...
            <a-col :span="12">
              <a-form-item
                :label="t('entity.customer.contactperson')"
                name="contactPerson"
              >
                <a-input
            ...
            <a-col :span="12">
              <a-form-item
                :label="t('entity.customer.contactphone')"
                name="contactPhone"
              >
                <a-input
      ...
      >
        <div :class="formContentClass">
          <a-row :gutter="24">
            <a-col :span="12">
              <a-form-item
                :label="t('entity.customer.contactemail')"
                name="contactEmail"
              >
                <a-input
            ...
            <a-col :span="12">
              <a-form-item
                :label="t('entity.customer.currencycode')"
                name="currencyCode"
              >
                <a-input
            ...
            <a-col :span="12">
              <a-form-item
                :label="t('entity.customer.paymentterms')"
                name="paymentTerms"
              >
                <a-input-number
            ...
            <a-col :span="12">
              <a-form-item
                :label="t('entity.customer.creditlevel')"
                name="creditLevel"
              >
                <a-input-number
            ...
            <a-col :span="12">
              <a-form-item
                :label="t('entity.customer.creditamount')"
                name="creditAmount"
              >
                <a-input-number
            ...
            <a-col :span="12">
              <a-form-item
                :label="t('entity.customer.discountrate')"
                name="discountRate"
              >
                <a-input-number
            ...
            <a-col :span="12">
              <a-form-item
                :label="t('entity.customer.salesby')"
                name="salesBy"
              >
                <a-input
            ...
            <a-col :span="12">
              <a-form-item
                :label="t('entity.customer.evaluationscore')"
            ...
            <a-col :span="12">
              <a-form-item
                :label="t('entity.customer.isqualified')"
                name="isQualified"
              >
                <a-input-number
      ...
      >
        <div :class="formContentClass">
          <a-row :gutter="24">
            <a-col :span="12">
              <a-form-item
                :label="t('entity.customer.status')"
                name="customerStatus"
              >
                <a-input-number
                  v-model:value="formState.customerStatus"
                  :placeholder="t('common.page.form.placeholder.required', { field: t('entity.customer.status') })"
                  size="small"
                  style="width: 100%"
                />
              </a-form-item>
            ...
            <a-col :span="12">
              <a-form-item
                :label="t('entity.customer.sortorder')"
                name="sortOrder"
              >
                <a-input-number
...
/**
 * Takt客户信息实体维护表单 · 由 generate-vue-from-api 根据 types/api 生成
...
const formFields = ["tenantCode","companyCode","companyDefaultCulture","plantCode","customerCode","customerName","customerShortName","customerType","industrySector","customerTaxNumber","registrationCountry","registrationAddress1","registrationAddress2","registrationAddress3","customerPhone","customerFax","customerEmail","customerWebsite","contactPerson","contactPhone","contactEmail","currencyCode","paymentTerms","creditLevel","creditAmount","discountRate","salesBy","customerLevel","evaluationScore","isQualified","customerStatus","sortOrder","extFieldJson","remark"]
...
watch(
  ...
  () => {
    const isCreate = !props.formData?.customerId
    if (isCreate) {
...
const rules = computed<Record<string, Rule[]>>(() => ({
  plantCode: [
    {
      required: true,
      message: t('common.page.form.placeholder.required', { field: t('entity.customer.plantcode') }),
      trigger: 'blur'
    }
  ],
  customerCode: [
    {
      required: true,
      message: t('common.page.form.placeholder.required', { field: t('entity.customer.code') }),
      trigger: 'blur'
    }
  ],
  customerName: [
    {
      required: true,
      message: t('common.page.form.placeholder.required', { field: t('entity.customer.name') }),
      trigger: 'blur'
    }
  ],
  customerType: [
    {
      required: true,
      message: t('common.page.form.placeholder.select', { field: t('entity.customer.type') }),
      trigger: 'change'
    }
  ],
  currencyCode: [
    {
      required: true,
      message: t('common.page.form.placeholder.required', { field: t('entity.customer.currencycode') }),
      trigger: 'blur'
    }
  ],
  paymentTerms: [
    {
      required: true,
      message: t('common.page.form.placeholder.select', { field: t('entity.customer.paymentterms') }),
      trigger: 'change'
    }
  ],
  creditLevel: [
    {
      required: true,
      message: t('common.page.form.placeholder.select', { field: t('entity.customer.creditlevel') }),
      trigger: 'change'
    }
  ],
  creditAmount: [
    {
      required: true,
      message: t('common.page.form.placeholder.select', { field: t('entity.customer.creditamount') }),
      trigger: 'change'
    }
  ],
  discountRate: [
    {
      required: true,
      message: t('common.page.form.placeholder.select', { field: t('entity.customer.discountrate') }),
      trigger: 'change'
    }
  ],
  customerLevel: [
    {
      required: true,
      message: t('common.page.form.placeholder.select', { field: t('entity.customer.level') }),
      trigger: 'change'
    }
  ],
  evaluationScore: [
    {
      required: true,
      message: t('common.page.form.placeholder.select', { field: t('entity.customer.evaluationscore') }),
      trigger: 'change'
    }
  ],
  isQualified: [
    {
      required: true,
      message: t('common.page.form.placeholder.select', { field: t('entity.customer.isqualified') }),
      trigger: 'change'
    }
  ],
  customerStatus: [
    {
      required: true,
      message: t('common.page.form.placeholder.select', { field: t('entity.customer.status') }),
      trigger: 'change'
    }
  ],
  sortOrder: [
    {
      required: true,
      message: t('common.page.form.placeholder.select', { field: t('entity.customer.sortorder') }),
      trigger: 'change'
    }
  ],
}))
