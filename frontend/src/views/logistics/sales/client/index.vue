...
<!-- 文件名称：index.vue -->
<!-- 功能描述：Takt客户端信息实体管理页面，含查询、增删改，由 generate-vue-crud-from-api.cjs 根据 types/api 自动生成 -->
...
<template>
  <div class="p-4">
    ...
    <TaktQueryDrawer
      ...
      :storage-key="'takt-query-fields-logistics-sales-client'"
...
/**
 * Takt客户端信息实体管理页 · 由 generate-vue-crud-from-api.cjs 根据 types/api 生成
