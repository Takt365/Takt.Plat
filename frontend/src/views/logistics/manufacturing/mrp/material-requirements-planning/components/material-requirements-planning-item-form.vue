...
function getValues(): Record<string, any> {
  ...
  if (props.formData?.materialRequirementsPlanningItemId) {
    payload.materialRequirementsPlanningItemId = props.formData.materialRequirementsPlanningItemId
  }
  ...
  if (masterRow) {
    const masterCode = masterRow.materialRequirementsPlanningCode ?? masterRow.MaterialRequirementsPlanningCode
    const masterName = masterRow.materialRequirementsPlanningName ?? masterRow.MaterialRequirementsPlanningName
    if (masterCode != null && masterCode !== '' && !payload.materialRequirementsPlanningCode) {
      payload.materialRequirementsPlanningCode = masterCode
    }
    if (masterName != null && masterName !== '' && !payload.materialRequirementsPlanningName) {
      payload.materialRequirementsPlanningName = masterName
    }
