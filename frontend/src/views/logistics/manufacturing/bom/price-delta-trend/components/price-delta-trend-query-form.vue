...
import { getBomPriceDeltaTrendPlantOptionsUrl } from '@/api/logistics/manufacturing/bom/price-delta-trend'
...
const plantOptionsUrl = getBomPriceDeltaTrendPlantOptionsUrl()
