...
<template>
  <div class="p-4 flex flex-col min-h-0 h-full">
    ...
    >
      <template #detail>
        <RoutingChangeLogPanel
          ref="routingChangeLogPanelRef"
    ...
    <TaktQueryDrawer
      ...
      :storage-key="'takt-query-fields-logistics-manufacturing-bom-routing-change-log'"
...
import RoutingChangeLogPanel from './components/routing-change-log-panel.vue'
...
const routingChangeLogPanelRef = ref<InstanceType<typeof RoutingChangeLogPanel> | null>(null)
...
async function handleFormSubmit() {
  ...
  routingChangeLogPanelRef.value?.reload?.()
    }
    loadData()
  } finally {
    formLoading.value = false
