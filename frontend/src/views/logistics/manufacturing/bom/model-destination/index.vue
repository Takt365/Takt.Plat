...
<template>
  <div class="logistics-manufacturing-bom-model-destination">
    ...
    <TaktQueryDrawer
      ...
      :storage-key="'takt-query-fields-logistics-manufacturing-bom-model-destination'"
...
const queryFieldsMeta = computed(() => [
  { key: 'plantCode', label: t('entity.modelDestination.plantcode') },
  ...
  { key: 'sortOrder', label: t('entity.modelDestination.sortorder') },
