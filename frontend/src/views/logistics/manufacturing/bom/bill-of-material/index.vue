...
<!-- 文件名称：index.vue -->
<!-- 功能描述：Takt物料清单实体管理页面，含查询、增删改，由 generate-vue-from-api 根据 types/api 自动生成 -->
...
<template>
  <div class="logistics-manufacturing-bom-bill-of-material">
    ...
    <TaktModal
      ...
      :title="t('common.page.button.import') + t('entity.billOfMaterial._self')"
      :width="600"
      :footer="null"
...
/**
 * Takt物料清单实体管理页 · 由 generate-vue-from-api 根据 types/api 生成
...
function handleCreate() {
  formTitle.value = t('common.page.button.create') + t('entity.billOfMaterial._self')
  formData.value = {}
  formVisible.value = true
}
function handleEdit(record: BillOfMaterial) {
  formTitle.value = t('common.page.button.edit') + t('entity.billOfMaterial._self')
