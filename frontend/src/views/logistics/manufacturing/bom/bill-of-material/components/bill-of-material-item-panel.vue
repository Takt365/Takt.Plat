...
<template>
  <div class="bill-of-material-item-panel flex h-full min-h-0 flex-col overflow-hidden">
    ...
    >
      ...
      <a-form-item :label="t('entity.billofmaterialitem.extfield')">
        <a-textarea
          v-model:value="advancedQueryForm.ExtField"
          :placeholder="t('common.page.form.placeholder.optional', { field: t('entity.billofmaterialitem.extfield') })"
          :rows="2"
          allow-clear
        />
      </a-form-item>
...
const queryFieldsMeta = computed(() => [
  ...
  { key: 'ExtField', label: t('entity.billofmaterialitem.extfield') },
