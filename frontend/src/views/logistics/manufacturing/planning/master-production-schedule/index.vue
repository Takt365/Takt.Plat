    ...
    >
      ...
      <a-form-item :label="t('entity.masterproductionschedule.approvalstatus')">
        <a-input-number
          ...
          :placeholder="t('common.page.form.placeholder.required', { field: t('entity.masterproductionschedule.approvalstatus') })"
          style="width: 100%"
        />
      </a-form-item>
      </div>
...
const rowSelection = computed(() => ({
  ...
  onSelect: (record: MasterProductionSchedule, selected: boolean) => {
    ...
    } else if (getMasterProductionScheduleId(selectedRow.value) === getMasterProductionScheduleId(record)) {
