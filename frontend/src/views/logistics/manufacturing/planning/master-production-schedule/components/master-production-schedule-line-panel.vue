...
const rowSelection = computed(() => ({
  ...
  onSelect: (record: MasterProductionScheduleLine, selected: boolean) => {
    ...
    } else if (getMasterProductionScheduleLineId(selectedRow.value) === getMasterProductionScheduleLineId(record)) {
...
async function handleEdit(record: MasterProductionScheduleLine) {
  ...
  try {
    const detail = await (getMasterProductionScheduleLineId(record))
...
async function handleDeleteOne(record: MasterProductionScheduleLine) {
  Modal.confirm({
    ...
    onOk: async () => {
      await (getMasterProductionScheduleLineId(record))
