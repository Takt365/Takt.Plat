...
<!-- 命名空间：@/views/logistics/manufacturing/planning/equipment-operation-rate -->
<!-- 文件名称：index.vue -->
...
<template>
  <div class="p-4">
    ...
    <!-- 工具栏 -->
    <TaktToolsBar
      create-permission="logistics:manufacturing:planning:equipment:operation:rate:create"
      update-permission="logistics:manufacturing:planning:equipment:operation:rate:update"
      delete-permission="logistics:manufacturing:planning:equipment:operation:rate:delete"
      import-permission="logistics:manufacturing:planning:equipment:operation:rate:import"
      export-permission="logistics:manufacturing:planning:equipment:operation:rate:export"
      :show-create="true"
      :show-update="true"
      :show-delete="true"
      :show-import="true"
    ...
    <TaktQueryDrawer
      ...
      :storage-key="'takt-query-fields-logistics-manufacturing-planning-equipment-operation-rate'"
 ...
 * @module views/logistics/manufacturing/planning/equipment-operation-rate
 */
...
import { getEquipmentOperationRateList, getEquipmentOperationRateById, createEquipmentOperationRate, updateEquipmentOperationRate, deleteEquipmentOperationRateById, deleteEquipmentOperationRateBatch, getEquipmentOperationRateTemplate, importEquipmentOperationRate, exportEquipmentOperationRate, updateEquipmentOperationRateStatus } from '@/api/logistics/manufacturing/planning/equipment-operation-rate'
import type { EquipmentOperationRate, EquipmentOperationRateQuery } from '@/types/logistics/manufacturing/planning/equipment-operation-rate'
    ...
    actions: [
      {
        ...
        shape: 'plain',
        icon: RiEditLine,
        permission: 'logistics:manufacturing:planning:equipment:operation:rate:update',
      ...
      },
      {
        ...
        permission: 'logistics:manufacturing:planning:equipment:operation:rate:delete',
