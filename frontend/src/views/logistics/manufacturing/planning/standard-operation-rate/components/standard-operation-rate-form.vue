...
<!-- 命名空间：@/views/logistics/manufacturing/planning/standard-operation-rate/components -->
 ...
 * @module views/logistics/manufacturing/planning/standard-operation-rate/components
 */
...
import type { StandardOperationRateCreate } from '@/types/logistics/manufacturing/planning/standard-operation-rate'
