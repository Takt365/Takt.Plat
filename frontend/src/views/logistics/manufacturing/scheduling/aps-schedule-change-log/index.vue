...
<template>
  <div class="p-4 flex flex-col min-h-0 h-full">
    ...
    >
      <template #detail>
        <ApsScheduleChangeLogPanel
          ref="apsScheduleChangeLogPanelRef"
    ...
    <TaktQueryDrawer
      ...
      :storage-key="'takt-query-fields-logistics-manufacturing-scheduling-aps-schedule-change-log'"
...
import ApsScheduleChangeLogPanel from './components/aps-schedule-change-log-panel.vue'
...
const apsScheduleChangeLogPanelRef = ref<InstanceType<typeof ApsScheduleChangeLogPanel> | null>(null)
...
async function handleFormSubmit() {
  ...
  apsScheduleChangeLogPanelRef.value?.reload?.()
    }
    loadData()
  } finally {
    formLoading.value = false
