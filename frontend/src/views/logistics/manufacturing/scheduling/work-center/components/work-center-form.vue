...
<template>
  <a-form
    ref="formRef"
    class="takt-generated-form work-center-form flex flex-col min-h-0"
    :model="formState"
    :rules="rules"
    layout="horizontal"
    label-align="right"
  >
      ...
      >
        <div :class="formContentClass">
          <a-row :gutter="24">
            ...
            <a-col :span="12">
              <a-form-item
                :label="t('entity.workcenter.plantcode')"
                name="plantCode"
              >
                <a-input
            ...
            <a-col :span="12">
              <a-form-item
                :label="t('entity.workcenter.code')"
                name="workCenterCode"
              >
                <a-input
            ...
            <a-col :span="12">
              <a-form-item
                :label="t('entity.workcenter.name')"
                name="workCenterName"
              >
                <a-input
    ...
    <TaktEditableTable
      ...
      :title="t('entity.workcenterresource._self')"
      :add-button-entity="t('entity.workcenterresource._self')"
...
import type { WorkCenterCreate } from '@/types/logistics/manufacturing/scheduling/work-center'
...
function syncChildRowsFromFormData(val: Partial<WorkCenterCreate & { workCenterId?: string }> | null | undefined) {
  childWorkCenterResourceRows.value = ((val as any)?.resources ?? []) as Record<string, unknown>[]
}
...
const rules = computed<Record<string, Rule[]>>(() => ({
  plantCode: [
    {
      required: true,
      message: t('common.page.form.placeholder.required', { field: t('entity.workcenter.plantcode') }),
      trigger: 'blur'
    }
  ],
  workCenterCode: [
    {
      required: true,
      message: t('common.page.form.placeholder.required', { field: t('entity.workcenter.code') }),
      trigger: 'blur'
    }
  ],
  workCenterName: [
    {
      required: true,
      message: t('common.page.form.placeholder.required', { field: t('entity.workcenter.name') }),
      trigger: 'blur'
    }
  ],
  workCenterStatus: [{
    validator: async (_rule, value) => {
      if (value === undefined || value === null || value === '') {
        return Promise.reject(t('common.page.form.placeholder.select', { field: t('entity.workcenter.status') }))
      }
