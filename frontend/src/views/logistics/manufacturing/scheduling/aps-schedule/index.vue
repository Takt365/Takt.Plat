...
<!-- 文件名称：index.vue -->
<!-- 功能描述：APS排程主表管理页面，含查询、增删改，由 generate-vue-from-api 根据 types/api 自动生成 -->
...
<template>
  <div class="logistics-manufacturing-scheduling-aps-schedule">
    ...
    <TaktModal
      ...
      :title="t('common.page.button.import') + t('entity.apsSchedule._self')"
      :width="600"
      :footer="null"
...
/**
 * APS排程主表管理页 · 由 generate-vue-from-api 根据 types/api 生成
...
function handleCreate() {
  formTitle.value = t('common.page.button.create') + t('entity.apsSchedule._self')
  formData.value = {}
  formVisible.value = true
}
function handleEdit(record: ApsSchedule) {
  formTitle.value = t('common.page.button.edit') + t('entity.apsSchedule._self')
