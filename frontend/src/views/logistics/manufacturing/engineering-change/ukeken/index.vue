...
<!-- 命名空间：@/views/logistics/manufacturing/engineering-change/ukeken -->
<!-- 文件名称：index.vue -->
<!-- 功能描述：设变受检部门页面 -->
...
<template>
  <div class="p-4">
    ...
    <TaktToolsBar
      ...
      :show-import="false"
      :show-export="true"
      update-permission="logistics:manufacturing:engineeringchange:ukeken:update"
      export-permission="logistics:manufacturing:engineeringchange:ukeken:export"
...
import { getEcUkekenList, updateEcUkeken, exportEcUkekenData } from '@/api/logistics/manufacturing/engineering-change/ukeken';
