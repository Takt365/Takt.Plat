...
<!-- 命名空间：@/views/logistics/manufacturing/engineering-change/koubai -->
<!-- 文件名称：index.vue -->
<!-- 功能描述：设变采购部门页面 -->
...
<template>
  <div class="p-4">
    ...
    <TaktToolsBar
      ...
      :show-import="false"
      :show-export="true"
      update-permission="logistics:manufacturing:engineeringchange:koubai:update"
      export-permission="logistics:manufacturing:engineeringchange:koubai:export"
...
import { getEcKoubaiList, updateEcKoubai, exportEcKoubaiData } from '@/api/logistics/manufacturing/engineering-change/koubai';
