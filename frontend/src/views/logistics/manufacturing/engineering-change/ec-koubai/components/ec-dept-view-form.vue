...
<template>
  <a-form ref="formRef" :model="formState" layout="horizontal" label-align="right" :label-col="{ span: 6 }" :wrapper-col="{ span: 16 }">
    <a-row :gutter="24">
      ...
      <a-col :span="12"><a-form-item :label="t('entity.ecdept.purchaseorderissuedate')"><a-date-picker v-model:value="formState.purchaseOrderIssueDate" value-format="YYYY-MM-DD" class="w-full" /></a-form-item></a-col>
      <a-col :span="12"><a-form-item :label="t('entity.ecdept.supplier')"><a-input v-model:value="formState.supplier" /></a-form-item></a-col>
      <a-col :span="12"><a-form-item :label="t('entity.ecdept.purchaseorderCode')"><a-input v-model:value="formState.purchaseOrderCode" /></a-form-item></a-col>
