...
<!-- 命名空间：@/views/logistics/manufacturing/engineering-change/hinkan -->
<!-- 文件名称：index.vue -->
<!-- 功能描述：设变品管部门页面 -->
...
<template>
  <div class="p-4">
    ...
    <TaktToolsBar
      ...
      :show-import="false"
      :show-export="true"
      update-permission="logistics:manufacturing:engineeringchange:hinkan:update"
      export-permission="logistics:manufacturing:engineeringchange:hinkan:export"
...
import { getEcHinkanList, updateEcHinkan, exportEcHinkanData } from '@/api/logistics/manufacturing/engineering-change/hinkan';
