...
<!-- 命名空间：@/views/logistics/manufacturing/engineering-change/kakunin -->
<!-- 文件名称：index.vue -->
<!-- 功能描述：设变物料确认页面 -->
...
<template>
  <div class="p-4">
    ...
    <TaktToolsBar
      ...
      :show-import="false"
      :show-export="true"
      update-permission="logistics:manufacturing:engineeringchange:kakunin:update"
      export-permission="logistics:manufacturing:engineeringchange:kakunin:export"
...
import { getEcKakuninList, updateEcKakunin, exportEcKakuninData } from '@/api/logistics/manufacturing/engineering-change/kakunin';
