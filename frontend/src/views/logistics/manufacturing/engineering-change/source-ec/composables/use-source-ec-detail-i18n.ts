...
export const SOURCEECDETAIL_PLACEHOLDER = {
  ...
  plantCode: 'optional',
  lineNumber: 'select',
  sourceFinishedProduct: 'required',
  sourceParentPart: 'required',
  sourceLegacyPartCode: 'optional',
  sourceLegacyPartName: 'optional',
  sourceLegacyUsage: 'optional',
  sourceLegacyMountingPosition: 'optional',
  sourceReplacementPartCode: 'optional',
  sourceReplacementPartName: 'optional',
  sourceReplacementUsage: 'optional',
  sourceReplacementMountingPosition: 'optional',
  sourceBomCode: 'optional',
  sourceCompatibility: 'optional',
  sourceDistinction: 'optional',
  sourceInstruction: 'optional',
  sourceLegacyPartDisposition: 'optional',
...
export type SourceEcDetailQueryField =
  ...
  | 'lineNumber' | 'sourceLegacyUsage' | 'sourceReplacementUsage' | 'isObsolete'
