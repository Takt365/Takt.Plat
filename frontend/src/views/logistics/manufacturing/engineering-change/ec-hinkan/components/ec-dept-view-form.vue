...
<!-- 功能描述：设变品管部门表单；defineExpose validate/getValues/resetFields -->
...
<template>
  <a-form ref="formRef" :model="formState" layout="horizontal" label-align="right" :label-col="{ span: 6 }" :wrapper-col="{ span: 16 }">
    <a-row :gutter="24">
      ...
      <a-col :span="12"><a-form-item :label="t('entity.ecdept.inspectionbatch')"><a-input v-model:value="formState.inspectionBatch" /></a-form-item></a-col>
      <a-col :span="12"><a-form-item :label="t('entity.ecdept.samplingCode')"><a-input v-model:value="formState.samplingCode" /></a-form-item></a-col>
