...
<!-- 命名空间：@/views/logistics/manufacturing/engineering-change/seikan -->
<!-- 文件名称：index.vue -->
<!-- 功能描述：设变生管部门页面 -->
...
<template>
  <div class="p-4">
    ...
    <TaktToolsBar
      ...
      :show-import="false"
      :show-export="true"
      update-permission="logistics:manufacturing:engineeringchange:seikan:update"
      export-permission="logistics:manufacturing:engineeringchange:seikan:export"
...
import { getEcSeikanList, updateEcSeikan, exportEcSeikanData } from '@/api/logistics/manufacturing/engineering-change/seikan';
