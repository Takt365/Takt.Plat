...
<!-- 命名空间：@/views/logistics/manufacturing/engineering-change/seizounika -->
<!-- 文件名称：index.vue -->
<!-- 功能描述：设变制造二课页面 -->
...
<template>
  <div class="p-4">
    ...
    <TaktToolsBar
      ...
      :show-import="false"
      :show-export="true"
      update-permission="logistics:manufacturing:engineeringchange:seizounika:update"
      export-permission="logistics:manufacturing:engineeringchange:seizounika:export"
...
import { getEcSeizounikaList, updateEcSeizounika, exportEcSeizounikaData } from '@/api/logistics/manufacturing/engineering-change/seizounika';
