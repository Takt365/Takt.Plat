...
<!-- 功能描述：设变制造一课表单；defineExpose validate/getValues/resetFields -->
...
<template>
  <a-form ref="formRef" :model="formState" layout="horizontal" label-align="right" :label-col="{ span: 6 }" :wrapper-col="{ span: 16 }">
    <a-row :gutter="24">
      ...
      <a-col :span="12"><a-form-item :label="t('entity.ecdept.implementationbatch')"><a-input v-model:value="formState.implementationBatch" /></a-form-item></a-col>
