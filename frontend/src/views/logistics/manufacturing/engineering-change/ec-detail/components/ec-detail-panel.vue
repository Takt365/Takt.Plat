...
<template>
  <div class="ec-detail-panel flex h-full min-h-0 flex-col overflow-hidden">
    ...
    <TaktQueryDrawer
      ...
      storage-key="takt-query-fields-logistics-manufacturing-engineering-change-ec-detail-ec-detail"
    ...
    >
      ...
      <a-form-item :label="t('entity.ecdetail.extfield')">
        <a-textarea
          v-model:value="advancedQueryForm.ExtField"
          :placeholder="t('common.page.form.placeholder.optional', { field: t('entity.ecdetail.extfield') })"
          :rows="2"
          allow-clear
        />
      </a-form-item>
...
const queryFieldsMeta = computed(() => [
  ...
  { key: 'ExtField', label: t('entity.ecdetail.extfield') },
