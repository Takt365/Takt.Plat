...
// 命名空间：@/views/logistics/manufacturing/engineering-change/ec-attachment/composables
...
import type { Ec } from '@/types/logistics/manufacturing/engineering-change/ec'
...
export function provideEcMasterContext(): EcMasterContext {
  const selectedMasterRow = ref<Ec | null>(null)
...
export function useEcMasterContext(): EcMasterContext {
  ...
  if (!ctx) {
    throw new Error('useEcMasterContext must be used within ec index')
  }
  return ctx
}
