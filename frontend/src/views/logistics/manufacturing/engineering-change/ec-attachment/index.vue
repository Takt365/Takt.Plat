...
<template>
  <div class="p-4 flex flex-col min-h-0 h-full">
    ...
    <TaktQueryDrawer
      ...
      :storage-key="'takt-query-fields-logistics-manufacturing-engineering-change-ec-attachment'"
...
import EcAttachmentPanel from './components/ec-attachment-panel.vue'
...
const ecAttachmentPanelRef = ref<InstanceType<typeof EcAttachmentPanel> | null>(null)
...
async function handleFormSubmit() {
  ...
  ecAttachmentPanelRef.value?.reload?.()
    }
    loadData()
  } finally {
    formLoading.value = false
