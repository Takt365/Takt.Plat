      ...
      >
        <div :class="formContentClass">
          <a-row :gutter="24">
            ...
            <a-col :span="12">
              <a-form-item
                :label="t('entity.ec.detailtext')"
                name="ecDetailText"
              >
                <a-input
                  v-model:value="formState.ecDetailText"
      ...
      >
        <div :class="formContentClass">
          <a-row :gutter="24">
            ...
            <a-col :span="12">
              <a-form-item
                :label="t('entity.ec.effectivedate')"
                name="effectiveDate"
              >
                <a-date-picker
                  v-model:value="formState.effectiveDate"
                  :placeholder="t('common.page.form.placeholder.select', { field: t('entity.ec.effectivedate') })"
                  value-format="YYYY-MM-DD"
                  size="small"
                  style="width: 100%"
                />
            ...
            <a-col :span="12">
              <a-form-item
                :label="t('entity.ec.flowinstanceid')"
                name="flowInstanceId"
              >
                <a-input
            ...
            <a-col :span="12">
              <a-form-item
                :label="t('entity.ec.details')"
                name="ecDetails"
              >
                <a-input
                  v-model:value="formState.ecDetails"
                  :placeholder="t('common.page.form.placeholder.required', { field: t('entity.ec.details') })"
                  size="small"
                  allow-clear
                />
              </a-form-item>
            ...
            <a-col :span="12">
              <a-form-item
                :label="t('entity.ec.attachments')"
                name="attachments"
              >
                <a-input
                  v-model:value="formState.attachments"
                  :placeholder="t('common.page.form.placeholder.required', { field: t('entity.ec.attachments') })"
                  size="small"
                  allow-clear
                />
              </a-form-item>
...
import type { EcCreate } from '@/types/logistics/manufacturing/engineering-change/ec'
...
const formFields = ["tenantCode","companyCode","companyDefaultCulture","plantCode","ecNo","ecIssueDate","changeStatus","ecTitle","ecDetailText","ecLeader","ecLossAmount","ecDistinction","effectiveDate","ecEntryDate","flowInstanceId","ecStatus","ecDetails","attachments","extFieldJson","remark"]


interface Props {
  formData?: Partial<EcCreate & { ecId?: string }> | null
  loading?: boolean
}
...
watch(
  ...
  () => {
    const isCreate = !props.formData?.ecId
    if (isCreate) {
...
const rules = computed<Record<string, Rule[]>>(() => ({
  ...
  changeStatus: [
    {
      required: true,
      message: t('common.page.form.placeholder.select', { field: t('entity.ec.changestatus') }),
      trigger: 'change'
    }
  ],
  ecTitle: [
  ...
  ecDetailText: [
    {
      required: true,
      message: t('common.page.form.placeholder.required', { field: t('entity.ec.detailtext') }),
      trigger: 'blur'
    }
  ],
  ecLeader: [
    {
      required: true,
      message: t('common.page.form.placeholder.required', { field: t('entity.ec.leader') }),
      trigger: 'blur'
    }
  ],
  ecLossAmount: [
    {
      required: true,
      message: t('common.page.form.placeholder.select', { field: t('entity.ec.lossamount') }),
      trigger: 'change'
    }
  ],
  ecDistinction: [
    {
      required: true,
      message: t('common.page.form.placeholder.required', { field: t('entity.ec.distinction') }),
      trigger: 'blur'
    }
  ],
  effectiveDate: [
    {
      required: true,
      message: t('common.page.form.placeholder.select', { field: t('entity.ec.effectivedate') }),
      trigger: 'change'
    }
  ],
  ecEntryDate: [
  ...
  flowInstanceId: [
    {
      required: true,
      message: t('common.page.form.placeholder.required', { field: t('entity.ec.flowinstanceid') }),
      trigger: 'blur'
    }
  ],
  ecStatus: [
    {
      required: true,
      message: t('common.page.form.placeholder.select', { field: t('entity.ec.status') }),
      trigger: 'change'
    }
  ],
}))
