...
<!-- 功能描述：设变制造二课表单；defineExpose validate/getValues/resetFields -->
...
<template>
  <a-form ref="formRef" :model="formState" layout="horizontal" label-align="right" :label-col="{ span: 6 }" :wrapper-col="{ span: 16 }">
    <a-row :gutter="24">
      ...
      <a-col :span="12"><a-form-item :label="t('entity.ecdept.outboundorderno')"><a-input v-model:value="formState.outboundOrderNo" /></a-form-item></a-col>
...
watch(() => props.formData, (val) => {
  ...
  Object.assign(formState, {
    ...
    outboundOrderNo: val.outboundOrderNo,
