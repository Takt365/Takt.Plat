...
<!-- 命名空间：@/views/logistics/manufacturing/aps/production-order/components -->
 ...
 * @module views/logistics/manufacturing/aps/production-order/components
 */
...
import type { ProductionOrderCreate } from '@/types/logistics/manufacturing/aps/production-order'
