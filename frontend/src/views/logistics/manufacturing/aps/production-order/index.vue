...
<!-- 命名空间：@/views/logistics/manufacturing/aps/production-order -->
<!-- 文件名称：index.vue -->
...
<template>
  <div class="p-4">
    ...
    <!-- 工具栏 -->
    <TaktToolsBar
      create-permission="logistics:manufacturing:aps:production:order:create"
      update-permission="logistics:manufacturing:aps:production:order:update"
      delete-permission="logistics:manufacturing:aps:production:order:delete"
      import-permission="logistics:manufacturing:aps:production:order:import"
      export-permission="logistics:manufacturing:aps:production:order:export"
      :show-create="true"
      :show-update="true"
      :show-delete="true"
      :show-import="true"
    ...
    <TaktQueryDrawer
      ...
      :storage-key="'takt-query-fields-logistics-manufacturing-aps-production-order'"
 ...
 * @module views/logistics/manufacturing/aps/production-order
 */
...
import { getProductionOrderList, getProductionOrderById, createProductionOrder, updateProductionOrder, deleteProductionOrderById, deleteProductionOrderBatch, getProductionOrderTemplate, importProductionOrder, exportProductionOrder, updateProductionOrderStatus } from '@/api/logistics/manufacturing/aps/production-order'
import type { ProductionOrder, ProductionOrderQuery } from '@/types/logistics/manufacturing/aps/production-order'
    ...
    actions: [
      {
        ...
        shape: 'plain',
        icon: RiEditLine,
        permission: 'logistics:manufacturing:aps:production:order:update',
      ...
      },
      {
        ...
        permission: 'logistics:manufacturing:aps:production:order:delete',
