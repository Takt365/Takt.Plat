...
function getValues(): Record<string, any> {
  ...
  if (props.formData?.workCenterResourceId) {
    payload.workCenterResourceId = props.formData.workCenterResourceId
  }
  ...
  if (masterRow) {
    const masterCode = masterRow.workCenterCode ?? masterRow.WorkCenterCode
    const masterName = masterRow.workCenterName ?? masterRow.WorkCenterName
    if (masterCode != null && masterCode !== '' && !payload.workCenterCode) {
      payload.workCenterCode = masterCode
    }
    if (masterName != null && masterName !== '' && !payload.workCenterName) {
      payload.workCenterName = masterName
    }
