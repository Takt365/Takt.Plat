...
<!-- 命名空间：@/views/logistics/manufacturing/aps/aps-order/components -->
<!-- 文件名称：aps-order-form.vue -->
...
<template>
  <a-form
    ref="formRef"
    class="takt-generated-form aps-order-form flex flex-col min-h-0"
    :model="formState"
    :rules="rules"
    layout="horizontal"
    label-align="right"
  >
      ...
      >
        <div :class="formContentClass">
          <a-row :gutter="24">
            ...
            <a-col :span="12">
              <a-form-item
                :label="t('entity.apsorder.plantcode')"
                name="plantCode"
              >
                <a-input
            ...
            <a-col :span="12">
              <a-form-item
                :label="t('entity.apsorder.plannedorderid')"
                name="plannedOrderId"
              >
                <a-input
            ...
            <a-col :span="12">
              <a-form-item
                :label="t('entity.apsorder.plannedordercode')"
            ...
            <a-col :span="12">
              <a-form-item
                :label="t('entity.apsorder.materialcode')"
                name="materialCode"
              >
                <a-input
            ...
            <a-col :span="12">
              <a-form-item
                :label="t('entity.apsorder.orderquantity')"
                name="orderQuantity"
              >
                <a-input-number
      ...
      >
        <div :class="formContentClass">
          <a-row :gutter="24">
            <a-col :span="24">
              <a-form-item
                :label="t('entity.apsorder.routingcode')"
                name="routingCode"
              >
                <a-input
            ...
            <a-col :span="24">
              <a-form-item
                :label="t('entity.apsorder.plannedstarttime')"
                name="plannedStartTime"
              >
                <a-date-picker
                  v-model:value="formState.plannedStartTime"
                  :placeholder="t('common.page.form.placeholder.select', { field: t('entity.apsorder.plannedstarttime') })"
            ...
            <a-col :span="24">
              <a-form-item
                :label="t('entity.apsorder.plannedendtime')"
                name="plannedEndTime"
              >
                <a-date-picker
                  v-model:value="formState.plannedEndTime"
                  :placeholder="t('common.page.form.placeholder.select', { field: t('entity.apsorder.plannedendtime') })"
                  value-format="YYYY-MM-DD"
                  style="width: 100%"
                />
              </a-form-item>
            ...
            <a-col :span="24">
              <a-form-item
                :label="t('entity.apsorder.orderstatus')"
                name="orderStatus"
              >
                <TaktSelect
            ...
            <a-col :span="24">
              <a-form-item
                :label="t('entity.apsorder.apsscheduleid')"
                name="apsScheduleId"
              >
                <a-input
    ...
    <TaktEditableTable
      ...
      :title="t('entity.apsoperation._self')"
      :add-button-entity="t('entity.apsoperation._self')"
 ...
 * @module views/logistics/manufacturing/aps/aps-order/components
 */
import { reactive, watch, computed, ref, onMounted } from 'vue'
import { useI18n } from 'vue-i18n'
import type { Rule } from 'ant-design-vue/es/form'
import type { ApsOrderCreate } from '@/types/logistics/manufacturing/aps/aps-order'
...
const formFields = ["tenantCode","companyCode","cultureCode","plantCode","apsOrderCode","plannedOrderId","plannedOrderCode","materialCode","orderQuantity","unitOfMeasure","routingCode","plannedStartTime","plannedEndTime","orderStatus","apsScheduleId","extField","remark"]
...
function syncChildRowsFromFormData(val: Partial<ApsOrderCreate & { apsOrderId?: string }> | null | undefined) {
  childApsOperationRows.value = ((val as any)?.operations ?? []) as Record<string, unknown>[]
}
...
function buildSubmitPayload() {
  ...
  return {
    ...formState,
    operations: apsOperationTableRef.value?.getRows?.() ?? childApsOperationRows.value.map((rest) => ({
      ...rest,
...
const rules = computed<Record<string, Rule[]>>(() => ({
  plantCode: [
    {
      required: true,
      message: t('common.page.form.placeholder.required', { field: t('entity.apsorder.plantcode') }),
      trigger: 'blur'
    }
  ],
  apsOrderCode: [
    {
      required: true,
      message: t('common.page.form.placeholder.required', { field: t('entity.apsorder.code') }),
      trigger: 'blur'
    }
  ],
  materialCode: [
    {
      required: true,
      message: t('common.page.form.placeholder.required', { field: t('entity.apsorder.materialcode') }),
      trigger: 'blur'
    }
  ],
  orderQuantity: [{
    validator: async (_rule, value) => {
      if (value === undefined || value === null || value === '') {
        return Promise.reject(t('common.page.form.placeholder.select', { field: t('entity.apsorder.orderquantity') }))
      }
  ...
  orderStatus: [{
    validator: async (_rule, value) => {
      if (value === undefined || value === null || value === '') {
        return Promise.reject(t('common.page.form.placeholder.select', { field: t('entity.apsorder.orderstatus') }))
      }
      const num = typeof value === 'number' ? value : Number(value)
      if (!Number.isFinite(num)) {
        return Promise.reject(t('common.page.form.placeholder.select', { field: t('entity.apsorder.orderstatus') }))
