...
<template>
  <a-form
    ref="formRef"
    class="takt-generated-form aps-operation-form flex flex-col min-h-0"
    :model="formState"
    :rules="rules"
    layout="horizontal"
    label-align="right"
...
import type { ApsOperationCreate } from '@/types/logistics/manufacturing/aps/aps-operation'
