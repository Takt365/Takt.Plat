...
<!-- 命名空间：@/views/logistics/manufacturing/sop/sop-workstation -->
<!-- 文件名称：index.vue -->
...
<template>
  <div class="logistics-manufacturing-sop-sop-workstation">
    <!-- 查询栏 -->
    <TaktQueryBar
    ...
    <!-- 表格 -->
    <div class="logistics-manufacturing-sop-sop-workstation-table-wrap">
      <TaktSingleTable
        :scroll="tableScroll"
        :columns="columns"
    ...
    <TaktQueryDrawer
      ...
      :storage-key="'takt-query-fields-logistics-manufacturing-sop-sop-workstation'"
 ...
 * @module views/logistics/manufacturing/sop/sop-workstation
 */
...
import SopWorkstationForm from './components/sop-workstation-form.vue'
import { getSopWorkstationList, getSopWorkstationById, createSopWorkstation, updateSopWorkstation, deleteSopWorkstationById, deleteSopWorkstationBatch, getSopWorkstationTemplate, importSopWorkstation, exportSopWorkstation, updateSopWorkstationStatus } from '@/api/logistics/manufacturing/sop/sop-workstation'
import type { SopWorkstation, SopWorkstationQuery, SopWorkstationCreate, SopWorkstationUpdate } from '@/types/logistics/manufacturing/sop/sop-workstation'
...
const rowSelection = computed(() => ({
  ...
  onSelect: (record: SopWorkstation, selected: boolean) => {
    ...
    } else if (getSopWorkstationId(selectedRow.value) === getSopWorkstationId(record)) {
...
.logistics-manufacturing-sop-sop-workstation {
  padding: 0 4px 0 0;
  display: flex;
...
.logistics-manufacturing-sop-sop-workstation-table-wrap {
  flex: 1;
  min-height: 0;
  min-width: 0;
}
