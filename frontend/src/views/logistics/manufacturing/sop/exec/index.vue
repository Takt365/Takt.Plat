...
<!-- 文件名称：index.vue -->
<!-- 功能描述：SOP 工位执行追溯实体管理页面，含查询、增删改，由 generate-vue-crud-from-api.cjs 根据 types/api 自动生成 -->
...
/**
 * SOP 工位执行追溯实体管理页 · 由 generate-vue-crud-from-api.cjs 根据 types/api 生成
...
/** 打开编辑弹窗 */
function handleEdit(record: SopExec) {
