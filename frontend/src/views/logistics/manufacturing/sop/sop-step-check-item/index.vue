...
<!-- 命名空间：@/views/logistics/manufacturing/sop/sop-step-check-item -->
<!-- 文件名称：index.vue -->
...
<template>
  <div class="p-4 flex flex-col min-h-0 h-full">
    ...
    >
      ...
      <template #detail>
        <SopStepCheckItemPanel
          ref="sopStepCheckItemPanelRef"
    ...
    <TaktQueryDrawer
      ...
      :storage-key="'takt-query-fields-logistics-manufacturing-sop-sop-step-check-item'"
 ...
 * @module views/logistics/manufacturing/sop/sop-step-check-item
 */
...
import SopStepCheckItemPanel from './components/sop-step-check-item-panel.vue'
...
const sopStepCheckItemPanelRef = ref<InstanceType<typeof SopStepCheckItemPanel> | null>(null)
...
async function handleFormSubmit() {
  ...
  sopStepCheckItemPanelRef.value?.reload?.()
    }
    loadData()
  } finally {
    formLoading.value = false
