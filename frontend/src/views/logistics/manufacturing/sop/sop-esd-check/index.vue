...
<!-- 命名空间：@/views/logistics/manufacturing/sop/sop-esd-check -->
<!-- 文件名称：index.vue -->
...
<template>
  <div class="logistics-manufacturing-sop-sop-esd-check">
    <!-- 查询栏 -->
    <TaktQueryBar
    ...
    <!-- 工具栏 -->
    <TaktToolsBar
      create-permission="logistics:manufacturing:sop:esdcheck:create"
      update-permission="logistics:manufacturing:sop:esdcheck:update"
      delete-permission="logistics:manufacturing:sop:esdcheck:delete"
      import-permission="logistics:manufacturing:sop:esdcheck:import"
      export-permission="logistics:manufacturing:sop:esdcheck:export"
      :show-create="true"
      :show-update="true"
      :show-delete="true"
      :show-import="true"
    ...
    <!-- 表格 -->
    <div class="logistics-manufacturing-sop-sop-esd-check-table-wrap">
      <TaktSingleTable
        :scroll="tableScroll"
        :columns="columns"
    ...
    <TaktQueryDrawer
      ...
      :storage-key="'takt-query-fields-logistics-manufacturing-sop-sop-esd-check'"
 ...
 * @module views/logistics/manufacturing/sop/sop-esd-check
 */
...
import SopEsdCheckForm from './components/sop-esd-check-form.vue'
import { getSopEsdCheckList, getSopEsdCheckById, createSopEsdCheck, updateSopEsdCheck, deleteSopEsdCheckById, deleteSopEsdCheckBatch, getSopEsdCheckTemplate, importSopEsdCheck, exportSopEsdCheck } from '@/api/logistics/manufacturing/sop/sop-esd-check'
import type { SopEsdCheck, SopEsdCheckQuery, SopEsdCheckCreate, SopEsdCheckUpdate } from '@/types/logistics/manufacturing/sop/sop-esd-check'
    ...
    actions: [
      {
        ...
        shape: 'plain',
        icon: RiEditLine,
        permission: 'logistics:manufacturing:sop:esdcheck:update',
      ...
      },
      {
        ...
        permission: 'logistics:manufacturing:sop:esdcheck:delete',
...
const rowSelection = computed(() => ({
  ...
  onSelect: (record: SopEsdCheck, selected: boolean) => {
    ...
    } else if (getSopEsdCheckId(selectedRow.value) === getSopEsdCheckId(record)) {
...
.logistics-manufacturing-sop-sop-esd-check {
  padding: 0 4px 0 0;
  display: flex;
...
.logistics-manufacturing-sop-sop-esd-check-table-wrap {
  flex: 1;
  min-height: 0;
  min-width: 0;
}
