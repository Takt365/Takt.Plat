...
<!-- 命名空间：@/views/logistics/manufacturing/sop/exec-step -->
<!-- 文件名称：index.vue -->
...
<template>
  <div class="p-4 flex flex-col min-h-0 h-full">
    ...
    <TaktQueryDrawer
      ...
      :storage-key="'takt-query-fields-logistics-manufacturing-sop-exec-step'"
 ...
 * @module views/logistics/manufacturing/sop/exec-step
 */
