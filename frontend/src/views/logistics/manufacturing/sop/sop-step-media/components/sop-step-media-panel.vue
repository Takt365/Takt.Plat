...
<!-- 命名空间：@/views/logistics/manufacturing/sop/sop-step-media/components -->
<!-- 文件名称：sop-step-media-panel.vue -->
<!-- 功能描述：SOP 工步实体主表实体右侧明细 sopStepMedia 独立 CRUD（按主表选中 sopStepId 分页） -->
<!-- 版权信息：Copyright (c) 2025 Takt  All rights reserved. -->
<!-- ======================================== -->

<template>
  <div class="sop-step-media-panel flex h-full min-h-0 flex-col overflow-hidden">
    ...
    />
    <div class="sop-step-media-panel__table-wrap min-h-0 flex-1 overflow-hidden">
      <TaktSingleTable
    ...
    <TaktQueryDrawer
      ...
      storage-key="takt-query-fields-logistics-manufacturing-sop-sop-step-media-sop-step-media"
 ...
 * @module views/logistics/manufacturing/sop/sop-step-media/components
 */
...
import SopStepMediaForm from './sop-step-media-form.vue'
...
import {
  ...
  importSopStepMedia,
  exportSopStepMedia,
} from '@/api/logistics/manufacturing/sop/sop-step-media'
import type { SopStepMedia, SopStepMediaQuery } from '@/types/logistics/manufacturing/sop/sop-step-media'
...
const rowSelection = computed(() => ({
  ...
  onSelect: (record: SopStepMedia, selected: boolean) => {
    ...
    } else if (getSopStepMediaId(selectedRow.value) === getSopStepMediaId(record)) {
...
async function handleImportFile(
  ...
  return await importSopStepMedia(file, sheetName)
}
