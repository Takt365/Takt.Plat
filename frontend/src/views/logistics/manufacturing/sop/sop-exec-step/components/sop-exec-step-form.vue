...
<template>
  <a-form
    ref="formRef"
    class="takt-generated-form sop-exec-step-form flex flex-col min-h-0"
    :model="formState"
    :rules="rules"
    layout="horizontal"
    label-align="right"
...
import type { SopExecStepCreate } from '@/types/logistics/manufacturing/sop/sop-exec-step'
...
const rules = computed<Record<string, Rule[]>>(() => ({
  ...
  startedAt: [
    {
      required: true,
      message: t('common.page.form.placeholder.required', { field: t('entity.sopexecstep.startedat') }),
      trigger: 'blur'
    }
  ],
}))
