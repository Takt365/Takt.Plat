...
<!-- 命名空间：@/views/logistics/manufacturing/sop/call/components -->
<!-- 文件名称：call-form.vue -->
            ...
            <a-col :span="12">
              ...
              >
                <a-date-picker
                  ...
                  :placeholder="t('common.page.form.placeholder.select', { field: t('entity.sopcall.calledat') })"
            ...
            <a-col :span="12">
              ...
              >
                <a-date-picker
                  ...
                  :placeholder="t('common.page.form.placeholder.select', { field: t('entity.sopcall.respondedat') })"
                  value-format="YYYY-MM-DD"
                  style="width: 100%"
                />
              </a-form-item>
 ...
 * @module views/logistics/manufacturing/sop/call/components
 */
import { reactive, watch, computed, ref, onMounted } from 'vue'
import { useI18n } from 'vue-i18n'
import type { Rule } from 'ant-design-vue/es/form'
import type { SopCallCreate } from '@/types/logistics/manufacturing/sop/call'
...
const formFields = ["tenantCode","companyCode","companyDefaultCulture","workstationId","execId","callType","callerId","calledAt","respondedBy","respondedAt","responseSeconds","callStatus","extField","remark"]
...
const rules = computed<Record<string, Rule[]>>(() => ({
  ...
  calledAt: [
    {
      required: true,
      message: t('common.page.form.placeholder.select', { field: t('entity.sopcall.calledat') }),
      trigger: 'change'
    }
  ],
  callStatus: [{
...
function resetFields() {
  ...
  applyFormDefaults(formState)
  applyScopeDefaults(formState as Record<string, unknown>, !props.formData?.sopCallId)
