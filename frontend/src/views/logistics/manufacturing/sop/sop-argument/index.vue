...
<!-- 命名空间：@/views/logistics/manufacturing/sop/sop-argument -->
<!-- 文件名称：index.vue -->
...
<template>
  <div class="p-4 flex flex-col min-h-0 h-full">
    ...
    <TaktQueryDrawer
      ...
      :storage-key="'takt-query-fields-logistics-manufacturing-sop-sop-argument'"
 ...
 * @module views/logistics/manufacturing/sop/sop-argument
 */
...
import SopArgumentPanel from './components/sop-argument-panel.vue'
...
const sopArgumentPanelRef = ref<InstanceType<typeof SopArgumentPanel> | null>(null)
...
async function handleFormSubmit() {
  ...
  sopArgumentPanelRef.value?.reload?.()
    }
    loadData()
  } finally {
    formLoading.value = false
