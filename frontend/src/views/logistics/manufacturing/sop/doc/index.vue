...
<template>
  <div class="p-4">
    ...
    >
      ...
      <a-form-item :label="t('entity.sopdoc.plantcode')">
        <a-input
...
const queryFieldsMeta = computed(() => [
  { key: 'plantCode', label: t('entity.sopdoc.plantcode') },
...
const columns = computed<TableColumnsType>(() => [
  ...
  {
    title: t('entity.sopdoc.plantcode'),
    dataIndex: 'plantCode',
    key: 'plantCode',
    width: 120,
    resizable: true,
    ellipsis: true,
    customRender: ({ record }: { record: any }) => getSopDocField(record, 'plantCode') ?? ''
  },
  {
...
/** 打开编辑弹窗 */
function handleEdit(record: SopDoc) {
