...
<template>
  <div class="equipment-operation-rate-change-log-panel flex h-full min-h-0 flex-col overflow-hidden">
    ...
    <TaktQueryDrawer
      ...
      storage-key="takt-query-fields-logistics-manufacturing-output-equipment-operation-rate-change-log-equipment-operation-rate-change-log"
...
const rowSelection = computed(() => ({
  ...
  onSelect: (record: EquipmentOperationRateChangeLog, selected: boolean) => {
    ...
    } else if (selectedRow.value && getEquipmentOperationRateChangeLogId(selectedRow.value) === getEquipmentOperationRateChangeLogId(record)) {
