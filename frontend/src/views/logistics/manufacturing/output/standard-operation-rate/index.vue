...
<!-- 文件名称：index.vue -->
<!-- 功能描述：标准生产稼动率实体管理页面，含查询、增删改，由 generate-vue-crud-from-api.cjs 根据 types/api 自动生成 -->
...
<template>
  <div class="p-4">
    ...
    <TaktToolsBar
      ...
      import-permission="logistics:manufacturing:output:standard:operation:rate:import"
    ...
    <TaktQueryDrawer
      ...
      :storage-key="'takt-query-fields-logistics-manufacturing-output-standard-operation-rate'"
...
/**
 * 标准生产稼动率实体管理页 · 由 generate-vue-crud-from-api.cjs 根据 types/api 生成
