...
// 命名空间：@/views/logistics/manufacturing/output/standard-operation-rate-change-log/composables
...
import type { StandardOperationRate } from '@/types/logistics/manufacturing/output/standard-operation-rate'
