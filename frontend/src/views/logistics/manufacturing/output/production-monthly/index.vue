...
<!-- 命名空间：@/views/logistics/manufacturing/output/production-monthly -->
<!-- 文件名称：index.vue -->
<!-- 功能描述：月生产推移（工厂×机种×产出类别×月份转置表） -->
...
<template>
  <div class="flex h-full min-h-0 flex-col p-4">
    ...
    <TaktToolsBar
      ...
      export-permission="logistics:manufacturing:output:production:monthly:export"
      @export="handleExport"
      @refresh="handleRefresh"
    />
    <production-monthly-panel
      ref="panelRef"
...
/** 产出类别 */
const outputCategory = ref<string | undefined>()
/** 明细面板 loading */
