...
function buildSubmitPayload() {
  ...
  return {
    ...formState,
    teamEquipmentList: productionTeamEquipmentTableRef.value?.getRows?.() ?? childProductionTeamEquipmentRows.value.map((rest) => ({
      ...rest,
...
function getValues(): Record<string, any> {
  ...
  if (props.formData?.productionTeamId) {
    payload.productionTeamId = props.formData.productionTeamId
  }
  return payload
}
