...
function getValues(): Record<string, any> {
  ...
  if (props.formData?.productionTeamEquipmentId) {
    payload.productionTeamEquipmentId = props.formData.productionTeamEquipmentId
  }
  ...
  if (masterRow) {
    const masterCode = masterRow.productionTeamCode ?? masterRow.ProductionTeamCode
    const masterName = masterRow.productionTeamName ?? masterRow.ProductionTeamName
    if (masterCode != null && masterCode !== '' && !payload.productionTeamCode) {
      payload.productionTeamCode = masterCode
    }
    if (masterName != null && masterName !== '' && !payload.productionTeamName) {
      payload.productionTeamName = masterName
    }
