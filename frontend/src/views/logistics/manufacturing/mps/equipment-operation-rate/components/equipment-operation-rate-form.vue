...
<!-- 命名空间：@/views/logistics/manufacturing/mps/equipment-operation-rate/components -->
 ...
 * @module views/logistics/manufacturing/mps/equipment-operation-rate/components
 */
...
import type { EquipmentOperationRateCreate } from '@/types/logistics/manufacturing/mps/equipment-operation-rate'
