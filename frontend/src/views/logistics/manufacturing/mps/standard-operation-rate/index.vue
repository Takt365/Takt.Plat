...
<!-- 命名空间：@/views/logistics/manufacturing/mps/standard-operation-rate -->
<!-- 文件名称：index.vue -->
...
<template>
  <div class="p-4">
    ...
    <!-- 工具栏 -->
    <TaktToolsBar
      create-permission="logistics:manufacturing:mps:standard:operation:rate:create"
      update-permission="logistics:manufacturing:mps:standard:operation:rate:update"
      delete-permission="logistics:manufacturing:mps:standard:operation:rate:delete"
      import-permission="logistics:manufacturing:mps:standard:operation:rate:import"
      export-permission="logistics:manufacturing:mps:standard:operation:rate:export"
      :show-create="true"
      :show-update="true"
      :show-delete="true"
      :show-import="true"
    ...
    <TaktQueryDrawer
      ...
      :storage-key="'takt-query-fields-logistics-manufacturing-mps-standard-operation-rate'"
 ...
 * @module views/logistics/manufacturing/mps/standard-operation-rate
 */
    ...
    actions: [
      {
        ...
        shape: 'plain',
        icon: RiEditLine,
        permission: 'logistics:manufacturing:mps:standard:operation:rate:update',
      ...
      },
      {
        ...
        permission: 'logistics:manufacturing:mps:standard:operation:rate:delete',
