...
<!-- 命名空间：@/views/logistics/manufacturing/defect/defect-monthly -->
<!-- 文件名称：index.vue -->
<!-- 功能描述：月生产不良推移（工厂×机种×不良类别×月份转置表） -->
...
<template>
  <div class="flex h-full min-h-0 flex-col p-4">
    ...
    <TaktToolsBar
      ...
      export-permission="logistics:manufacturing:defect:monthly:export"
      @export="handleExport"
      @refresh="handleRefresh"
    />
    <defect-monthly-panel
      ref="panelRef"
...
import DefectMonthlyPanel from './components/defect-monthly-panel.vue'
...
/** 不良类别 */
const defectCategory = ref<string | undefined>()
/** 明细面板 loading */
