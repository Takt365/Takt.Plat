...
<!-- 文件名称：index.vue -->
<!-- 功能描述：组立不良日报实体管理页面，含查询、增删改，由 generate-vue-from-api 根据 types/api 自动生成 -->
...
<template>
  <div class="logistics-manufacturing-defect-assy-defect">
    ...
    <TaktModal
      ...
      :title="t('common.page.button.import') + t('entity.assyDefect._self')"
      :width="600"
      :footer="null"
...
/**
 * 组立不良日报实体管理页 · 由 generate-vue-from-api 根据 types/api 生成
...
import type { AssyDefect, AssyDefectQuery, AssyDefectCreate, AssyDefectUpdate } from '@/types/logistics/manufacturing/defect/assy-defect'
...
function handleCreate() {
  formTitle.value = t('common.page.button.create') + t('entity.assyDefect._self')
  formData.value = {}
  formVisible.value = true
}
function handleEdit(record: AssyDefect) {
  formTitle.value = t('common.page.button.edit') + t('entity.assyDefect._self')
