...
<!-- 命名空间：@/views/logistics/materials/material-transaction -->
<!-- 文件名称：index.vue -->
...
<template>
  <div class="p-4 flex flex-col min-h-0 h-full">
    ...
    <!-- 工具栏 -->
    <TaktToolsBar
      create-permission="logistics:materials:material:transaction:create"
      update-permission="logistics:materials:material:transaction:update"
      delete-permission="logistics:materials:material:transaction:delete"
      import-permission="logistics:materials:material:transaction:import"
      export-permission="logistics:materials:material:transaction:export"
      :show-create="true"
      :show-update="true"
      :show-delete="true"
      :show-import="true"
    ...
    <TaktMasterDetailTableLr
      ...
      :master-row-key="getMaterialTransactionId"
      :master-row-selection="rowSelection"
      master-id-column-key="materialTransactionId"
    ...
    >
      ...
      <template #bodyCell="{ column, record }">
        <template v-if="column.key === 'transactionType'">
          <TaktDictTag
            :value="getMaterialTransactionField(record, 'transactionType')"
      ...
      <template #detail>
        <MaterialTransactionItemPanel
          ref="materialTransactionItemPanelRef"
    ...
    >
      <MaterialTransactionForm
        :key="formData?.materialTransactionId ?? 'create'"
        ref="formRef"
        :form-data="formData"
        :loading="formLoading"
      />
    ...
    <TaktQueryDrawer
      ...
      :storage-key="'takt-query-fields-logistics-materials-material-transaction'"
    ...
    >
      ...
      <a-form-item :label="t('entity.materialtransaction.plantcode')">
        <a-input
      ...
      <a-form-item :label="t('entity.materialtransaction.code')">
        <a-input
      ...
      <a-form-item :label="t('entity.materialtransaction.transactiondatestart')">
        <a-date-picker
          v-model:value="advancedQueryForm.transactionDateStart"
          :placeholder="t('common.page.form.placeholder.select', { field: t('entity.materialtransaction.transactiondatestart') })"
      ...
      <a-form-item :label="t('entity.materialtransaction.transactiondateend')">
        <a-date-picker
          v-model:value="advancedQueryForm.transactionDateEnd"
          :placeholder="t('common.page.form.placeholder.select', { field: t('entity.materialtransaction.transactiondateend') })"
          value-format="YYYY-MM-DD"
          style="width: 100%"
        />
      </a-form-item>
      </div>
      <div v-show="isFieldVisible('transactionDirection')">
      <a-form-item :label="t('entity.materialtransaction.transactiondirection')">
        <a-input-number
          v-model:value="advancedQueryForm.transactionDirection"
          :placeholder="t('common.page.form.placeholder.required', { field: t('entity.materialtransaction.transactiondirection') })"
          style="width: 100%"
        />
      </a-form-item>
      </div>
      <div v-show="isFieldVisible('transactionType')">
      <a-form-item :label="t('entity.materialtransaction.transactiontype')">
        <TaktSelect
          v-model:value="advancedQueryForm.transactionType"
          dict-type="logistics_inbound_type"
      ...
      <div v-show="isFieldVisible('businessAction')">
      <a-form-item :label="t('entity.materialtransaction.businessaction')">
        <a-input-number
          v-model:value="advancedQueryForm.businessAction"
      ...
      <a-form-item :label="t('entity.materialtransaction.sourcecode')">
        <a-input
      ...
      <a-form-item :label="t('entity.materialtransaction.partnercode')">
        <a-input
      ...
      <a-form-item :label="t('entity.materialtransaction.partnername')">
        <a-input
      ...
      <a-form-item :label="t('entity.materialtransaction.warehousecode')">
        <a-input
      ...
      <a-form-item :label="t('entity.materialtransaction.locationcode')">
        <a-input
      ...
      <a-form-item :label="t('entity.materialtransaction.targetwarehousecode')">
        <a-input
      ...
      <a-form-item :label="t('entity.materialtransaction.targetlocationcode')">
        <a-input
      ...
      <a-form-item :label="t('entity.materialtransaction.relatedcompany')">
        <a-input
      ...
      <a-form-item :label="t('entity.materialtransaction.totalquantity')">
        <a-input-number
      ...
      <a-form-item :label="t('entity.materialtransaction.transactionstatus')">
        <a-input-number
      ...
      <a-form-item :label="t('entity.materialtransaction.posteddatestart')">
        <a-date-picker
          v-model:value="advancedQueryForm.postedDateStart"
          :placeholder="t('common.page.form.placeholder.select', { field: t('entity.materialtransaction.posteddatestart') })"
          value-format="YYYY-MM-DD"
          style="width: 100%"
        />
      </a-form-item>
      ...
      <a-form-item :label="t('entity.materialtransaction.posteddateend')">
        <a-date-picker
          v-model:value="advancedQueryForm.postedDateEnd"
          :placeholder="t('common.page.form.placeholder.select', { field: t('entity.materialtransaction.posteddateend') })"
          value-format="YYYY-MM-DD"
          style="width: 100%"
        />
      </a-form-item>
      ...
      <a-form-item :label="t('entity.materialtransaction.postedby')">
        <a-input
    ...
    <TaktModal
      ...
      :title="t('common.dialog.title.import', { entity: t('entity.materialtransaction._self') })"
      :width="600"
      :footer="null"
    ...
    >
      <TaktImportFile
        entity-i18n-key="entity.materialtransaction._self"
        file-type="xlsx"
    ...
    <TaktColumnDrawer
      ...
      :id-column-key="'materialTransactionId'"
 ...
 * @module views/logistics/materials/material-transaction
 */
...
import MaterialTransactionForm from './components/material-transaction-form.vue'
import MaterialTransactionItemPanel from './components/material-transaction-item-panel.vue'
import { provideMaterialTransactionMasterContext } from './composables/use-material-transaction-master-context'
import { getMaterialTransactionList, getMaterialTransactionById, createMaterialTransaction, updateMaterialTransaction, deleteMaterialTransactionById, deleteMaterialTransactionBatch, getMaterialTransactionTemplate, importMaterialTransaction, exportMaterialTransaction, updateMaterialTransactionStatus } from '@/api/logistics/materials/material-transaction'
import type { MaterialTransaction, MaterialTransactionQuery } from '@/types/logistics/materials/material-transaction'
...
const excelNames = taktExcelEntityNames('TaktMaterialTransaction')
/** 列表快捷查询占位文案 */
const searchPlaceholder = computed(
  () => t('common.page.form.placeholder.search', { keyword: t('entity.materialtransaction._self') })
)
...
const advancedQueryForm = ref({
  ...
  transactionDateEnd: '',
  transactionDirection: undefined as number | undefined,
  transactionType: undefined as number | undefined,
  businessAction: undefined as number | undefined,
  sourceCode: '',
  partnerCode: '',
  partnerName: '',
  warehouseCode: '',
...
const queryFieldsMeta = computed(() => [
  { key: 'plantCode', label: t('entity.materialtransaction.plantcode') },
  { key: 'materialTransactionCode', label: t('entity.materialtransaction.code') },
  { key: 'transactionDateStart', label: t('common.page.entity.createdatstart').replace(t('common.page.entity.createdat'), t('entity.materialtransaction.transactiondate')) },
  { key: 'transactionDateEnd', label: t('common.page.entity.createdatend').replace(t('common.page.entity.createdat'), t('entity.materialtransaction.transactiondate')) },
  { key: 'transactionDirection', label: t('entity.materialtransaction.transactiondirection') },
  { key: 'transactionType', label: t('entity.materialtransaction.transactiontype') },
  { key: 'businessAction', label: t('entity.materialtransaction.businessaction') },
  { key: 'sourceCode', label: t('entity.materialtransaction.sourcecode') },
  { key: 'partnerCode', label: t('entity.materialtransaction.partnercode') },
  { key: 'partnerName', label: t('entity.materialtransaction.partnername') },
  { key: 'warehouseCode', label: t('entity.materialtransaction.warehousecode') },
  { key: 'locationCode', label: t('entity.materialtransaction.locationcode') },
  { key: 'targetWarehouseCode', label: t('entity.materialtransaction.targetwarehousecode') },
  { key: 'targetLocationCode', label: t('entity.materialtransaction.targetlocationcode') },
  { key: 'relatedCompany', label: t('entity.materialtransaction.relatedcompany') },
  { key: 'totalQuantity', label: t('entity.materialtransaction.totalquantity') },
  { key: 'transactionStatus', label: t('entity.materialtransaction.transactionstatus') },
  { key: 'postedDateStart', label: t('common.page.entity.createdatstart').replace(t('common.page.entity.createdat'), t('entity.materialtransaction.posteddate')) },
  { key: 'postedDateEnd', label: t('common.page.entity.createdatend').replace(t('common.page.entity.createdat'), t('entity.materialtransaction.posteddate')) },
  { key: 'postedBy', label: t('entity.materialtransaction.postedby') },
...
const entityIdName = 'materialTransactionId'
/** 工具栏「编辑」是否禁用（须恰好选中一行） */
...
const materialTransactionItemPanelRef = ref<InstanceType<typeof MaterialTransactionItemPanel> | null>(null)
...
function syncMasterSelection(record: MaterialTransaction | null) {
  ...
  selectedMasterKey.value = record ? getMaterialTransactionId(record) : ''
}
...
function handleMasterSelect(record: Record<string, unknown>) {
  ...
  const key = getMaterialTransactionId(row)
...
async function loadMaterialTransactionDetail(record: MaterialTransaction): Promise<MaterialTransaction | null> {
  const id = getMaterialTransactionId(record)
  if (!id) {
    return null
  }
  try {
    const detail = await getMaterialTransactionById(id)
    const index = dataSource.value.findIndex((row) => getMaterialTransactionId(row) === id)
    if (index !== -1) {
...
const columns = computed<TableColumnsType>(() => [
  {
    ...
    dataIndex: 'materialTransactionId',
    key: 'materialTransactionId',
    width: 80,
    resizable: true,
    ellipsis: true,
    fixed: 'left',
    customRender: ({ record }: { record: any }) => getMaterialTransactionField(record, 'materialTransactionId') ?? ''
  },
  {
    title: t('entity.materialtransaction.plantcode'),
    dataIndex: 'plantCode',
    key: 'plantCode',
    width: 120,
    resizable: true,
  ...
  {
    title: t('entity.materialtransaction.code'),
    dataIndex: 'materialTransactionCode',
    key: 'materialTransactionCode',
    width: 120,
    resizable: true,
    ellipsis: true,
    customRender: ({ record }: { record: any }) => getMaterialTransactionField(record, 'materialTransactionCode') ?? ''
  },
  {
    title: t('entity.materialtransaction.transactiondate'),
  ...
  {
    title: t('entity.materialtransaction.transactiondirection'),
  ...
  {
    title: t('entity.materialtransaction.transactiontype'),
  ...
  {
    title: t('entity.materialtransaction.businessaction'),
  ...
  {
    title: t('entity.materialtransaction.sourcecode'),
  ...
  {
    title: t('entity.materialtransaction.partnercode'),
  ...
  {
    title: t('entity.materialtransaction.partnername'),
  ...
  {
    title: t('entity.materialtransaction.warehousecode'),
  ...
  {
    title: t('entity.materialtransaction.locationcode'),
  ...
  {
    title: t('entity.materialtransaction.targetwarehousecode'),
  ...
  {
    title: t('entity.materialtransaction.targetlocationcode'),
  ...
  {
    title: t('entity.materialtransaction.relatedcompany'),
  ...
  {
    title: t('entity.materialtransaction.totalquantity'),
  ...
  {
    title: t('entity.materialtransaction.transactionstatus'),
  ...
  {
    title: t('entity.materialtransaction.posteddate'),
  ...
  {
    title: t('entity.materialtransaction.postedby'),
    dataIndex: 'postedBy',
    key: 'postedBy',
    width: 120,
    resizable: true,
    ...
    actions: [
      {
        ...
        shape: 'plain',
        icon: RiEditLine,
        permission: 'logistics:materials:material:transaction:update',
      ...
      },
      {
        ...
        permission: 'logistics:materials:material:transaction:delete',
...
/** 表格 row-key（优先实体主键字段） */
const getMaterialTransactionId = (record: any): string => record?.[entityIdName] ?? ''
/**
 * 读取行字段值
 * @param record 行数据
 * @param field 字段名
...
const rowSelection = computed(() => ({
  ...
  onSelect: (record: MaterialTransaction, selected: boolean) => {
    ...
    } else if (getMaterialTransactionId(selectedRow.value) === getMaterialTransactionId(record)) {
...
function handleCreate() {
  formTitle.value = t('common.dialog.title.create', { entity: t('entity.materialtransaction._self') })
  formData.value = null
...
async function handleEdit(record: MaterialTransaction) {
  formTitle.value = t('common.dialog.title.edit', { entity: t('entity.materialtransaction._self') })
...
function handleUpdate() {
  if (selectedRow.value) {
    ...
    message.warning(t('common.tip.select.to.action', { action: t('common.page.button.edit'), entity: t('entity.materialtransaction._self') }))
  }
}
/** 提交新增/编辑表单 */
async function handleFormSubmit() {
  ...
  try {
    ...
    if (id) {
      ...
      message.success(t('common.feedback.updated', { target: t('entity.materialtransaction._self') }))
    } else {
      await createMaterialTransaction(payload as any)
      message.success(t('common.feedback.created', { target: t('entity.materialtransaction._self') }))
    }
    formVisible.value = false
    formData.value = null
  nextTick(() => formRef.value?.resetFields())
    if (selectedMasterKey.value) {
  materialTransactionItemPanelRef.value?.reload?.()
    }
    loadData()
  } finally {
    formLoading.value = false
...
async function handleExport() {
  try {
    ...
    message.success(t('common.feedback.export.success', { target: t('entity.materialtransaction._self') }))
  } catch (error: any) {
    logger.error('[MaterialTransaction] 导出失败', { error })
    message.error(error?.message || t('common.feedback.export.failed', { target: t('entity.materialtransaction._self') }))
  } finally {
    loading.value = false
  }
}
...
async function handleDeleteOne(record: MaterialTransaction) {
  Modal.confirm({
    ...
    content: t('common.tip.confirm.delete.entity', { entity: t('entity.materialtransaction._self'), name: t('common.tip.this.target', { target: t('entity.materialtransaction._self') }) }),
    okText: t('common.page.button.delete'),
    cancelText: t('common.page.button.cancel'),
    onOk: async () => {
      await deleteMaterialTransactionById((record as any)[entityIdName])
      message.success(t('common.feedback.deleted', { target: t('entity.materialtransaction._self') }))
...
async function handleDelete() {
  if (selectedRows.value.length === 0) {
    message.warning(t('common.tip.select.to.action', { action: t('common.page.button.delete'), entity: t('entity.materialtransaction._self') }))
    return
  }
  Modal.confirm({
    title: t('common.tip.confirm.delete.title'),
    content: t('common.tip.confirm.delete.count', { entity: t('entity.materialtransaction._self'), count: selectedRows.value.length }),
    okText: t('common.page.button.delete'),
    cancelText: t('common.page.button.cancel'),
    onOk: async () => {
