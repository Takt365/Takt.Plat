...
// 功能描述：MaterialDescription字段清单 + useMaterialDescriptionI18n（字段名映射一次，文案由 entity.materialdescription.* 种子动态解析）
//
...
export const MATERIALDESCRIPTION_DEFAULT_VISIBLE_COLUMN_KEYS = [
  'materialId',
  'description',
  'cultureCode',
  'action',
...
export const MATERIALDESCRIPTION_SUMMARY_SUM_FIELDS = [] as const
...
/**
 * MaterialDescription字段 i18n：index / material-description-form 统一入口
 */
