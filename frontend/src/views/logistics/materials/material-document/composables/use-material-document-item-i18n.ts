...
export type MaterialDocumentItemQueryField = (typeof MATERIALDOCUMENTITEM_QUERY_STRING_FIELDS)[number]

/** 高级查询抽屉全部字段（含数值） */
export const MATERIALDOCUMENTITEM_QUERY_FIELDS: readonly MaterialDocumentItemQueryField[] = [...MATERIALDOCUMENTITEM_QUERY_STRING_FIELDS]
