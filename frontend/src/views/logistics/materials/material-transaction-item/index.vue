...
<!-- 命名空间：@/views/logistics/materials/material-transaction-item -->
<!-- 文件名称：index.vue -->
...
<template>
  <div class="p-4 flex flex-col min-h-0 h-full">
    ...
    <TaktQueryDrawer
      ...
      :storage-key="'takt-query-fields-logistics-materials-material-transaction-item'"
 ...
 * @module views/logistics/materials/material-transaction-item
 */
