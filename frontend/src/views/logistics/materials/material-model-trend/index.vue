...
<!-- 命名空间：@/views/logistics/materials/material-model-trend -->
<!-- 文件名称：index.vue -->
<!-- 功能描述：物料机种推移（BOM FERT 产品机种组 + 月移动单价转置；独立菜单） -->
...
<template>
  <div class="flex h-full min-h-0 flex-col p-4">
    <material-model-trend-query-form
    ...
    <TaktToolsBar
      ...
      export-permission="logistics:materials:material:model:trend:export"
      @export="handleExport"
      @refresh="handleRefresh"
    />
    <material-model-trend-panel
      ref="panelRef"
...
import MaterialModelTrendPanel from './components/material-model-trend-panel.vue'
import MaterialModelTrendQueryForm from './components/material-model-trend-query-form.vue'
