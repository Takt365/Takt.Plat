      ...
      >
        <div :class="formContentClass">
          <a-row :gutter="24">
            ...
            <a-col :span="12">
              <a-form-item
                :label="t('entity.materialdocument.plantcode')"
                name="plantCode"
              >
                <a-input
            ...
            <a-col :span="12">
              <a-form-item
                :label="t('entity.materialdocument.code')"
            ...
            <a-col :span="12">
              <a-form-item
                :label="t('entity.materialdocument.transactiondate')"
                name="transactionDate"
              >
                <a-date-picker
                  v-model:value="formState.transactionDate"
                  :placeholder="t('common.page.form.placeholder.select', { field: t('entity.materialdocument.transactiondate') })"
            ...
            <a-col :span="12">
              <a-form-item
                :label="t('entity.materialdocument.movementtype')"
                name="movementType"
              >
                <TaktSelect
            ...
            <a-col :span="12">
              <a-form-item
                :label="t('entity.materialdocument.sourcecode')"
                name="sourceCode"
              >
                <a-input
      ...
      >
        <div :class="formContentClass">
          <a-row :gutter="24">
            <a-col :span="12">
              <a-form-item
                :label="t('entity.materialdocument.partnercode')"
                name="partnerCode"
              >
                <a-input
            ...
            <a-col :span="12">
              <a-form-item
                :label="t('entity.materialdocument.partnername')"
                name="partnerName"
              >
                <a-input
            ...
            <a-col :span="12">
              <a-form-item
                :label="t('entity.materialdocument.warehousecode')"
                name="warehouseCode"
              >
                <a-input
            ...
            <a-col :span="12">
              <a-form-item
                :label="t('entity.materialdocument.locationcode')"
                name="locationCode"
              >
                <a-input
            ...
            <a-col :span="12">
              <a-form-item
                :label="t('entity.materialdocument.targetwarehousecode')"
            ...
            <a-col :span="12">
              <a-form-item
                :label="t('entity.materialdocument.targetlocationcode')"
            ...
            <a-col :span="12">
              <a-form-item
                :label="t('entity.materialdocument.relatedcompany')"
                name="relatedCompany"
              >
                <a-input
            ...
            <a-col :span="12">
              <a-form-item
                :label="t('entity.materialdocument.totalquantity')"
                name="totalQuantity"
              >
                <a-input-number
            ...
            <a-col :span="12">
              <a-form-item
                :label="t('entity.materialdocument.transactionstatus')"
            ...
            <a-col :span="12">
              <a-form-item
                :label="t('entity.materialdocument.posteddate')"
                name="postedDate"
              >
                <a-date-picker
                  v-model:value="formState.postedDate"
                  :placeholder="t('common.page.form.placeholder.select', { field: t('entity.materialdocument.posteddate') })"
                  value-format="YYYY-MM-DD"
                  style="width: 100%"
                />
              </a-form-item>
      ...
      >
        <div :class="formContentClass">
          <a-row :gutter="24">
            <a-col :span="24">
              <a-form-item
                :label="t('entity.materialdocument.postedby')"
                name="postedBy"
              >
                <a-input
...
import type { MaterialTransactionCreate } from '@/types/logistics/materials/material-document'
...
const formFields = ["tenantCode","companyCode","companyDefaultCulture","plantCode","materialDocumentCode","transactionDate","movementType","sourceCode","partnerCode","partnerName","warehouseCode","locationCode","targetWarehouseCode","targetLocationCode","relatedCompany","totalQuantity","transactionStatus","postedDate","postedBy","extField","remark"]
...
const materialDocumentItemFormColumns = computed<TaktEditableTableColumn[]>(() => [
  ...
  },
  {
    ...
    editor: 'input',
    width: 140, allowClear: true, placeholder: t('common.page.form.placeholder.optional', { field: t('entity.materialdocumentitem.sourcecode') }),
  },
  {
  ...
  },
  {
    ...
    editor: 'input',
    width: 140, allowClear: true, placeholder: t('common.page.form.placeholder.optional', { field: t('entity.materialdocumentitem.materialspecification') }),
  },
  {
    key: 'transactionUnit',
  ...
  },
  {
    ...
    title: t('entity.materialdocumentitem.transactionquantity'),
    editor: 'inputNumber',
    width: 140,
  },
])
...
function syncChildRowsFromFormData(val: Partial<MaterialTransactionCreate & { materialDocumentId?: string }> | null | undefined) {
...
function buildSubmitPayload() {
  ...
  return {
    ...formState,
    items: materialDocumentItemTableRef.value?.getRows?.() ?? childMaterialTransactionItemRows.value.map((rest) => ({
      ...rest,
...
interface Props {
  formData?: Partial<MaterialTransactionCreate & { materialDocumentId?: string }> | null
  /** 父级提交 loading，禁用表单项 */
  loading?: boolean
}
...
const rules = computed<Record<string, Rule[]>>(() => ({
  plantCode: [
    {
      required: true,
      message: t('common.page.form.placeholder.required', { field: t('entity.materialdocument.plantcode') }),
      trigger: 'blur'
    }
  ],
  materialDocumentCode: [
    {
      required: true,
      message: t('common.page.form.placeholder.required', { field: t('entity.materialdocument.code') }),
      trigger: 'blur'
    }
  ],
  transactionDate: [
    {
      required: true,
      message: t('common.page.form.placeholder.select', { field: t('entity.materialdocument.transactiondate') }),
      trigger: 'change'
    }
  ],
  movementType: [
    {
      required: true,
      message: t('common.page.form.placeholder.select', { field: t('entity.materialdocument.movementtype') }),
      trigger: 'change'
    }
  ],
  warehouseCode: [
    {
      required: true,
      message: t('common.page.form.placeholder.required', { field: t('entity.materialdocument.warehousecode') }),
      trigger: 'blur'
    }
  ],
  locationCode: [
    {
      required: true,
      message: t('common.page.form.placeholder.required', { field: t('entity.materialdocument.locationcode') }),
      trigger: 'blur'
    }
  ],
  relatedCompany: [
    {
      required: true,
      message: t('common.page.form.placeholder.required', { field: t('entity.materialdocument.relatedcompany') }),
      trigger: 'blur'
    }
  ],
  totalQuantity: [{
    validator: async (_rule, value) => {
      if (value === undefined || value === null || value === '') {
        return Promise.reject(t('common.page.form.placeholder.select', { field: t('entity.materialdocument.totalquantity') }))
      }
  ...
  transactionStatus: [{
    validator: async (_rule, value) => {
      if (value === undefined || value === null || value === '') {
        return Promise.reject(t('common.page.form.placeholder.select', { field: t('entity.materialdocument.transactionstatus') }))
      }
      const num = typeof value === 'number' ? value : Number(value)
      if (!Number.isFinite(num)) {
        return Promise.reject(t('common.page.form.placeholder.select', { field: t('entity.materialdocument.transactionstatus') }))
