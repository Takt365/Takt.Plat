...
<template>
  <div class="material-document-item-panel flex h-full min-h-0 flex-col overflow-hidden">
    ...
    <TaktQueryDrawer
      ...
      storage-key="takt-query-fields-logistics-materials-material-document-item-material-document-item"
    ...
    >
      ...
      <a-form-item :label="t('entity.materialdocumentitem.materialdocumentcode')">
        <a-input
          v-model:value="advancedQueryForm.materialDocumentCode"
          :placeholder="t('common.page.form.placeholder.required', { field: t('entity.materialdocumentitem.materialdocumentcode') })"
          show-count
          :maxlength="50"
          allow-clear
        />
      ...
      <a-form-item :label="t('entity.materialdocumentitem.linenumber')">
        <a-input-number
          v-model:value="advancedQueryForm.lineNumber"
          :placeholder="t('common.page.form.placeholder.required', { field: t('entity.materialdocumentitem.linenumber') })"
          style="width: 100%"
        />
      </a-form-item>
      </div>
      <div v-show="isFieldVisible('sourceCode')">
      <a-form-item :label="t('entity.materialdocumentitem.sourcecode')">
        <a-input
          v-model:value="advancedQueryForm.sourceCode"
          :placeholder="t('common.page.form.placeholder.required', { field: t('entity.materialdocumentitem.sourcecode') })"
          show-count
          :maxlength="50"
          allow-clear
        />
      ...
      <a-form-item :label="t('entity.materialdocumentitem.sourcelinenumber')">
        <a-input-number
          v-model:value="advancedQueryForm.sourceLineNumber"
          :placeholder="t('common.page.form.placeholder.required', { field: t('entity.materialdocumentitem.sourcelinenumber') })"
          style="width: 100%"
        />
      </a-form-item>
      </div>
      <div v-show="isFieldVisible('materialCode')">
      <a-form-item :label="t('entity.materialdocumentitem.materialcode')">
        <a-input
          v-model:value="advancedQueryForm.materialCode"
          :placeholder="t('common.page.form.placeholder.required', { field: t('entity.materialdocumentitem.materialcode') })"
          show-count
          :maxlength="20"
          allow-clear
        />
      ...
      <a-form-item :label="t('entity.materialdocumentitem.materialname')">
        <a-input
          v-model:value="advancedQueryForm.materialName"
          :placeholder="t('common.page.form.placeholder.required', { field: t('entity.materialdocumentitem.materialname') })"
          show-count
          :maxlength="20"
          allow-clear
        />
      ...
      <a-form-item :label="t('entity.materialdocumentitem.materialspecification')">
        <a-input
          v-model:value="advancedQueryForm.materialSpecification"
          :placeholder="t('common.page.form.placeholder.required', { field: t('entity.materialdocumentitem.materialspecification') })"
          show-count
          :maxlength="20"
          allow-clear
        />
      ...
      <a-form-item :label="t('entity.materialdocumentitem.transactionunit')">
        <a-input
          v-model:value="advancedQueryForm.transactionUnit"
          :placeholder="t('common.page.form.placeholder.required', { field: t('entity.materialdocumentitem.transactionunit') })"
          show-count
          :maxlength="20"
          allow-clear
        />
      ...
      <a-form-item :label="t('entity.materialdocumentitem.transactionquantity')">
        <a-input-number
          v-model:value="advancedQueryForm.transactionQuantity"
          :placeholder="t('common.page.form.placeholder.required', { field: t('entity.materialdocumentitem.transactionquantity') })"
          style="width: 100%"
        />
      </a-form-item>
      </div>
      <div v-show="isFieldVisible('batchNo')">
      <a-form-item :label="t('entity.materialdocumentitem.batchno')">
        <a-input
          v-model:value="advancedQueryForm.batchNo"
          :placeholder="t('common.page.form.placeholder.required', { field: t('entity.materialdocumentitem.batchno') })"
          show-count
          :maxlength="20"
          allow-clear
        />
      ...
      <a-form-item :label="t('entity.materialdocumentitem.warehousecode')">
        <a-input
          v-model:value="advancedQueryForm.warehouseCode"
          :placeholder="t('common.page.form.placeholder.required', { field: t('entity.materialdocumentitem.warehousecode') })"
          show-count
          :maxlength="50"
          allow-clear
        />
      ...
      <a-form-item :label="t('entity.materialdocumentitem.locationcode')">
        <a-input
          v-model:value="advancedQueryForm.locationCode"
          :placeholder="t('common.page.form.placeholder.required', { field: t('entity.materialdocumentitem.locationcode') })"
          show-count
          :maxlength="50"
          allow-clear
        />
      ...
      <a-form-item :label="t('entity.materialdocumentitem.targetwarehousecode')">
        <a-input
          v-model:value="advancedQueryForm.targetWarehouseCode"
          :placeholder="t('common.page.form.placeholder.required', { field: t('entity.materialdocumentitem.targetwarehousecode') })"
          show-count
          :maxlength="50"
          allow-clear
        />
      ...
      <a-form-item :label="t('entity.materialdocumentitem.targetlocationcode')">
        <a-input
          v-model:value="advancedQueryForm.targetLocationCode"
          :placeholder="t('common.page.form.placeholder.required', { field: t('entity.materialdocumentitem.targetlocationcode') })"
          show-count
          :maxlength="50"
          allow-clear
        />
      ...
      <a-form-item :label="t('entity.materialdocumentitem.unitprice')">
        <a-input-number
          v-model:value="advancedQueryForm.unitPrice"
          :placeholder="t('common.page.form.placeholder.required', { field: t('entity.materialdocumentitem.unitprice') })"
          style="width: 100%"
        />
      </a-form-item>
      </div>
      <div v-show="isFieldVisible('lineAmount')">
      <a-form-item :label="t('entity.materialdocumentitem.lineamount')">
        <a-input-number
          v-model:value="advancedQueryForm.lineAmount"
          :placeholder="t('common.page.form.placeholder.required', { field: t('entity.materialdocumentitem.lineamount') })"
          style="width: 100%"
        />
      </a-form-item>
      </div>
    ...
    <TaktModal
      ...
      :title="t('common.dialog.title.import', { entity: t('entity.materialdocumentitem._self') })"
      :width="600"
      :footer="null"
    ...
    >
      <TaktImportFile
        entity-i18n-key="entity.materialdocumentitem._self"
        file-type="xlsx"
...
import MaterialTransactionItemForm from './material-document-item-form.vue'
import { useMaterialTransactionMasterContext } from '../composables/use-material-document-master-context'
import {
...
import type { MaterialTransactionItem, MaterialTransactionItemQuery } from '@/types/logistics/materials/material-document-item'
...
const queryFieldsMeta = computed(() => [
  { key: 'materialDocumentCode', label: t('entity.materialdocumentitem.materialdocumentcode') },
  { key: 'lineNumber', label: t('entity.materialdocumentitem.linenumber') },
  { key: 'sourceCode', label: t('entity.materialdocumentitem.sourcecode') },
  { key: 'sourceLineNumber', label: t('entity.materialdocumentitem.sourcelinenumber') },
  { key: 'materialCode', label: t('entity.materialdocumentitem.materialcode') },
  { key: 'materialName', label: t('entity.materialdocumentitem.materialname') },
  { key: 'materialSpecification', label: t('entity.materialdocumentitem.materialspecification') },
  { key: 'transactionUnit', label: t('entity.materialdocumentitem.transactionunit') },
  { key: 'transactionQuantity', label: t('entity.materialdocumentitem.transactionquantity') },
  { key: 'batchNo', label: t('entity.materialdocumentitem.batchno') },
  { key: 'warehouseCode', label: t('entity.materialdocumentitem.warehousecode') },
  { key: 'locationCode', label: t('entity.materialdocumentitem.locationcode') },
  { key: 'targetWarehouseCode', label: t('entity.materialdocumentitem.targetwarehousecode') },
  { key: 'targetLocationCode', label: t('entity.materialdocumentitem.targetlocationcode') },
  { key: 'unitPrice', label: t('entity.materialdocumentitem.unitprice') },
  { key: 'lineAmount', label: t('entity.materialdocumentitem.lineamount') },
...
const columns = computed<TableColumnsType>(() => [
  {
    ...
    customRender: ({ record }: { record: MaterialTransactionItem }) =>
      String(getMaterialTransactionItemField(record, 'materialDocumentItemId') ?? ''),
  },
  {
    title: t('entity.materialdocumentitem.materialdocumentcode'),
    ...
    ellipsis: true,
    customRender: ({ record }: { record: MaterialTransactionItem }) =>
      String(getMaterialTransactionItemField(record, 'materialDocumentCode') ?? ''),
  },
  {
    title: t('entity.materialdocumentitem.linenumber'),
  ...
  {
    title: t('entity.materialdocumentitem.sourcecode'),
  ...
  {
    title: t('entity.materialdocumentitem.sourcelinenumber'),
  ...
  {
    title: t('entity.materialdocumentitem.materialcode'),
  ...
  {
    title: t('entity.materialdocumentitem.materialname'),
  ...
  {
    title: t('entity.materialdocumentitem.materialspecification'),
  ...
  {
    title: t('entity.materialdocumentitem.transactionunit'),
