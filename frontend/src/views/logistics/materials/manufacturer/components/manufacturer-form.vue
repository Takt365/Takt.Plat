...
<!-- 功能描述：Takt制造商实体维护弹窗内嵌表单。由 generate-vue-from-api 根据 types/api 自动生成；defineExpose 提供 validate、getValues、resetFields -->
      ...
      >
        <div :class="formContentClass">
          <a-row :gutter="24">
            ...
            <a-col :span="12">
              ...
              >
                <a-input-number
                  ...
                  :placeholder="t('common.page.form.placeholder.required', { field: t('entity.manufacturer.status') })"
                  size="small"
                  style="width: 100%"
                />
              </a-form-item>
            ...
            <a-col :span="12">
              <a-form-item
                :label="t('entity.manufacturer.materials')"
                name="manufacturerMaterials"
              >
                <a-input
                  v-model:value="formState.manufacturerMaterials"
                  :placeholder="t('common.page.form.placeholder.required', { field: t('entity.manufacturer.materials') })"
                  size="small"
                  allow-clear
                />
              </a-form-item>
...
/**
 * Takt制造商实体维护表单 · 由 generate-vue-from-api 根据 types/api 生成
