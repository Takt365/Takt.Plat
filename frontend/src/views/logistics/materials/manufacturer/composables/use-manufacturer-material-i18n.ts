...
// 功能描述：ManufacturerMaterial字段清单 + useManufacturerMaterialI18n（字段名映射一次，文案由 entity.manufacturermaterial.* 种子动态解析）
//
// 版权信息：Copyright (c) 2025 Takt  All rights reserved.
// 免责声明：此软件使用 MIT License，作者不承担任何使用风险。
// ========================================

import type { ManufacturerMaterialQuery } from '@/types/logistics/materials/manufacturer-material'
...
/**
 * ManufacturerMaterial字段 i18n：index / manufacturer-material-form 统一入口
 */
