...
<!-- 命名空间：@/views/logistics/materials/purchase-price-item/components -->
<!-- 文件名称：purchase-price-item-form.vue -->
<!-- 功能描述：Takt采购价格明细实体维护弹窗内嵌表单。由 generate-vue-from-api 根据 types/api 自动生成；defineExpose 提供 validate、getValues、resetFields -->
...
<template>
  ...
  >
    <a-tabs
      ...
      class="purchase-price-item-form-tabs"
    >
      <a-tab-pane
        key="tab-0"
      ...
      >
        <div :class="formContentClass">
          <a-row :gutter="24">
            ...
            <a-col :span="12">
              <a-form-item
                :label="t('entity.purchasePriceItem.purchasepriceid')"
            ...
            <a-col :span="12">
              <a-form-item
                :label="t('entity.purchasePriceItem.purchasepricecode')"
      ...
      >
        <div :class="formContentClass">
          <a-row :gutter="24">
            ...
            <a-col :span="12">
              <a-form-item
                :label="t('entity.purchasePriceItem.sortorder')"
                name="sortOrder"
              >
                <a-input-number
                  v-model:value="formState.sortOrder"
                  :placeholder="t('common.page.form.placeholder.required', { field: t('entity.purchasePriceItem.sortorder') })"
                  size="small"
                  style="width: 100%"
                />
              </a-form-item>
            ...
            <a-col :span="12">
              <a-form-item
                :label="t('entity.purchasePriceItem.scales')"
                name="scales"
              >
                <a-input
                  v-model:value="formState.scales"
                  :placeholder="t('common.page.form.placeholder.required', { field: t('entity.purchasePriceItem.scales') })"
                  size="small"
                  allow-clear
                />
              </a-form-item>
...
/**
 * Takt采购价格明细实体维护表单 · 由 generate-vue-from-api 根据 types/api 生成
 * @module views/logistics/materials/purchase-price-item/components
 */
import { reactive, watch, computed, ref } from 'vue'
import { useI18n } from 'vue-i18n'
import type { Rule } from 'ant-design-vue/es/form'
import type { PurchasePriceItemCreate } from '@/types/logistics/materials/purchase-price-item'
...
const formFields = ["tenantCode","companyCode","companyDefaultCulture","purchasePriceId","purchasePriceCode","lineNumber","materialCode","materialName","materialSpecification","purchaseUnit","purchasePrice","minPurchaseQuantity","maxPurchaseQuantity","sortOrder","scales","extFieldJson","remark"]
...
watch(
  ...
  () => {
    const isCreate = !props.formData?.purchasePriceItemId
    if (isCreate) {
...
const rules = computed<Record<string, Rule[]>>(() => ({
  purchasePriceId: [
    {
      required: true,
      message: t('common.page.form.placeholder.required', { field: t('entity.purchasePriceItem.purchasepriceid') }),
      trigger: 'blur'
    }
  ],
  purchasePriceCode: [
    {
      required: true,
      message: t('common.page.form.placeholder.required', { field: t('entity.purchasePriceItem.purchasepricecode') }),
      trigger: 'blur'
    }
  ],
  lineNumber: [
    {
      required: true,
      message: t('common.page.form.placeholder.select', { field: t('entity.purchasePriceItem.linenumber') }),
      trigger: 'change'
    }
  ],
  materialCode: [
  ...
  purchasePrice: [
    {
      required: true,
      message: t('common.page.form.placeholder.select', { field: t('entity.purchasePriceItem.purchaseprice') }),
      trigger: 'change'
    }
  ],
  minPurchaseQuantity: [
    {
      required: true,
      message: t('common.page.form.placeholder.select', { field: t('entity.purchasePriceItem.minpurchasequantity') }),
      trigger: 'change'
    }
  ],
  maxPurchaseQuantity: [
    {
      required: true,
      message: t('common.page.form.placeholder.select', { field: t('entity.purchasePriceItem.maxpurchasequantity') }),
      trigger: 'change'
    }
  ],
  sortOrder: [
    {
      required: true,
      message: t('common.page.form.placeholder.select', { field: t('entity.purchasePriceItem.sortorder') }),
      trigger: 'change'
    }
  ],
}))
