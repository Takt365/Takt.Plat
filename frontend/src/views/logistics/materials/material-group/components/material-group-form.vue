...
<!-- 命名空间：@/views/logistics/materials/material-group/components -->
<!-- 文件名称：material-group-form.vue -->
<!-- 功能描述：Takt物料组主数据实体维护弹窗内嵌表单。由 generate-vue-crud-from-api.cjs 根据 types/api 自动生成；defineExpose 提供 validate、getValues、resetFields -->
            ...
            <a-col :span="24">
              ...
              >
                <a-input
                  ...
                  :maxlength="20"
                  allow-clear
                  :disabled="!!formData?.materialGroupId"
                />
              </a-form-item>
            </a-col>
            <a-col :span="24">
...
/**
 * Takt物料组主数据实体维护表单 · 由 generate-vue-crud-from-api.cjs 根据 types/api 生成
 * @module views/logistics/materials/material-group/components
 */
...
interface Props {
  formData?: Partial<MaterialGroupCreate & { materialGroupId?: string }> | null
  /** 父级提交 loading，禁用表单项 */
  loading?: boolean
}
