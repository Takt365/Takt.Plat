...
<!-- 命名空间：@/views/logistics/quality/complaint/customer-complaint-item/components -->
<!-- 文件名称：customer-complaint-item-form.vue -->
<!-- 功能描述：客诉明细实体维护弹窗内嵌表单。由 generate-vue-from-api 根据 types/api 自动生成；defineExpose 提供 validate、getValues、resetFields -->
      ...
      >
        <div :class="formContentClass">
          <a-row :gutter="24">
            ...
            <a-col :span="12">
              <a-form-item
                :label="t('entity.customerComplaintItem.complaintid')"
                name="complaintId"
              >
                <a-input
            ...
            <a-col :span="12">
              <a-form-item
                :label="t('entity.customerComplaintItem.customercomplaintcode')"
            ...
            <a-col :span="12">
              <a-form-item
                :label="t('entity.customerComplaintItem.linenumber')"
                name="lineNumber"
              >
                <a-input-number
            ...
            <a-col :span="12">
              <a-form-item
                :label="t('entity.customerComplaintItem.productcode')"
                name="productCode"
              >
                <a-input
            ...
            <a-col :span="12">
              <a-form-item
                :label="t('entity.customerComplaintItem.productname')"
                name="productName"
              >
                <a-input
            ...
            <a-col :span="12">
              <a-form-item
                :label="t('entity.customerComplaintItem.batchno')"
                name="batchNo"
              >
                <a-input
            ...
            <a-col :span="12">
              <a-form-item
                :label="t('entity.customerComplaintItem.itemtype')"
                name="itemType"
              >
                <a-input-number
      ...
      >
        <div :class="formContentClass">
          <a-row :gutter="24">
            <a-col :span="24">
              <a-form-item
                :label="t('entity.customerComplaintItem.defectdescription')"
            ...
            <a-col :span="12">
              <a-form-item
                :label="t('entity.customerComplaintItem.defectlevel')"
                name="defectLevel"
              >
                <a-input
            ...
            <a-col :span="12">
              <a-form-item
                :label="t('entity.customerComplaintItem.defectquantity')"
                name="defectQuantity"
              >
                <a-input-number
            ...
            <a-col :span="12">
              <a-form-item
                :label="t('entity.customerComplaintItem.defectrate')"
                name="defectRate"
              >
                <a-input-number
            ...
            <a-col :span="12">
              <a-form-item
                :label="t('entity.customerComplaintItem.causeanalysis')"
                name="causeAnalysis"
              >
                <a-input
            ...
            <a-col :span="12">
              <a-form-item
                :label="t('entity.customerComplaintItem.improvementaction')"
            ...
            <a-col :span="12">
              <a-form-item
                :label="t('entity.customerComplaintItem.improvementresponsible')"
            ...
            <a-col :span="12">
              <a-form-item
                :label="t('entity.customerComplaintItem.plannedcompletiondate')"
                name="plannedCompletionDate"
              >
                <a-date-picker
                  v-model:value="formState.plannedCompletionDate"
                  :placeholder="t('common.page.form.placeholder.select', { field: t('entity.customerComplaintItem.plannedcompletiondate') })"
            ...
            <a-col :span="12">
              <a-form-item
                :label="t('entity.customerComplaintItem.actualcompletiondate')"
                name="actualCompletionDate"
              >
                <a-date-picker
                  v-model:value="formState.actualCompletionDate"
                  :placeholder="t('common.page.form.placeholder.select', { field: t('entity.customerComplaintItem.actualcompletiondate') })"
                  value-format="YYYY-MM-DD"
                  size="small"
                  style="width: 100%"
                />
            ...
            <a-col :span="12">
              <a-form-item
                :label="t('entity.customerComplaintItem.improvementstatus')"
      ...
      >
        <div :class="formContentClass">
          <a-row :gutter="24">
            <a-col :span="12">
              <a-form-item
                :label="t('entity.customerComplaintItem.attachmentpaths')"
...
/**
 * 客诉明细实体维护表单 · 由 generate-vue-from-api 根据 types/api 生成
 * @module views/logistics/quality/complaint/customer-complaint-item/components
 */
...
const formFields = ["tenantCode","companyCode","companyDefaultCulture","complaintId","customerComplaintCode","lineNumber","productCode","productName","batchNo","itemType","defectDescription","defectLevel","defectQuantity","defectRate","causeAnalysis","improvementAction","improvementResponsible","plannedCompletionDate","actualCompletionDate","improvementStatus","attachmentPaths","extFieldJson","remark"]
...
watch(
  ...
  () => {
    const isCreate = !props.formData?.customerComplaintItemId
    if (isCreate) {
...
const rules = computed<Record<string, Rule[]>>(() => ({
  complaintId: [
    {
      required: true,
      message: t('common.page.form.placeholder.required', { field: t('entity.customerComplaintItem.complaintid') }),
      trigger: 'blur'
    }
  ],
  customerComplaintCode: [
    {
      required: true,
      message: t('common.page.form.placeholder.required', { field: t('entity.customerComplaintItem.customercomplaintcode') }),
      trigger: 'blur'
    }
  ],
  lineNumber: [
    {
      required: true,
      message: t('common.page.form.placeholder.select', { field: t('entity.customerComplaintItem.linenumber') }),
      trigger: 'change'
    }
  ],
  itemType: [
    {
      required: true,
      message: t('common.page.form.placeholder.select', { field: t('entity.customerComplaintItem.itemtype') }),
      trigger: 'change'
    }
  ],
  defectDescription: [
    {
      required: true,
      message: t('common.page.form.placeholder.required', { field: t('entity.customerComplaintItem.defectdescription') }),
      trigger: 'blur'
    }
  ],
  defectLevel: [
    {
      required: true,
      message: t('common.page.form.placeholder.required', { field: t('entity.customerComplaintItem.defectlevel') }),
      trigger: 'blur'
    }
  ],
  defectQuantity: [
    {
      required: true,
      message: t('common.page.form.placeholder.select', { field: t('entity.customerComplaintItem.defectquantity') }),
      trigger: 'change'
    }
  ],
  improvementStatus: [
    {
      required: true,
      message: t('common.page.form.placeholder.select', { field: t('entity.customerComplaintItem.improvementstatus') }),
      trigger: 'change'
    }
  ],
}))
