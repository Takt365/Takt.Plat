      ...
      >
        <div :class="formContentClass">
          <a-row :gutter="24">
            ...
            <a-col :span="12">
              <a-form-item
                :label="t('entity.ipqcorderitem.sampleserialno')"
                name="sampleSerialNo"
              >
                <a-input
      ...
      >
        <div :class="formContentClass">
          <a-row :gutter="24">
            ...
            <a-col :span="24">
              <a-form-item
                :label="t('entity.ipqcorderitem.extfield')"
                name="ExtField"
              >
                <a-textarea
...
const formFields = ["tenantCode","companyCode","companyDefaultCulture","ipqcOrderId","ipqcOrderCode","lineNumber","materialCode","materialName","batchNo","productionQuantity","standardCode","samplingSchemeCode","inspectionMethod","sampleQuantity","qualifiedQuantity","unqualifiedQuantity","inspectionReturnQuantity","judgeStatus","sampleSerialNo","inspectionDescription","inspectorBy","inspectionDate","ExtField","remark"]
