...
const formFields = ["tenantCode","companyCode","companyDefaultCulture","ipqcOrderId","ipqcOrderCode","lineNumber","materialCode","materialName","batchNo","productionQuantity","standardCode","samplingSchemeCode","inspectionMethod","sampleQuantity","qualifiedQuantity","unqualifiedQuantity","inspectionReturnQuantity","sampleSerialNo","inspectionDescription","inspectorBy","inspectionDate","judgeStatus","extField","remark"]
