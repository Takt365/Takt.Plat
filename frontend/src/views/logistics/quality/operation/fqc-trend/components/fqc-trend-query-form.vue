...
<!-- 文件名称：fqc-trend-query-form.vue -->
<!-- 功能描述：成品检验推移查询栏（工厂/期间/客户） -->
...
<template>
  <div class="takt-query-bar inspection-trend-query-bar">
    <div class="inspection-trend-query-bar__fields min-w-0 flex flex-1 flex-wrap items-center gap-x-3 gap-y-2">
      ...
      <div class="flex items-center gap-1">
        <span class="shrink-0 text-sm text-text-secondary whitespace-nowrap">{{ t(`${localePrefix}.customerCode`) }}</span>
        <TaktSelect
