...
<!-- 命名空间：@/views/logistics/quality/operation/fqc-trend -->
<!-- 文件名称：index.vue -->
<!-- 功能描述：成品检验推移（工厂×客户×月份不良率转置表） -->
...
<template>
  <div class="flex h-full min-h-0 flex-col p-4">
    ...
    <TaktToolsBar
      ...
      export-permission="logistics:quality:operation:fqc:trend:export"
      @export="handleExport"
...
import FqcTrendQueryForm from './components/fqc-trend-query-form.vue'
import FqcTrendPanel from './components/fqc-trend-panel.vue'
