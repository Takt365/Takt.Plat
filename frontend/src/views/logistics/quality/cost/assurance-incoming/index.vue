...
<!-- 命名空间：@/views/logistics/quality/cost/assurance-incoming -->
<!-- 文件名称：index.vue -->
...
<template>
  <div class="p-4 flex flex-col min-h-0 h-full">
    ...
    <TaktQueryDrawer
      ...
      :storage-key="'takt-query-fields-logistics-quality-cost-assurance-incoming'"
 ...
 * @module views/logistics/quality/cost/assurance-incoming
 */
