...
<!-- 命名空间：@/views/logistics/quality/cost/assurance-other -->
<!-- 文件名称：index.vue -->
...
<template>
  <div class="p-4 flex flex-col min-h-0 h-full">
    ...
    >
      <template #detail>
        <QualityAssuranceOtherPanel
          ref="qualityAssuranceOtherPanelRef"
    ...
    <TaktQueryDrawer
      ...
      :storage-key="'takt-query-fields-logistics-quality-cost-assurance-other'"
 ...
 * @module views/logistics/quality/cost/assurance-other
 */
...
import QualityAssuranceOtherPanel from './components/assurance-other-panel.vue'
...
const qualityAssuranceOtherPanelRef = ref<InstanceType<typeof QualityAssuranceOtherPanel> | null>(null)
...
async function handleFormSubmit() {
  ...
  qualityAssuranceOtherPanelRef.value?.reload?.()
    }
    loadData()
  } finally {
    formLoading.value = false
