...
watch(
  ...
  (val) => {
    ...
    delete (next as any).meetingItems
...
async function validate() {
  ...
  await qualityIssueMeetingTableRef.value?.validate?.()
  return formState
}
...
function resetFields() {
  ...
  childQualityIssueMeetingRows.value = []
  qualityIssueMeetingTableRef.value?.resetRows?.()
