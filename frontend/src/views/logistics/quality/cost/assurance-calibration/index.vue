...
<!-- 命名空间：@/views/logistics/quality/cost/assurance-calibration -->
<!-- 文件名称：index.vue -->
...
<template>
  <div class="p-4 flex flex-col min-h-0 h-full">
    ...
    >
      <template #detail>
        <QualityAssuranceCalibrationPanel
          ref="qualityAssuranceCalibrationPanelRef"
    ...
    <TaktQueryDrawer
      ...
      :storage-key="'takt-query-fields-logistics-quality-cost-assurance-calibration'"
 ...
 * @module views/logistics/quality/cost/assurance-calibration
 */
...
import QualityAssuranceCalibrationPanel from './components/assurance-calibration-panel.vue'
...
const qualityAssuranceCalibrationPanelRef = ref<InstanceType<typeof QualityAssuranceCalibrationPanel> | null>(null)
...
async function handleFormSubmit() {
  ...
  qualityAssuranceCalibrationPanelRef.value?.reload?.()
    }
    loadData()
  } finally {
    formLoading.value = false
