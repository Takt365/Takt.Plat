...
<!-- 命名空间：@/views/logistics/quality/cost/cost-trend -->
<!-- 文件名称：index.vue -->
<!-- 功能描述：质量成本月推移（工厂×成本类别×币种×月份转置表） -->
...
<template>
  <div class="flex h-full min-h-0 flex-col p-4">
    ...
    <TaktToolsBar
      ...
      export-permission="logistics:quality:cost:trend:export"
      @export="handleExport"
...
import CostTrendQueryForm from './components/cost-trend-query-form.vue'
import CostTrendPanel from './components/cost-trend-panel.vue'
