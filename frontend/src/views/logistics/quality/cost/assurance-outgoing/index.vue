...
<!-- 命名空间：@/views/logistics/quality/cost/assurance-outgoing -->
<!-- 文件名称：index.vue -->
...
<template>
  <div class="p-4 flex flex-col min-h-0 h-full">
    ...
    >
      <template #detail>
        <QualityAssuranceOutgoingPanel
          ref="qualityAssuranceOutgoingPanelRef"
    ...
    <TaktQueryDrawer
      ...
      :storage-key="'takt-query-fields-logistics-quality-cost-assurance-outgoing'"
 ...
 * @module views/logistics/quality/cost/assurance-outgoing
 */
...
import QualityAssuranceOutgoingPanel from './components/assurance-outgoing-panel.vue'
...
const qualityAssuranceOutgoingPanelRef = ref<InstanceType<typeof QualityAssuranceOutgoingPanel> | null>(null)
...
async function handleFormSubmit() {
  ...
  qualityAssuranceOutgoingPanelRef.value?.reload?.()
    }
    loadData()
  } finally {
    formLoading.value = false
