...
<!-- 命名空间：@/views/logistics/quality/cost/assurance-reliability -->
<!-- 文件名称：index.vue -->
...
<template>
  <div class="p-4 flex flex-col min-h-0 h-full">
    ...
    >
      <template #detail>
        <QualityAssuranceReliabilityPanel
          ref="qualityAssuranceReliabilityPanelRef"
    ...
    <TaktQueryDrawer
      ...
      :storage-key="'takt-query-fields-logistics-quality-cost-assurance-reliability'"
 ...
 * @module views/logistics/quality/cost/assurance-reliability
 */
...
import QualityAssuranceReliabilityPanel from './components/assurance-reliability-panel.vue'
...
const qualityAssuranceReliabilityPanelRef = ref<InstanceType<typeof QualityAssuranceReliabilityPanel> | null>(null)
...
async function handleFormSubmit() {
  ...
  qualityAssuranceReliabilityPanelRef.value?.reload?.()
    }
    loadData()
  } finally {
    formLoading.value = false
