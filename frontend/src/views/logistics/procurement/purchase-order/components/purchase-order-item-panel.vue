    ...
    >
      ...
      <a-form-item :label="t('entity.purchaseorderitem.discountrate')">
        <TaktSelect
          ...
          :placeholder="t('common.page.form.placeholder.select', { field: t('entity.purchaseorderitem.discountrate') })"
          allow-clear
        />
      </a-form-item>
      </div>
      ...
      <a-form-item :label="t('entity.purchaseorderitem.taxrate')">
        <TaktSelect
          ...
          :placeholder="t('common.page.form.placeholder.select', { field: t('entity.purchaseorderitem.taxrate') })"
          allow-clear
        />
      </a-form-item>
      </div>
      ...
      <a-form-item :label="t('entity.purchaseorderitem.deliverystatus')">
        <TaktSelect
          ...
          :placeholder="t('common.page.form.placeholder.select', { field: t('entity.purchaseorderitem.deliverystatus') })"
          allow-clear
        />
      </a-form-item>
      </div>
