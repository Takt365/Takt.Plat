      ...
      >
        <div :class="formContentClass">
          <a-row :gutter="24">
            ...
            <a-col :span="12">
              <a-form-item
                :label="t('entity.purchasegroup.code')"
            ...
            <a-col :span="12">
              <a-form-item
                :label="t('entity.purchasegroup.name')"
            ...
            <a-col :span="24">
              <a-form-item
                :label="t('entity.purchasegroup.description')"
            ...
            <a-col :span="12">
              <a-form-item
                :label="t('entity.purchasegroup.responsibleuserid')"
            ...
            <a-col :span="12">
              <a-form-item
                :label="t('entity.purchasegroup.contactphone')"
                name="contactPhone"
              >
                <a-input
            ...
            <a-col :span="12">
              <a-form-item
                :label="t('entity.purchasegroup.contactemail')"
                name="contactEmail"
              >
                <a-input
      ...
      >
        <div :class="formContentClass">
          <a-row :gutter="24">
            <a-col :span="24">
              <a-form-item
                :label="t('entity.purchasegroup.isbuiltin')"
                name="isBuiltIn"
              >
                <TaktSelect
...
watch(
  ...
  () => {
    const isCreate = !props.formData?.purchaseGroupId
    if (isCreate) {
...
const rules = computed<Record<string, Rule[]>>(() => ({
  purchaseGroupCode: [
    {
      required: true,
      message: t('common.page.form.placeholder.required', { field: t('entity.purchasegroup.code') }),
      trigger: 'blur'
    }
  ],
  purchaseGroupName: [
    {
      required: true,
      message: t('common.page.form.placeholder.required', { field: t('entity.purchasegroup.name') }),
      trigger: 'blur'
    }
  ],
  GroupStatus: [{
  ...
  isBuiltIn: [{
    validator: async (_rule, value) => {
      if (value === undefined || value === null || value === '') {
        return Promise.reject(t('common.page.form.placeholder.select', { field: t('entity.purchasegroup.isbuiltin') }))
      }
      const num = typeof value === 'number' ? value : Number(value)
      if (!Number.isFinite(num)) {
        return Promise.reject(t('common.page.form.placeholder.select', { field: t('entity.purchasegroup.isbuiltin') }))
