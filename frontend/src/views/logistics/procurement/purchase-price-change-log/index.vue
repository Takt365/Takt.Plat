...
<!-- 命名空间：@/views/logistics/procurement/purchase-price-change-log -->
<!-- 文件名称：index.vue -->
...
<template>
  <div class="p-4 flex flex-col min-h-0 h-full">
    ...
    >
      ...
      <template #detail>
        <PurchasePriceChangeLogPanel
          ref="purchasePriceChangeLogPanelRef"
    ...
    <TaktQueryDrawer
      ...
      :storage-key="'takt-query-fields-logistics-procurement-purchase-price-change-log'"
 ...
 * @module views/logistics/procurement/purchase-price-change-log
 */
...
import PurchasePriceChangeLogPanel from './components/purchase-price-change-log-panel.vue'
...
const purchasePriceChangeLogPanelRef = ref<InstanceType<typeof PurchasePriceChangeLogPanel> | null>(null)
...
async function handleFormSubmit() {
  ...
  purchasePriceChangeLogPanelRef.value?.reload?.()
    }
    loadData()
  } finally {
    formLoading.value = false
