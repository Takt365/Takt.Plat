...
<!-- 命名空间：@/views/logistics/procurement/purchase-model-trend -->
<!-- 文件名称：index.vue -->
...
<template>
  <div class="flex h-full min-h-0 flex-col p-4">
    <purchase-model-trend-query-form
    ...
    <TaktToolsBar
      ...
      export-permission="logistics:procurement:purchase:model:trend:export"
      @export="handleExport"
      @refresh="handleRefresh"
    />
    <purchase-model-trend-panel
      ref="panelRef"
...
import PurchaseModelTrendQueryForm from './components/purchase-model-trend-query-form.vue'
import PurchaseModelTrendPanel from './components/purchase-model-trend-panel.vue'
