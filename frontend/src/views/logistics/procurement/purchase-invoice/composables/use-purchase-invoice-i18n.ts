...
// 功能描述：Takt采购发票实体字段清单 + usePurchaseInvoiceI18n（字段名映射一次，文案由 entity.purchaseinvoice.* 种子动态解析）
//
...
export type PurchaseInvoiceQueryField =
  ...
  | 'totalAmount' | 'taxRate' | 'taxAmount' | 'actualAmount' | 'paidAmount' | 'paymentMethod' | 'invoiceStatus'
...
/**
 * Takt采购发票实体字段 i18n：index / purchase-invoice-form 统一入口
 */
