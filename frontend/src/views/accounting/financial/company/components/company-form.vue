...
<!-- 功能描述：公司实体 代表租户下的独立公司/工厂维护弹窗内嵌表单。由 generate-vue-from-api 根据 types/api 自动生成；defineExpose 提供 validate、getValues、resetFields -->
...
/**
 * 公司实体 代表租户下的独立公司/工厂维护表单 · 由 generate-vue-from-api 根据 types/api 生成
