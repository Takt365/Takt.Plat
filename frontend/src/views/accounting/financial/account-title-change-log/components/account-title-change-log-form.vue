...
const formFields = ["tenantCode","companyCode","companyDefaultCulture","accountTitleId","titleCode","changeFields","changeTime","changeBy","changeReason","extFieldJson","remark"]
...
watch(
  ...
  () => {
    const isCreate = !props.formData?.accountTitleChangeLogId
    if (isCreate) {
