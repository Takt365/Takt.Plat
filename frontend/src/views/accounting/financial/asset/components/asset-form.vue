...
<!-- 文件名称：asset-form.vue -->
<!-- 功能描述：资产实体维护弹窗内嵌表单。由 generate-vue-from-api 根据 types/api 自动生成；defineExpose 提供 validate、getValues、resetFields -->
...
/**
 * 资产实体维护表单 · 由 generate-vue-from-api 根据 types/api 生成
