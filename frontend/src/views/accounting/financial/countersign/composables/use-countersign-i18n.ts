...
export const COUNTERSIGN_PLACEHOLDER = {
  ...
  stepNo: 'select',
  countersignDepts: 'optional',
  financeDept: 'optional',
  budgetReviewComment: 'optional',
  executiveOffice: 'optional',
  applicantBy: 'select',
  applicationDept: 'optional',
  costBearerDept: 'optional',
  isBudget: 'select',
  budgetItem: 'optional',
  budgetAmount: 'select',
...
export type CountersignQueryField =
  ...
  | 'stepNo' | 'isBudget' | 'budgetAmount' | 'applicationAmount' | 'countersignStatus' | 'approvalStatus'
