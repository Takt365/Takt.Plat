            ...
            <a-col :span="12">
              ...
              >
                <a-input
                  ...
                  :placeholder="t('common.page.form.placeholder.required', { field: t('entity.role.menuids') })"
                  size="small"
                  allow-clear
                />
              </a-form-item>
            ...
            <a-col :span="12">
              ...
              >
                <a-input
                  ...
                  :placeholder="t('common.page.form.placeholder.required', { field: t('entity.role.companycodes') })"
                  size="small"
                  allow-clear
                />
              </a-form-item>
            ...
            <a-col :span="12">
              ...
              >
                <a-input
                  ...
                  :placeholder="t('common.page.form.placeholder.required', { field: t('entity.role.deptids') })"
                  size="small"
                  allow-clear
                />
              </a-form-item>
...
const rules = computed<Record<string, Rule[]>>(() => ({
  ...
  dataScope: [
    {
      required: true,
      message: t('common.page.form.placeholder.required', { field: t('entity.role.datascope') }),
      trigger: 'blur'
    }
  ],
  sortOrder: [
    {
      required: true,
      message: t('common.page.form.placeholder.select', { field: t('entity.role.sortorder') }),
      trigger: 'change'
    }
  ],
  isBuiltIn: [
    {
      required: true,
      message: t('common.page.form.placeholder.select', { field: t('entity.role.isbuiltin') }),
      trigger: 'change'
    }
  ],
  roleStatus: [
    {
      required: true,
      message: t('common.page.form.placeholder.select', { field: t('entity.role.status') }),
      trigger: 'change'
    }
  ],
}))
