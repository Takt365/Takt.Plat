...
/**
 * 更新服务订单状态
 * @param {ServiceOrderStatus} dto 状态 DTO
 * @returns {Promise<ServiceOrder>} 服务订单DTO
 */
 ...
 */
export function importServiceOrder(file: globalThis.File, sheetName?: string): Promise<{ success: number; fail: number; errors: string[] }> {
