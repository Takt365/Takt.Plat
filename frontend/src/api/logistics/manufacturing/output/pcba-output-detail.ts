...
/**
 * 更新PCBA日报明细状态
 * @param {PcbaOutputDetailStatus} dto 状态DTO
 * @returns {Promise<PcbaOutputDetail>} PCBA日报明细DTO
 */
 ...
 */
export function importPcbaOutputDetail(file: File, sheetName?: string): Promise<{ success: number; fail: number; errors: string[] }> {
