...
} from '@/types/logistics/manufacturing/aps/production-order';
...
/**
 * 按工单号查询生产工单（用于日报回填）
 * @param {string} prodOrderCode 工单号
 * @param {string} [plantCode] 工厂代码（可选，用于精确匹配）
 * @returns {Promise<ProductionOrder>} 生产工单 DTO
 */
