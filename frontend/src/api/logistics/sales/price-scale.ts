...
/**
 * 更新销售价格阶梯作废状态
 * @param {SalesPriceScaleObsolete} dto 作废 DTO
 * @returns {Promise<SalesPriceScale>} 销售价格阶梯DTO
 */
export function updateSalesPriceScaleObsolete(dto: SalesPriceScaleObsolete): Promise<SalesPriceScale> {
  return request<SalesPriceScale>({
    url: `${SALES_PRICE_SCALE_API_BASE}/obsolete`,
    method: 'put',
    data: dto,
  });
}
