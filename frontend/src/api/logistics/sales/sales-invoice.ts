...
import type {
  ...
  SalesInvoiceStatus,
  SalesInvoiceUpdate
} from '@/types/logistics/sales/sales-invoice';
...
/**
 * 更新销售发票状态
 * @param {SalesInvoiceStatus} dto 状态DTO
 * @returns {Promise<SalesInvoice>} 销售发票DTO
 */
 ...
 */
export function importSalesInvoice(file: File, sheetName?: string): Promise<{ success: number; fail: number; errors: string[] }> {
