...
/**
 * 更新出货检验不良处理记录状态
 * @param {FqcDefectHandlingStatus} dto 状态DTO
 * @returns {Promise<FqcDefectHandling>} 出货检验不良处理记录DTO
 */
 ...
 */
export function importFqcDefectHandling(file: File, sheetName?: string): Promise<{ success: number; fail: number; errors: string[] }> {
