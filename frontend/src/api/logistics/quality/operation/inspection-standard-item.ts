 ...
 */
export function getInspectionStandardItemOptions(
  plantCode?: string,
  keyword?: string
 ...
 */
export function importInspectionStandardItem(file: globalThis.File, sheetName?: string): Promise<{ success: number; fail: number; errors: string[] }> {
