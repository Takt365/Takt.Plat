...
import type {
  ...
  QualityAssuranceCustomerResponseObsolete,
 ...
 * @param {QualityAssuranceCustomerResponseObsolete} dto 作废 DTO
 * @returns {Promise<QualityAssuranceCustomerResponse>} 品质业务顾客品质要求对应费用明细DTO
 */
export function updateQualityAssuranceCustomerResponseObsolete(dto: QualityAssuranceCustomerResponseObsolete): Promise<QualityAssuranceCustomerResponse> {
  return request<QualityAssuranceCustomerResponse>({
    url: `${QUALITY_ASSURANCE_CUSTOMER_RESPONSE_API_BASE}/obsolete`,
    method: 'put',
    data: dto,
  });
}
