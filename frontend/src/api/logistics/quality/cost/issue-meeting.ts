 ...
 * @param {QualityIssueMeetingObsolete} dto 作废 DTO
 * @returns {Promise<QualityIssueMeeting>} 质量问题会议调查试验费用明细DTO
 */
export function updateQualityIssueMeetingObsolete(dto: QualityIssueMeetingObsolete): Promise<QualityIssueMeeting> {
  return request<QualityIssueMeeting>({
    url: `${QUALITY_ISSUE_MEETING_API_BASE}/obsolete`,
    method: 'put',
    data: dto,
  });
}
 ...
 */
export function getQualityIssueMeetingOptions(
  plantCode?: string,
  keyword?: string
