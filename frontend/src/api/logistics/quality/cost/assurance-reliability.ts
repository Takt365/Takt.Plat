...
import type {
  ...
  QualityAssuranceReliabilityObsolete,
 ...
 * @param {QualityAssuranceReliabilityObsolete} dto 作废 DTO
 * @returns {Promise<QualityAssuranceReliability>} 品质业务信赖性评价ORT费用明细DTO
 */
export function updateQualityAssuranceReliabilityObsolete(dto: QualityAssuranceReliabilityObsolete): Promise<QualityAssuranceReliability> {
  return request<QualityAssuranceReliability>({
    url: `${QUALITY_ASSURANCE_RELIABILITY_API_BASE}/obsolete`,
    method: 'put',
    data: dto,
  });
}
 ...
 */
export function getQualityAssuranceReliabilityOptions(
  plantCode?: string,
  keyword?: string
