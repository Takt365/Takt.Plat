...
/**
 * 更新供应商评价考核项目明细状态
 * @param {SupplierEvaluationItemStatus} dto 状态DTO
 * @returns {Promise<SupplierEvaluationItem>} 供应商评价考核项目明细DTO
 */
 ...
 */
export function importSupplierEvaluationItem(file: File, sheetName?: string): Promise<{ success: number; fail: number; errors: string[] }> {
