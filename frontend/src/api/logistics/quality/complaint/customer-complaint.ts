...
/**
 * 更新客诉主状态
 * @param {CustomerComplaintStatus} dto 状态DTO
 * @returns {Promise<CustomerComplaint>} 客诉主DTO
 */
 ...
 */
export function importCustomerComplaint(file: File, sheetName?: string): Promise<{ success: number; fail: number; errors: string[] }> {
