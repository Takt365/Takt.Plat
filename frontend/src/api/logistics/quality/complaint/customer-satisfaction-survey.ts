...
/**
 * 更新客户满意度调查状态
 * @param {CustomerSatisfactionSurveyStatus} dto 状态DTO
 * @returns {Promise<CustomerSatisfactionSurvey>} 客户满意度调查DTO
 */
 ...
 */
export function importCustomerSatisfactionSurvey(file: File, sheetName?: string): Promise<{ success: number; fail: number; errors: string[] }> {
