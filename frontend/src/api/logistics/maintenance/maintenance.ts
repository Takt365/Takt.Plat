...
/**
 * 更新设备维护记录状态
 * @param {MaintenanceStatus} dto 状态 DTO
 * @returns {Promise<Maintenance>} 设备维护记录DTO
 */
 ...
 */
export function importMaintenance(file: globalThis.File, sheetName?: string): Promise<{ success: number; fail: number; errors: string[] }> {
