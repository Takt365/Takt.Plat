...
/**
 * 更新采购订单明细状态
 * @param {PurchaseOrderItemStatus} dto 状态DTO
 * @returns {Promise<PurchaseOrderItem>} 采购订单明细DTO
 */
 ...
 */
export function importPurchaseOrderItem(file: File, sheetName?: string): Promise<{ success: number; fail: number; errors: string[] }> {
