...
/**
 * 更新绩效考核状态
 * @param {AssessmentStatus} dto 状态 DTO
 * @returns {Promise<Assessment>} 绩效考核DTO
 */
 ...
 */
export function importAssessment(file: globalThis.File, sheetName?: string): Promise<{ success: number; fail: number; errors: string[] }> {
