...
/**
 * 更新绩效周期日程状态
 * @param {CycleScheduleStatus} dto 状态 DTO
 * @returns {Promise<CycleSchedule>} 绩效周期日程DTO
 */
 ...
 */
export function importCycleSchedule(file: globalThis.File, sheetName?: string): Promise<{ success: number; fail: number; errors: string[] }> {
