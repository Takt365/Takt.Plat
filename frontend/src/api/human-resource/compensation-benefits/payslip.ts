...
import type {
  ...
  PayslipStatus,
  PayslipUpdate
} from '@/types/human-resource/compensation-benefits/payslip';
...
/**
 * 根据ID获取薪资条
 * @param {string} id 薪资条ID
 * @returns {Promise<Payslip>} 薪资条DTO
 */
 ...
 */
export function importPayslip(file: File, sheetName?: string): Promise<{ success: number; fail: number; errors: string[] }> {
