...
/**
 * 更新职业发展状态
 * @param {CareerDevelopmentStatus} dto 状态 DTO
 * @returns {Promise<CareerDevelopment>} 职业发展DTO
 */
 ...
 */
export function importCareerDevelopment(file: globalThis.File, sheetName?: string): Promise<{ success: number; fail: number; errors: string[] }> {
