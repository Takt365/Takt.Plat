 ...
 */
export function getEmployeeDelegationOptions(
  plantCode?: string,
  keyword?: string
 ...
 */
export function importEmployeeDelegation(file: globalThis.File, sheetName?: string): Promise<{ success: number; fail: number; errors: string[] }> {
