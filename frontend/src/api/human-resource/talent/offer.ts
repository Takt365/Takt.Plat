...
import type {
  ...
  TalentOfferCreate,
  TalentOfferUpdate
} from '@/types/human-resource/talent/offer';
 ...
 */
export function getTalentOfferOptions(
  plantCode?: string,
  keyword?: string
 ...
 */
export function importTalentOffer(file: globalThis.File, sheetName?: string): Promise<{ success: number; fail: number; errors: string[] }> {
