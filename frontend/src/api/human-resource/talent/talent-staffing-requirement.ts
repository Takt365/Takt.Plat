...
// 文件名称：talent-staffing-requirement.ts
// 创建时间：2026-06-07
...
} from '@/types/human-resource/talent/talent-staffing-requirement';
 ...
 */
export function importTalentStaffingRequirement(file: File, sheetName?: string): Promise<{ success: number; fail: number; errors: string[] }> {
