...
} from '@/types/statistics/quick-query/configurable-group-by';
...
/**
 * 根据ID获取定制报表分组
 * @param {string} id 定制报表分组ID
 * @returns {Promise<ConfigurableGroupBy>} 定制报表分组DTO
 */
 ...
 */
export function getConfigurableGroupByOptions(
  plantCode?: string,
  keyword?: string
