...
} from '@/types/statistics/quick-query/configurable-selection';
...
/**
 * 根据ID获取定制报表筛选
 * @param {string} id 定制报表筛选ID
 * @returns {Promise<ConfigurableSelection>} 定制报表筛选DTO
 */
 ...
 */
export function getConfigurableSelectionOptions(
  plantCode?: string,
  keyword?: string
