...
} from '@/types/statistics/quick-query/configurable-order-by';
...
/**
 * 根据ID获取定制报表排序
 * @param {string} id 定制报表排序ID
 * @returns {Promise<ConfigurableOrderBy>} 定制报表排序DTO
 */
 ...
 */
export function getConfigurableOrderByOptions(
  plantCode?: string,
  keyword?: string
