...
} from '@/types/statistics/quick-query/configurable-execute-query';
import type {
  ConfigurableExportData
} from '@/types/statistics/quick-query/configurable-export-data';
import type {
  ConfigurablePreviewQuery
} from '@/types/statistics/quick-query/configurable-preview-query';
import type {
  ConfigurableQueryResult
} from '@/types/statistics/quick-query/configurable-query-result';
import type {
  ConfigurableRuntimeScreen
} from '@/types/statistics/quick-query/configurable-runtime-screen';
...
/**
 * 根据ID获取定制报表主
 * @param {string} id 定制报表主ID
 * @returns {Promise<Configurable>} 定制报表主DTO
 */
...
/**
 * 设计态预览查询（未保存定义）
 * @param {ConfigurablePreviewQuery} queryDto 定制报表定义与分页
 * @returns {Promise<ConfigurableQueryResult>} 查询结果
 */
