...
} from '@/types/statistics/quick-query/configurable-join';
...
/**
 * 根据ID获取定制报表关联
 * @param {string} id 定制报表关联ID
 * @returns {Promise<ConfigurableJoin>} 定制报表关联DTO
 */
 ...
 */
export function getConfigurableJoinOptions(
  plantCode?: string,
  keyword?: string
