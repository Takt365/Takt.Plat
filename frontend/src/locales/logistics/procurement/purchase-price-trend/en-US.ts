...
export default {
  page: {
    ...
    summary: '{count} material×supplier rows (gaps carry last valid price; hover * for price date)',
    summaryModel: '{count} material×supplier rows (model/product groups from BOM; gap fill same as left)',
