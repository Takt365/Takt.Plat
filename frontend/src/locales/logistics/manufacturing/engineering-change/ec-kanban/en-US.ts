...
// 功能描述：Kanban page-only copy (no entity/dict seed); column titles prefer entity.ecgijutsu.* / entity.ecexec.* / org.dept.*. Keys logistics.manufacturing.engineering-change.ec-kanban.page.*
//
