...
// 功能描述：产品成本分析页静态文案；引用键 logistics.manufacturing.bom.material-cost-trend.page.*
//
...
export default {
  page: {
    ...
    trendSummary: '明细环比 {base} → {compare}：涨 {up} · 跌 {down} · 平 {flat}',
    queryFailed: '产品成本分析查询失败',
    exportSuccess: '产品成本分析导出成功',
    exportFailed: '产品成本分析导出失败',
    filter: {
      all: '全部',
      changed: '仅涨跌',
    },
