...
export default {
  page: {
    ...
    summaryDetail: '{plant} / {model} — product group {productCount}, variance components {componentCount} (align by component code+description+qty+batch+production-related+purchase type+special procurement+profit center; period from costing date)',
