...
export default {
  page: {
    ...
    backfillPurchasePrice: '回填采购价格',
    refreshModelFields: '回填机种价格',
    costingMonth: '核算月份',
    ...
    backfillPurchasePriceSuccess: '{month} 回填完成：更新 {updated} 行，跳过 {skipped} 行（扫描 {scanned} 行）',
    backfillPurchasePriceFailed: '回填采购价格失败',
