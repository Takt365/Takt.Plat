...
export default {
  page: {
    ...
    summary: '{count} material×customer rows (monthly valid sales prices; empty when no price)',
    summaryModel: '{count} material×customer rows (model/product groups from BOM: component→product→model)',
