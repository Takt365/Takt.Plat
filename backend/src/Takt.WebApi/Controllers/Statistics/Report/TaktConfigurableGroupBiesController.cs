...
public class TaktConfigurableGroupBiesController : TaktControllerBase
{
    ...
    [TaktPermission("statistics:report:configurable:list", "自定义报表分组列表")]
    [HttpGet("list")]
    ...
    [TaktPermission("statistics:report:configurable:query", "自定义报表分组详情")]
    [HttpGet("{id}")]
    ...
    [TaktPermission("statistics:report:configurable:query", "自定义报表分组选项")]
    [HttpGet("options")]
    ...
    /// <returns>自定义报表分组DTO</returns>
    [TaktPermission("statistics:report:configurable:create", "创建自定义报表分组")]
    [HttpPost]
    ...
    /// <returns>自定义报表分组DTO</returns>
    [TaktPermission("statistics:report:configurable:update", "更新自定义报表分组")]
    [HttpPut("{id}")]
    ...
    [TaktPermission("statistics:report:configurable:delete", "删除自定义报表分组")]
    [HttpDelete("{id}")]
    ...
    /// <returns>操作结果</returns>
    [TaktPermission("statistics:report:configurable:delete", "批量删除自定义报表分组")]
    [HttpDelete("batch")]
    ...
    /// <returns>自定义报表分组DTO</returns>
    [TaktPermission("statistics:report:configurable:update", "更新自定义报表分组排序")]
    [HttpPut("sort")]
    ...
    [TaktPermission("statistics:report:configurable:import", "获取自定义报表分组导入模板")]
    [HttpGet("template")]
    ...
    [TaktPermission("statistics:report:configurable:import", "导入自定义报表分组")]
    [HttpPost("import")]
    ...
    /// </summary>
    /// <returns>Excel文件</returns>
    [TaktPermission("statistics:report:configurable:export", "导出自定义报表分组")]
    [HttpGet("export")]
