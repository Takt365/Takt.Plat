...
public class TaktQualityAssuranceReliabilitiesController : TaktControllerBase
{
    ...
    [HttpGet("options")]
    public async Task<IActionResult> GetQualityAssuranceReliabilityOptionsAsync([FromQuery] string? plantCode = null, [FromQuery] string? keyword = null)
    {
        try
        {
            var result = await _qualityAssuranceReliabilityService.GetQualityAssuranceReliabilityOptionsAsync(plantCode, keyword);
            return Success(result, "查询成功");
        }
        catch (Exception ex)
        {
    ...
    /// <returns>品质业务信赖性评价ORT费用明细DTO</returns>
    [TaktPermission("logistics:quality:cost:assurance:update", "更新品质业务信赖性评价ORT费用明细作废状态")]
    [HttpPut("obsolete")]
    public async Task<IActionResult> UpdateQualityAssuranceReliabilityObsoleteAsync([FromBody] TaktQualityAssuranceReliabilityObsoleteDto dto)
    {
        try
        {
            var result = await _qualityAssuranceReliabilityService.UpdateQualityAssuranceReliabilityObsoleteAsync(dto);
            return Success(result, "更新成功");
        }
        catch (Exception ex)
        {
