...
public class TaktQualityIssuesController : TaktControllerBase
{
    ...
    [TaktPermission("logistics:quality:cost:qualityissue:list", "品质问题应对主列表")]
    [HttpGet("list")]
    ...
    [TaktPermission("logistics:quality:cost:qualityissue:query", "品质问题应对主详情")]
    [HttpGet("{id}")]
    ...
    [TaktPermission("logistics:quality:cost:qualityissue:query", "品质问题应对主选项")]
    [HttpGet("options")]
    ...
    /// <returns>品质问题应对主DTO</returns>
    [TaktPermission("logistics:quality:cost:qualityissue:create", "创建品质问题应对主")]
    [HttpPost]
    ...
    /// <returns>品质问题应对主DTO</returns>
    [TaktPermission("logistics:quality:cost:qualityissue:update", "更新品质问题应对主")]
    [HttpPut("{id}")]
    ...
    [TaktPermission("logistics:quality:cost:qualityissue:delete", "删除品质问题应对主")]
    [HttpDelete("{id}")]
    ...
    /// <returns>操作结果</returns>
    [TaktPermission("logistics:quality:cost:qualityissue:delete", "批量删除品质问题应对主")]
    [HttpDelete("batch")]
    ...
    [TaktPermission("logistics:quality:cost:qualityissue:import", "获取品质问题应对主导入模板")]
    [HttpGet("template")]
    ...
    [TaktPermission("logistics:quality:cost:qualityissue:import", "导入品质问题应对主")]
    [HttpPost("import")]
    ...
    /// </summary>
    /// <returns>Excel文件</returns>
    [TaktPermission("logistics:quality:cost:qualityissue:export", "导出品质问题应对主")]
    [HttpGet("export")]
