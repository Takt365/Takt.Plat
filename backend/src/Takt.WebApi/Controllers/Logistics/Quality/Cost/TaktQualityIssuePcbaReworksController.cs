...
public class TaktQualityIssuePcbaReworksController : TaktControllerBase
{
    ...
    [TaktPermission("logistics:quality:cost:qualityissuepcbarework:list", "质量问题PCBA不良改修费用明细列表")]
    [HttpGet("list")]
    ...
    [TaktPermission("logistics:quality:cost:qualityissuepcbarework:query", "质量问题PCBA不良改修费用明细详情")]
    [HttpGet("{id}")]
    ...
    [TaktPermission("logistics:quality:cost:qualityissuepcbarework:query", "质量问题PCBA不良改修费用明细选项")]
    [HttpGet("options")]
    ...
    /// <returns>质量问题PCBA不良改修费用明细DTO</returns>
    [TaktPermission("logistics:quality:cost:qualityissuepcbarework:create", "创建质量问题PCBA不良改修费用明细")]
    [HttpPost]
    ...
    /// <returns>质量问题PCBA不良改修费用明细DTO</returns>
    [TaktPermission("logistics:quality:cost:qualityissuepcbarework:update", "更新质量问题PCBA不良改修费用明细")]
    [HttpPut("{id}")]
    ...
    [TaktPermission("logistics:quality:cost:qualityissuepcbarework:delete", "删除质量问题PCBA不良改修费用明细")]
    [HttpDelete("{id}")]
    ...
    /// <returns>操作结果</returns>
    [TaktPermission("logistics:quality:cost:qualityissuepcbarework:delete", "批量删除质量问题PCBA不良改修费用明细")]
    [HttpDelete("batch")]
    ...
    [TaktPermission("logistics:quality:cost:qualityissuepcbarework:import", "获取质量问题PCBA不良改修费用明细导入模板")]
    [HttpGet("template")]
    ...
    [TaktPermission("logistics:quality:cost:qualityissuepcbarework:import", "导入质量问题PCBA不良改修费用明细")]
    [HttpPost("import")]
    ...
    /// </summary>
    /// <returns>Excel文件</returns>
    [TaktPermission("logistics:quality:cost:qualityissuepcbarework:export", "导出质量问题PCBA不良改修费用明细")]
    [HttpGet("export")]
