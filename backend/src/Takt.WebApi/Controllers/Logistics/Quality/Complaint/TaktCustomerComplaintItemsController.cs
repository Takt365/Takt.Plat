...
public class TaktCustomerComplaintItemsController : TaktControllerBase
{
    ...
    [TaktPermission("logistics:quality:complaint:customercomplaintitem:list", "客诉明细列表")]
    [HttpGet("list")]
    ...
    [TaktPermission("logistics:quality:complaint:customercomplaintitem:query", "客诉明细详情")]
    [HttpGet("{id}")]
    ...
    [TaktPermission("logistics:quality:complaint:customercomplaintitem:query", "客诉明细选项")]
    [HttpGet("options")]
    ...
    /// <returns>客诉明细DTO</returns>
    [TaktPermission("logistics:quality:complaint:customercomplaintitem:create", "创建客诉明细")]
    [HttpPost]
    ...
    /// <returns>客诉明细DTO</returns>
    [TaktPermission("logistics:quality:complaint:customercomplaintitem:update", "更新客诉明细")]
    [HttpPut("{id}")]
    ...
    [TaktPermission("logistics:quality:complaint:customercomplaintitem:delete", "删除客诉明细")]
    [HttpDelete("{id}")]
    ...
    /// <returns>操作结果</returns>
    [TaktPermission("logistics:quality:complaint:customercomplaintitem:delete", "批量删除客诉明细")]
    [HttpDelete("batch")]
    ...
    [TaktPermission("logistics:quality:complaint:customercomplaintitem:import", "获取客诉明细导入模板")]
    [HttpGet("template")]
    ...
    [TaktPermission("logistics:quality:complaint:customercomplaintitem:import", "导入客诉明细")]
    [HttpPost("import")]
    ...
    /// </summary>
    /// <returns>Excel文件</returns>
    [TaktPermission("logistics:quality:complaint:customercomplaintitem:export", "导出客诉明细")]
    [HttpGet("export")]
