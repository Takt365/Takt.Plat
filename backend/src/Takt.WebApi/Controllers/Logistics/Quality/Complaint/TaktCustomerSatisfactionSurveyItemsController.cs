...
public class TaktCustomerSatisfactionSurveyItemsController : TaktControllerBase
{
    ...
    [TaktPermission("logistics:quality:complaint:customersatisfactionsurveyitem:list", "客户满意度调查项目明细列表")]
    [HttpGet("list")]
    ...
    [TaktPermission("logistics:quality:complaint:customersatisfactionsurveyitem:query", "客户满意度调查项目明细详情")]
    [HttpGet("{id}")]
    ...
    [TaktPermission("logistics:quality:complaint:customersatisfactionsurveyitem:query", "客户满意度调查项目明细选项")]
    [HttpGet("options")]
    ...
    /// <returns>客户满意度调查项目明细DTO</returns>
    [TaktPermission("logistics:quality:complaint:customersatisfactionsurveyitem:create", "创建客户满意度调查项目明细")]
    [HttpPost]
    ...
    /// <returns>客户满意度调查项目明细DTO</returns>
    [TaktPermission("logistics:quality:complaint:customersatisfactionsurveyitem:update", "更新客户满意度调查项目明细")]
    [HttpPut("{id}")]
    ...
    [TaktPermission("logistics:quality:complaint:customersatisfactionsurveyitem:delete", "删除客户满意度调查项目明细")]
    [HttpDelete("{id}")]
    ...
    /// <returns>操作结果</returns>
    [TaktPermission("logistics:quality:complaint:customersatisfactionsurveyitem:delete", "批量删除客户满意度调查项目明细")]
    [HttpDelete("batch")]
    ...
    /// <returns>客户满意度调查项目明细DTO</returns>
    [TaktPermission("logistics:quality:complaint:customersatisfactionsurveyitem:update", "更新客户满意度调查项目明细状态")]
    [HttpPut("status")]
    ...
    [TaktPermission("logistics:quality:complaint:customersatisfactionsurveyitem:import", "获取客户满意度调查项目明细导入模板")]
    [HttpGet("template")]
    ...
    [TaktPermission("logistics:quality:complaint:customersatisfactionsurveyitem:import", "导入客户满意度调查项目明细")]
    [HttpPost("import")]
    ...
    /// </summary>
    /// <returns>Excel文件</returns>
    [TaktPermission("logistics:quality:complaint:customersatisfactionsurveyitem:export", "导出客户满意度调查项目明细")]
    [HttpGet("export")]
