...
public class TaktSalesPriceScalesController : TaktControllerBase
{
    ...
    [TaktPermission("logistics:sales:price:list", "销售价格阶梯列表")]
    [HttpGet("list")]
    ...
    [TaktPermission("logistics:sales:price:query", "销售价格阶梯详情")]
    [HttpGet("{id}")]
    ...
    [TaktPermission("logistics:sales:price:query", "销售价格阶梯选项")]
    [HttpGet("options")]
    ...
    /// <returns>销售价格阶梯DTO</returns>
    [TaktPermission("logistics:sales:price:create", "创建销售价格阶梯")]
    [HttpPost]
    ...
    /// <returns>销售价格阶梯DTO</returns>
    [TaktPermission("logistics:sales:price:update", "更新销售价格阶梯")]
    [HttpPut("{id}")]
    ...
    [TaktPermission("logistics:sales:price:delete", "删除销售价格阶梯")]
    [HttpDelete("{id}")]
    ...
    /// <returns>操作结果</returns>
    [TaktPermission("logistics:sales:price:delete", "批量删除销售价格阶梯")]
    [HttpDelete("batch")]
    ...
    /// <returns>销售价格阶梯DTO</returns>
    [TaktPermission("logistics:sales:price:update", "更新销售价格阶梯作废状态")]
    [HttpPut("obsolete")]
    public async Task<IActionResult> UpdateSalesPriceScaleObsoleteAsync([FromBody] TaktSalesPriceScaleObsoleteDto dto)
    {
        try
        {
            var result = await _salesPriceScaleService.UpdateSalesPriceScaleObsoleteAsync(dto);
            return Success(result, "更新成功");
        }
        catch (Exception ex)
        {
    ...
    [TaktPermission("logistics:sales:price:import", "获取销售价格阶梯导入模板")]
    [HttpGet("template")]
    ...
    [TaktPermission("logistics:sales:price:import", "导入销售价格阶梯")]
    [HttpPost("import")]
    ...
    /// </summary>
    /// <returns>Excel文件</returns>
    [TaktPermission("logistics:sales:price:export", "导出销售价格阶梯")]
    [HttpGet("export")]
