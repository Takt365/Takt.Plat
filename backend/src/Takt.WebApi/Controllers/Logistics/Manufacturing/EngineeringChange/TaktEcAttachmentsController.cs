...
public class TaktEcAttachmentsController : TaktControllerBase
{
    ...
    [TaktPermission("logistics:manufacturing:engineering:change:ec:attachment:list", "设变附件列表")]
    [HttpGet("list")]
    ...
    [TaktPermission("logistics:manufacturing:engineering:change:ec:attachment:query", "设变附件详情")]
    [HttpGet("{id}")]
    ...
    [TaktPermission("logistics:manufacturing:engineering:change:ec:attachment:query", "设变附件选项")]
    [HttpGet("options")]
    ...
    /// <returns>设变附件DTO</returns>
    [TaktPermission("logistics:manufacturing:engineering:change:ec:attachment:create", "创建设变附件")]
    [HttpPost]
    ...
    /// <returns>设变附件DTO</returns>
    [TaktPermission("logistics:manufacturing:engineering:change:ec:attachment:update", "更新设变附件")]
    [HttpPut("{id}")]
    ...
    [TaktPermission("logistics:manufacturing:engineering:change:ec:attachment:delete", "删除设变附件")]
    [HttpDelete("{id}")]
    ...
    /// <returns>操作结果</returns>
    [TaktPermission("logistics:manufacturing:engineering:change:ec:attachment:delete", "批量删除设变附件")]
    [HttpDelete("batch")]
    ...
    [TaktPermission("logistics:manufacturing:engineering:change:ec:attachment:import", "获取设变附件导入模板")]
    [HttpGet("template")]
    ...
    [TaktPermission("logistics:manufacturing:engineering:change:ec:attachment:import", "导入设变附件")]
    [HttpPost("import")]
    ...
    /// </summary>
    /// <returns>Excel文件</returns>
    [TaktPermission("logistics:manufacturing:engineering:change:ec:attachment:export", "导出设变附件")]
    [HttpGet("export")]
