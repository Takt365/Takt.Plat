...
public class TaktEcAttachmentsController : TaktControllerBase
{
    ...
    [TaktPermission("logistics:manufacturing:engineeringchange:ec:list", "设变附件列表")]
    [HttpGet("list")]
    ...
    [TaktPermission("logistics:manufacturing:engineeringchange:ec:query", "设变附件详情")]
    [HttpGet("{id}")]
    ...
    [TaktPermission("logistics:manufacturing:engineeringchange:ec:query", "设变附件选项")]
    [HttpGet("options")]
    ...
    /// <returns>设变附件DTO</returns>
    [TaktPermission("logistics:manufacturing:engineeringchange:ec:create", "创建设变附件")]
    [HttpPost]
    ...
    /// <returns>设变附件DTO</returns>
    [TaktPermission("logistics:manufacturing:engineeringchange:ec:update", "更新设变附件")]
    [HttpPut("{id}")]
    ...
    [TaktPermission("logistics:manufacturing:engineeringchange:ec:delete", "删除设变附件")]
    [HttpDelete("{id}")]
    ...
    /// <returns>操作结果</returns>
    [TaktPermission("logistics:manufacturing:engineeringchange:ec:delete", "批量删除设变附件")]
    [HttpDelete("batch")]
    ...
    [TaktPermission("logistics:manufacturing:engineeringchange:ec:import", "获取设变附件导入模板")]
    [HttpGet("template")]
    ...
    [TaktPermission("logistics:manufacturing:engineeringchange:ec:import", "导入设变附件")]
    [HttpPost("import")]
    ...
    /// </summary>
    /// <returns>Excel文件</returns>
    [TaktPermission("logistics:manufacturing:engineeringchange:ec:export", "导出设变附件")]
    [HttpGet("export")]
