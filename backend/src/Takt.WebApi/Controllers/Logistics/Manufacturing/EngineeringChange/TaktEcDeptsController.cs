...
public class TaktEcDeptsController : TaktControllerBase
{
    ...
    [TaktPermission("logistics:manufacturing:engineering:change:ec:dept:list", "设变部门列表")]
    [HttpGet("list")]
    ...
    [TaktPermission("logistics:manufacturing:engineering:change:ec:dept:query", "设变部门详情")]
    [HttpGet("{id}")]
    ...
    [TaktPermission("logistics:manufacturing:engineering:change:ec:dept:query", "设变部门选项")]
    [HttpGet("options")]
    ...
    /// <returns>设变部门DTO</returns>
    [TaktPermission("logistics:manufacturing:engineering:change:ec:dept:create", "创建设变部门")]
    [HttpPost]
    ...
    /// <returns>设变部门DTO</returns>
    [TaktPermission("logistics:manufacturing:engineering:change:ec:dept:update", "更新设变部门")]
    [HttpPut("{id}")]
    ...
    [TaktPermission("logistics:manufacturing:engineering:change:ec:dept:delete", "删除设变部门")]
    [HttpDelete("{id}")]
    ...
    /// <returns>操作结果</returns>
    [TaktPermission("logistics:manufacturing:engineering:change:ec:dept:delete", "批量删除设变部门")]
    [HttpDelete("batch")]
    ...
    [TaktPermission("logistics:manufacturing:engineering:change:ec:dept:import", "获取设变部门导入模板")]
    [HttpGet("template")]
    ...
    [TaktPermission("logistics:manufacturing:engineering:change:ec:dept:import", "导入设变部门")]
    [HttpPost("import")]
    ...
    /// </summary>
    /// <returns>Excel文件</returns>
    [TaktPermission("logistics:manufacturing:engineering:change:ec:dept:export", "导出设变部门")]
    [HttpGet("export")]
