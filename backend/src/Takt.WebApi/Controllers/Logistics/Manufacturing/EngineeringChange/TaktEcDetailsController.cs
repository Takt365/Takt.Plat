...
public class TaktEcDetailsController : TaktControllerBase
{
    ...
    [TaktPermission("logistics:manufacturing:engineeringchange:ec:list", "设变明细列表")]
    [HttpGet("list")]
    ...
    [TaktPermission("logistics:manufacturing:engineeringchange:ec:query", "设变明细详情")]
    [HttpGet("{id}")]
    ...
    [TaktPermission("logistics:manufacturing:engineeringchange:ec:query", "设变明细选项")]
    [HttpGet("options")]
    ...
    /// <returns>设变明细DTO</returns>
    [TaktPermission("logistics:manufacturing:engineeringchange:ec:create", "创建设变明细")]
    [HttpPost]
    ...
    /// <returns>设变明细DTO</returns>
    [TaktPermission("logistics:manufacturing:engineeringchange:ec:update", "更新设变明细")]
    [HttpPut("{id}")]
    ...
    [TaktPermission("logistics:manufacturing:engineeringchange:ec:delete", "删除设变明细")]
    [HttpDelete("{id}")]
    ...
    /// <returns>操作结果</returns>
    [TaktPermission("logistics:manufacturing:engineeringchange:ec:delete", "批量删除设变明细")]
    [HttpDelete("batch")]
    ...
    [TaktPermission("logistics:manufacturing:engineeringchange:ec:import", "获取设变明细导入模板")]
    [HttpGet("template")]
    ...
    [TaktPermission("logistics:manufacturing:engineeringchange:ec:import", "导入设变明细")]
    [HttpPost("import")]
    ...
    /// </summary>
    /// <returns>Excel文件</returns>
    [TaktPermission("logistics:manufacturing:engineeringchange:ec:export", "导出设变明细")]
    [HttpGet("export")]
