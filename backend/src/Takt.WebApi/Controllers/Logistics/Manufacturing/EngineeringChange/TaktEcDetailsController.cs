...
public class TaktEcDetailsController : TaktControllerBase
{
    ...
    [TaktPermission("logistics:manufacturing:engineering:change:ec:detail:list", "设变明细列表")]
    [HttpGet("list")]
    ...
    [TaktPermission("logistics:manufacturing:engineering:change:ec:detail:query", "设变明细详情")]
    [HttpGet("{id}")]
    ...
    [TaktPermission("logistics:manufacturing:engineering:change:ec:detail:query", "设变明细选项")]
    [HttpGet("options")]
    ...
    /// <returns>设变明细DTO</returns>
    [TaktPermission("logistics:manufacturing:engineering:change:ec:detail:create", "创建设变明细")]
    [HttpPost]
    ...
    /// <returns>设变明细DTO</returns>
    [TaktPermission("logistics:manufacturing:engineering:change:ec:detail:update", "更新设变明细")]
    [HttpPut("{id}")]
    ...
    [TaktPermission("logistics:manufacturing:engineering:change:ec:detail:delete", "删除设变明细")]
    [HttpDelete("{id}")]
    ...
    /// <returns>操作结果</returns>
    [TaktPermission("logistics:manufacturing:engineering:change:ec:detail:delete", "批量删除设变明细")]
    [HttpDelete("batch")]
    ...
    [TaktPermission("logistics:manufacturing:engineering:change:ec:detail:import", "获取设变明细导入模板")]
    [HttpGet("template")]
    ...
    [TaktPermission("logistics:manufacturing:engineering:change:ec:detail:import", "导入设变明细")]
    [HttpPost("import")]
    ...
    /// </summary>
    /// <returns>Excel文件</returns>
    [TaktPermission("logistics:manufacturing:engineering:change:ec:detail:export", "导出设变明细")]
    [HttpGet("export")]
