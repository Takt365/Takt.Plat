...
public class TaktAssyDefectsController : TaktControllerBase
{
    ...
    [TaktPermission("logistics:manufacturing:defect:assydefect:list", "组立不良日报列表")]
    [HttpGet("list")]
    ...
    [TaktPermission("logistics:manufacturing:defect:assydefect:query", "组立不良日报详情")]
    [HttpGet("{id}")]
    ...
    [TaktPermission("logistics:manufacturing:defect:assydefect:query", "组立不良日报选项")]
    [HttpGet("options")]
    ...
    /// <returns>组立不良日报DTO</returns>
    [TaktPermission("logistics:manufacturing:defect:assydefect:create", "创建组立不良日报")]
    [HttpPost]
    ...
    /// <returns>组立不良日报DTO</returns>
    [TaktPermission("logistics:manufacturing:defect:assydefect:update", "更新组立不良日报")]
    [HttpPut("{id}")]
    ...
    [TaktPermission("logistics:manufacturing:defect:assydefect:delete", "删除组立不良日报")]
    [HttpDelete("{id}")]
    ...
    /// <returns>操作结果</returns>
    [TaktPermission("logistics:manufacturing:defect:assydefect:delete", "批量删除组立不良日报")]
    [HttpDelete("batch")]
    ...
    /// <returns>组立不良日报DTO</returns>
    [TaktPermission("logistics:manufacturing:defect:assydefect:update", "更新组立不良日报状态")]
    [HttpPut("status")]
    ...
    [TaktPermission("logistics:manufacturing:defect:assydefect:import", "获取组立不良日报导入模板")]
    [HttpGet("template")]
    ...
    [TaktPermission("logistics:manufacturing:defect:assydefect:import", "导入组立不良日报")]
    [HttpPost("import")]
    ...
    /// </summary>
    /// <returns>Excel文件</returns>
    [TaktPermission("logistics:manufacturing:defect:assydefect:export", "导出组立不良日报")]
    [HttpGet("export")]
