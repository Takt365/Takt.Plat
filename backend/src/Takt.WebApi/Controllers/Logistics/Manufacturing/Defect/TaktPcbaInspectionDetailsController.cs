...
public class TaktPcbaInspectionDetailsController : TaktControllerBase
{
    ...
    [TaktPermission("logistics:manufacturing:defect:pcba:inspection:list", "PCBA检查明细列表")]
    [HttpGet("list")]
    ...
    [TaktPermission("logistics:manufacturing:defect:pcba:inspection:query", "PCBA检查明细详情")]
    [HttpGet("{id}")]
    ...
    /// <returns>PCBA检查明细DTO</returns>
    [TaktPermission("logistics:manufacturing:defect:pcba:inspection:create", "创建PCBA检查明细")]
    [HttpPost]
    ...
    /// <returns>PCBA检查明细DTO</returns>
    [TaktPermission("logistics:manufacturing:defect:pcba:inspection:update", "更新PCBA检查明细")]
    [HttpPut("{id}")]
    ...
    [TaktPermission("logistics:manufacturing:defect:pcba:inspection:delete", "删除PCBA检查明细")]
    [HttpDelete("{id}")]
    ...
    /// <returns>操作结果</returns>
    [TaktPermission("logistics:manufacturing:defect:pcba:inspection:delete", "批量删除PCBA检查明细")]
    [HttpDelete("batch")]
    ...
    /// <returns>PCBA检查明细DTO</returns>
    [TaktPermission("logistics:manufacturing:defect:pcba:inspection:update", "更新PCBA检查明细状态")]
    [HttpPut("status")]
    ...
    [TaktPermission("logistics:manufacturing:defect:pcba:inspection:import", "获取PCBA检查明细导入模板")]
    [HttpGet("template")]
    ...
    [TaktPermission("logistics:manufacturing:defect:pcba:inspection:import", "导入PCBA检查明细")]
    [HttpPost("import")]
    ...
    /// </summary>
    /// <returns>Excel文件</returns>
    [TaktPermission("logistics:manufacturing:defect:pcba:inspection:export", "导出PCBA检查明细")]
    [HttpGet("export")]
