...
public class TaktSalesPlanItemsController : TaktControllerBase
{
    ...
    [TaktPermission("logistics:manufacturing:planning:salesplan:list", "销售计划明细列表")]
    [HttpGet("list")]
    ...
    [TaktPermission("logistics:manufacturing:planning:salesplan:query", "销售计划明细详情")]
    [HttpGet("{id}")]
    ...
    [TaktPermission("logistics:manufacturing:planning:salesplan:query", "销售计划明细选项")]
    [HttpGet("options")]
    ...
    /// <returns>销售计划明细DTO</returns>
    [TaktPermission("logistics:manufacturing:planning:salesplan:create", "创建销售计划明细")]
    [HttpPost]
    ...
    /// <returns>销售计划明细DTO</returns>
    [TaktPermission("logistics:manufacturing:planning:salesplan:update", "更新销售计划明细")]
    [HttpPut("{id}")]
    ...
    [TaktPermission("logistics:manufacturing:planning:salesplan:delete", "删除销售计划明细")]
    [HttpDelete("{id}")]
    ...
    /// <returns>操作结果</returns>
    [TaktPermission("logistics:manufacturing:planning:salesplan:delete", "批量删除销售计划明细")]
    [HttpDelete("batch")]
    ...
    [TaktPermission("logistics:manufacturing:planning:salesplan:import", "获取销售计划明细导入模板")]
    [HttpGet("template")]
    ...
    [TaktPermission("logistics:manufacturing:planning:salesplan:import", "导入销售计划明细")]
    [HttpPost("import")]
    ...
    /// </summary>
    /// <returns>Excel文件</returns>
    [TaktPermission("logistics:manufacturing:planning:salesplan:export", "导出销售计划明细")]
    [HttpGet("export")]
