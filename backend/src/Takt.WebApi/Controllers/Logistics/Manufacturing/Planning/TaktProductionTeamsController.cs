...
public class TaktProductionTeamsController : TaktControllerBase
{
    ...
    [TaktPermission("logistics:manufacturing:planning:production:team:list", "生产班组列表")]
    [HttpGet("list")]
    ...
    [TaktPermission("logistics:manufacturing:planning:production:team:query", "生产班组详情")]
    [HttpGet("{id}")]
    ...
    [TaktPermission("logistics:manufacturing:planning:production:team:query", "生产班组选项")]
    [HttpGet("options")]
    ...
    /// <returns>生产班组DTO</returns>
    [TaktPermission("logistics:manufacturing:planning:production:team:create", "创建生产班组")]
    [HttpPost]
    ...
    /// <returns>生产班组DTO</returns>
    [TaktPermission("logistics:manufacturing:planning:production:team:update", "更新生产班组")]
    [HttpPut("{id}")]
    ...
    [TaktPermission("logistics:manufacturing:planning:production:team:delete", "删除生产班组")]
    [HttpDelete("{id}")]
    ...
    /// <returns>操作结果</returns>
    [TaktPermission("logistics:manufacturing:planning:production:team:delete", "批量删除生产班组")]
    [HttpDelete("batch")]
    ...
    /// <returns>生产班组DTO</returns>
    [TaktPermission("logistics:manufacturing:planning:production:team:update", "更新生产班组状态")]
    [HttpPut("status")]
    ...
    [TaktPermission("logistics:manufacturing:planning:production:team:import", "获取生产班组导入模板")]
    [HttpGet("template")]
    ...
    [TaktPermission("logistics:manufacturing:planning:production:team:import", "导入生产班组")]
    [HttpPost("import")]
    ...
    /// </summary>
    /// <returns>Excel文件</returns>
    [TaktPermission("logistics:manufacturing:planning:production:team:export", "导出生产班组")]
    [HttpGet("export")]
