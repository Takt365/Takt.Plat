...
public class TaktMasterProductionSchedulesController : TaktControllerBase
{
    ...
    [TaktPermission("logistics:manufacturing:planning:master:production:schedule:list", "主生产计划MPS头列表")]
    [HttpGet("list")]
    ...
    [TaktPermission("logistics:manufacturing:planning:master:production:schedule:query", "主生产计划MPS头详情")]
    [HttpGet("{id}")]
    ...
    [TaktPermission("logistics:manufacturing:planning:master:production:schedule:query", "主生产计划MPS头选项")]
    [HttpGet("options")]
    ...
    /// <returns>主生产计划MPS头DTO</returns>
    [TaktPermission("logistics:manufacturing:planning:master:production:schedule:create", "创建主生产计划MPS头")]
    [HttpPost]
    ...
    /// <returns>主生产计划MPS头DTO</returns>
    [TaktPermission("logistics:manufacturing:planning:master:production:schedule:update", "更新主生产计划MPS头")]
    [HttpPut("{id}")]
    ...
    [TaktPermission("logistics:manufacturing:planning:master:production:schedule:delete", "删除主生产计划MPS头")]
    [HttpDelete("{id}")]
    ...
    /// <returns>操作结果</returns>
    [TaktPermission("logistics:manufacturing:planning:master:production:schedule:delete", "批量删除主生产计划MPS头")]
    [HttpDelete("batch")]
    ...
    /// <returns>主生产计划MPS头DTO</returns>
    [TaktPermission("logistics:manufacturing:planning:master:production:schedule:update", "更新主生产计划MPS头状态")]
    [HttpPut("status")]
    ...
    [TaktPermission("logistics:manufacturing:planning:master:production:schedule:import", "获取主生产计划MPS头导入模板")]
    [HttpGet("template")]
    ...
    [TaktPermission("logistics:manufacturing:planning:master:production:schedule:import", "导入主生产计划MPS头")]
    [HttpPost("import")]
    ...
    /// </summary>
    /// <returns>Excel文件</returns>
    [TaktPermission("logistics:manufacturing:planning:master:production:schedule:export", "导出主生产计划MPS头")]
    [HttpGet("export")]
