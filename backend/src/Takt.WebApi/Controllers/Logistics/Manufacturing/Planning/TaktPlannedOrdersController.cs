...
public class TaktPlannedOrdersController : TaktControllerBase
{
    ...
    [TaktPermission("logistics:manufacturing:planning:planned:order:list", "计划订单列表")]
    [HttpGet("list")]
    ...
    [TaktPermission("logistics:manufacturing:planning:planned:order:query", "计划订单详情")]
    [HttpGet("{id}")]
    ...
    [TaktPermission("logistics:manufacturing:planning:planned:order:query", "计划订单选项")]
    [HttpGet("options")]
    ...
    /// <returns>计划订单DTO</returns>
    [TaktPermission("logistics:manufacturing:planning:planned:order:create", "创建计划订单")]
    [HttpPost]
    ...
    /// <returns>计划订单DTO</returns>
    [TaktPermission("logistics:manufacturing:planning:planned:order:update", "更新计划订单")]
    [HttpPut("{id}")]
    ...
    [TaktPermission("logistics:manufacturing:planning:planned:order:delete", "删除计划订单")]
    [HttpDelete("{id}")]
    ...
    /// <returns>操作结果</returns>
    [TaktPermission("logistics:manufacturing:planning:planned:order:delete", "批量删除计划订单")]
    [HttpDelete("batch")]
    ...
    /// <returns>计划订单DTO</returns>
    [TaktPermission("logistics:manufacturing:planning:planned:order:update", "更新计划订单状态")]
    [HttpPut("status")]
    ...
    [TaktPermission("logistics:manufacturing:planning:planned:order:import", "获取计划订单导入模板")]
    [HttpGet("template")]
    ...
    [TaktPermission("logistics:manufacturing:planning:planned:order:import", "导入计划订单")]
    [HttpPost("import")]
    ...
    /// </summary>
    /// <returns>Excel文件</returns>
    [TaktPermission("logistics:manufacturing:planning:planned:order:export", "导出计划订单")]
    [HttpGet("export")]
