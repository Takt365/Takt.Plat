...
public class TaktStandardOperationRatesController : TaktControllerBase
{
    ...
    [TaktPermission("logistics:manufacturing:planning:standard:operation:rate:list", "标准生产稼动率列表")]
    [HttpGet("list")]
    ...
    [TaktPermission("logistics:manufacturing:planning:standard:operation:rate:query", "标准生产稼动率详情")]
    [HttpGet("{id}")]
    ...
    [TaktPermission("logistics:manufacturing:planning:standard:operation:rate:query", "标准生产稼动率选项")]
    [HttpGet("options")]
    ...
    /// <returns>稼动率(%)</returns>
    [TaktPermission("logistics:manufacturing:planning:standard:operation:rate:query", "有效标准生产稼动率")]
    ...
    /// <returns>标准生产稼动率DTO</returns>
    [TaktPermission("logistics:manufacturing:planning:standard:operation:rate:create", "创建标准生产稼动率")]
    [HttpPost]
    ...
    /// <returns>标准生产稼动率DTO</returns>
    [TaktPermission("logistics:manufacturing:planning:standard:operation:rate:update", "更新标准生产稼动率")]
    [HttpPut("{id}")]
    ...
    [TaktPermission("logistics:manufacturing:planning:standard:operation:rate:delete", "删除标准生产稼动率")]
    [HttpDelete("{id}")]
    ...
    /// <returns>操作结果</returns>
    [TaktPermission("logistics:manufacturing:planning:standard:operation:rate:delete", "批量删除标准生产稼动率")]
    [HttpDelete("batch")]
    ...
    /// <returns>标准生产稼动率DTO</returns>
    [TaktPermission("logistics:manufacturing:planning:standard:operation:rate:update", "更新标准生产稼动率状态")]
    [HttpPut("status")]
    ...
    [TaktPermission("logistics:manufacturing:planning:standard:operation:rate:import", "获取标准生产稼动率导入模板")]
    [HttpGet("template")]
    ...
    [TaktPermission("logistics:manufacturing:planning:standard:operation:rate:import", "导入标准生产稼动率")]
    [HttpPost("import")]
    ...
    /// </summary>
    /// <returns>Excel文件</returns>
    [TaktPermission("logistics:manufacturing:planning:standard:operation:rate:export", "导出标准生产稼动率")]
    [HttpGet("export")]
