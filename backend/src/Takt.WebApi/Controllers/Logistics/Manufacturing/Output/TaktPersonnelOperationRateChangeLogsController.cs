...
public class TaktPersonnelOperationRateChangeLogsController : TaktControllerBase
{
    ...
    [TaktPermission("logistics:manufacturing:output:personnel:operation:rate:change:log:list", "人员稼动率变更记录列表")]
    [HttpGet("list")]
    ...
    [TaktPermission("logistics:manufacturing:output:personnel:operation:rate:change:log:query", "人员稼动率变更记录详情")]
    [HttpGet("{id}")]
    ...
    [TaktPermission("logistics:manufacturing:output:personnel:operation:rate:change:log:query", "人员稼动率变更记录选项")]
    [HttpGet("options")]
    ...
    /// <returns>人员稼动率变更记录DTO</returns>
    [TaktPermission("logistics:manufacturing:output:personnel:operation:rate:change:log:create", "创建人员稼动率变更记录")]
    [HttpPost]
    ...
    /// <returns>人员稼动率变更记录DTO</returns>
    [TaktPermission("logistics:manufacturing:output:personnel:operation:rate:change:log:update", "更新人员稼动率变更记录")]
    [HttpPut("{id}")]
    ...
    [TaktPermission("logistics:manufacturing:output:personnel:operation:rate:change:log:delete", "删除人员稼动率变更记录")]
    [HttpDelete("{id}")]
    ...
    /// <returns>操作结果</returns>
    [TaktPermission("logistics:manufacturing:output:personnel:operation:rate:change:log:delete", "批量删除人员稼动率变更记录")]
    [HttpDelete("batch")]
    ...
    [TaktPermission("logistics:manufacturing:output:personnel:operation:rate:change:log:export", "导出人员稼动率变更记录")]
    [HttpGet("export")]
