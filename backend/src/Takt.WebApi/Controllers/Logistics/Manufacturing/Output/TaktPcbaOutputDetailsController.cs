...
public class TaktPcbaOutputDetailsController : TaktControllerBase
{
    ...
    [TaktPermission("logistics:manufacturing:output:pcbaoutputdetail:list", "PCBA日报明细列表")]
    [HttpGet("list")]
    ...
    [TaktPermission("logistics:manufacturing:output:pcbaoutputdetail:query", "PCBA日报明细详情")]
    [HttpGet("{id}")]
    ...
    [TaktPermission("logistics:manufacturing:output:pcbaoutputdetail:query", "PCBA日报明细选项")]
    [HttpGet("options")]
    ...
    /// <returns>PCBA日报明细DTO</returns>
    [TaktPermission("logistics:manufacturing:output:pcbaoutputdetail:create", "创建PCBA日报明细")]
    [HttpPost]
    ...
    /// <returns>PCBA日报明细DTO</returns>
    [TaktPermission("logistics:manufacturing:output:pcbaoutputdetail:update", "更新PCBA日报明细")]
    [HttpPut("{id}")]
    ...
    [TaktPermission("logistics:manufacturing:output:pcbaoutputdetail:delete", "删除PCBA日报明细")]
    [HttpDelete("{id}")]
    ...
    /// <returns>操作结果</returns>
    [TaktPermission("logistics:manufacturing:output:pcbaoutputdetail:delete", "批量删除PCBA日报明细")]
    [HttpDelete("batch")]
    ...
    /// <returns>PCBA日报明细DTO</returns>
    [TaktPermission("logistics:manufacturing:output:pcbaoutputdetail:update", "更新PCBA日报明细状态")]
    [HttpPut("status")]
    ...
    [TaktPermission("logistics:manufacturing:output:pcbaoutputdetail:import", "获取PCBA日报明细导入模板")]
    [HttpGet("template")]
    ...
    [TaktPermission("logistics:manufacturing:output:pcbaoutputdetail:import", "导入PCBA日报明细")]
    [HttpPost("import")]
    ...
    /// </summary>
    /// <returns>Excel文件</returns>
    [TaktPermission("logistics:manufacturing:output:pcbaoutputdetail:export", "导出PCBA日报明细")]
    [HttpGet("export")]
