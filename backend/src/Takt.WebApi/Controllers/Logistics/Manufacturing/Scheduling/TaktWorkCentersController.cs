...
public class TaktWorkCentersController : TaktControllerBase
{
    ...
    [TaktPermission("logistics:manufacturing:scheduling:work:center:list", "工作中心列表")]
    [HttpGet("list")]
    ...
    [TaktPermission("logistics:manufacturing:scheduling:work:center:query", "工作中心详情")]
    [HttpGet("{id}")]
    ...
    [TaktPermission("logistics:manufacturing:scheduling:work:center:query", "工作中心选项")]
    [HttpGet("options")]
    ...
    /// <returns>工作中心DTO</returns>
    [TaktPermission("logistics:manufacturing:scheduling:work:center:create", "创建工作中心")]
    [HttpPost]
    ...
    /// <returns>工作中心DTO</returns>
    [TaktPermission("logistics:manufacturing:scheduling:work:center:update", "更新工作中心")]
    [HttpPut("{id}")]
    ...
    [TaktPermission("logistics:manufacturing:scheduling:work:center:delete", "删除工作中心")]
    [HttpDelete("{id}")]
    ...
    /// <returns>操作结果</returns>
    [TaktPermission("logistics:manufacturing:scheduling:work:center:delete", "批量删除工作中心")]
    [HttpDelete("batch")]
    ...
    /// <returns>工作中心DTO</returns>
    [TaktPermission("logistics:manufacturing:scheduling:work:center:update", "更新工作中心状态")]
    [HttpPut("status")]
    ...
    [TaktPermission("logistics:manufacturing:scheduling:work:center:import", "获取工作中心导入模板")]
    [HttpGet("template")]
    ...
    [TaktPermission("logistics:manufacturing:scheduling:work:center:import", "导入工作中心")]
    [HttpPost("import")]
    ...
    /// </summary>
    /// <returns>Excel文件</returns>
    [TaktPermission("logistics:manufacturing:scheduling:work:center:export", "导出工作中心")]
    [HttpGet("export")]
