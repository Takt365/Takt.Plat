...
public class TaktServiceTicketsController : TaktControllerBase
{
    ...
    [TaktPermission("logistics:service:ticket:list", "服务工单列表")]
    [HttpGet("list")]
    ...
    [TaktPermission("logistics:service:ticket:query", "服务工单详情")]
    [HttpGet("{id}")]
    ...
    [TaktPermission("logistics:service:ticket:query", "服务工单选项")]
    [HttpGet("options")]
    ...
    /// <returns>服务工单DTO</returns>
    [TaktPermission("logistics:service:ticket:create", "创建服务工单")]
    [HttpPost]
    ...
    /// <returns>服务工单DTO</returns>
    [TaktPermission("logistics:service:ticket:update", "更新服务工单")]
    [HttpPut("{id}")]
    ...
    [TaktPermission("logistics:service:ticket:delete", "删除服务工单")]
    [HttpDelete("{id}")]
    ...
    /// <returns>操作结果</returns>
    [TaktPermission("logistics:service:ticket:delete", "批量删除服务工单")]
    [HttpDelete("batch")]
    ...
    /// <returns>服务工单DTO</returns>
    [TaktPermission("logistics:service:ticket:update", "更新服务工单状态")]
    [HttpPut("status")]
    ...
    /// <returns>服务工单DTO</returns>
    [TaktPermission("logistics:service:ticket:update", "更新服务工单排序")]
    [HttpPut("sort")]
    ...
    [TaktPermission("logistics:service:ticket:import", "获取服务工单导入模板")]
    [HttpGet("template")]
    ...
    [TaktPermission("logistics:service:ticket:import", "导入服务工单")]
    [HttpPost("import")]
    ...
    /// </summary>
    /// <returns>Excel文件</returns>
    [TaktPermission("logistics:service:ticket:export", "导出服务工单")]
    [HttpGet("export")]
