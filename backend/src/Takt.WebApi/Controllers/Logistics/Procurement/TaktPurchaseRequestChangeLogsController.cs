...
public class TaktPurchaseRequestChangeLogsController : TaktControllerBase
{
    ...
    [TaktPermission("logistics:procurement:purchaserequest:list", "采购申请变更记录列表")]
    [HttpGet("list")]
    ...
    [TaktPermission("logistics:procurement:purchaserequest:query", "采购申请变更记录详情")]
    [HttpGet("{id}")]
    ...
    [TaktPermission("logistics:procurement:purchaserequest:query", "采购申请变更记录选项")]
    [HttpGet("options")]
    ...
    /// <returns>采购申请变更记录DTO</returns>
    [TaktPermission("logistics:procurement:purchaserequest:create", "创建采购申请变更记录")]
    [HttpPost]
    ...
    /// <returns>采购申请变更记录DTO</returns>
    [TaktPermission("logistics:procurement:purchaserequest:update", "更新采购申请变更记录")]
    [HttpPut("{id}")]
    ...
    [TaktPermission("logistics:procurement:purchaserequest:delete", "删除采购申请变更记录")]
    [HttpDelete("{id}")]
    ...
    /// <returns>操作结果</returns>
    [TaktPermission("logistics:procurement:purchaserequest:delete", "批量删除采购申请变更记录")]
    [HttpDelete("batch")]
    ...
    [TaktPermission("logistics:procurement:purchaserequest:export", "导出采购申请变更记录")]
    [HttpGet("export")]
