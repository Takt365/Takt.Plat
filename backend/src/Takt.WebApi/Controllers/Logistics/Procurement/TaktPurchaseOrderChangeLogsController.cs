...
public class TaktPurchaseOrderChangeLogsController : TaktControllerBase
{
    ...
    [TaktPermission("logistics:procurement:purchase:order:list", "采购订单变更记录列表")]
    [HttpGet("list")]
    ...
    [TaktPermission("logistics:procurement:purchase:order:query", "采购订单变更记录详情")]
    [HttpGet("{id}")]
    ...
    [TaktPermission("logistics:procurement:purchase:order:query", "采购订单变更记录选项")]
    [HttpGet("options")]
    ...
    /// <returns>采购订单变更记录DTO</returns>
    [TaktPermission("logistics:procurement:purchase:order:create", "创建采购订单变更记录")]
    [HttpPost]
    ...
    /// <returns>采购订单变更记录DTO</returns>
    [TaktPermission("logistics:procurement:purchase:order:update", "更新采购订单变更记录")]
    [HttpPut("{id}")]
    ...
    [TaktPermission("logistics:procurement:purchase:order:delete", "删除采购订单变更记录")]
    [HttpDelete("{id}")]
    ...
    /// <returns>操作结果</returns>
    [TaktPermission("logistics:procurement:purchase:order:delete", "批量删除采购订单变更记录")]
    [HttpDelete("batch")]
    ...
    [TaktPermission("logistics:procurement:purchase:order:export", "导出采购订单变更记录")]
    [HttpGet("export")]
