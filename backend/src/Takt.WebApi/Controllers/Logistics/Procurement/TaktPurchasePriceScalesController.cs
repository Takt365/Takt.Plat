...
public class TaktPurchasePriceScalesController : TaktControllerBase
{
    ...
    [TaktPermission("logistics:procurement:purchase:price:list", "采购价格阶梯列表")]
    [HttpGet("list")]
    ...
    [TaktPermission("logistics:procurement:purchase:price:query", "采购价格阶梯详情")]
    [HttpGet("{id}")]
    ...
    [TaktPermission("logistics:procurement:purchase:price:query", "采购价格阶梯选项")]
    [HttpGet("options")]
    ...
    /// <returns>采购价格阶梯DTO</returns>
    [TaktPermission("logistics:procurement:purchase:price:create", "创建采购价格阶梯")]
    [HttpPost]
    ...
    /// <returns>采购价格阶梯DTO</returns>
    [TaktPermission("logistics:procurement:purchase:price:update", "更新采购价格阶梯")]
    [HttpPut("{id}")]
    ...
    [TaktPermission("logistics:procurement:purchase:price:delete", "删除采购价格阶梯")]
    [HttpDelete("{id}")]
    ...
    /// <returns>操作结果</returns>
    [TaktPermission("logistics:procurement:purchase:price:delete", "批量删除采购价格阶梯")]
    [HttpDelete("batch")]
    ...
    /// <returns>采购价格阶梯DTO</returns>
    [TaktPermission("logistics:procurement:purchase:price:update", "更新采购价格阶梯排序")]
    [HttpPut("sort")]
    ...
    /// <returns>采购价格阶梯DTO</returns>
    [TaktPermission("logistics:procurement:purchase:price:update", "更新采购价格阶梯作废状态")]
    [HttpPut("obsolete")]
    public async Task<IActionResult> UpdatePurchasePriceScaleObsoleteAsync([FromBody] TaktPurchasePriceScaleObsoleteDto dto)
    {
        try
        {
            var result = await _purchasePriceScaleService.UpdatePurchasePriceScaleObsoleteAsync(dto);
            return Success(result, "更新成功");
        }
        catch (Exception ex)
        {
    ...
    [TaktPermission("logistics:procurement:purchase:price:import", "获取采购价格阶梯导入模板")]
    [HttpGet("template")]
    ...
    [TaktPermission("logistics:procurement:purchase:price:import", "导入采购价格阶梯")]
    [HttpPost("import")]
    ...
    /// </summary>
    /// <returns>Excel文件</returns>
    [TaktPermission("logistics:procurement:purchase:price:export", "导出采购价格阶梯")]
    [HttpGet("export")]
