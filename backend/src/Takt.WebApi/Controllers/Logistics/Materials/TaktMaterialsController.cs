...
public class TaktMaterialsController : TaktControllerBase
{
    ...
    /// 构造函数
    /// </summary>
    /// <param name="materialService">全局物料服务</param>
    ...
    [TaktPermission("logistics:materials:material:list", "全局物料列表")]
    [HttpGet("list")]
    ...
    [TaktPermission("logistics:materials:material:query", "全局物料详情")]
    [HttpGet("{id}")]
    ...
    [TaktPermission("logistics:materials:material:query", "全局物料选项")]
    [HttpGet("options")]
    ...
    /// <returns>全局物料DTO</returns>
    [TaktPermission("logistics:materials:material:create", "创建全局物料")]
    [HttpPost]
    ...
    /// <returns>全局物料DTO</returns>
    [TaktPermission("logistics:materials:material:update", "更新全局物料")]
    [HttpPut("{id}")]
    ...
    [TaktPermission("logistics:materials:material:delete", "删除全局物料")]
    [HttpDelete("{id}")]
    ...
    /// <returns>操作结果</returns>
    [TaktPermission("logistics:materials:material:delete", "批量删除全局物料")]
    [HttpDelete("batch")]
    ...
    /// <returns>全局物料DTO</returns>
    [TaktPermission("logistics:materials:material:update", "更新全局物料状态")]
    [HttpPut("status")]
    ...
    [TaktPermission("logistics:materials:material:import", "获取全局物料导入模板")]
    [HttpGet("template")]
    ...
    [TaktPermission("logistics:materials:material:import", "导入全局物料")]
    [HttpPost("import")]
    ...
    /// </summary>
    /// <returns>Excel文件</returns>
    [TaktPermission("logistics:materials:material:export", "导出全局物料")]
    [HttpGet("export")]
