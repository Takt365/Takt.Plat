...
public class TaktPurchasePriceChangeLogsController : TaktControllerBase
{
    ...
    [TaktPermission("logistics:materials:purchasepricechangelog:list", "采购价格变更记录列表")]
    [HttpGet("list")]
    ...
    [TaktPermission("logistics:materials:purchasepricechangelog:query", "采购价格变更记录详情")]
    [HttpGet("{id}")]
    ...
    [TaktPermission("logistics:materials:purchasepricechangelog:query", "采购价格变更记录选项")]
    [HttpGet("options")]
    ...
    /// <returns>采购价格变更记录DTO</returns>
    [TaktPermission("logistics:materials:purchasepricechangelog:create", "创建采购价格变更记录")]
    [HttpPost]
    ...
    /// <returns>采购价格变更记录DTO</returns>
    [TaktPermission("logistics:materials:purchasepricechangelog:update", "更新采购价格变更记录")]
    [HttpPut("{id}")]
    ...
    [TaktPermission("logistics:materials:purchasepricechangelog:delete", "删除采购价格变更记录")]
    [HttpDelete("{id}")]
    ...
    /// <returns>操作结果</returns>
    [TaktPermission("logistics:materials:purchasepricechangelog:delete", "批量删除采购价格变更记录")]
    [HttpDelete("batch")]
    ...
    [TaktPermission("logistics:materials:purchasepricechangelog:export", "导出采购价格变更记录")]
    [HttpGet("export")]
