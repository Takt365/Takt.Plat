...
public class TaktTrainingCoursesController : TaktControllerBase
{
    ...
    [TaktPermission("humanresource:trainingdevelopment:trainingcourse:list", "培训课程列表")]
    [HttpGet("list")]
    ...
    [TaktPermission("humanresource:trainingdevelopment:trainingcourse:query", "培训课程详情")]
    [HttpGet("{id}")]
    ...
    [TaktPermission("humanresource:trainingdevelopment:trainingcourse:query", "培训课程选项")]
    [HttpGet("options")]
    ...
    /// <returns>培训课程DTO</returns>
    [TaktPermission("humanresource:trainingdevelopment:trainingcourse:create", "创建培训课程")]
    [HttpPost]
    ...
    /// <returns>培训课程DTO</returns>
    [TaktPermission("humanresource:trainingdevelopment:trainingcourse:update", "更新培训课程")]
    [HttpPut("{id}")]
    ...
    [TaktPermission("humanresource:trainingdevelopment:trainingcourse:delete", "删除培训课程")]
    [HttpDelete("{id}")]
    ...
    /// <returns>操作结果</returns>
    [TaktPermission("humanresource:trainingdevelopment:trainingcourse:delete", "批量删除培训课程")]
    [HttpDelete("batch")]
    ...
    /// <returns>培训课程DTO</returns>
    [TaktPermission("humanresource:trainingdevelopment:trainingcourse:update", "更新培训课程状态")]
    [HttpPut("status")]
    ...
    /// <returns>培训课程DTO</returns>
    [TaktPermission("humanresource:trainingdevelopment:trainingcourse:update", "更新培训课程排序")]
    [HttpPut("sort")]
    ...
    [TaktPermission("humanresource:trainingdevelopment:trainingcourse:import", "获取培训课程导入模板")]
    [HttpGet("template")]
    ...
    [TaktPermission("humanresource:trainingdevelopment:trainingcourse:import", "导入培训课程")]
    [HttpPost("import")]
    ...
    /// </summary>
    /// <returns>Excel文件</returns>
    [TaktPermission("humanresource:trainingdevelopment:trainingcourse:export", "导出培训课程")]
    [HttpGet("export")]
