...
public class TaktPayslipsController : TaktControllerBase
{
    ...
    /// 构造函数
    /// </summary>
    /// <param name="payslipService">薪资条服务</param>
    ...
    [TaktPermission("humanresource:compensationbenefits:payslip:list", "薪资条列表")]
    [HttpGet("list")]
    ...
    /// 根据ID获取薪资条
    /// </summary>
    /// <param name="id">薪资条ID</param>
    /// <returns>薪资条DTO</returns>
    [TaktPermission("humanresource:compensationbenefits:payslip:query", "薪资条详情")]
    [HttpGet("{id}")]
    ...
    [TaktPermission("humanresource:compensationbenefits:payslip:query", "薪资条选项")]
    [HttpGet("options")]
    ...
    /// <returns>薪资条DTO</returns>
    [TaktPermission("humanresource:compensationbenefits:payslip:create", "创建薪资条")]
    [HttpPost]
    ...
    /// <returns>薪资条DTO</returns>
    [TaktPermission("humanresource:compensationbenefits:payslip:update", "更新薪资条")]
    [HttpPut("{id}")]
    ...
    [TaktPermission("humanresource:compensationbenefits:payslip:delete", "删除薪资条")]
    [HttpDelete("{id}")]
    ...
    /// <returns>操作结果</returns>
    [TaktPermission("humanresource:compensationbenefits:payslip:delete", "批量删除薪资条")]
    [HttpDelete("batch")]
    ...
    /// <returns>薪资条DTO</returns>
    [TaktPermission("humanresource:compensationbenefits:payslip:update", "更新薪资条状态")]
    [HttpPut("status")]
    ...
    [TaktPermission("humanresource:compensationbenefits:payslip:import", "获取薪资条导入模板")]
    [HttpGet("template")]
    ...
    [TaktPermission("humanresource:compensationbenefits:payslip:import", "导入薪资条")]
    [HttpPost("import")]
    ...
    /// </summary>
    /// <returns>Excel文件</returns>
    [TaktPermission("humanresource:compensationbenefits:payslip:export", "导出薪资条")]
    [HttpGet("export")]
