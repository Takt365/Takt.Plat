...
public class TaktEmployeeOnboardingsController : TaktControllerBase
{
    ...
    [TaktPermission("human:resource:personnel:talent:staffing:requirement:list", "入职待办列表")]
    [HttpGet("list")]
    ...
    [TaktPermission("human:resource:personnel:talent:staffing:requirement:query", "入职待办详情")]
    [HttpGet("{id}")]
    ...
    [TaktPermission("human:resource:personnel:talent:staffing:requirement:query", "入职待办选项")]
    [HttpGet("options")]
    ...
    /// <returns>入职待办DTO</returns>
    [TaktPermission("human:resource:personnel:talent:staffing:requirement:create", "创建入职待办")]
    [HttpPost]
    ...
    /// <returns>入职待办DTO</returns>
    [TaktPermission("human:resource:personnel:talent:staffing:requirement:update", "更新入职待办")]
    [HttpPut("{id}")]
    ...
    [TaktPermission("human:resource:personnel:talent:staffing:requirement:delete", "删除入职待办")]
    [HttpDelete("{id}")]
    ...
    /// <returns>操作结果</returns>
    [TaktPermission("human:resource:personnel:talent:staffing:requirement:delete", "批量删除入职待办")]
    [HttpDelete("batch")]
    ...
    /// <returns>入职待办DTO</returns>
    [TaktPermission("human:resource:personnel:talent:staffing:requirement:update", "更新入职待办状态")]
    [HttpPut("status")]
    ...
    [TaktPermission("human:resource:personnel:talent:staffing:requirement:import", "获取入职待办导入模板")]
    [HttpGet("template")]
    ...
    [TaktPermission("human:resource:personnel:talent:staffing:requirement:import", "导入入职待办")]
    [HttpPost("import")]
    ...
    /// </summary>
    /// <returns>Excel文件</returns>
    [TaktPermission("human:resource:personnel:talent:staffing:requirement:export", "导出入职待办")]
    [HttpGet("export")]
