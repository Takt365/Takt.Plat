...
public class TaktEmployeeAttachmentsController : TaktControllerBase
{
    ...
    [TaktPermission("human:resource:personnel:employee:list", "员工附件列表")]
    [HttpGet("list")]
    ...
    [TaktPermission("human:resource:personnel:employee:query", "员工附件详情")]
    [HttpGet("{id}")]
    ...
    [TaktPermission("human:resource:personnel:employee:query", "员工附件选项")]
    [HttpGet("options")]
    ...
    /// <returns>员工附件DTO</returns>
    [TaktPermission("human:resource:personnel:employee:create", "创建员工附件")]
    [HttpPost]
    ...
    /// <returns>员工附件DTO</returns>
    [TaktPermission("human:resource:personnel:employee:update", "更新员工附件")]
    [HttpPut("{id}")]
    ...
    [TaktPermission("human:resource:personnel:employee:delete", "删除员工附件")]
    [HttpDelete("{id}")]
    ...
    /// <returns>操作结果</returns>
    [TaktPermission("human:resource:personnel:employee:delete", "批量删除员工附件")]
    [HttpDelete("batch")]
    ...
    [TaktPermission("human:resource:personnel:employee:import", "获取员工附件导入模板")]
    [HttpGet("template")]
    ...
    [TaktPermission("human:resource:personnel:employee:import", "导入员工附件")]
    [HttpPost("import")]
    ...
    /// </summary>
    /// <returns>Excel文件</returns>
    [TaktPermission("human:resource:personnel:employee:export", "导出员工附件")]
    [HttpGet("export")]
