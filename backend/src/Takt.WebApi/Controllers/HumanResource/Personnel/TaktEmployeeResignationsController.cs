...
public class TaktEmployeeResignationsController : TaktControllerBase
{
    ...
    [TaktPermission("human:resource:personnel:employee:list", "员工离职列表")]
    [HttpGet("list")]
    ...
    [TaktPermission("human:resource:personnel:employee:query", "员工离职详情")]
    [HttpGet("{id}")]
    ...
    [TaktPermission("human:resource:personnel:employee:query", "员工离职选项")]
    [HttpGet("options")]
    ...
    /// <returns>员工离职DTO</returns>
    [TaktPermission("human:resource:personnel:employee:create", "创建员工离职")]
    [HttpPost]
    ...
    /// <returns>员工离职DTO</returns>
    [TaktPermission("human:resource:personnel:employee:update", "更新员工离职")]
    [HttpPut("{id}")]
    ...
    [TaktPermission("human:resource:personnel:employee:delete", "删除员工离职")]
    [HttpDelete("{id}")]
    ...
    /// <returns>操作结果</returns>
    [TaktPermission("human:resource:personnel:employee:delete", "批量删除员工离职")]
    [HttpDelete("batch")]
    ...
    [TaktPermission("human:resource:personnel:employee:import", "获取员工离职导入模板")]
    [HttpGet("template")]
    ...
    [TaktPermission("human:resource:personnel:employee:import", "导入员工离职")]
    [HttpPost("import")]
    ...
    /// </summary>
    /// <returns>Excel文件</returns>
    [TaktPermission("human:resource:personnel:employee:export", "导出员工离职")]
    [HttpGet("export")]
