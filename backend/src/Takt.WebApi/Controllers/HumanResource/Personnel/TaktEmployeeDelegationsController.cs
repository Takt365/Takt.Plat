...
public class TaktEmployeeDelegationsController : TaktControllerBase
{
    ...
    [TaktPermission("human:resource:personnel:employeedelegation:list", "员工代理关系列表")]
    [HttpGet("list")]
    ...
    [TaktPermission("human:resource:personnel:employeedelegation:query", "员工代理关系详情")]
    [HttpGet("{id}")]
    ...
    [TaktPermission("human:resource:personnel:employeedelegation:query", "员工代理关系选项")]
    [HttpGet("options")]
    ...
    /// <returns>员工代理关系DTO</returns>
    [TaktPermission("human:resource:personnel:employeedelegation:create", "创建员工代理关系")]
    [HttpPost]
    ...
    /// <returns>员工代理关系DTO</returns>
    [TaktPermission("human:resource:personnel:employeedelegation:update", "更新员工代理关系")]
    [HttpPut("{id}")]
    ...
    [TaktPermission("human:resource:personnel:employeedelegation:delete", "删除员工代理关系")]
    [HttpDelete("{id}")]
    ...
    /// <returns>操作结果</returns>
    [TaktPermission("human:resource:personnel:employeedelegation:delete", "批量删除员工代理关系")]
    [HttpDelete("batch")]
    ...
    [TaktPermission("human:resource:personnel:employeedelegation:import", "获取员工代理关系导入模板")]
    [HttpGet("template")]
    ...
    [TaktPermission("human:resource:personnel:employeedelegation:import", "导入员工代理关系")]
    [HttpPost("import")]
    ...
    /// </summary>
    /// <returns>Excel文件</returns>
    [TaktPermission("human:resource:personnel:employeedelegation:export", "导出员工代理关系")]
    [HttpGet("export")]
