...
public class TaktEmployeeExperiencesController : TaktControllerBase
{
    ...
    [TaktPermission("human:resource:personnel:employee:list", "员工工作经历列表")]
    [HttpGet("list")]
    ...
    [TaktPermission("human:resource:personnel:employee:query", "员工工作经历详情")]
    [HttpGet("{id}")]
    ...
    [TaktPermission("human:resource:personnel:employee:query", "员工工作经历选项")]
    [HttpGet("options")]
    ...
    /// <returns>员工工作经历DTO</returns>
    [TaktPermission("human:resource:personnel:employee:create", "创建员工工作经历")]
    [HttpPost]
    ...
    /// <returns>员工工作经历DTO</returns>
    [TaktPermission("human:resource:personnel:employee:update", "更新员工工作经历")]
    [HttpPut("{id}")]
    ...
    [TaktPermission("human:resource:personnel:employee:delete", "删除员工工作经历")]
    [HttpDelete("{id}")]
    ...
    /// <returns>操作结果</returns>
    [TaktPermission("human:resource:personnel:employee:delete", "批量删除员工工作经历")]
    [HttpDelete("batch")]
    ...
    [TaktPermission("human:resource:personnel:employee:import", "获取员工工作经历导入模板")]
    [HttpGet("template")]
    ...
    [TaktPermission("human:resource:personnel:employee:import", "导入员工工作经历")]
    [HttpPost("import")]
    ...
    /// </summary>
    /// <returns>Excel文件</returns>
    [TaktPermission("human:resource:personnel:employee:export", "导出员工工作经历")]
    [HttpGet("export")]
