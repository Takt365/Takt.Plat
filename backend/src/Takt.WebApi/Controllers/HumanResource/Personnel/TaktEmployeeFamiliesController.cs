...
public class TaktEmployeeFamiliesController : TaktControllerBase
{
    ...
    [TaktPermission("human:resource:personnel:employee:list", "员工家庭成员列表")]
    [HttpGet("list")]
    ...
    [TaktPermission("human:resource:personnel:employee:query", "员工家庭成员详情")]
    [HttpGet("{id}")]
    ...
    [TaktPermission("human:resource:personnel:employee:query", "员工家庭成员选项")]
    [HttpGet("options")]
    ...
    /// <returns>员工家庭成员DTO</returns>
    [TaktPermission("human:resource:personnel:employee:create", "创建员工家庭成员")]
    [HttpPost]
    ...
    /// <returns>员工家庭成员DTO</returns>
    [TaktPermission("human:resource:personnel:employee:update", "更新员工家庭成员")]
    [HttpPut("{id}")]
    ...
    [TaktPermission("human:resource:personnel:employee:delete", "删除员工家庭成员")]
    [HttpDelete("{id}")]
    ...
    /// <returns>操作结果</returns>
    [TaktPermission("human:resource:personnel:employee:delete", "批量删除员工家庭成员")]
    [HttpDelete("batch")]
    ...
    [TaktPermission("human:resource:personnel:employee:import", "获取员工家庭成员导入模板")]
    [HttpGet("template")]
    ...
    [TaktPermission("human:resource:personnel:employee:import", "导入员工家庭成员")]
    [HttpPost("import")]
    ...
    /// </summary>
    /// <returns>Excel文件</returns>
    [TaktPermission("human:resource:personnel:employee:export", "导出员工家庭成员")]
    [HttpGet("export")]
