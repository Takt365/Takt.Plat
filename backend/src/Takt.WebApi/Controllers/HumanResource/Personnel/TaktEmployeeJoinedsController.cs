...
public class TaktEmployeeJoinedsController : TaktControllerBase
{
    ...
    [TaktPermission("human:resource:personnel:employee:list", "员工入职上岗列表")]
    [HttpGet("list")]
    ...
    [TaktPermission("human:resource:personnel:employee:query", "员工入职上岗详情")]
    [HttpGet("{id}")]
    ...
    [TaktPermission("human:resource:personnel:employee:query", "员工入职上岗选项")]
    [HttpGet("options")]
    ...
    /// <returns>员工入职上岗DTO</returns>
    [TaktPermission("human:resource:personnel:employee:create", "创建员工入职上岗")]
    [HttpPost]
    ...
    /// <returns>员工入职上岗DTO</returns>
    [TaktPermission("human:resource:personnel:employee:update", "更新员工入职上岗")]
    [HttpPut("{id}")]
    ...
    [TaktPermission("human:resource:personnel:employee:delete", "删除员工入职上岗")]
    [HttpDelete("{id}")]
    ...
    /// <returns>操作结果</returns>
    [TaktPermission("human:resource:personnel:employee:delete", "批量删除员工入职上岗")]
    [HttpDelete("batch")]
    ...
    [TaktPermission("human:resource:personnel:employee:import", "获取员工入职上岗导入模板")]
    [HttpGet("template")]
    ...
    [TaktPermission("human:resource:personnel:employee:import", "导入员工入职上岗")]
    [HttpPost("import")]
    ...
    /// </summary>
    /// <returns>Excel文件</returns>
    [TaktPermission("human:resource:personnel:employee:export", "导出员工入职上岗")]
    [HttpGet("export")]
