...
public class TaktFlowVariablesController : TaktControllerBase
{
    ...
    [TaktPermission("workflow:flowvariable:list", "流程变量列表")]
    [HttpGet("list")]
    ...
    [TaktPermission("workflow:flowvariable:query", "流程变量详情")]
    [HttpGet("{id}")]
    ...
    [TaktPermission("workflow:flowvariable:query", "流程变量选项")]
    [HttpGet("options")]
    ...
    /// <returns>流程变量DTO</returns>
    [TaktPermission("workflow:flowvariable:create", "创建流程变量")]
    [HttpPost]
    ...
    /// <returns>流程变量DTO</returns>
    [TaktPermission("workflow:flowvariable:update", "更新流程变量")]
    [HttpPut("{id}")]
    ...
    [TaktPermission("workflow:flowvariable:delete", "删除流程变量")]
    [HttpDelete("{id}")]
    ...
    /// <returns>操作结果</returns>
    [TaktPermission("workflow:flowvariable:delete", "批量删除流程变量")]
    [HttpDelete("batch")]
    ...
    [TaktPermission("workflow:flowvariable:import", "获取流程变量导入模板")]
    [HttpGet("template")]
    ...
    [TaktPermission("workflow:flowvariable:import", "导入流程变量")]
    [HttpPost("import")]
    ...
    /// </summary>
    /// <returns>Excel文件</returns>
    [TaktPermission("workflow:flowvariable:export", "导出流程变量")]
    [HttpGet("export")]
