...
public class TaktItAssetChangeLogsController : TaktControllerBase
{
    ...
    [TaktPermission("routine:help:desk:it:asset:change:log:list", "IT设备保修变更日志列表")]
    [HttpGet("list")]
    ...
    [TaktPermission("routine:help:desk:it:asset:change:log:query", "IT设备保修变更日志详情")]
    [HttpGet("{id}")]
    ...
    [TaktPermission("routine:help:desk:it:asset:change:log:query", "IT设备保修变更日志选项")]
    [HttpGet("options")]
    ...
    /// <returns>IT设备保修变更日志DTO</returns>
    [TaktPermission("routine:help:desk:it:asset:change:log:create", "创建IT设备保修变更日志")]
    [HttpPost]
    ...
    /// <returns>IT设备保修变更日志DTO</returns>
    [TaktPermission("routine:help:desk:it:asset:change:log:update", "更新IT设备保修变更日志")]
    [HttpPut("{id}")]
    ...
    [TaktPermission("routine:help:desk:it:asset:change:log:delete", "删除IT设备保修变更日志")]
    [HttpDelete("{id}")]
    ...
    /// <returns>操作结果</returns>
    [TaktPermission("routine:help:desk:it:asset:change:log:delete", "批量删除IT设备保修变更日志")]
    [HttpDelete("batch")]
    ...
    [TaktPermission("routine:help:desk:it:asset:change:log:export", "导出IT设备保修变更日志")]
    [HttpGet("export")]
