...
public class TaktItAssetsController : TaktControllerBase
{
    ...
    [TaktPermission("routine:helpdesk:itasset:list", "IT设备保修扩展列表")]
    [HttpGet("list")]
    ...
    [TaktPermission("routine:helpdesk:itasset:query", "IT设备保修扩展详情")]
    [HttpGet("{id}")]
    ...
    [TaktPermission("routine:helpdesk:itasset:query", "IT设备保修扩展选项")]
    [HttpGet("options")]
    ...
    /// <returns>IT设备保修扩展DTO</returns>
    [TaktPermission("routine:helpdesk:itasset:create", "创建IT设备保修扩展")]
    [HttpPost]
    ...
    /// <returns>IT设备保修扩展DTO</returns>
    [TaktPermission("routine:helpdesk:itasset:update", "更新IT设备保修扩展")]
    [HttpPut("{id}")]
    ...
    [TaktPermission("routine:helpdesk:itasset:delete", "删除IT设备保修扩展")]
    [HttpDelete("{id}")]
    ...
    /// <returns>操作结果</returns>
    [TaktPermission("routine:helpdesk:itasset:delete", "批量删除IT设备保修扩展")]
    [HttpDelete("batch")]
    ...
    [TaktPermission("routine:helpdesk:itasset:import", "获取IT设备保修扩展导入模板")]
    [HttpGet("template")]
    ...
    [TaktPermission("routine:helpdesk:itasset:import", "导入IT设备保修扩展")]
    [HttpPost("import")]
    ...
    /// </summary>
    /// <returns>Excel文件</returns>
    [TaktPermission("routine:helpdesk:itasset:export", "导出IT设备保修扩展")]
    [HttpGet("export")]
