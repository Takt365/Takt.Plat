...
public class TaktKnowledgeChangeLogsController : TaktControllerBase
{
    ...
    [TaktPermission("routine:help:desk:knowledge:list", "知识库变更日志列表")]
    [HttpGet("list")]
    ...
    [TaktPermission("routine:help:desk:knowledge:query", "知识库变更日志详情")]
    [HttpGet("{id}")]
    ...
    [TaktPermission("routine:help:desk:knowledge:query", "知识库变更日志选项")]
    [HttpGet("options")]
    ...
    /// <returns>知识库变更日志DTO</returns>
    [TaktPermission("routine:help:desk:knowledge:create", "创建知识库变更日志")]
    [HttpPost]
    ...
    /// <returns>知识库变更日志DTO</returns>
    [TaktPermission("routine:help:desk:knowledge:update", "更新知识库变更日志")]
    [HttpPut("{id}")]
    ...
    [TaktPermission("routine:help:desk:knowledge:delete", "删除知识库变更日志")]
    [HttpDelete("{id}")]
    ...
    /// <returns>操作结果</returns>
    [TaktPermission("routine:help:desk:knowledge:delete", "批量删除知识库变更日志")]
    [HttpDelete("batch")]
    ...
    [TaktPermission("routine:help:desk:knowledge:export", "导出知识库变更日志")]
    [HttpGet("export")]
