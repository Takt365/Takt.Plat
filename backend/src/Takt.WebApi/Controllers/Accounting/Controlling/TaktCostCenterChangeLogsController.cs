...
public class TaktCostCenterChangeLogsController : TaktControllerBase
{
    ...
    [TaktPermission("accounting:controlling:costcenterchangelog:list", "成本中心变更记录列表")]
    [HttpGet("list")]
    ...
    [TaktPermission("accounting:controlling:costcenterchangelog:query", "成本中心变更记录详情")]
    [HttpGet("{id}")]
    ...
    [TaktPermission("accounting:controlling:costcenterchangelog:query", "成本中心变更记录选项")]
    [HttpGet("options")]
    ...
    /// <returns>成本中心变更记录DTO</returns>
    [TaktPermission("accounting:controlling:costcenterchangelog:create", "创建成本中心变更记录")]
    [HttpPost]
    ...
    /// <returns>成本中心变更记录DTO</returns>
    [TaktPermission("accounting:controlling:costcenterchangelog:update", "更新成本中心变更记录")]
    [HttpPut("{id}")]
    ...
    [TaktPermission("accounting:controlling:costcenterchangelog:delete", "删除成本中心变更记录")]
    [HttpDelete("{id}")]
    ...
    /// <returns>操作结果</returns>
    [TaktPermission("accounting:controlling:costcenterchangelog:delete", "批量删除成本中心变更记录")]
    [HttpDelete("batch")]
    ...
    [TaktPermission("accounting:controlling:costcenterchangelog:export", "导出成本中心变更记录")]
    [HttpGet("export")]
