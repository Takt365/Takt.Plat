...
public class TaktCostElementChangeLogsController : TaktControllerBase
{
    ...
    [TaktPermission("accounting:controlling:cost:element:list", "成本要素变更记录列表")]
    [HttpGet("list")]
    ...
    [TaktPermission("accounting:controlling:cost:element:query", "成本要素变更记录详情")]
    [HttpGet("{id}")]
    ...
    [TaktPermission("accounting:controlling:cost:element:query", "成本要素变更记录选项")]
    [HttpGet("options")]
    ...
    /// <returns>成本要素变更记录DTO</returns>
    [TaktPermission("accounting:controlling:cost:element:create", "创建成本要素变更记录")]
    [HttpPost]
    ...
    /// <returns>成本要素变更记录DTO</returns>
    [TaktPermission("accounting:controlling:cost:element:update", "更新成本要素变更记录")]
    [HttpPut("{id}")]
    ...
    [TaktPermission("accounting:controlling:cost:element:delete", "删除成本要素变更记录")]
    [HttpDelete("{id}")]
    ...
    /// <returns>操作结果</returns>
    [TaktPermission("accounting:controlling:cost:element:delete", "批量删除成本要素变更记录")]
    [HttpDelete("batch")]
    ...
    [TaktPermission("accounting:controlling:cost:element:export", "导出成本要素变更记录")]
    [HttpGet("export")]
