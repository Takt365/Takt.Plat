...
public class TaktProfitCenterChangeLogsController : TaktControllerBase
{
    ...
    [TaktPermission("accounting:controlling:profit:center:list", "利润中心变更记录列表")]
    [HttpGet("list")]
    ...
    [TaktPermission("accounting:controlling:profit:center:query", "利润中心变更记录详情")]
    [HttpGet("{id}")]
    ...
    [TaktPermission("accounting:controlling:profit:center:query", "利润中心变更记录选项")]
    [HttpGet("options")]
    ...
    /// <returns>利润中心变更记录DTO</returns>
    [TaktPermission("accounting:controlling:profit:center:create", "创建利润中心变更记录")]
    [HttpPost]
    ...
    /// <returns>利润中心变更记录DTO</returns>
    [TaktPermission("accounting:controlling:profit:center:update", "更新利润中心变更记录")]
    [HttpPut("{id}")]
    ...
    [TaktPermission("accounting:controlling:profit:center:delete", "删除利润中心变更记录")]
    [HttpDelete("{id}")]
    ...
    /// <returns>操作结果</returns>
    [TaktPermission("accounting:controlling:profit:center:delete", "批量删除利润中心变更记录")]
    [HttpDelete("batch")]
    ...
    [TaktPermission("accounting:controlling:profit:center:export", "导出利润中心变更记录")]
    [HttpGet("export")]
