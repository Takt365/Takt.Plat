...
public class TaktAccountTitleChangeLogsController : TaktControllerBase
{
    ...
    [TaktPermission("accounting:financial:account:title:list", "会计科目变更记录列表")]
    [HttpGet("list")]
    ...
    [TaktPermission("accounting:financial:account:title:query", "会计科目变更记录详情")]
    [HttpGet("{id}")]
    ...
    [TaktPermission("accounting:financial:account:title:query", "会计科目变更记录选项")]
    [HttpGet("options")]
    ...
    /// <returns>会计科目变更记录DTO</returns>
    [TaktPermission("accounting:financial:account:title:create", "创建会计科目变更记录")]
    [HttpPost]
    ...
    /// <returns>会计科目变更记录DTO</returns>
    [TaktPermission("accounting:financial:account:title:update", "更新会计科目变更记录")]
    [HttpPut("{id}")]
    ...
    [TaktPermission("accounting:financial:account:title:delete", "删除会计科目变更记录")]
    [HttpDelete("{id}")]
    ...
    /// <returns>操作结果</returns>
    [TaktPermission("accounting:financial:account:title:delete", "批量删除会计科目变更记录")]
    [HttpDelete("batch")]
    ...
    [TaktPermission("accounting:financial:account:title:export", "导出会计科目变更记录")]
    [HttpGet("export")]
