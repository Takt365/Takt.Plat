...
public interface ITaktQuartzTaskService
{
    ...
    Task<List<TaktSelectOption>> GetQuartzTaskOptionsAsync(string? plantCode = null, string? keyword = null);
    ...
    /// <returns>DTO</returns>
    Task<TaktQuartzTaskDto> ExecuteQuartzTaskNowAsync(long id, string? executeParams = null);
