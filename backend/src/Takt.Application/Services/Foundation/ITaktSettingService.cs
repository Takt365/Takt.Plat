...
public interface ITaktSettingService
{
    ...
    Task<List<TaktSelectOption>> GetSettingOptionsAsync(string? plantCode = null, string? keyword = null);
    ...
    /// <returns>DTO</returns>
    Task<TaktSettingDto> UpdateSettingBuiltInAsync(TaktSettingBuiltInDto dto);
