...
public interface ITaktNewsLikeService
{
    ...
    Task<List<TaktSelectOption>> GetNewsLikeOptionsAsync(string? plantCode = null, string? keyword = null);
    ...
    /// <returns>DTO</returns>
    Task<TaktNewsLikeDto> UpdateNewsLikeObsoleteAsync(TaktNewsLikeObsoleteDto dto);
