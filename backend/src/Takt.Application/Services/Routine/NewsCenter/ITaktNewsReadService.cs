...
public interface ITaktNewsReadService
{
    ...
    Task<List<TaktSelectOption>> GetNewsReadOptionsAsync(string? plantCode = null, string? keyword = null);
    ...
    /// <returns>DTO</returns>
    Task<TaktNewsReadDto> UpdateNewsReadObsoleteAsync(TaktNewsReadObsoleteDto dto);
