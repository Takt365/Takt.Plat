...
public interface ITaktKnowledgeChangeLogService
{
    ...
    Task<(string fileName, byte[] fileContent)> ExportKnowledgeChangeLogAsync(TaktKnowledgeChangeLogQueryDto? query = null, string? sheetName = null, string? fileName = null);
