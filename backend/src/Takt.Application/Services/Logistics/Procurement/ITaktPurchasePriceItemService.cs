...
public interface ITaktPurchasePriceItemService
{
    ...
    Task<List<TaktSelectOption>> GetPurchasePriceItemOptionsAsync(string? plantCode = null, string? keyword = null);
    ...
    /// <returns>DTO</returns>
    Task<TaktPurchasePriceItemDto> UpdatePurchasePriceItemObsoleteAsync(TaktPurchasePriceItemObsoleteDto dto);
