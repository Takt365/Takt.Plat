...
public interface ITaktPurchaseOrderItemService
{
    ...
    Task<List<TaktSelectOption>> GetPurchaseOrderItemOptionsAsync(string? plantCode = null, string? keyword = null);
    ...
    /// <returns>DTO</returns>
    Task<TaktPurchaseOrderItemDto> UpdatePurchaseOrderItemObsoleteAsync(TaktPurchaseOrderItemObsoleteDto dto);
