...
public interface ITaktEquipmentService
{
    ...
    Task<List<TaktSelectOption>> GetEquipmentOptionsAsync(string? plantCode = null, string? keyword = null);
    ...
    Task<(string fileName, byte[] content)> GetEquipmentTemplateAsync(string? sheetName = null, string? fileName = null);
    ...
    Task<(int success, int fail, List<string> errors)> ImportEquipmentAsync(Stream fileStream, string? sheetName = null);
    ...
    Task<TaktEquipmentStatDto> GetEquipmentStatAsync(TaktEquipmentStatQueryDto queryDto);
