...
public interface ITaktPcbaOutputDetailService
{
    ...
    Task<List<TaktSelectOption>> GetPcbaOutputDetailOptionsAsync(string? plantCode = null, string? keyword = null);
    ...
    /// <returns>DTO</returns>
    Task<TaktPcbaOutputDetailDto> UpdatePcbaOutputDetailObsoleteAsync(TaktPcbaOutputDetailObsoleteDto dto);
