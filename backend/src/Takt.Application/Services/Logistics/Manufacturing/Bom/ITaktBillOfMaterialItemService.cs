...
public interface ITaktBillOfMaterialItemService
{
    ...
    Task<List<TaktSelectOption>> GetBillOfMaterialItemOptionsAsync(string? plantCode = null, string? keyword = null);
    ...
    /// <returns>DTO</returns>
    Task<TaktBillOfMaterialItemDto> UpdateBillOfMaterialItemObsoleteAsync(TaktBillOfMaterialItemObsoleteDto dto);
    ...
    Task<(string fileName, byte[] content)> GetBillOfMaterialItemTemplateAsync(string? sheetName = null, string? fileName = null);
    ...
    Task<(int success, int fail, List<string> errors)> ImportBillOfMaterialItemAsync(Stream fileStream, string? sheetName = null);
    ...
    /// <param name="fileName">文件名</param>
    /// <returns>Excel 文件</returns>
    Task<(string fileName, byte[] fileContent)> ExportBillOfMaterialItemAsync(TaktBillOfMaterialItemQueryDto? query = null, string? sheetName = null, string? fileName = null);
