...
public class TaktSopExecStepService : TaktServiceBase, ITaktSopExecStepService
{
    ...
    public async Task<List<TaktSelectOption>> GetSopExecStepOptionsAsync(string? plantCode = null, string? keyword = null)
    {
