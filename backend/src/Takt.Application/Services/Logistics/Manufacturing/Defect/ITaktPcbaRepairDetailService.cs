...
public interface ITaktPcbaRepairDetailService
{
    ...
    Task<List<TaktSelectOption>> GetPcbaRepairDetailOptionsAsync(string? plantCode = null, string? keyword = null);
    ...
    /// <returns>DTO</returns>
    Task<TaktPcbaRepairDetailDto> UpdatePcbaRepairDetailObsoleteAsync(TaktPcbaRepairDetailObsoleteDto dto);
    ...
    Task<(string fileName, byte[] content)> GetPcbaRepairDetailTemplateAsync(string? sheetName = null, string? fileName = null);
    ...
    Task<(int success, int fail, List<string> errors)> ImportPcbaRepairDetailAsync(Stream fileStream, string? sheetName = null);
    ...
    /// <param name="fileName">文件名</param>
    /// <returns>Excel 文件</returns>
    Task<(string fileName, byte[] fileContent)> ExportPcbaRepairDetailAsync(TaktPcbaRepairDetailQueryDto? query = null, string? sheetName = null, string? fileName = null);
