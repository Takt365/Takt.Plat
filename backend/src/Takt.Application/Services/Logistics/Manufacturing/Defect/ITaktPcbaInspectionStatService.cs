...
// 文件名称：ITaktPcbaInspectionStatService.cs
// 创建时间：2026-08-31
// 创建人：Takt365(Cursor AI)
// 功能描述：PCBA 检查不良看板统计服务接口（与 TaktPcbaInspection CRUD 分离）
//
...
/// <summary>
/// PCBA 检查不良看板统计服务（与 TaktPcbaInspectionService CRUD 分离）
/// </summary>
public interface ITaktPcbaInspectionStatService
{
    /// <summary>
    /// 获取 PCBA 检查不良统计（数据看板 defect-stat；按明细实装日期、生产班组）
    /// </summary>
