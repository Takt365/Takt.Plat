...
public interface ITaktPcbaRepairService
{
    ...
    Task<(string fileName, byte[] content)> GetPcbaRepairTemplateAsync(string? sheetName = null, string? fileName = null);
    ...
    Task<(int success, int fail, List<string> errors)> ImportPcbaRepairAsync(Stream fileStream, string? sheetName = null);
