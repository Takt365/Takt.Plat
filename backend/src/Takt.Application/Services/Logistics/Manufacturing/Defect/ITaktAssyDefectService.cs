...
public interface ITaktAssyDefectService
{
    ...
    Task<(string fileName, byte[] content)> GetAssyDefectTemplateAsync(string? sheetName = null, string? fileName = null);
    ...
    Task<(int success, int fail, List<string> errors)> ImportAssyDefectAsync(Stream fileStream, string? sheetName = null);
