...
public interface ITaktSalesPriceItemService
{
    ...
    Task<List<TaktSelectOption>> GetSalesPriceItemOptionsAsync(string? plantCode = null, string? keyword = null);
    ...
    /// <returns>DTO</returns>
    Task<TaktSalesPriceItemDto> UpdateSalesPriceItemObsoleteAsync(TaktSalesPriceItemObsoleteDto dto);
