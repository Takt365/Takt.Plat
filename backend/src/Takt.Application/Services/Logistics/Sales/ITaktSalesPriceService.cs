...
public interface ITaktSalesPriceService
{
    ...
    Task<List<TaktSelectOption>> GetSalesPriceOptionsAsync(string? plantCode = null, string? keyword = null);
    ...
    Task<(string fileName, byte[] content)> GetSalesPriceTemplateAsync(string? sheetName = null, string? fileName = null);
    ...
    Task<(int success, int fail, List<string> errors)> ImportSalesPriceAsync(Stream fileStream, string? sheetName = null);
    ...
    /// <param name="fileName">文件名</param>
    /// <returns>Excel 文件</returns>
    Task<(string fileName, byte[] fileContent)> ExportSalesPriceAsync(TaktSalesPriceQueryDto? query = null, string? sheetName = null, string? fileName = null);
