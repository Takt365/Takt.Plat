...
public interface ITaktSalesPriceChangeLogService
{
    ...
    Task<(string fileName, byte[] fileContent)> ExportSalesPriceChangeLogAsync(TaktSalesPriceChangeLogQueryDto? query = null, string? sheetName = null, string? fileName = null);
