...
public interface ITaktIpqcDefectHandlingService
{
    ...
    Task<List<TaktSelectOption>> GetIpqcDefectHandlingOptionsAsync(string? plantCode = null, string? keyword = null);
    ...
    /// <returns>DTO</returns>
    Task<TaktIpqcDefectHandlingDto> UpdateIpqcDefectHandlingObsoleteAsync(TaktIpqcDefectHandlingObsoleteDto dto);
