...
public class TaktIpqcDefectHandlingService : TaktServiceBase, ITaktIpqcDefectHandlingService
{
    ...
    public async Task<List<TaktSelectOption>> GetIpqcDefectHandlingOptionsAsync()
    {
        ...
        {
            DictValue = e.Id,
            DictLabel = e.IpqcDefectHandlingCode ?? e.Id.ToString(),
        }).ToList();
    }
    ...
    private static Expression<Func<TaktIpqcDefectHandling, bool>> QueryExpression(TaktIpqcDefectHandlingQueryDto? queryDto)
    {
        ...
        if (!string.IsNullOrEmpty(queryDto?.KeyWords))
        {
            ...
            exp = exp.And(x =>
                ...
                || SqlFunc.ToString(x.IpqcOrderItemId).Contains(keywords)
        ...
        if (!string.IsNullOrEmpty(queryDto?.IpqcDefectHandlingCode))
        {
            exp = exp.And(x => x.IpqcDefectHandlingCode != null && x.IpqcDefectHandlingCode.Contains(queryDto.IpqcDefectHandlingCode));
        }
