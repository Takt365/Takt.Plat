...
public interface ITaktFqcDefectHandlingService
{
    ...
    Task<List<TaktSelectOption>> GetFqcDefectHandlingOptionsAsync(string? plantCode = null, string? keyword = null);
    ...
    /// <returns>DTO</returns>
    Task<TaktFqcDefectHandlingDto> UpdateFqcDefectHandlingObsoleteAsync(TaktFqcDefectHandlingObsoleteDto dto);
