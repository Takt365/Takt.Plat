...
public interface ITaktSupplierEvaluationItemService
{
    ...
    Task<List<TaktSelectOption>> GetSupplierEvaluationItemOptionsAsync(string? plantCode = null, string? keyword = null);
    ...
    /// <returns>DTO</returns>
    Task<TaktSupplierEvaluationItemDto> UpdateSupplierEvaluationItemStatusAsync(TaktSupplierEvaluationItemStatusDto dto);
    ...
    /// <returns>DTO</returns>
    Task<TaktSupplierEvaluationItemDto> UpdateSupplierEvaluationItemObsoleteAsync(TaktSupplierEvaluationItemObsoleteDto dto);
    ...
    Task<(string fileName, byte[] content)> GetSupplierEvaluationItemTemplateAsync(string? sheetName = null, string? fileName = null);
    ...
    Task<(int success, int fail, List<string> errors)> ImportSupplierEvaluationItemAsync(Stream fileStream, string? sheetName = null);
    ...
    /// <param name="fileName">文件名</param>
    /// <returns>Excel 文件</returns>
    Task<(string fileName, byte[] fileContent)> ExportSupplierEvaluationItemAsync(TaktSupplierEvaluationItemQueryDto? query = null, string? sheetName = null, string? fileName = null);
