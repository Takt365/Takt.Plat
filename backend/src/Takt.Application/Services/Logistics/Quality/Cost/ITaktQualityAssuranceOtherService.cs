...
public interface ITaktQualityAssuranceOtherService
{
    ...
    Task<List<TaktSelectOption>> GetQualityAssuranceOtherOptionsAsync(string? plantCode = null, string? keyword = null);
    ...
    /// <returns>DTO</returns>
    Task<TaktQualityAssuranceOtherDto> UpdateQualityAssuranceOtherObsoleteAsync(TaktQualityAssuranceOtherObsoleteDto dto);
