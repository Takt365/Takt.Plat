...
public interface ITaktQualityAssuranceIncomingService
{
    ...
    Task<List<TaktSelectOption>> GetQualityAssuranceIncomingOptionsAsync(string? plantCode = null, string? keyword = null);
    ...
    /// <returns>DTO</returns>
    Task<TaktQualityAssuranceIncomingDto> UpdateQualityAssuranceIncomingObsoleteAsync(TaktQualityAssuranceIncomingObsoleteDto dto);
