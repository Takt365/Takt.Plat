...
public class TaktCompanyDto : TaktTenantDtoBase
{
    ...
    /// 公司类型
    /// </summary>
    public TaktCompanyType CompanyType { get; set; }
    ...
    /// 存续状态（市场主体登记状态）
    /// </summary>
    public TaktCompanyExistenceStatus CompanyExistence { get; set; }
    ...
    /// 公司状态
    /// </summary>
    public TaktCommonStatus CompanyStatus { get; set; }
...
public class TaktCompanyCreateDto
{
    ...
    /// 关联工厂编码（如 0001、C100）
    /// </summary>
    [Required(ErrorMessage = "关联工厂编码（如 0001、C100）不能为空")]
    public string RelatedPlant { get; set; } = string.Empty;
...
public class TaktCompanyStatusDto
{
    ...
    /// 公司状态
    /// </summary>
    [Required(ErrorMessage = "公司状态不能为空")]
    public TaktCommonStatus CompanyStatus { get; set; }
}
