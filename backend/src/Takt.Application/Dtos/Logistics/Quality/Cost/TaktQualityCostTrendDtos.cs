...
// 文件名称：TaktQualityCostTrendDtos.cs
// 创建时间：2026-07-18
// 创建人：Takt365(Cursor AI)
// 功能描述：质量成本月推移转置分析 DTO
//
...
/// 质量成本月推移转置分析查询 DTO
/// </summary>
public class TaktQualityCostTrendQueryDto : TaktPagedQuery
{
    /// <summary>
    /// 工厂代码（必填）
    /// </summary>
    ...
    /// <summary>
    /// 成本类别：assurance / issue / incident；空表示全部
    /// </summary>
...
/// <summary>
/// 质量成本月推移转置行（行=工厂+成本类别+币种，列=各月汇总金额）
/// </summary>
public class TaktQualityCostTrendDto
{
    /// <summary>
    /// 工厂代码
    /// </summary>
...
/// 质量成本月推移转置分析结果
/// </summary>
public class TaktQualityCostTrendResultDto
{
    /// <summary>
    /// 分页行
    /// </summary>
    public TaktPagedResult<TaktQualityCostTrendDto> Paged { get; set; } = null!;
