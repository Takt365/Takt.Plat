...
// 功能描述：IqcOrderChangeLog 模块 DTO（由 generate-dtos-from-entity.cjs 根据 TaktIqcOrderChangeLog 生成，请按需审阅）
// 
...
/// </summary>
public class TaktIqcOrderChangeLogDto : TaktCompanyDtoBase
{
    /// <summary>
    ...
    public long IqcOrderChangeLogId { get; set; }
...
/// 继承 TaktPagedQuery
/// </summary>
public class TaktIqcOrderChangeLogQueryDto : TaktPagedQuery
{
    /// <summary>
    /// 租户编码
    /// </summary>
...
/// 创建IqcOrderChangeLog DTO
/// </summary>
public class TaktIqcOrderChangeLogCreateDto
{
    /// <summary>
...
/// </summary>
public class TaktIqcOrderChangeLogUpdateDto : TaktIqcOrderChangeLogCreateDto
{
    /// <summary>
...
/// </summary>
public class TaktIqcOrderChangeLogExportDto
{
    /// <summary>
    /// IqcOrderChangeLogID
    /// </summary>
