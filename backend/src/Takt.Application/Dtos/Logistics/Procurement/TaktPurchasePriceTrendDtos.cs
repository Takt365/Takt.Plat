...
/// 工厂 × 物料 × 供应商采购单价转置分析查询
/// </summary>
public class TaktPurchasePriceMonthlyTrendQueryDto : TaktPagedQuery
{
    /// <summary>
    /// 工厂代码（必填）
    /// </summary>
...
/// <summary>
/// 采购价格月推移转置行（行=工厂+物料+供应商，列=各月折算单价）
/// </summary>
public class TaktPurchasePriceMonthlyTrendDto
{
    /// <summary>
    /// 工厂代码
    /// </summary>
...
/// 采购价格月推移转置分析结果
/// </summary>
public class TaktPurchasePriceMonthlyTrendResultDto
{
    /// <summary>
    /// 分页行
    /// </summary>
    public TaktPagedResult<TaktPurchasePriceMonthlyTrendDto> Paged { get; set; } = null!;
...
/// </summary>
public class TaktPurchasePriceModelTrendDto : TaktPurchasePriceMonthlyTrendDto
{
    /// <summary>
...
/// 采购机种价格推移分析结果
/// </summary>
public class TaktPurchasePriceModelTrendResultDto
{
    /// <summary>
    /// 分页行
    /// </summary>
    public TaktPagedResult<TaktPurchasePriceModelTrendDto> Paged { get; set; } = null!;
