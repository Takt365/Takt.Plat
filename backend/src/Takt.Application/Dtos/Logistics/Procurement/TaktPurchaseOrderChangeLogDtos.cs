...
// 功能描述：PurchaseOrderChangeLog 模块 DTO（由 generate-dtos-from-entity.cjs 根据 TaktPurchaseOrderChangeLog 生成，请按需审阅）
// 
...
/// </summary>
public class TaktPurchaseOrderChangeLogDto : TaktCompanyDtoBase
{
    /// <summary>
...
/// 继承 TaktPagedQuery
/// </summary>
public class TaktPurchaseOrderChangeLogQueryDto : TaktPagedQuery
{
    /// <summary>
    /// 租户编码
    /// </summary>
...
/// 创建PurchaseOrderChangeLog DTO
/// </summary>
public class TaktPurchaseOrderChangeLogCreateDto
{
    /// <summary>
...
/// </summary>
public class TaktPurchaseOrderChangeLogUpdateDto : TaktPurchaseOrderChangeLogCreateDto
{
    /// <summary>
...
/// </summary>
public class TaktPurchaseOrderChangeLogExportDto
{
    /// <summary>
