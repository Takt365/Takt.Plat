...
// ========================================
// 成本合计 / 重算 / 机种月均（非 CRUD；勿写入可被 generate-all 覆盖的 Item/Cost DTO）
// ========================================
...
{
    /// <summary>
    /// 规范化后的明细查询（CostingDate 已收束为单月首尾）
    /// </summary>
...
/// <summary>
/// 刷新主表机种编码 / 物料类型 / 机种月均成本查询
/// </summary>
public class TaktBomMaterialCostRefreshModelQueryDto
{
    /// <summary>
    /// 工厂代码（必填）
    /// </summary>
...
/// <summary>
/// 刷新机种编码、物料类型与机种月平均成本结果
/// </summary>
public class TaktBomMaterialCostRefreshModelResultDto
{
    /// <summary>
    /// 扫描主表行数
    /// </summary>
