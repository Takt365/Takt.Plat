...
// 文件名称：TaktPcbaSmtLaborHourDtos.cs
// 创建时间：2026-07-09
// 创建人：Takt365(Auto Generated)
// 功能描述：PcbaSmtLaborHour 模块 DTO（由 generate-dtos-from-entity.cjs 根据 TaktPcbaSmtLaborHour 生成，请按需审阅）
// 
...
/// </summary>
public class TaktPcbaSmtLaborHourDto : TaktCompanyDtoBase
{
    /// <summary>
    ...
    public long PcbaSmtLaborHourId { get; set; }
...
/// 继承 TaktPagedQuery
/// </summary>
public class TaktPcbaSmtLaborHourQueryDto : TaktPagedQuery
{
    /// <summary>
    /// 租户编码
    /// </summary>
...
/// 创建PcbaSmtLaborHour DTO
/// </summary>
public class TaktPcbaSmtLaborHourCreateDto
{
    /// <summary>
...
/// </summary>
public class TaktPcbaSmtLaborHourUpdateDto : TaktPcbaSmtLaborHourCreateDto
{
    /// <summary>
...
/// </summary>
public class TaktPcbaSmtLaborHourTemplateDto
{
    /// <summary>
    /// 租户编码（登录上下文注入，对应请求头 X-Tenant-Code）
    /// </summary>
...
/// </summary>
public class TaktPcbaSmtLaborHourImportDto
{
    /// <summary>
    /// 租户编码（登录上下文注入，对应请求头 X-Tenant-Code）
    /// </summary>
...
/// </summary>
public class TaktPcbaSmtLaborHourExportDto
{
    /// <summary>
    /// PcbaSmtLaborHourID
    /// </summary>
