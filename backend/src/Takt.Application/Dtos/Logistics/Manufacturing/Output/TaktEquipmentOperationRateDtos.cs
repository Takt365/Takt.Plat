...
public class TaktEquipmentOperationRateDto : TaktCompanyDtoBase
{
    ...
    /// （子表：TaktEquipmentOperationRateChangeLog）
    /// </summary>
    public List<TaktEquipmentOperationRateChangeLogDto>? ChangeLogs { get; set; }
...
public class TaktEquipmentOperationRateQueryDto : TaktPagedQuery
{
    ...
    /// 状态（0=正常，1=停用）
    /// </summary>
    public int? EquipmentOperationRateStatus { get; set; }
...
public class TaktEquipmentOperationRateCreateDto
{
    ...
    /// </summary>
    public List<TaktEquipmentOperationRateChangeLogCreateDto>? ChangeLogs { get; set; }
