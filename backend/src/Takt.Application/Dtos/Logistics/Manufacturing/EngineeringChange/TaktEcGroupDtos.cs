...
/// </summary>
public class TaktEcGroupDto : TaktCompanyDtoBase
{
    /// <summary>
...
/// 继承 TaktPagedQuery
/// </summary>
public class TaktEcGroupQueryDto : TaktPagedQuery
{
    /// <summary>
    /// 租户编码
    /// </summary>
...
/// 创建EcGroup DTO
/// </summary>
public class TaktEcGroupCreateDto
{
    /// <summary>
    ...
    /// 设变组编码（3）
    /// </summary>
    [Required(ErrorMessage = "设变组编码（3）不能为空")]
    public string EcGroupCode { get; set; } = string.Empty;

    /// <summary>
    /// 设变组名称
    /// </summary>
    [Required(ErrorMessage = "设变组名称不能为空")]
    public string EcGroupName { get; set; } = string.Empty;
...
/// </summary>
public class TaktEcGroupUpdateDto : TaktEcGroupCreateDto
{
    /// <summary>
    /// EcGroupID（标识要更新的实体）
    /// </summary>
...
/// EcGroup 状态更新 DTO
/// </summary>
public class TaktEcGroupStatusDto
{
    /// <summary>
    /// EcGroupID
    /// </summary>
...
/// EcGroup 排序更新 DTO
/// </summary>
public class TaktEcGroupSortDto
{
    /// <summary>
    /// EcGroupID
    /// </summary>
...
/// EcGroup 导入模板行 DTO
/// </summary>
public class TaktEcGroupTemplateDto
{
    /// <summary>
    /// 租户编码（登录上下文注入，对应请求头 X-Tenant-Code）
    /// </summary>
...
/// </summary>
public class TaktEcGroupImportDto
{
    /// <summary>
    /// 租户编码（登录上下文注入，对应请求头 X-Tenant-Code）
    /// </summary>
...
/// </summary>
public class TaktEcGroupExportDto
{
    /// <summary>
    /// EcGroupID
    /// </summary>
