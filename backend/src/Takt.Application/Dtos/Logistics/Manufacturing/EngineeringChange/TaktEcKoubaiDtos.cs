...
/// </summary>
public class TaktEcKoubaiDto : TaktCompanyDtoBase
{
    /// <summary>
...
/// 继承 TaktPagedQuery
/// </summary>
public class TaktEcKoubaiQueryDto : TaktPagedQuery
{
    /// <summary>
    /// 租户编码
    /// </summary>
...
/// 创建EcKoubai DTO
/// </summary>
public class TaktEcKoubaiCreateDto
{
    /// <summary>
    ...
    /// 部门编码（TaktDept.DeptCode，5 位，如 D0510）
    /// </summary>
    [Required(ErrorMessage = "部门编码（TaktDept.DeptCode，5 位，如 D0510）不能为空")]
    public string DeptCode { get; set; } = string.Empty;
...
/// </summary>
public class TaktEcKoubaiUpdateDto : TaktEcKoubaiCreateDto
{
    /// <summary>
    /// EcKoubaiID（标识要更新的实体）
    /// </summary>
...
/// </summary>
public class TaktEcKoubaiObsoleteDto
{
    /// <summary>
    /// EcKoubaiID
    /// </summary>
...
/// EcKoubai 导入模板行 DTO
/// </summary>
public class TaktEcKoubaiTemplateDto
{
    /// <summary>
    /// 租户编码（登录上下文注入，对应请求头 X-Tenant-Code）
    /// </summary>
...
/// </summary>
public class TaktEcKoubaiImportDto
{
    /// <summary>
    /// 租户编码（登录上下文注入，对应请求头 X-Tenant-Code）
    /// </summary>
...
/// </summary>
public class TaktEcKoubaiExportDto
{
    /// <summary>
    /// EcKoubaiID
    /// </summary>
