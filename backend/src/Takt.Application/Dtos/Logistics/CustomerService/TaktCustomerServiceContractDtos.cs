...
// ========================================
// CustomerServiceContract 响应 DTO
// ========================================
...
/// </summary>
public class TaktCustomerServiceContractDto : TaktCompanyDtoBase
{
    /// <summary>
    ...
    /// （子表：TaktCustomerServiceOrder）
    /// </summary>
    public List<TaktCustomerServiceOrderDto>? ServiceOrders { get; set; }

    /// <summary>
    /// 服务请求列表（外键在子表 TaktCustomerServiceRequest.ServiceContractId）
    /// （子表：TaktCustomerServiceRequest）
    /// </summary>
    public List<TaktCustomerServiceRequestDto>? ServiceRequests { get; set; }

}

// ========================================
// CustomerServiceContract 查询 DTO
// ========================================
...
/// 继承 TaktPagedQuery
/// </summary>
public class TaktCustomerServiceContractQueryDto : TaktPagedQuery
{
    /// <summary>
    /// 租户编码
    /// </summary>
...
/// 创建CustomerServiceContract DTO
/// </summary>
public class TaktCustomerServiceContractCreateDto
{
    /// <summary>
    ...
    /// </summary>
    public List<TaktCustomerServiceOrderCreateDto>? ServiceOrders { get; set; }

    /// <summary>
    /// 服务请求列表（外键在子表 TaktCustomerServiceRequest.ServiceContractId）（子表，级联保存）
    /// </summary>
    public List<TaktCustomerServiceRequestCreateDto>? ServiceRequests { get; set; }
...
/// </summary>
public class TaktCustomerServiceContractUpdateDto : TaktCustomerServiceContractCreateDto
{
    /// <summary>
    ...
    /// 服务订单列表（外键在子表 TaktCustomerServiceOrder.ServiceContractId）（子表，级联保存）
    /// </summary>
    public new List<TaktCustomerServiceOrderUpdateDto>? ServiceOrders { get; set; }

    /// <summary>
    /// 服务请求列表（外键在子表 TaktCustomerServiceRequest.ServiceContractId）（子表，级联保存）
    /// </summary>
    public new List<TaktCustomerServiceRequestUpdateDto>? ServiceRequests { get; set; }

}

// ========================================
// CustomerServiceContract 状态 DTO
// ========================================

/// <summary>
/// CustomerServiceContract 状态更新 DTO
/// </summary>
public class TaktCustomerServiceContractStatusDto
{
    /// <summary>
...
// ========================================
// CustomerServiceContract 排序 DTO
// ========================================

/// <summary>
/// CustomerServiceContract 排序更新 DTO
/// </summary>
public class TaktCustomerServiceContractSortDto
{
    /// <summary>
    /// CustomerServiceContractID
    /// </summary>
...
/// </summary>
public class TaktCustomerServiceContractTemplateDto
{
    /// <summary>
    /// 租户编码（登录上下文注入，对应请求头 X-Tenant-Code）
    /// </summary>
...
/// </summary>
public class TaktCustomerServiceContractImportDto
{
    /// <summary>
    /// 租户编码（登录上下文注入，对应请求头 X-Tenant-Code）
    /// </summary>
...
/// </summary>
public class TaktCustomerServiceContractExportDto
{
    /// <summary>
    /// CustomerServiceContractID
    /// </summary>
