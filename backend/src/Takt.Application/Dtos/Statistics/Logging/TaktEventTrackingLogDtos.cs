...
// 文件名称：TaktEventTrackingLogDtos.cs
// 创建时间：2026-06-25
// 创建人：Takt365(Auto Generated)
// 功能描述：EventTrackingLog 模块 DTO（由 generate-dtos-from-entity.cjs 根据 TaktEventTrackingLog 生成，请按需审阅）
// 
...
/// </summary>
public class TaktEventTrackingLogDto : TaktCompanyDtoBase
{
    /// <summary>
    ...
    public long EventTrackingLogId { get; set; }
...
/// 继承 TaktPagedQuery
/// </summary>
public class TaktEventTrackingLogQueryDto : TaktPagedQuery
{
    /// <summary>
    /// 租户编码
    /// </summary>
...
/// 创建EventTrackingLog DTO
/// </summary>
public class TaktEventTrackingLogCreateDto
{
    /// <summary>
...
/// </summary>
public class TaktEventTrackingLogUpdateDto : TaktEventTrackingLogCreateDto
{
    /// <summary>
...
/// </summary>
public class TaktEventTrackingLogExportDto
{
    /// <summary>
    /// EventTrackingLogID
    /// </summary>
...
/// </summary>
public class TaktEventTrackingLogTrackDto
{
    /// <summary>
    /// 事件类型（默认 longtask）
    /// </summary>
...
/// Long Task 批量上报 DTO
/// </summary>
public class TaktEventTrackingLogBatchTrackDto
{
    /// <summary>
    /// 上报条目（单次最多 50 条）
    /// </summary>
    public List<TaktEventTrackingLogTrackDto> Items { get; set; } = new();
}
