...
// 文件名称：TaktAnalysisImprovementDtos.cs
// 创建时间：2026-06-06
// 创建人：Takt365(Auto Generated)
// 功能描述：AnalysisImprovement 模块 DTO（由 generate-dtos-from-entity.cjs 根据 TaktAnalysisImprovement 生成，请按需审阅）
// 
...
/// </summary>
public class TaktAnalysisImprovementDto : TaktApprovalDtoBase
{
    /// <summary>
    ...
    public long AnalysisImprovementId { get; set; }
...
/// 继承 TaktPagedQuery
/// </summary>
public class TaktAnalysisImprovementQueryDto : TaktPagedQuery
{
    /// <summary>
    /// 租户编码
    /// </summary>
...
/// 创建AnalysisImprovement DTO
/// </summary>
public class TaktAnalysisImprovementCreateDto
{
    /// <summary>
...
/// </summary>
public class TaktAnalysisImprovementUpdateDto : TaktAnalysisImprovementCreateDto
{
    /// <summary>
...
// ========================================
// AnalysisImprovement 状态 DTO
// ========================================

/// <summary>
/// AnalysisImprovement 状态更新 DTO
/// </summary>
public class TaktAnalysisImprovementStatusDto
{
    /// <summary>
...
/// </summary>
public class TaktAnalysisImprovementTemplateDto
{
    /// <summary>
    /// 租户编码（登录上下文注入，对应请求头 X-Tenant-Code）
    /// </summary>
...
/// </summary>
public class TaktAnalysisImprovementImportDto
{
    /// <summary>
    /// 租户编码（登录上下文注入，对应请求头 X-Tenant-Code）
    /// </summary>
...
/// </summary>
public class TaktAnalysisImprovementExportDto
{
    /// <summary>
    /// AnalysisImprovementID
    /// </summary>
