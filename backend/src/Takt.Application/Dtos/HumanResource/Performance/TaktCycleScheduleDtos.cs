...
// 文件名称：TaktCycleScheduleDtos.cs
// 创建时间：2026-06-08
// 创建人：Takt365(Auto Generated)
// 功能描述：CycleSchedule 模块 DTO（由 generate-dtos-from-entity.cjs 根据 TaktCycleSchedule 生成，请按需审阅）
// 
...
/// </summary>
public class TaktCycleScheduleDto : TaktCompanyDtoBase
{
    /// <summary>
    ...
    public long CycleScheduleId { get; set; }
...
/// 继承 TaktPagedQuery
/// </summary>
public class TaktCycleScheduleQueryDto : TaktPagedQuery
{
    /// <summary>
    /// 租户编码
    /// </summary>
...
/// 创建CycleSchedule DTO
/// </summary>
public class TaktCycleScheduleCreateDto
{
    /// <summary>
...
/// </summary>
public class TaktCycleScheduleUpdateDto : TaktCycleScheduleCreateDto
{
    /// <summary>
...
// ========================================
// CycleSchedule 状态 DTO
// ========================================

/// <summary>
/// CycleSchedule 状态更新 DTO
/// </summary>
public class TaktCycleScheduleStatusDto
{
    /// <summary>
    /// CycleScheduleID
    /// </summary>
...
/// </summary>
public class TaktCycleScheduleTemplateDto
{
    /// <summary>
    /// 租户编码（登录上下文注入，对应请求头 X-Tenant-Code）
    /// </summary>
...
/// </summary>
public class TaktCycleScheduleImportDto
{
    /// <summary>
    /// 租户编码（登录上下文注入，对应请求头 X-Tenant-Code）
    /// </summary>
...
/// </summary>
public class TaktCycleScheduleExportDto
{
    /// <summary>
    /// CycleScheduleID
    /// </summary>
