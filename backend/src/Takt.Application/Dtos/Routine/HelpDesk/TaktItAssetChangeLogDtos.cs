...
// 文件名称：TaktItAssetChangeLogDtos.cs
// 创建时间：2026-06-10
// 创建人：Takt365(Auto Generated)
// 功能描述：ItAssetChangeLog 模块 DTO（由 generate-dtos-from-entity.cjs 根据 TaktItAssetChangeLog 生成，请按需审阅）
// 
...
/// </summary>
public class TaktItAssetChangeLogDto : TaktCompanyDtoBase
{
    /// <summary>
    ...
    public long ItAssetChangeLogId { get; set; }
    ...
    /// （主表：TaktItAsset）
    /// </summary>
    public TaktItAssetDto? ItAsset { get; set; }

}

// ========================================
// ItAssetChangeLog 查询 DTO
// ========================================
...
/// 继承 TaktPagedQuery
/// </summary>
public class TaktItAssetChangeLogQueryDto : TaktPagedQuery
{
    /// <summary>
    /// 租户编码
    /// </summary>
...
/// 创建ItAssetChangeLog DTO
/// </summary>
public class TaktItAssetChangeLogCreateDto
{
    /// <summary>
...
/// </summary>
public class TaktItAssetChangeLogUpdateDto : TaktItAssetChangeLogCreateDto
{
    /// <summary>
...
/// </summary>
public class TaktItAssetChangeLogExportDto
{
    /// <summary>
    /// ItAssetChangeLogID
    /// </summary>
