// ========================================
// 项目名称：节拍工厂·Takt Plat
// 命名空间：Takt.Application.Scheduling
// 文件名称：ITaktQuartzSchedulerManager.cs
// 创建时间：2026-06-05
// 创建人：Takt365(Cursor AI)
// 功能描述：Quartz 调度管理器接口（Application 层抽象）
//
...
namespace Takt.Application.Scheduling;
...
public interface ITaktQuartzSchedulerManager
{
    ...
    /// <returns>任务</returns>
    Task ScheduleQuartzTaskAsync(TaktQuartzTask task, CancellationToken cancellationToken = default);
