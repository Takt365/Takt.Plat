...
// 文件名称：TaktEventTrackingLogValidators.cs
// 创建时间：2026-07-09
// 创建人：Takt365(Auto Generated)
// 功能描述：EventTrackingLog 模块 FluentValidation 验证器（由 generate-validators-from-entity.cjs 根据 TaktEventTrackingLog 生成，请按需审阅）
// 
...
// ========================================
// 创建EventTrackingLog 验证器
// ========================================

/// <summary>
/// 创建EventTrackingLog DTO 验证器
/// </summary>
public class TaktEventTrackingLogCreateValidator : AbstractValidator<TaktEventTrackingLogCreateDto>
{
    /// <summary>
    /// 初始化 创建EventTrackingLog 校验规则
    /// </summary>
    public TaktEventTrackingLogCreateValidator()
    {
...
// ========================================
// 更新EventTrackingLog 验证器
// ========================================

/// <summary>
/// 更新EventTrackingLog DTO 验证器
/// </summary>
public class TaktEventTrackingLogUpdateValidator : AbstractValidator<TaktEventTrackingLogUpdateDto>
{
    /// <summary>
    /// 初始化 更新EventTrackingLog 校验规则
    /// </summary>
    public TaktEventTrackingLogUpdateValidator()
    {
        RuleFor(x => x.EventTrackingLogId)
            .GreaterThan(0).WithMessage("EventTrackingLogID无效");
        RuleFor(x => x.TenantCode)
            .NotEmpty().WithMessage("租户编码不能为空")
            .MaximumLength(3).WithMessage("租户编码长度不能超过3个字符");
        RuleFor(x => x.CompanyCode)
