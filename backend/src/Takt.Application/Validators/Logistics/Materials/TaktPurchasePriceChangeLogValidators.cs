...
/// <summary>
/// 创建PurchasePriceChangeLog DTO 验证器
/// </summary>
public class TaktPurchasePriceChangeLogCreateValidator : AbstractValidator<TaktPurchasePriceChangeLogCreateDto>
{
    /// <summary>
    /// 初始化 创建PurchasePriceChangeLog 校验规则
    /// </summary>
    public TaktPurchasePriceChangeLogCreateValidator()
    {
...
// ========================================
// 更新PurchasePriceChangeLog 验证器
// ========================================

/// <summary>
/// 更新PurchasePriceChangeLog DTO 验证器
/// </summary>
public class TaktPurchasePriceChangeLogUpdateValidator : AbstractValidator<TaktPurchasePriceChangeLogUpdateDto>
{
    /// <summary>
    /// 初始化 更新PurchasePriceChangeLog 校验规则
    /// </summary>
    public TaktPurchasePriceChangeLogUpdateValidator()
    {
        RuleFor(x => x.PurchasePriceChangeLogId)
            .GreaterThan(0).WithMessage("PurchasePriceChangeLogID无效");
    }
}
