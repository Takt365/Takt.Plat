...
public class TaktPlantCreateValidator : AbstractValidator<TaktPlantCreateDto>
{
    ...
    public TaktPlantCreateValidator()
    {
        ...
        RuleFor(x => x.PlantAddress1)
            .MaximumLength(200).WithMessage("工厂地址1长度不能超过200个字符");
        RuleFor(x => x.PlantAddress2)
            .MaximumLength(200).WithMessage("工厂地址2长度不能超过200个字符");
        RuleFor(x => x.PlantAddress3)
            .MaximumLength(200).WithMessage("工厂地址3长度不能超过200个字符");
