...
{
    /// <summary>租户编码（与 TenantContext:TenantHeaderName 默认一致）</summary>
    public const string TenantCode = "X-Tenant-Code";

    /// <summary>公司编码（与 TenantContext:CompanyHeaderName 默认一致）</summary>
    public const string CompanyCode = "X-Company-Code";

    /// <summary>显式 User-Agent（代理/WebSocket 场景下 User-Agent 为空时的回退）</summary>
    public const string ClientUserAgent = "X-Takt-User-Agent";

    /// <summary>显式浏览器（TaktConstants.BrowserType）</summary>
    public const string ClientBrowser = "X-Takt-Client-Browser";

    /// <summary>显式操作系统（TaktConstants.OperatingSystem）</summary>
    public const string ClientOperatingSystem = "X-Takt-Client-Os";

    /// <summary>显式登录设备（TaktConstants.DeviceType）</summary>
