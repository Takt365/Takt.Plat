...
public static class TaktConstants
{
    ...
    /// <summary>Quartz 触发器类型（对齐 TaktQuartzSchedulerManager：0=Simple 1=Cron）</summary>
    public static class QuartzTriggerType
    {
        /// <summary>Simple 间隔触发</summary>
        public const int Simple = 0;
        /// <summary>Cron 表达式触发</summary>
        ...
        /// <summary>是否为允许的触发器类型</summary>
        /// <param name="value">待校验值</param>
        /// <returns>是否允许</returns>
        public static bool IsValid(int value) => Allowed.Contains(value);
    }

    /// <summary>Quartz Misfire 策略（对齐 TaktQuartzSchedulerManager：0=默认 1=忽略 2=立即触发 3=不触发）</summary>
    public static class QuartzMisfirePolicy
    {
        /// <summary>默认策略</summary>
        public const int Default = 0;
        /// <summary>忽略 Misfire</summary>
        ...
        /// <summary>是否为允许的 Misfire 策略</summary>
        /// <param name="value">待校验值</param>
        /// <returns>是否允许</returns>
        public static bool IsValid(int value) => Allowed.Contains(value);
    }
    ...
    /// <summary>审计日志操作人登录名（无法解析时落库值）</summary>
    public static class AuditUserName
    {
        /// <summary>未知操作人</summary>
        public const string Unknown = "unknown";
    }

    /// <summary>无登录上下文时的审计操作人 ID（与种子 admin 工号 900001、菜单种子 CreatedBy 一致）</summary>
    public static class SystemAuditUser
    {
        /// <summary>系统默认审计用户 ID</summary>
