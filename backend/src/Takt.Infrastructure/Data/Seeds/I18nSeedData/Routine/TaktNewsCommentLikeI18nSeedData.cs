...
public class TaktNewsCommentLikeI18nSeedData : ITaktSeedDataCoordinator
{
    ...
    private static List<TranslationSeedItem> GetNewsCommentLikeTranslations()
    {
        return new List<TranslationSeedItem>
        {
            ...
            // entity.newsCommentLike._self
            new TranslationSeedItem("entity.newsCommentLike._self", "ja-JP", "新闻评论点赞记录信息", "实体名称"),
            // entity.newsCommentLike._self
            new TranslationSeedItem("entity.newsCommentLike._self", "zh-CN", "新闻评论点赞记录信息", "实体名称"),
            // entity.newsCommentLike._self
            new TranslationSeedItem("entity.newsCommentLike._self", "zh-HK", "新闻评论点赞记录信息", "实体名称"),
