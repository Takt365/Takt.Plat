...
public class TaktTicketChangeLogI18nSeedData : ITaktSeedDataCoordinator
{
    ...
    private static List<TranslationSeedItem> GetTicketChangeLogTranslations()
    {
        return new List<TranslationSeedItem>
        {
            ...
            new TranslationSeedItem("entity.ticketChangeLog.ticketno", "en-US", "工单编号", "工单编号（冗余）"),
            // entity.ticketChangeLog.ticketno
            new TranslationSeedItem("entity.ticketChangeLog.ticketno", "ja-JP", "工单编号", "工单编号（冗余）"),
            // entity.ticketChangeLog.ticketno
            new TranslationSeedItem("entity.ticketChangeLog.ticketno", "zh-CN", "工单编号", "工单编号（冗余）"),
            // entity.ticketChangeLog.ticketno
            new TranslationSeedItem("entity.ticketChangeLog.ticketno", "zh-HK", "工单编号", "工单编号（冗余）"),

            // entity.ticketChangeLog.changetype
            new TranslationSeedItem("entity.ticketChangeLog.changetype", "en-US", "变更类型", "变更类型"),
            // entity.ticketChangeLog.changetype
            new TranslationSeedItem("entity.ticketChangeLog.changetype", "ja-JP", "变更类型", "变更类型"),
            // entity.ticketChangeLog.changetype
            new TranslationSeedItem("entity.ticketChangeLog.changetype", "zh-CN", "变更类型", "变更类型"),
            // entity.ticketChangeLog.changetype
            new TranslationSeedItem("entity.ticketChangeLog.changetype", "zh-HK", "变更类型", "变更类型"),
            ...
            new TranslationSeedItem("entity.ticketChangeLog.changereason", "en-US", "变更原因", "变更原因"),
            // entity.ticketChangeLog.changereason
            new TranslationSeedItem("entity.ticketChangeLog.changereason", "ja-JP", "变更原因", "变更原因"),
            // entity.ticketChangeLog.changereason
            new TranslationSeedItem("entity.ticketChangeLog.changereason", "zh-CN", "变更原因", "变更原因"),
            // entity.ticketChangeLog.changereason
            new TranslationSeedItem("entity.ticketChangeLog.changereason", "zh-HK", "变更原因", "变更原因"),
        };
    }
