...
public class TaktNewsCommentI18nSeedData : ITaktSeedDataCoordinator
{
    ...
    private static List<TranslationSeedItem> GetNewsCommentTranslations()
    {
        return new List<TranslationSeedItem>
        {
            ...
            // entity.newsComment._self
            new TranslationSeedItem("entity.newsComment._self", "ja-JP", "新闻评论信息", "实体名称"),
            // entity.newsComment._self
            new TranslationSeedItem("entity.newsComment._self", "zh-CN", "新闻评论信息", "实体名称"),
            // entity.newsComment._self
            new TranslationSeedItem("entity.newsComment._self", "zh-HK", "新闻评论信息", "实体名称"),
            ...
            new TranslationSeedItem("entity.newsComment.replycount", "en-US", "回复次数", "回复次数"),
            // entity.newsComment.replycount
            new TranslationSeedItem("entity.newsComment.replycount", "ja-JP", "回复次数", "回复次数"),
            // entity.newsComment.replycount
            new TranslationSeedItem("entity.newsComment.replycount", "zh-CN", "回复次数", "回复次数"),
            // entity.newsComment.replycount
            new TranslationSeedItem("entity.newsComment.replycount", "zh-HK", "回复次数", "回复次数"),
