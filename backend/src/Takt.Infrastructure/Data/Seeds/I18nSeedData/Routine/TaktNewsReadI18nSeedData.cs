...
public class TaktNewsReadI18nSeedData : ITaktSeedDataCoordinator
{
    ...
    private static List<TranslationSeedItem> GetNewsReadTranslations()
    {
        return new List<TranslationSeedItem>
        {
            ...
            // entity.newsRead._self
            new TranslationSeedItem("entity.newsRead._self", "ja-JP", "新闻阅读记录信息", "实体名称"),
            // entity.newsRead._self
            new TranslationSeedItem("entity.newsRead._self", "zh-CN", "新闻阅读记录信息", "实体名称"),
            // entity.newsRead._self
            new TranslationSeedItem("entity.newsRead._self", "zh-HK", "新闻阅读记录信息", "实体名称"),
