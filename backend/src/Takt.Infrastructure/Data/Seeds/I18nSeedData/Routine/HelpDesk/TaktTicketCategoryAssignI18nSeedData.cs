...
public class TaktTicketCategoryAssignI18nSeedData : ITaktSeedDataCoordinator
{
    ...
    private static List<TranslationSeedItem> GetTicketCategoryAssignTranslations()
    {
        return new List<TranslationSeedItem>
        {
            ...
            new TranslationSeedItem("entity.ticketcategoryassign.assigneeid", "en-US", "默认处理人ID_us", "默认处理人 ID（关联 TaktUser.Id，选项 TaktUsers/options）"),
            // entity.ticketcategoryassign.assigneeid
            new TranslationSeedItem("entity.ticketcategoryassign.assigneeid", "ja-JP", "默认处理人ID_jp", "默认处理人 ID（关联 TaktUser.Id，选项 TaktUsers/options）"),
            // entity.ticketcategoryassign.assigneeid
            new TranslationSeedItem("entity.ticketcategoryassign.assigneeid", "zh-CN", "默认处理人ID", "默认处理人 ID（关联 TaktUser.Id，选项 TaktUsers/options）"),
            // entity.ticketcategoryassign.assigneeid
            new TranslationSeedItem("entity.ticketcategoryassign.assigneeid", "zh-HK", "默认处理人ID_hk", "默认处理人 ID（关联 TaktUser.Id，选项 TaktUsers/options）"),
