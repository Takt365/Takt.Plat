...
public class TaktNewsLikeI18nSeedData : ITaktSeedDataCoordinator
{
    ...
    private static List<TranslationSeedItem> GetNewsLikeTranslations()
    {
        return new List<TranslationSeedItem>
        {
            ...
            new TranslationSeedItem("entity.newslike.newsid", "en-US", "新闻ID_us", "新闻 ID（关联 TaktNews.Id，选项 TaktNews/options）"),
            // entity.newslike.newsid
            new TranslationSeedItem("entity.newslike.newsid", "ja-JP", "新闻ID_jp", "新闻 ID（关联 TaktNews.Id，选项 TaktNews/options）"),
            // entity.newslike.newsid
            new TranslationSeedItem("entity.newslike.newsid", "zh-CN", "新闻ID", "新闻 ID（关联 TaktNews.Id，选项 TaktNews/options）"),
            // entity.newslike.newsid
            new TranslationSeedItem("entity.newslike.newsid", "zh-HK", "新闻ID_hk", "新闻 ID（关联 TaktNews.Id，选项 TaktNews/options）"),

            // entity.newslike.userid
            new TranslationSeedItem("entity.newslike.userid", "en-US", "用户ID_us", "用户 ID（关联 TaktUser.Id，选项 TaktUsers/options）"),
            // entity.newslike.userid
            new TranslationSeedItem("entity.newslike.userid", "ja-JP", "用户ID_jp", "用户 ID（关联 TaktUser.Id，选项 TaktUsers/options）"),
            // entity.newslike.userid
            new TranslationSeedItem("entity.newslike.userid", "zh-CN", "用户ID", "用户 ID（关联 TaktUser.Id，选项 TaktUsers/options）"),
            // entity.newslike.userid
            new TranslationSeedItem("entity.newslike.userid", "zh-HK", "用户ID_hk", "用户 ID（关联 TaktUser.Id，选项 TaktUsers/options）"),
