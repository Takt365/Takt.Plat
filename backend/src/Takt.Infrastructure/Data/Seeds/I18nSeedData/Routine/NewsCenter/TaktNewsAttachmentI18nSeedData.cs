...
public class TaktNewsAttachmentI18nSeedData : ITaktSeedDataCoordinator
{
    ...
    private static List<TranslationSeedItem> GetNewsAttachmentTranslations()
    {
        return new List<TranslationSeedItem>
        {
            ...
            new TranslationSeedItem("entity.newsattachment.newsid", "en-US", "新闻ID_us", "新闻 ID（选项 TaktNews/options；DictValue=Id）"),
            // entity.newsattachment.newsid
            new TranslationSeedItem("entity.newsattachment.newsid", "ja-JP", "新闻ID_jp", "新闻 ID（选项 TaktNews/options；DictValue=Id）"),
            // entity.newsattachment.newsid
            new TranslationSeedItem("entity.newsattachment.newsid", "zh-CN", "新闻ID", "新闻 ID（选项 TaktNews/options；DictValue=Id）"),
            // entity.newsattachment.newsid
            new TranslationSeedItem("entity.newsattachment.newsid", "zh-HK", "新闻ID_hk", "新闻 ID（选项 TaktNews/options；DictValue=Id）"),

            // entity.newsattachment.fileid
            new TranslationSeedItem("entity.newsattachment.fileid", "en-US", "文件ID_us", "文件 ID（选项 TaktFiles/options；DictValue=Id）"),
            // entity.newsattachment.fileid
            new TranslationSeedItem("entity.newsattachment.fileid", "ja-JP", "文件ID_jp", "文件 ID（选项 TaktFiles/options；DictValue=Id）"),
            // entity.newsattachment.fileid
            new TranslationSeedItem("entity.newsattachment.fileid", "zh-CN", "文件ID", "文件 ID（选项 TaktFiles/options；DictValue=Id）"),
            // entity.newsattachment.fileid
            new TranslationSeedItem("entity.newsattachment.fileid", "zh-HK", "文件ID_hk", "文件 ID（选项 TaktFiles/options；DictValue=Id）"),
