...
public class TaktKnowledgeChangeLogI18nSeedData : ITaktSeedDataCoordinator
{
    ...
    /// I18nKey：entity.knowledgeChangeLog._self / entity.knowledgeChangeLog.{{field}}；ResourceGroup=TaktModule.Routine；ResourceType=TaktAppSide.Frontend
    /// </summary>
    private static List<TranslationSeedItem> GetKnowledgeChangeLogTranslations()
    {
        return new List<TranslationSeedItem>
        {
            ...
            new TranslationSeedItem("entity.knowledgeChangeLog.changetype", "en-US", "变更类型", "变更类型"),
            // entity.knowledgeChangeLog.changetype
            new TranslationSeedItem("entity.knowledgeChangeLog.changetype", "ja-JP", "变更类型", "变更类型"),
            // entity.knowledgeChangeLog.changetype
            new TranslationSeedItem("entity.knowledgeChangeLog.changetype", "zh-CN", "变更类型", "变更类型"),
            // entity.knowledgeChangeLog.changetype
            new TranslationSeedItem("entity.knowledgeChangeLog.changetype", "zh-HK", "变更类型", "变更类型"),
            ...
            new TranslationSeedItem("entity.knowledgeChangeLog.changereason", "en-US", "变更原因", "变更原因"),
            // entity.knowledgeChangeLog.changereason
            new TranslationSeedItem("entity.knowledgeChangeLog.changereason", "ja-JP", "变更原因", "变更原因"),
            // entity.knowledgeChangeLog.changereason
            new TranslationSeedItem("entity.knowledgeChangeLog.changereason", "zh-CN", "变更原因", "变更原因"),
            // entity.knowledgeChangeLog.changereason
            new TranslationSeedItem("entity.knowledgeChangeLog.changereason", "zh-HK", "变更原因", "变更原因"),
