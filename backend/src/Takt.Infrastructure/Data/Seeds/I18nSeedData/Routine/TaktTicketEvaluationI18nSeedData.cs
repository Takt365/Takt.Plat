...
public class TaktTicketEvaluationI18nSeedData : ITaktSeedDataCoordinator
{
    ...
    private static List<TranslationSeedItem> GetTicketEvaluationTranslations()
    {
        return new List<TranslationSeedItem>
        {
            ...
            new TranslationSeedItem("entity.ticketEvaluation.score", "en-US", "综合评分", "综合评分（1-5 星或 1-10 分）"),
            // entity.ticketEvaluation.score
            new TranslationSeedItem("entity.ticketEvaluation.score", "ja-JP", "综合评分", "综合评分（1-5 星或 1-10 分）"),
            // entity.ticketEvaluation.score
            new TranslationSeedItem("entity.ticketEvaluation.score", "zh-CN", "综合评分", "综合评分（1-5 星或 1-10 分）"),
            // entity.ticketEvaluation.score
            new TranslationSeedItem("entity.ticketEvaluation.score", "zh-HK", "综合评分", "综合评分（1-5 星或 1-10 分）"),
