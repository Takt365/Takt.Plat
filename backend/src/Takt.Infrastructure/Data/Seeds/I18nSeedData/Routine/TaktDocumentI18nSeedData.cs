...
public class TaktDocumentI18nSeedData : ITaktSeedDataCoordinator
{
    ...
    /// I18nKey：entity.document._self / entity.document.{{field}}；ResourceGroup=TaktModule.Routine；ResourceType=TaktAppSide.Frontend
    /// </summary>
    private static List<TranslationSeedItem> GetDocumentTranslations()
    {
        return new List<TranslationSeedItem>
        {
            ...
            new TranslationSeedItem("entity.document.summary", "en-US", "文档摘要", "文档摘要"),
            // entity.document.summary
            new TranslationSeedItem("entity.document.summary", "ja-JP", "文档摘要", "文档摘要"),
            // entity.document.summary
            new TranslationSeedItem("entity.document.summary", "zh-CN", "文档摘要", "文档摘要"),
            // entity.document.summary
            new TranslationSeedItem("entity.document.summary", "zh-HK", "文档摘要", "文档摘要"),
            ...
            new TranslationSeedItem("entity.document.versions", "en-US", "versions", "版本历史列表"),
            // entity.document.versions
            new TranslationSeedItem("entity.document.versions", "ja-JP", "versions", "版本历史列表"),
            // entity.document.versions
            new TranslationSeedItem("entity.document.versions", "zh-CN", "versions", "版本历史列表"),
            // entity.document.versions
            new TranslationSeedItem("entity.document.versions", "zh-HK", "versions", "版本历史列表"),
        };
    }
