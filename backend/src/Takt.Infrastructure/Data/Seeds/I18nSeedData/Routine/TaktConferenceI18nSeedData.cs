...
public class TaktConferenceI18nSeedData : ITaktSeedDataCoordinator
{
    ...
    private static List<TranslationSeedItem> GetConferenceTranslations()
    {
        return new List<TranslationSeedItem>
        {
            ...
            new TranslationSeedItem("entity.conference.summary", "en-US", "会议纪要摘要", "会议纪要摘要"),
            // entity.conference.summary
            new TranslationSeedItem("entity.conference.summary", "ja-JP", "会议纪要摘要", "会议纪要摘要"),
            // entity.conference.summary
            new TranslationSeedItem("entity.conference.summary", "zh-CN", "会议纪要摘要", "会议纪要摘要"),
            // entity.conference.summary
            new TranslationSeedItem("entity.conference.summary", "zh-HK", "会议纪要摘要", "会议纪要摘要"),
            ...
            new TranslationSeedItem("entity.conference.participants", "en-US", "participants", "参与人列表"),
            // entity.conference.participants
            new TranslationSeedItem("entity.conference.participants", "ja-JP", "participants", "参与人列表"),
            // entity.conference.participants
            new TranslationSeedItem("entity.conference.participants", "zh-CN", "participants", "参与人列表"),
            // entity.conference.participants
            new TranslationSeedItem("entity.conference.participants", "zh-HK", "participants", "参与人列表"),
        };
    }
