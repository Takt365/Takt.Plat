...
public class TaktLeaveI18nSeedData : ITaktSeedDataCoordinator
{
    ...
    private static List<TranslationSeedItem> GetLeaveTranslations()
    {
        return new List<TranslationSeedItem>
        {
            ...
            new TranslationSeedItem("entity.leave.employeeid", "en-US", "员工ID_us", "员工（关联 TaktEmployee.Id，选项 TaktEmployees/options）"),
            // entity.leave.employeeid
            new TranslationSeedItem("entity.leave.employeeid", "ja-JP", "员工ID_jp", "员工（关联 TaktEmployee.Id，选项 TaktEmployees/options）"),
            // entity.leave.employeeid
            new TranslationSeedItem("entity.leave.employeeid", "zh-CN", "员工ID", "员工（关联 TaktEmployee.Id，选项 TaktEmployees/options）"),
            // entity.leave.employeeid
            new TranslationSeedItem("entity.leave.employeeid", "zh-HK", "员工ID_hk", "员工（关联 TaktEmployee.Id，选项 TaktEmployees/options）"),
            ...
            // entity.leave.type
            new TranslationSeedItem("entity.leave.type", "ja-JP", "请假类型_jp", "请假类型（字典 sys_leave_type；列存 DictValue）"),
            // entity.leave.type
            new TranslationSeedItem("entity.leave.type", "zh-CN", "请假类型", "请假类型（字典 sys_leave_type；列存 DictValue）"),
            // entity.leave.type
            new TranslationSeedItem("entity.leave.type", "zh-HK", "请假类型_hk", "请假类型（字典 sys_leave_type；列存 DictValue）"),
            ...
            // entity.leave.attachments
            new TranslationSeedItem("entity.leave.attachments", "en-US", "证明附件JSON_us", "证明附件（JSON 列表，由 TaktFile 统一上传）"),
            // entity.leave.attachments
            new TranslationSeedItem("entity.leave.attachments", "ja-JP", "证明附件JSON_jp", "证明附件（JSON 列表，由 TaktFile 统一上传）"),
            // entity.leave.attachments
            new TranslationSeedItem("entity.leave.attachments", "zh-CN", "证明附件JSON", "证明附件（JSON 列表，由 TaktFile 统一上传）"),
            // entity.leave.attachments
            new TranslationSeedItem("entity.leave.attachments", "zh-HK", "证明附件JSON_hk", "证明附件（JSON 列表，由 TaktFile 统一上传）"),

            // entity.leave.handlingby
            new TranslationSeedItem("entity.leave.handlingby", "en-US", "经办人_us", "经办人（关联 TaktEmployee.Id，选项 TaktEmployees/options）"),
            // entity.leave.handlingby
            new TranslationSeedItem("entity.leave.handlingby", "ja-JP", "经办人_jp", "经办人（关联 TaktEmployee.Id，选项 TaktEmployees/options）"),
            // entity.leave.handlingby
            new TranslationSeedItem("entity.leave.handlingby", "zh-CN", "经办人", "经办人（关联 TaktEmployee.Id，选项 TaktEmployees/options）"),
            // entity.leave.handlingby
            new TranslationSeedItem("entity.leave.handlingby", "zh-HK", "经办人_hk", "经办人（关联 TaktEmployee.Id，选项 TaktEmployees/options）"),
            ...
            new TranslationSeedItem("entity.leave.relatedplant", "en-US", "关联工厂_us", "关联工厂（关联 TaktPlant.PlantCode，选项 TaktPlants/options）"),
            // entity.leave.relatedplant
            new TranslationSeedItem("entity.leave.relatedplant", "ja-JP", "关联工厂_jp", "关联工厂（关联 TaktPlant.PlantCode，选项 TaktPlants/options）"),
            // entity.leave.relatedplant
            new TranslationSeedItem("entity.leave.relatedplant", "zh-CN", "关联工厂", "关联工厂（关联 TaktPlant.PlantCode，选项 TaktPlants/options）"),
            // entity.leave.relatedplant
            new TranslationSeedItem("entity.leave.relatedplant", "zh-HK", "关联工厂_hk", "关联工厂（关联 TaktPlant.PlantCode，选项 TaktPlants/options）"),
            ...
            // entity.leave.status
            new TranslationSeedItem("entity.leave.status", "ja-JP", "请假状态_jp", "请假状态（字典 sys_approval_status；0=待审批 1=审批中 2=已通过 3=已驳回 4=已撤回 5=已终止）"),
            // entity.leave.status
            new TranslationSeedItem("entity.leave.status", "zh-CN", "请假状态", "请假状态（字典 sys_approval_status；0=待审批 1=审批中 2=已通过 3=已驳回 4=已撤回 5=已终止）"),
            // entity.leave.status
            new TranslationSeedItem("entity.leave.status", "zh-HK", "请假状态_hk", "请假状态（字典 sys_approval_status；0=待审批 1=审批中 2=已通过 3=已驳回 4=已撤回 5=已终止）"),
        };
    }
