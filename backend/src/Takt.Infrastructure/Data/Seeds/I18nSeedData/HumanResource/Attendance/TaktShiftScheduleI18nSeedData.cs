...
public class TaktShiftScheduleI18nSeedData : ITaktSeedDataCoordinator
{
    ...
    private static List<TranslationSeedItem> GetShiftScheduleTranslations()
    {
        return new List<TranslationSeedItem>
        {
            ...
            new TranslationSeedItem("entity.shiftschedule.employeeid", "en-US", "员工ID_us", "员工（关联 TaktEmployee.Id，选项 TaktEmployees/options；ScheduleType=1 时必填）"),
            // entity.shiftschedule.employeeid
            new TranslationSeedItem("entity.shiftschedule.employeeid", "ja-JP", "员工ID_jp", "员工（关联 TaktEmployee.Id，选项 TaktEmployees/options；ScheduleType=1 时必填）"),
            // entity.shiftschedule.employeeid
            new TranslationSeedItem("entity.shiftschedule.employeeid", "zh-CN", "员工ID", "员工（关联 TaktEmployee.Id，选项 TaktEmployees/options；ScheduleType=1 时必填）"),
            // entity.shiftschedule.employeeid
            new TranslationSeedItem("entity.shiftschedule.employeeid", "zh-HK", "员工ID_hk", "员工（关联 TaktEmployee.Id，选项 TaktEmployees/options；ScheduleType=1 时必填）"),
            ...
            new TranslationSeedItem("entity.shiftschedule.shiftid", "en-US", "班次ID_us", "班次（关联 TaktWorkShift.Id，选项 TaktWorkShifts/options）"),
            // entity.shiftschedule.shiftid
            new TranslationSeedItem("entity.shiftschedule.shiftid", "ja-JP", "班次ID_jp", "班次（关联 TaktWorkShift.Id，选项 TaktWorkShifts/options）"),
            // entity.shiftschedule.shiftid
            new TranslationSeedItem("entity.shiftschedule.shiftid", "zh-CN", "班次ID", "班次（关联 TaktWorkShift.Id，选项 TaktWorkShifts/options）"),
            // entity.shiftschedule.shiftid
            new TranslationSeedItem("entity.shiftschedule.shiftid", "zh-HK", "班次ID_hk", "班次（关联 TaktWorkShift.Id，选项 TaktWorkShifts/options）"),

            // entity.shiftschedule.relatedplant
            new TranslationSeedItem("entity.shiftschedule.relatedplant", "en-US", "关联工厂_us", "关联工厂（关联 TaktPlant.PlantCode，选项 TaktPlants/options）"),
            // entity.shiftschedule.relatedplant
            new TranslationSeedItem("entity.shiftschedule.relatedplant", "ja-JP", "关联工厂_jp", "关联工厂（关联 TaktPlant.PlantCode，选项 TaktPlants/options）"),
            // entity.shiftschedule.relatedplant
            new TranslationSeedItem("entity.shiftschedule.relatedplant", "zh-CN", "关联工厂", "关联工厂（关联 TaktPlant.PlantCode，选项 TaktPlants/options）"),
            // entity.shiftschedule.relatedplant
            new TranslationSeedItem("entity.shiftschedule.relatedplant", "zh-HK", "关联工厂_hk", "关联工厂（关联 TaktPlant.PlantCode，选项 TaktPlants/options）"),
        };
    }
