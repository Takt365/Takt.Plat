...
public class TaktShiftScheduleI18nSeedData : ITaktSeedDataCoordinator
{
    ...
    private static List<TranslationSeedItem> GetShiftScheduleTranslations()
    {
        return new List<TranslationSeedItem>
        {
            ...
            new TranslationSeedItem("entity.shiftschedule.scheduletype", "en-US", "排班类别_us", "排班类别（0=部门 1=人员）"),
            // entity.shiftschedule.scheduletype
            new TranslationSeedItem("entity.shiftschedule.scheduletype", "ja-JP", "排班类别_jp", "排班类别（0=部门 1=人员）"),
            // entity.shiftschedule.scheduletype
            new TranslationSeedItem("entity.shiftschedule.scheduletype", "zh-CN", "排班类别", "排班类别（0=部门 1=人员）"),
            // entity.shiftschedule.scheduletype
            new TranslationSeedItem("entity.shiftschedule.scheduletype", "zh-HK", "排班类别_hk", "排班类别（0=部门 1=人员）"),

            // entity.shiftschedule.deptid
            new TranslationSeedItem("entity.shiftschedule.deptid", "en-US", "部门ID_us", "部门 ID（ScheduleType=0 时必填）"),
            // entity.shiftschedule.deptid
            new TranslationSeedItem("entity.shiftschedule.deptid", "ja-JP", "部门ID_jp", "部门 ID（ScheduleType=0 时必填）"),
            // entity.shiftschedule.deptid
            new TranslationSeedItem("entity.shiftschedule.deptid", "zh-CN", "部门ID", "部门 ID（ScheduleType=0 时必填）"),
            // entity.shiftschedule.deptid
            new TranslationSeedItem("entity.shiftschedule.deptid", "zh-HK", "部门ID_hk", "部门 ID（ScheduleType=0 时必填）"),

            // entity.shiftschedule.employeeid
            new TranslationSeedItem("entity.shiftschedule.employeeid", "en-US", "员工ID_us", "员工 ID（ScheduleType=1 时必填）"),
            // entity.shiftschedule.employeeid
            new TranslationSeedItem("entity.shiftschedule.employeeid", "ja-JP", "员工ID_jp", "员工 ID（ScheduleType=1 时必填）"),
            // entity.shiftschedule.employeeid
            new TranslationSeedItem("entity.shiftschedule.employeeid", "zh-CN", "员工ID", "员工 ID（ScheduleType=1 时必填）"),
            // entity.shiftschedule.employeeid
            new TranslationSeedItem("entity.shiftschedule.employeeid", "zh-HK", "员工ID_hk", "员工 ID（ScheduleType=1 时必填）"),
            ...
            new TranslationSeedItem("entity.shiftschedule.shiftid", "en-US", "班次ID_us", "班次 ID（TaktWorkShift）"),
            // entity.shiftschedule.shiftid
            new TranslationSeedItem("entity.shiftschedule.shiftid", "ja-JP", "班次ID_jp", "班次 ID（TaktWorkShift）"),
            // entity.shiftschedule.shiftid
            new TranslationSeedItem("entity.shiftschedule.shiftid", "zh-CN", "班次ID", "班次 ID（TaktWorkShift）"),
            // entity.shiftschedule.shiftid
            new TranslationSeedItem("entity.shiftschedule.shiftid", "zh-HK", "班次ID_hk", "班次 ID（TaktWorkShift）"),

            // entity.shiftschedule.relatedplant
            new TranslationSeedItem("entity.shiftschedule.relatedplant", "en-US", "关联工厂_us", "关联工厂"),
            // entity.shiftschedule.relatedplant
            new TranslationSeedItem("entity.shiftschedule.relatedplant", "ja-JP", "关联工厂_jp", "关联工厂"),
            // entity.shiftschedule.relatedplant
            new TranslationSeedItem("entity.shiftschedule.relatedplant", "zh-CN", "关联工厂", "关联工厂"),
            // entity.shiftschedule.relatedplant
            new TranslationSeedItem("entity.shiftschedule.relatedplant", "zh-HK", "关联工厂_hk", "关联工厂"),
        };
    }
