...
public class TaktCalendarI18nSeedData : ITaktSeedDataCoordinator
{
    ...
    private static List<TranslationSeedItem> GetCalendarTranslations()
    {
        return new List<TranslationSeedItem>
        {
            ...
            new TranslationSeedItem("entity.calendar.holidayid", "en-US", "关联假日ID_us", "关联假日（关联 TaktHoliday.Id，选项 TaktHolidays/options）"),
            // entity.calendar.holidayid
            new TranslationSeedItem("entity.calendar.holidayid", "ja-JP", "关联假日ID_jp", "关联假日（关联 TaktHoliday.Id，选项 TaktHolidays/options）"),
            // entity.calendar.holidayid
            new TranslationSeedItem("entity.calendar.holidayid", "zh-CN", "关联假日ID", "关联假日（关联 TaktHoliday.Id，选项 TaktHolidays/options）"),
            // entity.calendar.holidayid
            new TranslationSeedItem("entity.calendar.holidayid", "zh-HK", "关联假日ID_hk", "关联假日（关联 TaktHoliday.Id，选项 TaktHolidays/options）"),

            // entity.calendar.shiftid
            new TranslationSeedItem("entity.calendar.shiftid", "en-US", "关联班次ID_us", "关联班次（关联 TaktWorkShift.Id，选项 TaktWorkShifts/options）"),
            // entity.calendar.shiftid
            new TranslationSeedItem("entity.calendar.shiftid", "ja-JP", "关联班次ID_jp", "关联班次（关联 TaktWorkShift.Id，选项 TaktWorkShifts/options）"),
            // entity.calendar.shiftid
            new TranslationSeedItem("entity.calendar.shiftid", "zh-CN", "关联班次ID", "关联班次（关联 TaktWorkShift.Id，选项 TaktWorkShifts/options）"),
            // entity.calendar.shiftid
            new TranslationSeedItem("entity.calendar.shiftid", "zh-HK", "关联班次ID_hk", "关联班次（关联 TaktWorkShift.Id，选项 TaktWorkShifts/options）"),

            // entity.calendar.relatedplant
            new TranslationSeedItem("entity.calendar.relatedplant", "en-US", "关联工厂_us", "关联工厂（关联 TaktPlant.PlantCode，选项 TaktPlants/options）"),
            // entity.calendar.relatedplant
            new TranslationSeedItem("entity.calendar.relatedplant", "ja-JP", "关联工厂_jp", "关联工厂（关联 TaktPlant.PlantCode，选项 TaktPlants/options）"),
            // entity.calendar.relatedplant
            new TranslationSeedItem("entity.calendar.relatedplant", "zh-CN", "关联工厂", "关联工厂（关联 TaktPlant.PlantCode，选项 TaktPlants/options）"),
            // entity.calendar.relatedplant
            new TranslationSeedItem("entity.calendar.relatedplant", "zh-HK", "关联工厂_hk", "关联工厂（关联 TaktPlant.PlantCode，选项 TaktPlants/options）"),
        };
    }
