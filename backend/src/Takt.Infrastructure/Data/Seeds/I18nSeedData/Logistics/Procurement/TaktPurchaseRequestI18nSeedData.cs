...
public class TaktPurchaseRequestI18nSeedData : ITaktSeedDataCoordinator
{
    ...
    /// I18nKey：entity.purchaserequest._self / entity.purchaserequest.{{field}}；ResourceGroup=4；ResourceType=0
    /// </summary>
    private static List<TranslationSeedItem> GetPurchaseRequestTranslations()
    {
        return new List<TranslationSeedItem>
        {
            ...
            new TranslationSeedItem("entity.purchaserequest.changelogs", "en-US", "采购申请变更记录列表", "采购申请变更记录列表（外键在子表 TaktPurchaseRequestChangeLog.RequestId）"),
            // entity.purchaserequest.changelogs
            new TranslationSeedItem("entity.purchaserequest.changelogs", "ja-JP", "采购申请变更记录列表", "采购申请变更记录列表（外键在子表 TaktPurchaseRequestChangeLog.RequestId）"),
            // entity.purchaserequest.changelogs
            ...
            // entity.purchaserequest.changelogs
            new TranslationSeedItem("entity.purchaserequest.changelogs", "zh-HK", "采购申请变更记录列表", "采购申请变更记录列表（外键在子表 TaktPurchaseRequestChangeLog.RequestId）"),
        };
    }
