...
public class TaktStandardOperationRateI18nSeedData : ITaktSeedDataCoordinator
{
    ...
    private static List<TranslationSeedItem> GetStandardOperationRateTranslations()
    {
        return new List<TranslationSeedItem>
        {
            ...
            new TranslationSeedItem("entity.standardoperationrate.plantcode", "en-US", "工厂代码_us", "工厂代码（选项 TaktPlants/options，DictValue=Id）"),
            // entity.standardoperationrate.plantcode
            new TranslationSeedItem("entity.standardoperationrate.plantcode", "ja-JP", "工厂代码_jp", "工厂代码（选项 TaktPlants/options，DictValue=Id）"),
            // entity.standardoperationrate.plantcode
            new TranslationSeedItem("entity.standardoperationrate.plantcode", "zh-CN", "工厂代码", "工厂代码（选项 TaktPlants/options，DictValue=Id）"),
            // entity.standardoperationrate.plantcode
            new TranslationSeedItem("entity.standardoperationrate.plantcode", "zh-HK", "工厂代码_hk", "工厂代码（选项 TaktPlants/options，DictValue=Id）"),
            ...
            new TranslationSeedItem("entity.standardoperationrate.ratestatus", "en-US", "状态_us", "状态（字典 sys_normal_disable_status；0=禁用，1=启用）"),
            // entity.standardoperationrate.ratestatus
            new TranslationSeedItem("entity.standardoperationrate.ratestatus", "ja-JP", "状态_jp", "状态（字典 sys_normal_disable_status；0=禁用，1=启用）"),
            // entity.standardoperationrate.ratestatus
            new TranslationSeedItem("entity.standardoperationrate.ratestatus", "zh-CN", "状态", "状态（字典 sys_normal_disable_status；0=禁用，1=启用）"),
            // entity.standardoperationrate.ratestatus
            new TranslationSeedItem("entity.standardoperationrate.ratestatus", "zh-HK", "状态_hk", "状态（字典 sys_normal_disable_status；0=禁用，1=启用）"),
        };
    }
