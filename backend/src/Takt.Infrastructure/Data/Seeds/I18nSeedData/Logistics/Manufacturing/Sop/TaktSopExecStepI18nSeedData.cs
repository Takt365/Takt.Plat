...
public class TaktSopExecStepI18nSeedData : ITaktSeedDataCoordinator
{
    ...
    private static List<TranslationSeedItem> GetSopExecStepTranslations()
    {
        return new List<TranslationSeedItem>
        {
            ...
            new TranslationSeedItem("entity.sopexecstep.execid", "en-US", "执行追溯ID_us", "执行追溯 ID（序列化为 string 以避免 Javascript 精度问题）"),
            // entity.sopexecstep.execid
            new TranslationSeedItem("entity.sopexecstep.execid", "ja-JP", "执行追溯ID_jp", "执行追溯 ID（序列化为 string 以避免 Javascript 精度问题）"),
            // entity.sopexecstep.execid
            new TranslationSeedItem("entity.sopexecstep.execid", "zh-CN", "执行追溯ID", "执行追溯 ID（序列化为 string 以避免 Javascript 精度问题）"),
            // entity.sopexecstep.execid
            new TranslationSeedItem("entity.sopexecstep.execid", "zh-HK", "执行追溯ID_hk", "执行追溯 ID（序列化为 string 以避免 Javascript 精度问题）"),

            // entity.sopexecstep.stepid
            new TranslationSeedItem("entity.sopexecstep.stepid", "en-US", "工步ID_us", "工步 ID（序列化为 string 以避免 Javascript 精度问题）"),
            // entity.sopexecstep.stepid
            new TranslationSeedItem("entity.sopexecstep.stepid", "ja-JP", "工步ID_jp", "工步 ID（序列化为 string 以避免 Javascript 精度问题）"),
            // entity.sopexecstep.stepid
            new TranslationSeedItem("entity.sopexecstep.stepid", "zh-CN", "工步ID", "工步 ID（序列化为 string 以避免 Javascript 精度问题）"),
            // entity.sopexecstep.stepid
            new TranslationSeedItem("entity.sopexecstep.stepid", "zh-HK", "工步ID_hk", "工步 ID（序列化为 string 以避免 Javascript 精度问题）"),
            ...
            new TranslationSeedItem("entity.sopexecstep.stepresult", "en-US", "工步结果_us", "工步结果（1=合格，2=不合格，3=跳过；字典 logistics_sop_check_result_type）"),
            // entity.sopexecstep.stepresult
            new TranslationSeedItem("entity.sopexecstep.stepresult", "ja-JP", "工步结果_jp", "工步结果（1=合格，2=不合格，3=跳过；字典 logistics_sop_check_result_type）"),
            // entity.sopexecstep.stepresult
            new TranslationSeedItem("entity.sopexecstep.stepresult", "zh-CN", "工步结果", "工步结果（1=合格，2=不合格，3=跳过；字典 logistics_sop_check_result_type）"),
            // entity.sopexecstep.stepresult
            new TranslationSeedItem("entity.sopexecstep.stepresult", "zh-HK", "工步结果_hk", "工步结果（1=合格，2=不合格，3=跳过；字典 logistics_sop_check_result_type）"),

            // entity.sopexecstep.confirmedby
            new TranslationSeedItem("entity.sopexecstep.confirmedby", "en-US", "确认人ID_us", "确认人 ID（序列化为 string 以避免 Javascript 精度问题）"),
            // entity.sopexecstep.confirmedby
            new TranslationSeedItem("entity.sopexecstep.confirmedby", "ja-JP", "确认人ID_jp", "确认人 ID（序列化为 string 以避免 Javascript 精度问题）"),
            // entity.sopexecstep.confirmedby
            new TranslationSeedItem("entity.sopexecstep.confirmedby", "zh-CN", "确认人ID", "确认人 ID（序列化为 string 以避免 Javascript 精度问题）"),
            // entity.sopexecstep.confirmedby
            new TranslationSeedItem("entity.sopexecstep.confirmedby", "zh-HK", "确认人ID_hk", "确认人 ID（序列化为 string 以避免 Javascript 精度问题）"),
            ...
            new TranslationSeedItem("entity.sopexecstep.blocknextstep", "en-US", "是否禁止下一步_us", "是否禁止下一步（字典 sys_yes_no_type，扫码 NG 等）"),
            // entity.sopexecstep.blocknextstep
            new TranslationSeedItem("entity.sopexecstep.blocknextstep", "ja-JP", "是否禁止下一步_jp", "是否禁止下一步（字典 sys_yes_no_type，扫码 NG 等）"),
            // entity.sopexecstep.blocknextstep
            new TranslationSeedItem("entity.sopexecstep.blocknextstep", "zh-CN", "是否禁止下一步", "是否禁止下一步（字典 sys_yes_no_type，扫码 NG 等）"),
            // entity.sopexecstep.blocknextstep
            new TranslationSeedItem("entity.sopexecstep.blocknextstep", "zh-HK", "是否禁止下一步_hk", "是否禁止下一步（字典 sys_yes_no_type，扫码 NG 等）"),
