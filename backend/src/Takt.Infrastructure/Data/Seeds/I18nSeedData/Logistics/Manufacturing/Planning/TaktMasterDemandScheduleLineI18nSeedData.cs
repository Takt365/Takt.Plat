...
public class TaktMasterDemandScheduleLineI18nSeedData : ITaktSeedDataCoordinator
{
    ...
    /// I18nKey：entity.masterdemandscheduleline._self / entity.masterdemandscheduleline.{{field}}；ResourceGroup=Planning；ResourceType=frontend
    /// </summary>
    private static List<TranslationSeedItem> GetMasterDemandScheduleLineTranslations()
    {
        return new List<TranslationSeedItem>
        {
            ...
            // entity.masterdemandscheduleline.salesplanid
            new TranslationSeedItem("entity.masterdemandscheduleline.salesplanid", "en-US", "来源销售计划ID_us", "来源销售计划 ID（可选；预测/计划类需求）"),
            // entity.masterdemandscheduleline.salesplanid
            new TranslationSeedItem("entity.masterdemandscheduleline.salesplanid", "ja-JP", "来源销售计划ID_jp", "来源销售计划 ID（可选；预测/计划类需求）"),
            // entity.masterdemandscheduleline.salesplanid
            new TranslationSeedItem("entity.masterdemandscheduleline.salesplanid", "zh-CN", "来源销售计划ID", "来源销售计划 ID（可选；预测/计划类需求）"),
            // entity.masterdemandscheduleline.salesplanid
            new TranslationSeedItem("entity.masterdemandscheduleline.salesplanid", "zh-HK", "来源销售计划ID_hk", "来源销售计划 ID（可选；预测/计划类需求）"),

            // entity.masterdemandscheduleline.salesplanlinenumber
            new TranslationSeedItem("entity.masterdemandscheduleline.salesplanlinenumber", "en-US", "来源销售计划行号_us", "来源销售计划行号（可选；与 SalesPlanId 成对）"),
            // entity.masterdemandscheduleline.salesplanlinenumber
            new TranslationSeedItem("entity.masterdemandscheduleline.salesplanlinenumber", "ja-JP", "来源销售计划行号_jp", "来源销售计划行号（可选；与 SalesPlanId 成对）"),
            // entity.masterdemandscheduleline.salesplanlinenumber
            new TranslationSeedItem("entity.masterdemandscheduleline.salesplanlinenumber", "zh-CN", "来源销售计划行号", "来源销售计划行号（可选；与 SalesPlanId 成对）"),
            // entity.masterdemandscheduleline.salesplanlinenumber
            new TranslationSeedItem("entity.masterdemandscheduleline.salesplanlinenumber", "zh-HK", "来源销售计划行号_hk", "来源销售计划行号（可选；与 SalesPlanId 成对）"),

            // entity.masterdemandscheduleline.materialcode
            new TranslationSeedItem("entity.masterdemandscheduleline.materialcode", "en-US", "物料编码_us", "物料编码"),
            // entity.masterdemandscheduleline.materialcode
            new TranslationSeedItem("entity.masterdemandscheduleline.materialcode", "ja-JP", "物料编码_jp", "物料编码"),
            // entity.masterdemandscheduleline.materialcode
            new TranslationSeedItem("entity.masterdemandscheduleline.materialcode", "zh-CN", "物料编码", "物料编码"),
            // entity.masterdemandscheduleline.materialcode
            new TranslationSeedItem("entity.masterdemandscheduleline.materialcode", "zh-HK", "物料编码_hk", "物料编码"),
            ...
            new TranslationSeedItem("entity.masterdemandscheduleline.unitofmeasure", "en-US", "计量单位_us", "计量单位"),
            // entity.masterdemandscheduleline.unitofmeasure
            new TranslationSeedItem("entity.masterdemandscheduleline.unitofmeasure", "ja-JP", "计量单位_jp", "计量单位"),
            // entity.masterdemandscheduleline.unitofmeasure
            new TranslationSeedItem("entity.masterdemandscheduleline.unitofmeasure", "zh-CN", "计量单位", "计量单位"),
            // entity.masterdemandscheduleline.unitofmeasure
            new TranslationSeedItem("entity.masterdemandscheduleline.unitofmeasure", "zh-HK", "计量单位_hk", "计量单位"),
        };
    }
