...
public class TaktAssyDefectDetailI18nSeedData : ITaktSeedDataCoordinator
{
    ...
    private static List<TranslationSeedItem> GetAssyDefectDetailTranslations()
    {
        return new List<TranslationSeedItem>
        {
            ...
            new TranslationSeedItem("entity.assydefectdetail.defectcategory", "en-US", "不良区分_us", "不良区分"),
            // entity.assydefectdetail.defectcategory
            new TranslationSeedItem("entity.assydefectdetail.defectcategory", "ja-JP", "不良区分_jp", "不良区分"),
            // entity.assydefectdetail.defectcategory
            new TranslationSeedItem("entity.assydefectdetail.defectcategory", "zh-CN", "不良区分", "不良区分"),
            // entity.assydefectdetail.defectcategory
            new TranslationSeedItem("entity.assydefectdetail.defectcategory", "zh-HK", "不良区分_hk", "不良区分"),
            ...
            new TranslationSeedItem("entity.assydefectdetail.defectlocation", "en-US", "不良个所_us", "不良个所"),
            // entity.assydefectdetail.defectlocation
            new TranslationSeedItem("entity.assydefectdetail.defectlocation", "ja-JP", "不良个所_jp", "不良个所"),
            // entity.assydefectdetail.defectlocation
            new TranslationSeedItem("entity.assydefectdetail.defectlocation", "zh-CN", "不良个所", "不良个所"),
            // entity.assydefectdetail.defectlocation
            new TranslationSeedItem("entity.assydefectdetail.defectlocation", "zh-HK", "不良个所_hk", "不良个所"),
            ...
            new TranslationSeedItem("entity.assydefectdetail.repairoperator", "en-US", "修理员_us", "修理员"),
            // entity.assydefectdetail.repairoperator
            new TranslationSeedItem("entity.assydefectdetail.repairoperator", "ja-JP", "修理员_jp", "修理员"),
            // entity.assydefectdetail.repairoperator
            new TranslationSeedItem("entity.assydefectdetail.repairoperator", "zh-CN", "修理员", "修理员"),
            // entity.assydefectdetail.repairoperator
            new TranslationSeedItem("entity.assydefectdetail.repairoperator", "zh-HK", "修理员_hk", "修理员"),
