...
public class TaktMasterDemandScheduleI18nSeedData : ITaktSeedDataCoordinator
{
    ...
    /// I18nKey：entity.masterdemandschedule._self / entity.masterdemandschedule.{{field}}；ResourceGroup=Planning；ResourceType=frontend
    /// </summary>
    private static List<TranslationSeedItem> GetMasterDemandScheduleTranslations()
    {
        return new List<TranslationSeedItem>
        {
            ...
            // entity.masterdemandschedule.plantcode
            new TranslationSeedItem("entity.masterdemandschedule.plantcode", "en-US", "工厂代码_us", "工厂代码（关联 TaktPlant.PlantCode）"),
            // entity.masterdemandschedule.plantcode
            new TranslationSeedItem("entity.masterdemandschedule.plantcode", "ja-JP", "工厂代码_jp", "工厂代码（关联 TaktPlant.PlantCode）"),
            // entity.masterdemandschedule.plantcode
            new TranslationSeedItem("entity.masterdemandschedule.plantcode", "zh-CN", "工厂代码", "工厂代码（关联 TaktPlant.PlantCode）"),
            // entity.masterdemandschedule.plantcode
            new TranslationSeedItem("entity.masterdemandschedule.plantcode", "zh-HK", "工厂代码_hk", "工厂代码（关联 TaktPlant.PlantCode）"),
            ...
            new TranslationSeedItem("entity.masterdemandschedule.schedulestatus", "en-US", "计划状态_us", "计划状态（字典 sys_normal_disable_status；1=启用，0=禁用）"),
            // entity.masterdemandschedule.schedulestatus
            new TranslationSeedItem("entity.masterdemandschedule.schedulestatus", "ja-JP", "计划状态_jp", "计划状态（字典 sys_normal_disable_status；1=启用，0=禁用）"),
            // entity.masterdemandschedule.schedulestatus
            new TranslationSeedItem("entity.masterdemandschedule.schedulestatus", "zh-CN", "计划状态", "计划状态（字典 sys_normal_disable_status；1=启用，0=禁用）"),
            // entity.masterdemandschedule.schedulestatus
            new TranslationSeedItem("entity.masterdemandschedule.schedulestatus", "zh-HK", "计划状态_hk", "计划状态（字典 sys_normal_disable_status；1=启用，0=禁用）"),
