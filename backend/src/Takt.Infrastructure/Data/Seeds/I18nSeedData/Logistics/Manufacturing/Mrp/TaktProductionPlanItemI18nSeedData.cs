...
public class TaktProductionPlanItemI18nSeedData : ITaktSeedDataCoordinator
{
    ...
    private static List<TranslationSeedItem> GetProductionPlanItemTranslations()
    {
        return new List<TranslationSeedItem>
        {
            ...
            new TranslationSeedItem("entity.productionplanitem.materialname", "en-US", "物料名称_us", "物料名称（回填：随物料）"),
            // entity.productionplanitem.materialname
            new TranslationSeedItem("entity.productionplanitem.materialname", "ja-JP", "物料名称_jp", "物料名称（回填：随物料）"),
            // entity.productionplanitem.materialname
            new TranslationSeedItem("entity.productionplanitem.materialname", "zh-CN", "物料名称", "物料名称（回填：随物料）"),
            // entity.productionplanitem.materialname
            new TranslationSeedItem("entity.productionplanitem.materialname", "zh-HK", "物料名称_hk", "物料名称（回填：随物料）"),
