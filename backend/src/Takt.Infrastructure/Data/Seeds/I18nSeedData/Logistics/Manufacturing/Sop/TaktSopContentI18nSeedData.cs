...
public class TaktSopContentI18nSeedData : ITaktSeedDataCoordinator
{
    ...
    private static List<TranslationSeedItem> GetSopContentTranslations()
    {
        return new List<TranslationSeedItem>
        {
            ...
            new TranslationSeedItem("entity.sopcontent.revisionid", "en-US", "版本ID_us", "版本 ID（序列化为 string 以避免 Javascript 精度问题）"),
            // entity.sopcontent.revisionid
            new TranslationSeedItem("entity.sopcontent.revisionid", "ja-JP", "版本ID_jp", "版本 ID（序列化为 string 以避免 Javascript 精度问题）"),
            // entity.sopcontent.revisionid
            new TranslationSeedItem("entity.sopcontent.revisionid", "zh-CN", "版本ID", "版本 ID（序列化为 string 以避免 Javascript 精度问题）"),
            // entity.sopcontent.revisionid
            new TranslationSeedItem("entity.sopcontent.revisionid", "zh-HK", "版本ID_hk", "版本 ID（序列化为 string 以避免 Javascript 精度问题）"),

            // entity.sopcontent.sopid
            new TranslationSeedItem("entity.sopcontent.sopid", "en-US", "SOP主档ID_us", "SOP 主档 ID（冗余，序列化为 string 以避免 Javascript 精度问题）"),
            // entity.sopcontent.sopid
            new TranslationSeedItem("entity.sopcontent.sopid", "ja-JP", "SOP主档ID_jp", "SOP 主档 ID（冗余，序列化为 string 以避免 Javascript 精度问题）"),
            // entity.sopcontent.sopid
            new TranslationSeedItem("entity.sopcontent.sopid", "zh-CN", "SOP主档ID", "SOP 主档 ID（冗余，序列化为 string 以避免 Javascript 精度问题）"),
            // entity.sopcontent.sopid
            new TranslationSeedItem("entity.sopcontent.sopid", "zh-HK", "SOP主档ID_hk", "SOP 主档 ID（冗余，序列化为 string 以避免 Javascript 精度问题）"),

            // entity.sopcontent.contentlang
            new TranslationSeedItem("entity.sopcontent.contentlang", "en-US", "正文语言_us", "正文语言（zh-CN 简体 / en-US 英文 / ja-JP 日文 / zh-HK 香港繁体；与 TaktCulture.CultureCode 一致）"),
            // entity.sopcontent.contentlang
            new TranslationSeedItem("entity.sopcontent.contentlang", "ja-JP", "正文语言_jp", "正文语言（zh-CN 简体 / en-US 英文 / ja-JP 日文 / zh-HK 香港繁体；与 TaktCulture.CultureCode 一致）"),
            // entity.sopcontent.contentlang
            new TranslationSeedItem("entity.sopcontent.contentlang", "zh-CN", "正文语言", "正文语言（zh-CN 简体 / en-US 英文 / ja-JP 日文 / zh-HK 香港繁体；与 TaktCulture.CultureCode 一致）"),
            // entity.sopcontent.contentlang
            new TranslationSeedItem("entity.sopcontent.contentlang", "zh-HK", "正文语言_hk", "正文语言（zh-CN 简体 / en-US 英文 / ja-JP 日文 / zh-HK 香港繁体；与 TaktCulture.CultureCode 一致）"),
