...
public class TaktChangeoverMatrixI18nSeedData : ITaktSeedDataCoordinator
{
    ...
    private static List<TranslationSeedItem> GetChangeoverMatrixTranslations()
    {
        return new List<TranslationSeedItem>
        {
            ...
            new TranslationSeedItem("entity.changeovermatrix.plantcode", "en-US", "工厂代码_us", "工厂代码"),
            // entity.changeovermatrix.plantcode
            new TranslationSeedItem("entity.changeovermatrix.plantcode", "ja-JP", "工厂代码_jp", "工厂代码"),
            // entity.changeovermatrix.plantcode
            new TranslationSeedItem("entity.changeovermatrix.plantcode", "zh-CN", "工厂代码", "工厂代码"),
            // entity.changeovermatrix.plantcode
            new TranslationSeedItem("entity.changeovermatrix.plantcode", "zh-HK", "工厂代码_hk", "工厂代码"),

            // entity.changeovermatrix.workcentercode
            new TranslationSeedItem("entity.changeovermatrix.workcentercode", "en-US", "工作中心编码_us", "工作中心编码"),
            // entity.changeovermatrix.workcentercode
            new TranslationSeedItem("entity.changeovermatrix.workcentercode", "ja-JP", "工作中心编码_jp", "工作中心编码"),
            // entity.changeovermatrix.workcentercode
            new TranslationSeedItem("entity.changeovermatrix.workcentercode", "zh-CN", "工作中心编码", "工作中心编码"),
            // entity.changeovermatrix.workcentercode
            new TranslationSeedItem("entity.changeovermatrix.workcentercode", "zh-HK", "工作中心编码_hk", "工作中心编码"),

            // entity.changeovermatrix.frommaterialcode
            new TranslationSeedItem("entity.changeovermatrix.frommaterialcode", "en-US", "换型前物料编码_us", "换型前物料编码"),
            // entity.changeovermatrix.frommaterialcode
            new TranslationSeedItem("entity.changeovermatrix.frommaterialcode", "ja-JP", "换型前物料编码_jp", "换型前物料编码"),
            // entity.changeovermatrix.frommaterialcode
            new TranslationSeedItem("entity.changeovermatrix.frommaterialcode", "zh-CN", "换型前物料编码", "换型前物料编码"),
            // entity.changeovermatrix.frommaterialcode
            new TranslationSeedItem("entity.changeovermatrix.frommaterialcode", "zh-HK", "换型前物料编码_hk", "换型前物料编码"),

            // entity.changeovermatrix.tomaterialcode
            new TranslationSeedItem("entity.changeovermatrix.tomaterialcode", "en-US", "换型后物料编码_us", "换型后物料编码"),
            // entity.changeovermatrix.tomaterialcode
            new TranslationSeedItem("entity.changeovermatrix.tomaterialcode", "ja-JP", "换型后物料编码_jp", "换型后物料编码"),
            // entity.changeovermatrix.tomaterialcode
            new TranslationSeedItem("entity.changeovermatrix.tomaterialcode", "zh-CN", "换型后物料编码", "换型后物料编码"),
            // entity.changeovermatrix.tomaterialcode
            new TranslationSeedItem("entity.changeovermatrix.tomaterialcode", "zh-HK", "换型后物料编码_hk", "换型后物料编码"),
