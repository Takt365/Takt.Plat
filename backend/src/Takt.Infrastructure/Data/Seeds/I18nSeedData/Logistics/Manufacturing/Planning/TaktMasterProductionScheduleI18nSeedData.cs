...
public class TaktMasterProductionScheduleI18nSeedData : ITaktSeedDataCoordinator
{
    ...
    /// I18nKey：entity.masterproductionschedule._self / entity.masterproductionschedule.{{field}}；ResourceGroup=Planning；ResourceType=frontend
    /// </summary>
    private static List<TranslationSeedItem> GetMasterProductionScheduleTranslations()
    {
        return new List<TranslationSeedItem>
        {
            ...
            // entity.masterproductionschedule.plantcode
            new TranslationSeedItem("entity.masterproductionschedule.plantcode", "en-US", "工厂代码_us", "工厂代码"),
            // entity.masterproductionschedule.plantcode
            new TranslationSeedItem("entity.masterproductionschedule.plantcode", "ja-JP", "工厂代码_jp", "工厂代码"),
            // entity.masterproductionschedule.plantcode
            new TranslationSeedItem("entity.masterproductionschedule.plantcode", "zh-CN", "工厂代码", "工厂代码"),
            // entity.masterproductionschedule.plantcode
            new TranslationSeedItem("entity.masterproductionschedule.plantcode", "zh-HK", "工厂代码_hk", "工厂代码"),
            ...
            new TranslationSeedItem("entity.masterproductionschedule.masterdemandscheduleid", "en-US", "来源MDS头表ID_us", "来源 MDS 头表 ID（可选）"),
            // entity.masterproductionschedule.masterdemandscheduleid
            new TranslationSeedItem("entity.masterproductionschedule.masterdemandscheduleid", "ja-JP", "来源MDS头表ID_jp", "来源 MDS 头表 ID（可选）"),
            // entity.masterproductionschedule.masterdemandscheduleid
            new TranslationSeedItem("entity.masterproductionschedule.masterdemandscheduleid", "zh-CN", "来源MDS头表ID", "来源 MDS 头表 ID（可选）"),
            // entity.masterproductionschedule.masterdemandscheduleid
            new TranslationSeedItem("entity.masterproductionschedule.masterdemandscheduleid", "zh-HK", "来源MDS头表ID_hk", "来源 MDS 头表 ID（可选）"),
            ...
            new TranslationSeedItem("entity.masterproductionschedule.schedulestatus", "en-US", "计划状态_us", "计划状态（字典 sys_normal_disable_status；1=启用，0=禁用）"),
            // entity.masterproductionschedule.schedulestatus
            new TranslationSeedItem("entity.masterproductionschedule.schedulestatus", "ja-JP", "计划状态_jp", "计划状态（字典 sys_normal_disable_status；1=启用，0=禁用）"),
            // entity.masterproductionschedule.schedulestatus
            new TranslationSeedItem("entity.masterproductionschedule.schedulestatus", "zh-CN", "计划状态", "计划状态（字典 sys_normal_disable_status；1=启用，0=禁用）"),
            // entity.masterproductionschedule.schedulestatus
            new TranslationSeedItem("entity.masterproductionschedule.schedulestatus", "zh-HK", "计划状态_hk", "计划状态（字典 sys_normal_disable_status；1=启用，0=禁用）"),
