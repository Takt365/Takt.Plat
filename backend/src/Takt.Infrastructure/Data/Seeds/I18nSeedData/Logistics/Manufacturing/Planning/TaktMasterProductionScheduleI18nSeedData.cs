...
public class TaktMasterProductionScheduleI18nSeedData : ITaktSeedDataCoordinator
{
    ...
    private static List<TranslationSeedItem> GetMasterProductionScheduleTranslations()
    {
        return new List<TranslationSeedItem>
        {
            ...
            new TranslationSeedItem("entity.masterproductionschedule.plantcode", "en-US", "工厂代码_us", "工厂代码（选项 TaktPlants/options，DictValue=PlantCode）"),
            // entity.masterproductionschedule.plantcode
            new TranslationSeedItem("entity.masterproductionschedule.plantcode", "ja-JP", "工厂代码_jp", "工厂代码（选项 TaktPlants/options，DictValue=PlantCode）"),
            // entity.masterproductionschedule.plantcode
            new TranslationSeedItem("entity.masterproductionschedule.plantcode", "zh-CN", "工厂代码", "工厂代码（选项 TaktPlants/options，DictValue=PlantCode）"),
            // entity.masterproductionschedule.plantcode
            new TranslationSeedItem("entity.masterproductionschedule.plantcode", "zh-HK", "工厂代码_hk", "工厂代码（选项 TaktPlants/options，DictValue=PlantCode）"),
