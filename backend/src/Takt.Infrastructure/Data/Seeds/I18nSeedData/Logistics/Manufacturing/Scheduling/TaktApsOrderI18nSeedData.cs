...
public class TaktApsOrderI18nSeedData : ITaktSeedDataCoordinator
{
    ...
    private static List<TranslationSeedItem> GetApsOrderTranslations()
    {
        return new List<TranslationSeedItem>
        {
            ...
            new TranslationSeedItem("entity.apsorder.materialcode", "en-US", "物料编码_us", "物料编码（关联 TaktMaterial.MaterialCode，选项 TaktMaterials/options）"),
            // entity.apsorder.materialcode
            new TranslationSeedItem("entity.apsorder.materialcode", "ja-JP", "物料编码_jp", "物料编码（关联 TaktMaterial.MaterialCode，选项 TaktMaterials/options）"),
            // entity.apsorder.materialcode
            new TranslationSeedItem("entity.apsorder.materialcode", "zh-CN", "物料编码", "物料编码（关联 TaktMaterial.MaterialCode，选项 TaktMaterials/options）"),
            // entity.apsorder.materialcode
            new TranslationSeedItem("entity.apsorder.materialcode", "zh-HK", "物料编码_hk", "物料编码（关联 TaktMaterial.MaterialCode，选项 TaktMaterials/options）"),
            ...
            new TranslationSeedItem("entity.apsorder.routingcode", "en-US", "工艺路线编码_us", "工艺路线编码（关联 TaktRouting.RoutingCode，选项 TaktRoutings/options，DictValue=RoutingCode）"),
            // entity.apsorder.routingcode
            new TranslationSeedItem("entity.apsorder.routingcode", "ja-JP", "工艺路线编码_jp", "工艺路线编码（关联 TaktRouting.RoutingCode，选项 TaktRoutings/options，DictValue=RoutingCode）"),
            // entity.apsorder.routingcode
            new TranslationSeedItem("entity.apsorder.routingcode", "zh-CN", "工艺路线编码", "工艺路线编码（关联 TaktRouting.RoutingCode，选项 TaktRoutings/options，DictValue=RoutingCode）"),
            // entity.apsorder.routingcode
            new TranslationSeedItem("entity.apsorder.routingcode", "zh-HK", "工艺路线编码_hk", "工艺路线编码（关联 TaktRouting.RoutingCode，选项 TaktRoutings/options，DictValue=RoutingCode）"),
