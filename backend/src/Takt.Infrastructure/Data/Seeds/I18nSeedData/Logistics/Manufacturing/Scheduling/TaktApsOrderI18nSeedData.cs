...
public class TaktApsOrderI18nSeedData : ITaktSeedDataCoordinator
{
    ...
    /// I18nKey：entity.apsorder._self / entity.apsorder.{{field}}；ResourceGroup=Scheduling；ResourceType=frontend
    /// </summary>
    private static List<TranslationSeedItem> GetApsOrderTranslations()
    {
        return new List<TranslationSeedItem>
        {
            ...
            new TranslationSeedItem("entity.apsorder.plantcode", "en-US", "工厂代码_us", "工厂代码"),
            // entity.apsorder.plantcode
            new TranslationSeedItem("entity.apsorder.plantcode", "ja-JP", "工厂代码_jp", "工厂代码"),
            // entity.apsorder.plantcode
            new TranslationSeedItem("entity.apsorder.plantcode", "zh-CN", "工厂代码", "工厂代码"),
            // entity.apsorder.plantcode
            new TranslationSeedItem("entity.apsorder.plantcode", "zh-HK", "工厂代码_hk", "工厂代码"),
            ...
            new TranslationSeedItem("entity.apsorder.materialcode", "en-US", "物料编码_us", "物料编码"),
            // entity.apsorder.materialcode
            new TranslationSeedItem("entity.apsorder.materialcode", "ja-JP", "物料编码_jp", "物料编码"),
            // entity.apsorder.materialcode
            new TranslationSeedItem("entity.apsorder.materialcode", "zh-CN", "物料编码", "物料编码"),
            // entity.apsorder.materialcode
            new TranslationSeedItem("entity.apsorder.materialcode", "zh-HK", "物料编码_hk", "物料编码"),
            ...
            new TranslationSeedItem("entity.apsorder.unitofmeasure", "en-US", "计量单位_us", "计量单位"),
            // entity.apsorder.unitofmeasure
            new TranslationSeedItem("entity.apsorder.unitofmeasure", "ja-JP", "计量单位_jp", "计量单位"),
            // entity.apsorder.unitofmeasure
            new TranslationSeedItem("entity.apsorder.unitofmeasure", "zh-CN", "计量单位", "计量单位"),
            // entity.apsorder.unitofmeasure
            new TranslationSeedItem("entity.apsorder.unitofmeasure", "zh-HK", "计量单位_hk", "计量单位"),

            // entity.apsorder.routingcode
            new TranslationSeedItem("entity.apsorder.routingcode", "en-US", "工艺路线编码_us", "工艺路线编码"),
            // entity.apsorder.routingcode
            new TranslationSeedItem("entity.apsorder.routingcode", "ja-JP", "工艺路线编码_jp", "工艺路线编码"),
            // entity.apsorder.routingcode
            new TranslationSeedItem("entity.apsorder.routingcode", "zh-CN", "工艺路线编码", "工艺路线编码"),
            // entity.apsorder.routingcode
            new TranslationSeedItem("entity.apsorder.routingcode", "zh-HK", "工艺路线编码_hk", "工艺路线编码"),
