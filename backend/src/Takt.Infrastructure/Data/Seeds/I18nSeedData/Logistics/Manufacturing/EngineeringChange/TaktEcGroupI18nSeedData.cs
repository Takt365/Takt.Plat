...
public class TaktEcGroupI18nSeedData : ITaktSeedDataCoordinator
{
    ...
    private static List<TranslationSeedItem> GetEcGroupTranslations()
    {
        return new List<TranslationSeedItem>
        {
            ...
            // entity.ecgroup.plantcode
            new TranslationSeedItem("entity.ecgroup.plantcode", "en-US", "工厂代码_us", "工厂代码（选项 TaktPlants/options，DictValue=PlantCode）"),
            // entity.ecgroup.plantcode
            new TranslationSeedItem("entity.ecgroup.plantcode", "ja-JP", "工厂代码_jp", "工厂代码（选项 TaktPlants/options，DictValue=PlantCode）"),
            // entity.ecgroup.plantcode
            new TranslationSeedItem("entity.ecgroup.plantcode", "zh-CN", "工厂代码", "工厂代码（选项 TaktPlants/options，DictValue=PlantCode）"),
            // entity.ecgroup.plantcode
            new TranslationSeedItem("entity.ecgroup.plantcode", "zh-HK", "工厂代码_hk", "工厂代码（选项 TaktPlants/options，DictValue=PlantCode）"),
            ...
            // entity.ecgroup.responsibleuserid
            new TranslationSeedItem("entity.ecgroup.responsibleuserid", "en-US", "负责人用户ID_us", "设变组负责人用户 ID（关联 TaktUser.Id，选项 TaktUsers/options）"),
            // entity.ecgroup.responsibleuserid
            new TranslationSeedItem("entity.ecgroup.responsibleuserid", "ja-JP", "负责人用户ID_jp", "设变组负责人用户 ID（关联 TaktUser.Id，选项 TaktUsers/options）"),
            // entity.ecgroup.responsibleuserid
            new TranslationSeedItem("entity.ecgroup.responsibleuserid", "zh-CN", "负责人用户ID", "设变组负责人用户 ID（关联 TaktUser.Id，选项 TaktUsers/options）"),
            // entity.ecgroup.responsibleuserid
            new TranslationSeedItem("entity.ecgroup.responsibleuserid", "zh-HK", "负责人用户ID_hk", "设变组负责人用户 ID（关联 TaktUser.Id，选项 TaktUsers/options）"),
            ...
            new TranslationSeedItem("entity.ecgroup.isbuiltin", "en-US", "内置_us", "内置（字典 sys_yes_no_type；1=是，0=否；内置记录禁止删除）"),
            // entity.ecgroup.isbuiltin
            new TranslationSeedItem("entity.ecgroup.isbuiltin", "ja-JP", "内置_jp", "内置（字典 sys_yes_no_type；1=是，0=否；内置记录禁止删除）"),
            // entity.ecgroup.isbuiltin
            new TranslationSeedItem("entity.ecgroup.isbuiltin", "zh-CN", "内置", "内置（字典 sys_yes_no_type；1=是，0=否；内置记录禁止删除）"),
            // entity.ecgroup.isbuiltin
            new TranslationSeedItem("entity.ecgroup.isbuiltin", "zh-HK", "内置_hk", "内置（字典 sys_yes_no_type；1=是，0=否；内置记录禁止删除）"),

            // entity.ecgroup.sortorder
            new TranslationSeedItem("entity.ecgroup.sortorder", "en-US", "排序号_us", "排序号（越小越靠前）"),
            // entity.ecgroup.sortorder
            new TranslationSeedItem("entity.ecgroup.sortorder", "ja-JP", "排序号_jp", "排序号（越小越靠前）"),
            // entity.ecgroup.sortorder
            new TranslationSeedItem("entity.ecgroup.sortorder", "zh-CN", "排序号", "排序号（越小越靠前）"),
            // entity.ecgroup.sortorder
            new TranslationSeedItem("entity.ecgroup.sortorder", "zh-HK", "排序号_hk", "排序号（越小越靠前）"),

            // entity.ecgroup.groupstatus
            new TranslationSeedItem("entity.ecgroup.groupstatus", "en-US", "设变组状态_us", "设变组状态（字典 sys_normal_disable_status；1=启用，0=禁用）"),
            // entity.ecgroup.groupstatus
            new TranslationSeedItem("entity.ecgroup.groupstatus", "ja-JP", "设变组状态_jp", "设变组状态（字典 sys_normal_disable_status；1=启用，0=禁用）"),
            // entity.ecgroup.groupstatus
            new TranslationSeedItem("entity.ecgroup.groupstatus", "zh-CN", "设变组状态", "设变组状态（字典 sys_normal_disable_status；1=启用，0=禁用）"),
            // entity.ecgroup.groupstatus
            new TranslationSeedItem("entity.ecgroup.groupstatus", "zh-HK", "设变组状态_hk", "设变组状态（字典 sys_normal_disable_status；1=启用，0=禁用）"),
        };
    }
