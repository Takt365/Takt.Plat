...
public class TaktPlannedOrderI18nSeedData : ITaktSeedDataCoordinator
{
    ...
    /// I18nKey：entity.plannedorder._self / entity.plannedorder.{{field}}；ResourceGroup=Planning；ResourceType=frontend
    /// </summary>
    private static List<TranslationSeedItem> GetPlannedOrderTranslations()
    {
        return new List<TranslationSeedItem>
        {
            ...
            // entity.plannedorder.masterproductionscheduleid
            new TranslationSeedItem("entity.plannedorder.masterproductionscheduleid", "en-US", "来源MPS头表ID_us", "来源 MPS 头表 ID"),
            // entity.plannedorder.masterproductionscheduleid
            new TranslationSeedItem("entity.plannedorder.masterproductionscheduleid", "ja-JP", "来源MPS头表ID_jp", "来源 MPS 头表 ID"),
            // entity.plannedorder.masterproductionscheduleid
            new TranslationSeedItem("entity.plannedorder.masterproductionscheduleid", "zh-CN", "来源MPS头表ID", "来源 MPS 头表 ID"),
            // entity.plannedorder.masterproductionscheduleid
            new TranslationSeedItem("entity.plannedorder.masterproductionscheduleid", "zh-HK", "来源MPS头表ID_hk", "来源 MPS 头表 ID"),

            // entity.plannedorder.masterproductionschedulelineid
            new TranslationSeedItem("entity.plannedorder.masterproductionschedulelineid", "en-US", "来源MPS行ID_us", "来源 MPS 行 ID"),
            // entity.plannedorder.masterproductionschedulelineid
            new TranslationSeedItem("entity.plannedorder.masterproductionschedulelineid", "ja-JP", "来源MPS行ID_jp", "来源 MPS 行 ID"),
            // entity.plannedorder.masterproductionschedulelineid
            new TranslationSeedItem("entity.plannedorder.masterproductionschedulelineid", "zh-CN", "来源MPS行ID", "来源 MPS 行 ID"),
            // entity.plannedorder.masterproductionschedulelineid
