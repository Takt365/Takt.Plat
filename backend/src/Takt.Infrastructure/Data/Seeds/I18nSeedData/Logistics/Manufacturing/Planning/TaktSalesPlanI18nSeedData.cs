...
public class TaktSalesPlanI18nSeedData : ITaktSeedDataCoordinator
{
    ...
    private static List<TranslationSeedItem> GetSalesPlanTranslations()
    {
        return new List<TranslationSeedItem>
        {
            ...
            new TranslationSeedItem("entity.salesplan.plantcode", "en-US", "工厂代码_us", "工厂代码（选项 TaktPlants/options，DictValue=PlantCode）"),
            // entity.salesplan.plantcode
            new TranslationSeedItem("entity.salesplan.plantcode", "ja-JP", "工厂代码_jp", "工厂代码（选项 TaktPlants/options，DictValue=PlantCode）"),
            // entity.salesplan.plantcode
            new TranslationSeedItem("entity.salesplan.plantcode", "zh-CN", "工厂代码", "工厂代码（选项 TaktPlants/options，DictValue=PlantCode）"),
            // entity.salesplan.plantcode
            new TranslationSeedItem("entity.salesplan.plantcode", "zh-HK", "工厂代码_hk", "工厂代码（选项 TaktPlants/options，DictValue=PlantCode）"),
            ...
            new TranslationSeedItem("entity.salesplan.customercode", "en-US", "客户编码_us", "客户编码（关联 TaktCustomer.CustomerCode，选项 TaktCustomers/options；汇总计划时可为空）"),
            // entity.salesplan.customercode
            new TranslationSeedItem("entity.salesplan.customercode", "ja-JP", "客户编码_jp", "客户编码（关联 TaktCustomer.CustomerCode，选项 TaktCustomers/options；汇总计划时可为空）"),
            // entity.salesplan.customercode
            new TranslationSeedItem("entity.salesplan.customercode", "zh-CN", "客户编码", "客户编码（关联 TaktCustomer.CustomerCode，选项 TaktCustomers/options；汇总计划时可为空）"),
            // entity.salesplan.customercode
            new TranslationSeedItem("entity.salesplan.customercode", "zh-HK", "客户编码_hk", "客户编码（关联 TaktCustomer.CustomerCode，选项 TaktCustomers/options；汇总计划时可为空）"),
            ...
            new TranslationSeedItem("entity.salesplan.plannerid", "en-US", "计划人员工ID_us", "计划人员工ID（关联 TaktEmployee.Id，选项 TaktEmployees/options）"),
            // entity.salesplan.plannerid
            new TranslationSeedItem("entity.salesplan.plannerid", "ja-JP", "计划人员工ID_jp", "计划人员工ID（关联 TaktEmployee.Id，选项 TaktEmployees/options）"),
            // entity.salesplan.plannerid
            new TranslationSeedItem("entity.salesplan.plannerid", "zh-CN", "计划人员工ID", "计划人员工ID（关联 TaktEmployee.Id，选项 TaktEmployees/options）"),
            // entity.salesplan.plannerid
            new TranslationSeedItem("entity.salesplan.plannerid", "zh-HK", "计划人员工ID_hk", "计划人员工ID（关联 TaktEmployee.Id，选项 TaktEmployees/options）"),

            // entity.salesplan.planby
            new TranslationSeedItem("entity.salesplan.planby", "en-US", "计划人_us", "计划人（关联 TaktEmployee.EmployeeNo，选项 TaktEmployees/options，DictValue=EmployeeNo）"),
            // entity.salesplan.planby
            new TranslationSeedItem("entity.salesplan.planby", "ja-JP", "计划人_jp", "计划人（关联 TaktEmployee.EmployeeNo，选项 TaktEmployees/options，DictValue=EmployeeNo）"),
            // entity.salesplan.planby
            new TranslationSeedItem("entity.salesplan.planby", "zh-CN", "计划人", "计划人（关联 TaktEmployee.EmployeeNo，选项 TaktEmployees/options，DictValue=EmployeeNo）"),
            // entity.salesplan.planby
            new TranslationSeedItem("entity.salesplan.planby", "zh-HK", "计划人_hk", "计划人（关联 TaktEmployee.EmployeeNo，选项 TaktEmployees/options，DictValue=EmployeeNo）"),
            ...
            new TranslationSeedItem("entity.salesplan.planstatus", "en-US", "计划状态_us", "计划状态（字典 sys_normal_disable_status；1=启用，0=禁用，2=锁定）"),
            // entity.salesplan.planstatus
            new TranslationSeedItem("entity.salesplan.planstatus", "ja-JP", "计划状态_jp", "计划状态（字典 sys_normal_disable_status；1=启用，0=禁用，2=锁定）"),
            // entity.salesplan.planstatus
            new TranslationSeedItem("entity.salesplan.planstatus", "zh-CN", "计划状态", "计划状态（字典 sys_normal_disable_status；1=启用，0=禁用，2=锁定）"),
            // entity.salesplan.planstatus
            new TranslationSeedItem("entity.salesplan.planstatus", "zh-HK", "计划状态_hk", "计划状态（字典 sys_normal_disable_status；1=启用，0=禁用，2=锁定）"),

            // entity.salesplan.convertedstatus
            new TranslationSeedItem("entity.salesplan.convertedstatus", "en-US", "转单状态_us", "转单状态（字典 sys_convert_status；0=未转换，1=部分转换，2=全部转换）"),
            // entity.salesplan.convertedstatus
            new TranslationSeedItem("entity.salesplan.convertedstatus", "ja-JP", "转单状态_jp", "转单状态（字典 sys_convert_status；0=未转换，1=部分转换，2=全部转换）"),
            // entity.salesplan.convertedstatus
            new TranslationSeedItem("entity.salesplan.convertedstatus", "zh-CN", "转单状态", "转单状态（字典 sys_convert_status；0=未转换，1=部分转换，2=全部转换）"),
            // entity.salesplan.convertedstatus
            new TranslationSeedItem("entity.salesplan.convertedstatus", "zh-HK", "转单状态_hk", "转单状态（字典 sys_convert_status；0=未转换，1=部分转换，2=全部转换）"),
