...
public class TaktEcSeikanI18nSeedData : ITaktSeedDataCoordinator
{
    ...
    private static List<TranslationSeedItem> GetEcSeikanTranslations()
    {
        return new List<TranslationSeedItem>
        {
            ...
            // entity.ecseikan.ecno
            new TranslationSeedItem("entity.ecseikan.ecno", "en-US", "设变单号_us", "设变单号（冗余，便于查询）"),
            // entity.ecseikan.ecno
            new TranslationSeedItem("entity.ecseikan.ecno", "ja-JP", "设变单号_jp", "设变单号（冗余，便于查询）"),
            // entity.ecseikan.ecno
            new TranslationSeedItem("entity.ecseikan.ecno", "zh-CN", "设变单号", "设变单号（冗余，便于查询）"),
            // entity.ecseikan.ecno
            new TranslationSeedItem("entity.ecseikan.ecno", "zh-HK", "设变单号_hk", "设变单号（冗余，便于查询）"),
            ...
            new TranslationSeedItem("entity.ecseikan.isobsolete", "en-US", "是否作废_us", "是否作废（字典 sys_yes_no_type；0=否 1=是；编辑移除子行时标记作废）"),
            // entity.ecseikan.isobsolete
            new TranslationSeedItem("entity.ecseikan.isobsolete", "ja-JP", "是否作废_jp", "是否作废（字典 sys_yes_no_type；0=否 1=是；编辑移除子行时标记作废）"),
            // entity.ecseikan.isobsolete
            new TranslationSeedItem("entity.ecseikan.isobsolete", "zh-CN", "是否作废", "是否作废（字典 sys_yes_no_type；0=否 1=是；编辑移除子行时标记作废）"),
            // entity.ecseikan.isobsolete
            new TranslationSeedItem("entity.ecseikan.isobsolete", "zh-HK", "是否作废_hk", "是否作废（字典 sys_yes_no_type；0=否 1=是；编辑移除子行时标记作废）"),
        };
    }
