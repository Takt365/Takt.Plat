...
public class TaktSopDocI18nSeedData : ITaktSeedDataCoordinator
{
    ...
    private static List<TranslationSeedItem> GetSopDocTranslations()
    {
        return new List<TranslationSeedItem>
        {
            ...
            new TranslationSeedItem("entity.sopdoc.materialcode", "en-US", "物料编码_us", "产品/物料编码（关联 TaktMaterial.MaterialCode，选项 TaktMaterials/options）"),
            // entity.sopdoc.materialcode
            new TranslationSeedItem("entity.sopdoc.materialcode", "ja-JP", "物料编码_jp", "产品/物料编码（关联 TaktMaterial.MaterialCode，选项 TaktMaterials/options）"),
            // entity.sopdoc.materialcode
            new TranslationSeedItem("entity.sopdoc.materialcode", "zh-CN", "物料编码", "产品/物料编码（关联 TaktMaterial.MaterialCode，选项 TaktMaterials/options）"),
            // entity.sopdoc.materialcode
            new TranslationSeedItem("entity.sopdoc.materialcode", "zh-HK", "物料编码_hk", "产品/物料编码（关联 TaktMaterial.MaterialCode，选项 TaktMaterials/options）"),

            // entity.sopdoc.routingitemid
            new TranslationSeedItem("entity.sopdoc.routingitemid", "en-US", "工序ID_us", "工艺路线明细 ID（关联 TaktRoutingItem.Id，选项 TaktRoutingItems/options）"),
            // entity.sopdoc.routingitemid
            new TranslationSeedItem("entity.sopdoc.routingitemid", "ja-JP", "工序ID_jp", "工艺路线明细 ID（关联 TaktRoutingItem.Id，选项 TaktRoutingItems/options）"),
            // entity.sopdoc.routingitemid
            new TranslationSeedItem("entity.sopdoc.routingitemid", "zh-CN", "工序ID", "工艺路线明细 ID（关联 TaktRoutingItem.Id，选项 TaktRoutingItems/options）"),
            // entity.sopdoc.routingitemid
            new TranslationSeedItem("entity.sopdoc.routingitemid", "zh-HK", "工序ID_hk", "工艺路线明细 ID（关联 TaktRoutingItem.Id，选项 TaktRoutingItems/options）"),

            // entity.sopdoc.workstationid
            new TranslationSeedItem("entity.sopdoc.workstationid", "en-US", "工位ID_us", "工位 ID（关联 TaktSopWorkstation.Id，选项 TaktSopWorkstations/options）"),
            // entity.sopdoc.workstationid
            new TranslationSeedItem("entity.sopdoc.workstationid", "ja-JP", "工位ID_jp", "工位 ID（关联 TaktSopWorkstation.Id，选项 TaktSopWorkstations/options）"),
            // entity.sopdoc.workstationid
            new TranslationSeedItem("entity.sopdoc.workstationid", "zh-CN", "工位ID", "工位 ID（关联 TaktSopWorkstation.Id，选项 TaktSopWorkstations/options）"),
            // entity.sopdoc.workstationid
            new TranslationSeedItem("entity.sopdoc.workstationid", "zh-HK", "工位ID_hk", "工位 ID（关联 TaktSopWorkstation.Id，选项 TaktSopWorkstations/options）"),

            // entity.sopdoc.currentrevisionid
            new TranslationSeedItem("entity.sopdoc.currentrevisionid", "en-US", "当前版本ID_us", "当前生效版本 ID（关联 TaktSopRevision.Id，选项 TaktSopRevisions/options）"),
            // entity.sopdoc.currentrevisionid
            new TranslationSeedItem("entity.sopdoc.currentrevisionid", "ja-JP", "当前版本ID_jp", "当前生效版本 ID（关联 TaktSopRevision.Id，选项 TaktSopRevisions/options）"),
            // entity.sopdoc.currentrevisionid
            new TranslationSeedItem("entity.sopdoc.currentrevisionid", "zh-CN", "当前版本ID", "当前生效版本 ID（关联 TaktSopRevision.Id，选项 TaktSopRevisions/options）"),
            // entity.sopdoc.currentrevisionid
            new TranslationSeedItem("entity.sopdoc.currentrevisionid", "zh-HK", "当前版本ID_hk", "当前生效版本 ID（关联 TaktSopRevision.Id，选项 TaktSopRevisions/options）"),
