...
public class TaktSopDocI18nSeedData : ITaktSeedDataCoordinator
{
    ...
    private static List<TranslationSeedItem> GetSopDocTranslations()
    {
        return new List<TranslationSeedItem>
        {
            ...
            new TranslationSeedItem("entity.sopdoc.materialcode", "en-US", "产品物料编码_us", "产品/物料编码"),
            // entity.sopdoc.materialcode
            new TranslationSeedItem("entity.sopdoc.materialcode", "ja-JP", "产品物料编码_jp", "产品/物料编码"),
            // entity.sopdoc.materialcode
            new TranslationSeedItem("entity.sopdoc.materialcode", "zh-CN", "产品物料编码", "产品/物料编码"),
            // entity.sopdoc.materialcode
            new TranslationSeedItem("entity.sopdoc.materialcode", "zh-HK", "产品物料编码_hk", "产品/物料编码"),

            // entity.sopdoc.routingitemid
            new TranslationSeedItem("entity.sopdoc.routingitemid", "en-US", "工序ID_us", "工艺路线明细 ID（序列化为 string 以避免 Javascript 精度问题）"),
            // entity.sopdoc.routingitemid
            new TranslationSeedItem("entity.sopdoc.routingitemid", "ja-JP", "工序ID_jp", "工艺路线明细 ID（序列化为 string 以避免 Javascript 精度问题）"),
            // entity.sopdoc.routingitemid
            new TranslationSeedItem("entity.sopdoc.routingitemid", "zh-CN", "工序ID", "工艺路线明细 ID（序列化为 string 以避免 Javascript 精度问题）"),
            // entity.sopdoc.routingitemid
            new TranslationSeedItem("entity.sopdoc.routingitemid", "zh-HK", "工序ID_hk", "工艺路线明细 ID（序列化为 string 以避免 Javascript 精度问题）"),

            // entity.sopdoc.workstationid
            new TranslationSeedItem("entity.sopdoc.workstationid", "en-US", "工位ID_us", "工位 ID（可选，工位级 ESOP；序列化为 string 以避免 Javascript 精度问题）"),
            // entity.sopdoc.workstationid
            new TranslationSeedItem("entity.sopdoc.workstationid", "ja-JP", "工位ID_jp", "工位 ID（可选，工位级 ESOP；序列化为 string 以避免 Javascript 精度问题）"),
            // entity.sopdoc.workstationid
            new TranslationSeedItem("entity.sopdoc.workstationid", "zh-CN", "工位ID", "工位 ID（可选，工位级 ESOP；序列化为 string 以避免 Javascript 精度问题）"),
            // entity.sopdoc.workstationid
            new TranslationSeedItem("entity.sopdoc.workstationid", "zh-HK", "工位ID_hk", "工位 ID（可选，工位级 ESOP；序列化为 string 以避免 Javascript 精度问题）"),

            // entity.sopdoc.currentrevisionid
            new TranslationSeedItem("entity.sopdoc.currentrevisionid", "en-US", "当前版本ID_us", "当前生效版本 ID（序列化为 string 以避免 Javascript 精度问题）"),
            // entity.sopdoc.currentrevisionid
            new TranslationSeedItem("entity.sopdoc.currentrevisionid", "ja-JP", "当前版本ID_jp", "当前生效版本 ID（序列化为 string 以避免 Javascript 精度问题）"),
            // entity.sopdoc.currentrevisionid
            new TranslationSeedItem("entity.sopdoc.currentrevisionid", "zh-CN", "当前版本ID", "当前生效版本 ID（序列化为 string 以避免 Javascript 精度问题）"),
            // entity.sopdoc.currentrevisionid
            new TranslationSeedItem("entity.sopdoc.currentrevisionid", "zh-HK", "当前版本ID_hk", "当前生效版本 ID（序列化为 string 以避免 Javascript 精度问题）"),

            // entity.sopdoc.defaultlang
            new TranslationSeedItem("entity.sopdoc.defaultlang", "en-US", "默认语言_us", "默认语言（zh-CN 简体 / en-US 英文 / ja-JP 日文 / zh-HK 香港繁体；与 TaktCulture.CultureCode 一致）"),
            // entity.sopdoc.defaultlang
            new TranslationSeedItem("entity.sopdoc.defaultlang", "ja-JP", "默认语言_jp", "默认语言（zh-CN 简体 / en-US 英文 / ja-JP 日文 / zh-HK 香港繁体；与 TaktCulture.CultureCode 一致）"),
            // entity.sopdoc.defaultlang
            new TranslationSeedItem("entity.sopdoc.defaultlang", "zh-CN", "默认语言", "默认语言（zh-CN 简体 / en-US 英文 / ja-JP 日文 / zh-HK 香港繁体；与 TaktCulture.CultureCode 一致）"),
            // entity.sopdoc.defaultlang
            new TranslationSeedItem("entity.sopdoc.defaultlang", "zh-HK", "默认语言_hk", "默认语言（zh-CN 简体 / en-US 英文 / ja-JP 日文 / zh-HK 香港繁体；与 TaktCulture.CultureCode 一致）"),

            // entity.sopdoc.sopstatus
            new TranslationSeedItem("entity.sopdoc.sopstatus", "en-US", "文档状态_us", "状态（字典 sys_normal_disable_status，0=停用，1=正常）"),
            // entity.sopdoc.sopstatus
            new TranslationSeedItem("entity.sopdoc.sopstatus", "ja-JP", "文档状态_jp", "状态（字典 sys_normal_disable_status，0=停用，1=正常）"),
            // entity.sopdoc.sopstatus
            new TranslationSeedItem("entity.sopdoc.sopstatus", "zh-CN", "文档状态", "状态（字典 sys_normal_disable_status，0=停用，1=正常）"),
            // entity.sopdoc.sopstatus
            new TranslationSeedItem("entity.sopdoc.sopstatus", "zh-HK", "文档状态_hk", "状态（字典 sys_normal_disable_status，0=停用，1=正常）"),
