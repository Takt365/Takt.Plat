...
public class TaktProductionDispatchI18nSeedData : ITaktSeedDataCoordinator
{
    ...
    private static List<TranslationSeedItem> GetProductionDispatchTranslations()
    {
        return new List<TranslationSeedItem>
        {
            ...
            new TranslationSeedItem("entity.productiondispatch.productionorderid", "en-US", "生产工单ID_us", "生产工单 ID（关联 TaktProductionOrder.Id，选项 TaktProductionOrders/options）"),
            // entity.productiondispatch.productionorderid
            new TranslationSeedItem("entity.productiondispatch.productionorderid", "ja-JP", "生产工单ID_jp", "生产工单 ID（关联 TaktProductionOrder.Id，选项 TaktProductionOrders/options）"),
            // entity.productiondispatch.productionorderid
            new TranslationSeedItem("entity.productiondispatch.productionorderid", "zh-CN", "生产工单ID", "生产工单 ID（关联 TaktProductionOrder.Id，选项 TaktProductionOrders/options）"),
            // entity.productiondispatch.productionorderid
            ...
            // entity.productiondispatch.apsoperationid
            new TranslationSeedItem("entity.productiondispatch.apsoperationid", "ja-JP", "APS工序排程ID_jp", "APS 工序排程 ID（关联 TaktApsOperation.Id，选项 TaktApsOperations/options）"),
            // entity.productiondispatch.apsoperationid
            new TranslationSeedItem("entity.productiondispatch.apsoperationid", "zh-CN", "APS工序排程ID", "APS 工序排程 ID（关联 TaktApsOperation.Id，选项 TaktApsOperations/options）"),
            // entity.productiondispatch.apsoperationid
            new TranslationSeedItem("entity.productiondispatch.apsoperationid", "zh-HK", "APS工序排程ID_hk", "APS 工序排程 ID（关联 TaktApsOperation.Id，选项 TaktApsOperations/options）"),

            // entity.productiondispatch.workcentercode
            new TranslationSeedItem("entity.productiondispatch.workcentercode", "en-US", "工作中心编码_us", "工作中心编码（关联 TaktWorkCenter.WorkCenterCode，选项 TaktWorkCenters/options，DictValue=WorkCenterCode）"),
            // entity.productiondispatch.workcentercode
            new TranslationSeedItem("entity.productiondispatch.workcentercode", "ja-JP", "工作中心编码_jp", "工作中心编码（关联 TaktWorkCenter.WorkCenterCode，选项 TaktWorkCenters/options，DictValue=WorkCenterCode）"),
            // entity.productiondispatch.workcentercode
            new TranslationSeedItem("entity.productiondispatch.workcentercode", "zh-CN", "工作中心编码", "工作中心编码（关联 TaktWorkCenter.WorkCenterCode，选项 TaktWorkCenters/options，DictValue=WorkCenterCode）"),
            // entity.productiondispatch.workcentercode
            new TranslationSeedItem("entity.productiondispatch.workcentercode", "zh-HK", "工作中心编码_hk", "工作中心编码（关联 TaktWorkCenter.WorkCenterCode，选项 TaktWorkCenters/options，DictValue=WorkCenterCode）"),
