...
public class TaktProductionDispatchI18nSeedData : ITaktSeedDataCoordinator
{
    ...
    /// I18nKey：entity.productiondispatch._self / entity.productiondispatch.{{field}}；ResourceGroup=Scheduling；ResourceType=frontend
    /// </summary>
    private static List<TranslationSeedItem> GetProductionDispatchTranslations()
    {
        return new List<TranslationSeedItem>
        {
            ...
            new TranslationSeedItem("entity.productiondispatch.plantcode", "en-US", "工厂代码_us", "工厂代码"),
            // entity.productiondispatch.plantcode
            new TranslationSeedItem("entity.productiondispatch.plantcode", "ja-JP", "工厂代码_jp", "工厂代码"),
            // entity.productiondispatch.plantcode
            new TranslationSeedItem("entity.productiondispatch.plantcode", "zh-CN", "工厂代码", "工厂代码"),
            // entity.productiondispatch.plantcode
            new TranslationSeedItem("entity.productiondispatch.plantcode", "zh-HK", "工厂代码_hk", "工厂代码"),
            ...
            new TranslationSeedItem("entity.productiondispatch.productionorderid", "en-US", "生产工单ID_us", "生产工单 ID（关联 TaktProductionOrder）"),
            // entity.productiondispatch.productionorderid
            new TranslationSeedItem("entity.productiondispatch.productionorderid", "ja-JP", "生产工单ID_jp", "生产工单 ID（关联 TaktProductionOrder）"),
            // entity.productiondispatch.productionorderid
            new TranslationSeedItem("entity.productiondispatch.productionorderid", "zh-CN", "生产工单ID", "生产工单 ID（关联 TaktProductionOrder）"),
            // entity.productiondispatch.productionorderid
            new TranslationSeedItem("entity.productiondispatch.productionorderid", "zh-HK", "生产工单ID_hk", "生产工单 ID（关联 TaktProductionOrder）"),

            // entity.productiondispatch.prodordercode
            new TranslationSeedItem("entity.productiondispatch.prodordercode", "en-US", "生产工单号_us", "生产工单号（冗余）"),
            // entity.productiondispatch.prodordercode
            new TranslationSeedItem("entity.productiondispatch.prodordercode", "ja-JP", "生产工单号_jp", "生产工单号（冗余）"),
            // entity.productiondispatch.prodordercode
            new TranslationSeedItem("entity.productiondispatch.prodordercode", "zh-CN", "生产工单号", "生产工单号（冗余）"),
            // entity.productiondispatch.prodordercode
            new TranslationSeedItem("entity.productiondispatch.prodordercode", "zh-HK", "生产工单号_hk", "生产工单号（冗余）"),

            // entity.productiondispatch.apsoperationid
            new TranslationSeedItem("entity.productiondispatch.apsoperationid", "en-US", "APS工序排程ID_us", "APS 工序排程 ID（可选）"),
            // entity.productiondispatch.apsoperationid
            new TranslationSeedItem("entity.productiondispatch.apsoperationid", "ja-JP", "APS工序排程ID_jp", "APS 工序排程 ID（可选）"),
            // entity.productiondispatch.apsoperationid
            new TranslationSeedItem("entity.productiondispatch.apsoperationid", "zh-CN", "APS工序排程ID", "APS 工序排程 ID（可选）"),
            // entity.productiondispatch.apsoperationid
            new TranslationSeedItem("entity.productiondispatch.apsoperationid", "zh-HK", "APS工序排程ID_hk", "APS 工序排程 ID（可选）"),

            // entity.productiondispatch.workcentercode
            new TranslationSeedItem("entity.productiondispatch.workcentercode", "en-US", "工作中心编码_us", "工作中心编码"),
            // entity.productiondispatch.workcentercode
            new TranslationSeedItem("entity.productiondispatch.workcentercode", "ja-JP", "工作中心编码_jp", "工作中心编码"),
            // entity.productiondispatch.workcentercode
            new TranslationSeedItem("entity.productiondispatch.workcentercode", "zh-CN", "工作中心编码", "工作中心编码"),
            // entity.productiondispatch.workcentercode
            new TranslationSeedItem("entity.productiondispatch.workcentercode", "zh-HK", "工作中心编码_hk", "工作中心编码"),
