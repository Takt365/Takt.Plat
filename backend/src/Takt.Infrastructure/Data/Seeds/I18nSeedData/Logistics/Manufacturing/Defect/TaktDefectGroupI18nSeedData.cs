...
public class TaktDefectGroupI18nSeedData : ITaktSeedDataCoordinator
{
    ...
    private static List<TranslationSeedItem> GetDefectGroupTranslations()
    {
        return new List<TranslationSeedItem>
        {
            ...
            new TranslationSeedItem("entity.defectgroup.responsibleuserid", "en-US", "负责人用户ID_us", "不良组负责人用户 ID（关联 TaktUser.Id，选项 TaktUsers/options）"),
            // entity.defectgroup.responsibleuserid
            new TranslationSeedItem("entity.defectgroup.responsibleuserid", "ja-JP", "负责人用户ID_jp", "不良组负责人用户 ID（关联 TaktUser.Id，选项 TaktUsers/options）"),
            // entity.defectgroup.responsibleuserid
            new TranslationSeedItem("entity.defectgroup.responsibleuserid", "zh-CN", "负责人用户ID", "不良组负责人用户 ID（关联 TaktUser.Id，选项 TaktUsers/options）"),
            // entity.defectgroup.responsibleuserid
            new TranslationSeedItem("entity.defectgroup.responsibleuserid", "zh-HK", "负责人用户ID_hk", "不良组负责人用户 ID（关联 TaktUser.Id，选项 TaktUsers/options）"),
