...
public class TaktSopStepMediaI18nSeedData : ITaktSeedDataCoordinator
{
    ...
    private static List<TranslationSeedItem> GetSopStepMediaTranslations()
    {
        return new List<TranslationSeedItem>
        {
            ...
            new TranslationSeedItem("entity.sopstepmedia.stepid", "en-US", "工步ID_us", "工步 ID（序列化为 string 以避免 Javascript 精度问题）"),
            // entity.sopstepmedia.stepid
            new TranslationSeedItem("entity.sopstepmedia.stepid", "ja-JP", "工步ID_jp", "工步 ID（序列化为 string 以避免 Javascript 精度问题）"),
            // entity.sopstepmedia.stepid
            new TranslationSeedItem("entity.sopstepmedia.stepid", "zh-CN", "工步ID", "工步 ID（序列化为 string 以避免 Javascript 精度问题）"),
            // entity.sopstepmedia.stepid
            new TranslationSeedItem("entity.sopstepmedia.stepid", "zh-HK", "工步ID_hk", "工步 ID（序列化为 string 以避免 Javascript 精度问题）"),

            // entity.sopstepmedia.mediatype
            new TranslationSeedItem("entity.sopstepmedia.mediatype", "en-US", "媒体类型_us", "媒体类型（1=图片JPG/PNG，2=视频MP4，3=PDF，4=3D轻量化；字典 logistics_sop_media_type）"),
            // entity.sopstepmedia.mediatype
            new TranslationSeedItem("entity.sopstepmedia.mediatype", "ja-JP", "媒体类型_jp", "媒体类型（1=图片JPG/PNG，2=视频MP4，3=PDF，4=3D轻量化；字典 logistics_sop_media_type）"),
            // entity.sopstepmedia.mediatype
            new TranslationSeedItem("entity.sopstepmedia.mediatype", "zh-CN", "媒体类型", "媒体类型（1=图片JPG/PNG，2=视频MP4，3=PDF，4=3D轻量化；字典 logistics_sop_media_type）"),
            // entity.sopstepmedia.mediatype
            new TranslationSeedItem("entity.sopstepmedia.mediatype", "zh-HK", "媒体类型_hk", "媒体类型（1=图片JPG/PNG，2=视频MP4，3=PDF，4=3D轻量化；字典 logistics_sop_media_type）"),
