...
public class TaktSopStepMediaI18nSeedData : ITaktSeedDataCoordinator
{
    ...
    private static List<TranslationSeedItem> GetSopStepMediaTranslations()
    {
        return new List<TranslationSeedItem>
        {
            ...
            new TranslationSeedItem("entity.sopstepmedia.stepid", "en-US", "工步ID_us", "工步 ID（关联 TaktSopStep.Id，选项 TaktSopSteps/options）"),
            // entity.sopstepmedia.stepid
            new TranslationSeedItem("entity.sopstepmedia.stepid", "ja-JP", "工步ID_jp", "工步 ID（关联 TaktSopStep.Id，选项 TaktSopSteps/options）"),
            // entity.sopstepmedia.stepid
            new TranslationSeedItem("entity.sopstepmedia.stepid", "zh-CN", "工步ID", "工步 ID（关联 TaktSopStep.Id，选项 TaktSopSteps/options）"),
            // entity.sopstepmedia.stepid
            new TranslationSeedItem("entity.sopstepmedia.stepid", "zh-HK", "工步ID_hk", "工步 ID（关联 TaktSopStep.Id，选项 TaktSopSteps/options）"),
