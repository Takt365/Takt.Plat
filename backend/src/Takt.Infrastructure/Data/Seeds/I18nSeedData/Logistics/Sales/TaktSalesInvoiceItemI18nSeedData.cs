...
public class TaktSalesInvoiceItemI18nSeedData : ITaktSeedDataCoordinator
{
    ...
    private static List<TranslationSeedItem> GetSalesInvoiceItemTranslations()
    {
        return new List<TranslationSeedItem>
        {
            ...
            new TranslationSeedItem("entity.salesinvoiceitem.accountingdocumentcode", "en-US", "会计凭证编码_us", "会计凭证编码（冗余，与主表 AccountingDocumentCode 一致）"),
            // entity.salesinvoiceitem.accountingdocumentcode
            new TranslationSeedItem("entity.salesinvoiceitem.accountingdocumentcode", "ja-JP", "会计凭证编码_jp", "会计凭证编码（冗余，与主表 AccountingDocumentCode 一致）"),
            // entity.salesinvoiceitem.accountingdocumentcode
            new TranslationSeedItem("entity.salesinvoiceitem.accountingdocumentcode", "zh-CN", "会计凭证编码", "会计凭证编码（冗余，与主表 AccountingDocumentCode 一致）"),
            // entity.salesinvoiceitem.accountingdocumentcode
            new TranslationSeedItem("entity.salesinvoiceitem.accountingdocumentcode", "zh-HK", "会计凭证编码_hk", "会计凭证编码（冗余，与主表 AccountingDocumentCode 一致）"),
            ...
            // entity.salesinvoiceitem.taxincludedprice
            new TranslationSeedItem("entity.salesinvoiceitem.taxincludedprice", "en-US", "含税价格_us", "含税价格（打印用；如 100.00）"),
            // entity.salesinvoiceitem.taxincludedprice
            new TranslationSeedItem("entity.salesinvoiceitem.taxincludedprice", "ja-JP", "含税价格_jp", "含税价格（打印用；如 100.00）"),
            // entity.salesinvoiceitem.taxincludedprice
            new TranslationSeedItem("entity.salesinvoiceitem.taxincludedprice", "zh-CN", "含税价格", "含税价格（打印用；如 100.00）"),
            // entity.salesinvoiceitem.taxincludedprice
            new TranslationSeedItem("entity.salesinvoiceitem.taxincludedprice", "zh-HK", "含税价格_hk", "含税价格（打印用；如 100.00）"),

            // entity.salesinvoiceitem.untaxedprice
            new TranslationSeedItem("entity.salesinvoiceitem.untaxedprice", "en-US", "未税价格_us", "未税价格（打印用；如 88.50）"),
            // entity.salesinvoiceitem.untaxedprice
            new TranslationSeedItem("entity.salesinvoiceitem.untaxedprice", "ja-JP", "未税价格_jp", "未税价格（打印用；如 88.50）"),
            // entity.salesinvoiceitem.untaxedprice
            new TranslationSeedItem("entity.salesinvoiceitem.untaxedprice", "zh-CN", "未税价格", "未税价格（打印用；如 88.50）"),
            // entity.salesinvoiceitem.untaxedprice
            new TranslationSeedItem("entity.salesinvoiceitem.untaxedprice", "zh-HK", "未税价格_hk", "未税价格（打印用；如 88.50）"),

            // entity.salesinvoiceitem.taxamount
            new TranslationSeedItem("entity.salesinvoiceitem.taxamount", "en-US", "税费_us", "税费（打印用；行税额，如 11.50）"),
            // entity.salesinvoiceitem.taxamount
            new TranslationSeedItem("entity.salesinvoiceitem.taxamount", "ja-JP", "税费_jp", "税费（打印用；行税额，如 11.50）"),
            // entity.salesinvoiceitem.taxamount
            new TranslationSeedItem("entity.salesinvoiceitem.taxamount", "zh-CN", "税费", "税费（打印用；行税额，如 11.50）"),
            // entity.salesinvoiceitem.taxamount
            new TranslationSeedItem("entity.salesinvoiceitem.taxamount", "zh-HK", "税费_hk", "税费（打印用；行税额，如 11.50）"),
