...
public class TaktSalesPriceItemI18nSeedData : ITaktSeedDataCoordinator
{
    ...
    private static List<TranslationSeedItem> GetSalesPriceItemTranslations()
    {
        return new List<TranslationSeedItem>
        {
            ...
            new TranslationSeedItem("entity.salespriceitem.salespricecode", "en-US", "定价记录号_us", "定价记录号（冗余：按对应 Id 取主数据名称联动）"),
            // entity.salespriceitem.salespricecode
            new TranslationSeedItem("entity.salespriceitem.salespricecode", "ja-JP", "定价记录号_jp", "定价记录号（冗余：按对应 Id 取主数据名称联动）"),
            // entity.salespriceitem.salespricecode
            new TranslationSeedItem("entity.salespriceitem.salespricecode", "zh-CN", "定价记录号", "定价记录号（冗余：按对应 Id 取主数据名称联动）"),
            // entity.salespriceitem.salespricecode
            new TranslationSeedItem("entity.salespriceitem.salespricecode", "zh-HK", "定价记录号_hk", "定价记录号（冗余：按对应 Id 取主数据名称联动）"),
            ...
            new TranslationSeedItem("entity.salespriceitem.pricetype", "en-US", "条件类型_us", "条件类型（冗余；字典 logistics_procurement_price_type；与主表 PriceType 一致，PB00/PR00/MWST/MWRK/NLXV）"),
            // entity.salespriceitem.pricetype
            new TranslationSeedItem("entity.salespriceitem.pricetype", "ja-JP", "条件类型_jp", "条件类型（冗余；字典 logistics_procurement_price_type；与主表 PriceType 一致，PB00/PR00/MWST/MWRK/NLXV）"),
            // entity.salespriceitem.pricetype
            new TranslationSeedItem("entity.salespriceitem.pricetype", "zh-CN", "条件类型", "条件类型（冗余；字典 logistics_procurement_price_type；与主表 PriceType 一致，PB00/PR00/MWST/MWRK/NLXV）"),
            // entity.salespriceitem.pricetype
            new TranslationSeedItem("entity.salespriceitem.pricetype", "zh-HK", "条件类型_hk", "条件类型（冗余；字典 logistics_procurement_price_type；与主表 PriceType 一致，PB00/PR00/MWST/MWRK/NLXV）"),

            // entity.salespriceitem.scaletype
            new TranslationSeedItem("entity.salespriceitem.scaletype", "en-US", "等级类型_us", "等级类型（字典 logistics_procurement_scale；A=基础等级，B=到等级，C=未使用，D=累进间隔等级）"),
            // entity.salespriceitem.scaletype
            new TranslationSeedItem("entity.salespriceitem.scaletype", "ja-JP", "等级类型_jp", "等级类型（字典 logistics_procurement_scale；A=基础等级，B=到等级，C=未使用，D=累进间隔等级）"),
            // entity.salespriceitem.scaletype
            new TranslationSeedItem("entity.salespriceitem.scaletype", "zh-CN", "等级类型", "等级类型（字典 logistics_procurement_scale；A=基础等级，B=到等级，C=未使用，D=累进间隔等级）"),
            // entity.salespriceitem.scaletype
            new TranslationSeedItem("entity.salespriceitem.scaletype", "zh-HK", "等级类型_hk", "等级类型（字典 logistics_procurement_scale；A=基础等级，B=到等级，C=未使用，D=累进间隔等级）"),

            // entity.salespriceitem.scalebasis
            new TranslationSeedItem("entity.salespriceitem.scalebasis", "en-US", "等级基础_us", "等级基础（字典 logistics_procurement_scale_basis；B=价值等级，C=数量规模，…）"),
            // entity.salespriceitem.scalebasis
            new TranslationSeedItem("entity.salespriceitem.scalebasis", "ja-JP", "等级基础_jp", "等级基础（字典 logistics_procurement_scale_basis；B=价值等级，C=数量规模，…）"),
            // entity.salespriceitem.scalebasis
            new TranslationSeedItem("entity.salespriceitem.scalebasis", "zh-CN", "等级基础", "等级基础（字典 logistics_procurement_scale_basis；B=价值等级，C=数量规模，…）"),
            // entity.salespriceitem.scalebasis
            new TranslationSeedItem("entity.salespriceitem.scalebasis", "zh-HK", "等级基础_hk", "等级基础（字典 logistics_procurement_scale_basis；B=价值等级，C=数量规模，…）"),
            ...
            new TranslationSeedItem("entity.salespriceitem.scaleunit", "en-US", "等级单位_us", "等级单位（字典 logistics_materials_unit_of_measure_code；DictValue=PC/EA 等）"),
            // entity.salespriceitem.scaleunit
            new TranslationSeedItem("entity.salespriceitem.scaleunit", "ja-JP", "等级单位_jp", "等级单位（字典 logistics_materials_unit_of_measure_code；DictValue=PC/EA 等）"),
            // entity.salespriceitem.scaleunit
            new TranslationSeedItem("entity.salespriceitem.scaleunit", "zh-CN", "等级单位", "等级单位（字典 logistics_materials_unit_of_measure_code；DictValue=PC/EA 等）"),
            // entity.salespriceitem.scaleunit
            new TranslationSeedItem("entity.salespriceitem.scaleunit", "zh-HK", "等级单位_hk", "等级单位（字典 logistics_materials_unit_of_measure_code；DictValue=PC/EA 等）"),
            ...
            new TranslationSeedItem("entity.salespriceitem.scalecurrencycode", "en-US", "等级货币_us", "等级货币（字典 accounting_financial_currency_code；DictValue=CNY/USD 等）"),
            // entity.salespriceitem.scalecurrencycode
            new TranslationSeedItem("entity.salespriceitem.scalecurrencycode", "ja-JP", "等级货币_jp", "等级货币（字典 accounting_financial_currency_code；DictValue=CNY/USD 等）"),
            // entity.salespriceitem.scalecurrencycode
            new TranslationSeedItem("entity.salespriceitem.scalecurrencycode", "zh-CN", "等级货币", "等级货币（字典 accounting_financial_currency_code；DictValue=CNY/USD 等）"),
            // entity.salespriceitem.scalecurrencycode
            new TranslationSeedItem("entity.salespriceitem.scalecurrencycode", "zh-HK", "等级货币_hk", "等级货币（字典 accounting_financial_currency_code；DictValue=CNY/USD 等）"),

            // entity.salespriceitem.calculationtype
            new TranslationSeedItem("entity.salespriceitem.calculationtype", "en-US", "计算类型_us", "计算类型（字典 logistics_procurement_calculation_type；默认 A=百分数）"),
            // entity.salespriceitem.calculationtype
            new TranslationSeedItem("entity.salespriceitem.calculationtype", "ja-JP", "计算类型_jp", "计算类型（字典 logistics_procurement_calculation_type；默认 A=百分数）"),
            // entity.salespriceitem.calculationtype
            new TranslationSeedItem("entity.salespriceitem.calculationtype", "zh-CN", "计算类型", "计算类型（字典 logistics_procurement_calculation_type；默认 A=百分数）"),
            // entity.salespriceitem.calculationtype
            new TranslationSeedItem("entity.salespriceitem.calculationtype", "zh-HK", "计算类型_hk", "计算类型（字典 logistics_procurement_calculation_type；默认 A=百分数）"),
            ...
            new TranslationSeedItem("entity.salespriceitem.conditioncurrencycode", "en-US", "条件货币_us", "条件货币（字典 accounting_financial_currency_code；DictValue=CNY/USD 等；默认 CNY）"),
            // entity.salespriceitem.conditioncurrencycode
            new TranslationSeedItem("entity.salespriceitem.conditioncurrencycode", "ja-JP", "条件货币_jp", "条件货币（字典 accounting_financial_currency_code；DictValue=CNY/USD 等；默认 CNY）"),
            // entity.salespriceitem.conditioncurrencycode
            new TranslationSeedItem("entity.salespriceitem.conditioncurrencycode", "zh-CN", "条件货币", "条件货币（字典 accounting_financial_currency_code；DictValue=CNY/USD 等；默认 CNY）"),
            // entity.salespriceitem.conditioncurrencycode
            new TranslationSeedItem("entity.salespriceitem.conditioncurrencycode", "zh-HK", "条件货币_hk", "条件货币（字典 accounting_financial_currency_code；DictValue=CNY/USD 等；默认 CNY）"),

            // entity.salespriceitem.priceunit
            new TranslationSeedItem("entity.salespriceitem.priceunit", "en-US", "定价单位_us", "定价单位（字典 logistics_materials_price_unit_param；1/10/100/1000；默认 1000）"),
            // entity.salespriceitem.priceunit
            new TranslationSeedItem("entity.salespriceitem.priceunit", "ja-JP", "定价单位_jp", "定价单位（字典 logistics_materials_price_unit_param；1/10/100/1000；默认 1000）"),
            // entity.salespriceitem.priceunit
            new TranslationSeedItem("entity.salespriceitem.priceunit", "zh-CN", "定价单位", "定价单位（字典 logistics_materials_price_unit_param；1/10/100/1000；默认 1000）"),
            // entity.salespriceitem.priceunit
            new TranslationSeedItem("entity.salespriceitem.priceunit", "zh-HK", "定价单位_hk", "定价单位（字典 logistics_materials_price_unit_param；1/10/100/1000；默认 1000）"),

            // entity.salespriceitem.unitofmeasure
            new TranslationSeedItem("entity.salespriceitem.unitofmeasure", "en-US", "计量单位_us", "计量单位（字典 logistics_materials_unit_of_measure_code；DictValue=PC/EA 等；默认 PC）"),
            // entity.salespriceitem.unitofmeasure
            new TranslationSeedItem("entity.salespriceitem.unitofmeasure", "ja-JP", "计量单位_jp", "计量单位（字典 logistics_materials_unit_of_measure_code；DictValue=PC/EA 等；默认 PC）"),
            // entity.salespriceitem.unitofmeasure
            new TranslationSeedItem("entity.salespriceitem.unitofmeasure", "zh-CN", "计量单位", "计量单位（字典 logistics_materials_unit_of_measure_code；DictValue=PC/EA 等；默认 PC）"),
            // entity.salespriceitem.unitofmeasure
            new TranslationSeedItem("entity.salespriceitem.unitofmeasure", "zh-HK", "计量单位_hk", "计量单位（字典 logistics_materials_unit_of_measure_code；DictValue=PC/EA 等；默认 PC）"),
            ...
            new TranslationSeedItem("entity.salespriceitem.isobsolete", "en-US", "是否作废_us", "是否作废（字典 sys_yes_no；0=否 1=是；编辑移除子行时标记作废）"),
            // entity.salespriceitem.isobsolete
            new TranslationSeedItem("entity.salespriceitem.isobsolete", "ja-JP", "是否作废_jp", "是否作废（字典 sys_yes_no；0=否 1=是；编辑移除子行时标记作废）"),
            // entity.salespriceitem.isobsolete
            new TranslationSeedItem("entity.salespriceitem.isobsolete", "zh-CN", "是否作废", "是否作废（字典 sys_yes_no；0=否 1=是；编辑移除子行时标记作废）"),
            // entity.salespriceitem.isobsolete
            new TranslationSeedItem("entity.salespriceitem.isobsolete", "zh-HK", "是否作废_hk", "是否作废（字典 sys_yes_no；0=否 1=是；编辑移除子行时标记作废）"),
