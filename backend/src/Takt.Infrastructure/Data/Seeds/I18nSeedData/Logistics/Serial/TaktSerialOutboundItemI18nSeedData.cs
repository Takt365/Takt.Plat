...
public class TaktSerialOutboundItemI18nSeedData : ITaktSeedDataCoordinator
{
    ...
    private static List<TranslationSeedItem> GetSerialOutboundItemTranslations()
    {
        return new List<TranslationSeedItem>
        {
            ...
            // entity.serialoutbounditem.outboundtime
            new TranslationSeedItem("entity.serialoutbounditem.outboundtime", "ja-JP", "出库时间_jp", "出库时间"),
            // entity.serialoutbounditem.outboundtime
            new TranslationSeedItem("entity.serialoutbounditem.outboundtime", "zh-CN", "出库时间", "出库时间"),
            // entity.serialoutbounditem.outboundtime
            new TranslationSeedItem("entity.serialoutbounditem.outboundtime", "zh-HK", "出库时间_hk", "出库时间"),
