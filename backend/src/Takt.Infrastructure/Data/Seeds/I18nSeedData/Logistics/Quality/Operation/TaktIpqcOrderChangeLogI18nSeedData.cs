...
public class TaktIpqcOrderChangeLogI18nSeedData : ITaktSeedDataCoordinator
{
    ...
    private static List<TranslationSeedItem> GetIpqcOrderChangeLogTranslations()
    {
        return new List<TranslationSeedItem>
        {
            ...
            new TranslationSeedItem("entity.ipqcorderchangelog.ipqcorderid", "en-US", "IPQC检验单ID_us", "IPQC检验单 ID（关联 TaktIpqcOrder.Id，选项 TaktIpqcOrders/options）"),
            // entity.ipqcorderchangelog.ipqcorderid
            new TranslationSeedItem("entity.ipqcorderchangelog.ipqcorderid", "ja-JP", "IPQC检验单ID_jp", "IPQC检验单 ID（关联 TaktIpqcOrder.Id，选项 TaktIpqcOrders/options）"),
            // entity.ipqcorderchangelog.ipqcorderid
            new TranslationSeedItem("entity.ipqcorderchangelog.ipqcorderid", "zh-CN", "IPQC检验单ID", "IPQC检验单 ID（关联 TaktIpqcOrder.Id，选项 TaktIpqcOrders/options）"),
            // entity.ipqcorderchangelog.ipqcorderid
            new TranslationSeedItem("entity.ipqcorderchangelog.ipqcorderid", "zh-HK", "IPQC检验单ID_hk", "IPQC检验单 ID（关联 TaktIpqcOrder.Id，选项 TaktIpqcOrders/options）"),
