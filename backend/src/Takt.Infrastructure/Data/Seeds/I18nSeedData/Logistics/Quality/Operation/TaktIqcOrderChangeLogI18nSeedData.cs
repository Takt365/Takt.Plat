...
public class TaktIqcOrderChangeLogI18nSeedData : ITaktSeedDataCoordinator
{
    ...
    /// I18nKey：entity.iqcorderchangelog._self / entity.iqcorderchangelog.{{field}}；ResourceGroup=Operation；ResourceType=frontend
    /// </summary>
    private static List<TranslationSeedItem> GetIqcOrderChangeLogTranslations()
    {
        return new List<TranslationSeedItem>
        {
            ...
            new TranslationSeedItem("entity.iqcorderchangelog._self", "en-US", "Iqc Order Change Log Information_us", "实体名称"),
            // entity.iqcorderchangelog._self
            new TranslationSeedItem("entity.iqcorderchangelog._self", "ja-JP", "IQC进货检验单变更日志信息_jp", "实体名称"),
            // entity.iqcorderchangelog._self
            ...
            // entity.iqcorderchangelog.changefields
            new TranslationSeedItem("entity.iqcorderchangelog.changefields", "ja-JP", "变更字段列表_jp", "变更字段列表（JSON数组格式，记录同一时间点修改的所有字段及其旧值、新值） 格式：[{\"field\":\"FieldName\",\"description\":\"字段描述\",\"oldValue\":\"旧值\",\"newValue\":\"新值\"}]"),
            // entity.iqcorderchangelog.changefields
            ...
            // entity.iqcorderchangelog.changefields
            new TranslationSeedItem("entity.iqcorderchangelog.changefields", "zh-HK", "变更字段列表_hk", "变更字段列表（JSON数组格式，记录同一时间点修改的所有字段及其旧值、新值） 格式：[{\"field\":\"FieldName\",\"description\":\"字段描述\",\"oldValue\":\"旧值\",\"newValue\":\"新值\"}]"),

            // entity.iqcorderchangelog.changetype
            new TranslationSeedItem("entity.iqcorderchangelog.changetype", "en-US", "变更类型_us", "变更类型（0=新增，1=修改，2=删除，3=状态变更）"),
            // entity.iqcorderchangelog.changetype
            new TranslationSeedItem("entity.iqcorderchangelog.changetype", "ja-JP", "变更类型_jp", "变更类型（0=新增，1=修改，2=删除，3=状态变更）"),
            // entity.iqcorderchangelog.changetype
            new TranslationSeedItem("entity.iqcorderchangelog.changetype", "zh-CN", "变更类型", "变更类型（0=新增，1=修改，2=删除，3=状态变更）"),
            // entity.iqcorderchangelog.changetype
            new TranslationSeedItem("entity.iqcorderchangelog.changetype", "zh-HK", "变更类型_hk", "变更类型（0=新增，1=修改，2=删除，3=状态变更）"),

            // entity.iqcorderchangelog.changereason
            new TranslationSeedItem("entity.iqcorderchangelog.changereason", "en-US", "变更原因_us", "变更原因"),
            // entity.iqcorderchangelog.changereason
            new TranslationSeedItem("entity.iqcorderchangelog.changereason", "ja-JP", "变更原因_jp", "变更原因"),
            // entity.iqcorderchangelog.changereason
            new TranslationSeedItem("entity.iqcorderchangelog.changereason", "zh-CN", "变更原因", "变更原因"),
            // entity.iqcorderchangelog.changereason
            new TranslationSeedItem("entity.iqcorderchangelog.changereason", "zh-HK", "变更原因_hk", "变更原因"),

            // entity.iqcorderchangelog.changeby
            new TranslationSeedItem("entity.iqcorderchangelog.changeby", "en-US", "变更人_us", "变更人（人员代码）"),
            // entity.iqcorderchangelog.changeby
            new TranslationSeedItem("entity.iqcorderchangelog.changeby", "ja-JP", "变更人_jp", "变更人（人员代码）"),
            // entity.iqcorderchangelog.changeby
            new TranslationSeedItem("entity.iqcorderchangelog.changeby", "zh-CN", "变更人", "变更人（人员代码）"),
            // entity.iqcorderchangelog.changeby
            new TranslationSeedItem("entity.iqcorderchangelog.changeby", "zh-HK", "变更人_hk", "变更人（人员代码）"),

            // entity.iqcorderchangelog.changetime
            new TranslationSeedItem("entity.iqcorderchangelog.changetime", "en-US", "变更时间_us", "变更时间"),
            // entity.iqcorderchangelog.changetime
            new TranslationSeedItem("entity.iqcorderchangelog.changetime", "ja-JP", "变更时间_jp", "变更时间"),
            // entity.iqcorderchangelog.changetime
            new TranslationSeedItem("entity.iqcorderchangelog.changetime", "zh-CN", "变更时间", "变更时间"),
            // entity.iqcorderchangelog.changetime
            new TranslationSeedItem("entity.iqcorderchangelog.changetime", "zh-HK", "变更时间_hk", "变更时间"),

            // entity.iqcorderchangelog.order
            new TranslationSeedItem("entity.iqcorderchangelog.order", "en-US", "IQC检验单_us", "IQC检验单（主表）"),
            // entity.iqcorderchangelog.order
            new TranslationSeedItem("entity.iqcorderchangelog.order", "ja-JP", "IQC检验单_jp", "IQC检验单（主表）"),
            // entity.iqcorderchangelog.order
            new TranslationSeedItem("entity.iqcorderchangelog.order", "zh-CN", "IQC检验单", "IQC检验单（主表）"),
            // entity.iqcorderchangelog.order
            new TranslationSeedItem("entity.iqcorderchangelog.order", "zh-HK", "IQC检验单_hk", "IQC检验单（主表）"),
        };
    }
