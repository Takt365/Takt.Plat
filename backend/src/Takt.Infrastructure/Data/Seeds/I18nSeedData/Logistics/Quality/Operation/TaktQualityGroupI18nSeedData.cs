...
public class TaktQualityGroupI18nSeedData : ITaktSeedDataCoordinator
{
    ...
    private static List<TranslationSeedItem> GetQualityGroupTranslations()
    {
        return new List<TranslationSeedItem>
        {
            ...
            new TranslationSeedItem("entity.qualitygroup.responsibleuserid", "en-US", "负责人用户ID_us", "质量组负责人用户 ID（关联 TaktUser.Id，选项 TaktUsers/options）"),
            // entity.qualitygroup.responsibleuserid
            new TranslationSeedItem("entity.qualitygroup.responsibleuserid", "ja-JP", "负责人用户ID_jp", "质量组负责人用户 ID（关联 TaktUser.Id，选项 TaktUsers/options）"),
            // entity.qualitygroup.responsibleuserid
            new TranslationSeedItem("entity.qualitygroup.responsibleuserid", "zh-CN", "负责人用户ID", "质量组负责人用户 ID（关联 TaktUser.Id，选项 TaktUsers/options）"),
            // entity.qualitygroup.responsibleuserid
            new TranslationSeedItem("entity.qualitygroup.responsibleuserid", "zh-HK", "负责人用户ID_hk", "质量组负责人用户 ID（关联 TaktUser.Id，选项 TaktUsers/options）"),
