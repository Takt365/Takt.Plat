...
public class TaktCustomerComplaintItemI18nSeedData : ITaktSeedDataCoordinator
{
    ...
    private static List<TranslationSeedItem> GetCustomerComplaintItemTranslations()
    {
        return new List<TranslationSeedItem>
        {
            ...
            new TranslationSeedItem("entity.customercomplaintitem.complaintid", "en-US", "客诉ID_us", "客诉ID（主子表关系，序列化为string以避免Javascript精度问题）"),
            // entity.customercomplaintitem.complaintid
            new TranslationSeedItem("entity.customercomplaintitem.complaintid", "ja-JP", "客诉ID_jp", "客诉ID（主子表关系，序列化为string以避免Javascript精度问题）"),
            // entity.customercomplaintitem.complaintid
            new TranslationSeedItem("entity.customercomplaintitem.complaintid", "zh-CN", "客诉ID", "客诉ID（主子表关系，序列化为string以避免Javascript精度问题）"),
            // entity.customercomplaintitem.complaintid
            new TranslationSeedItem("entity.customercomplaintitem.complaintid", "zh-HK", "客诉ID_hk", "客诉ID（主子表关系，序列化为string以避免Javascript精度问题）"),
            ...
            // entity.customercomplaintitem.customercomplaintcode
            new TranslationSeedItem("entity.customercomplaintitem.customercomplaintcode", "ja-JP", "客诉单号_jp", "客诉单号（冗余字段，便于查询）"),
            // entity.customercomplaintitem.customercomplaintcode
            new TranslationSeedItem("entity.customercomplaintitem.customercomplaintcode", "zh-CN", "客诉单号", "客诉单号（冗余字段，便于查询）"),
            // entity.customercomplaintitem.customercomplaintcode
            new TranslationSeedItem("entity.customercomplaintitem.customercomplaintcode", "zh-HK", "客诉单号_hk", "客诉单号（冗余字段，便于查询）"),
            ...
            new TranslationSeedItem("entity.customercomplaintitem.productcode", "en-US", "产品编码_us", "产品编码"),
            // entity.customercomplaintitem.productcode
            new TranslationSeedItem("entity.customercomplaintitem.productcode", "ja-JP", "产品编码_jp", "产品编码"),
            // entity.customercomplaintitem.productcode
            new TranslationSeedItem("entity.customercomplaintitem.productcode", "zh-CN", "产品编码", "产品编码"),
            // entity.customercomplaintitem.productcode
            new TranslationSeedItem("entity.customercomplaintitem.productcode", "zh-HK", "产品编码_hk", "产品编码"),
            ...
            new TranslationSeedItem("entity.customercomplaintitem.itemtype", "en-US", "不良项目类型_us", "不良项目类型（0=外观，1=尺寸，2=性能，3=功能，4=包装，5=其他）"),
            // entity.customercomplaintitem.itemtype
            new TranslationSeedItem("entity.customercomplaintitem.itemtype", "ja-JP", "不良项目类型_jp", "不良项目类型（0=外观，1=尺寸，2=性能，3=功能，4=包装，5=其他）"),
            // entity.customercomplaintitem.itemtype
            new TranslationSeedItem("entity.customercomplaintitem.itemtype", "zh-CN", "不良项目类型", "不良项目类型（0=外观，1=尺寸，2=性能，3=功能，4=包装，5=其他）"),
            // entity.customercomplaintitem.itemtype
            new TranslationSeedItem("entity.customercomplaintitem.itemtype", "zh-HK", "不良项目类型_hk", "不良项目类型（0=外观，1=尺寸，2=性能，3=功能，4=包装，5=其他）"),
            ...
            new TranslationSeedItem("entity.customercomplaintitem.defectlevel", "en-US", "缺点等级_us", "缺点等级（CR=严重，MA=主要，MI=次要）"),
            // entity.customercomplaintitem.defectlevel
            new TranslationSeedItem("entity.customercomplaintitem.defectlevel", "ja-JP", "缺点等级_jp", "缺点等级（CR=严重，MA=主要，MI=次要）"),
            // entity.customercomplaintitem.defectlevel
            new TranslationSeedItem("entity.customercomplaintitem.defectlevel", "zh-CN", "缺点等级", "缺点等级（CR=严重，MA=主要，MI=次要）"),
            // entity.customercomplaintitem.defectlevel
            new TranslationSeedItem("entity.customercomplaintitem.defectlevel", "zh-HK", "缺点等级_hk", "缺点等级（CR=严重，MA=主要，MI=次要）"),
            ...
            new TranslationSeedItem("entity.customercomplaintitem.improvementresponsible", "en-US", "改善责任人_us", "改善责任人"),
            // entity.customercomplaintitem.improvementresponsible
            new TranslationSeedItem("entity.customercomplaintitem.improvementresponsible", "ja-JP", "改善责任人_jp", "改善责任人"),
            // entity.customercomplaintitem.improvementresponsible
            new TranslationSeedItem("entity.customercomplaintitem.improvementresponsible", "zh-CN", "改善责任人", "改善责任人"),
            // entity.customercomplaintitem.improvementresponsible
            new TranslationSeedItem("entity.customercomplaintitem.improvementresponsible", "zh-HK", "改善责任人_hk", "改善责任人"),
            ...
            new TranslationSeedItem("entity.customercomplaintitem.improvementstatus", "en-US", "改善状态_us", "改善状态（0=待改善，1=改善中，2=已完成，3=已验证）"),
            // entity.customercomplaintitem.improvementstatus
            new TranslationSeedItem("entity.customercomplaintitem.improvementstatus", "ja-JP", "改善状态_jp", "改善状态（0=待改善，1=改善中，2=已完成，3=已验证）"),
            // entity.customercomplaintitem.improvementstatus
            new TranslationSeedItem("entity.customercomplaintitem.improvementstatus", "zh-CN", "改善状态", "改善状态（0=待改善，1=改善中，2=已完成，3=已验证）"),
            // entity.customercomplaintitem.improvementstatus
            new TranslationSeedItem("entity.customercomplaintitem.improvementstatus", "zh-HK", "改善状态_hk", "改善状态（0=待改善，1=改善中，2=已完成，3=已验证）"),

            // entity.customercomplaintitem.attachmentpaths
            new TranslationSeedItem("entity.customercomplaintitem.attachmentpaths", "en-US", "附件路径_us", "附件路径（多个附件用逗号分隔）"),
            // entity.customercomplaintitem.attachmentpaths
            new TranslationSeedItem("entity.customercomplaintitem.attachmentpaths", "ja-JP", "附件路径_jp", "附件路径（多个附件用逗号分隔）"),
            // entity.customercomplaintitem.attachmentpaths
            new TranslationSeedItem("entity.customercomplaintitem.attachmentpaths", "zh-CN", "附件路径", "附件路径（多个附件用逗号分隔）"),
            // entity.customercomplaintitem.attachmentpaths
            new TranslationSeedItem("entity.customercomplaintitem.attachmentpaths", "zh-HK", "附件路径_hk", "附件路径（多个附件用逗号分隔）"),
