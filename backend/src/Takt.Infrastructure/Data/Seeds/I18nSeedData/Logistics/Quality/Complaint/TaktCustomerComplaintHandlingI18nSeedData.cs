...
public class TaktCustomerComplaintHandlingI18nSeedData : ITaktSeedDataCoordinator
{
    ...
    private static List<TranslationSeedItem> GetCustomerComplaintHandlingTranslations()
    {
        return new List<TranslationSeedItem>
        {
            ...
            new TranslationSeedItem("entity.customercomplainthandling.complaintid", "en-US", "客诉ID_us", "客诉ID（主子表关系，序列化为string以避免Javascript精度问题）"),
            // entity.customercomplainthandling.complaintid
            new TranslationSeedItem("entity.customercomplainthandling.complaintid", "ja-JP", "客诉ID_jp", "客诉ID（主子表关系，序列化为string以避免Javascript精度问题）"),
            // entity.customercomplainthandling.complaintid
            new TranslationSeedItem("entity.customercomplainthandling.complaintid", "zh-CN", "客诉ID", "客诉ID（主子表关系，序列化为string以避免Javascript精度问题）"),
            // entity.customercomplainthandling.complaintid
            new TranslationSeedItem("entity.customercomplainthandling.complaintid", "zh-HK", "客诉ID_hk", "客诉ID（主子表关系，序列化为string以避免Javascript精度问题）"),

            // entity.customercomplainthandling.complaintno
            new TranslationSeedItem("entity.customercomplainthandling.complaintno", "en-US", "客诉单号_us", "客诉单号（冗余字段，便于查询）"),
            // entity.customercomplainthandling.complaintno
            new TranslationSeedItem("entity.customercomplainthandling.complaintno", "ja-JP", "客诉单号_jp", "客诉单号（冗余字段，便于查询）"),
            // entity.customercomplainthandling.complaintno
            new TranslationSeedItem("entity.customercomplainthandling.complaintno", "zh-CN", "客诉单号", "客诉单号（冗余字段，便于查询）"),
            // entity.customercomplainthandling.complaintno
            new TranslationSeedItem("entity.customercomplainthandling.complaintno", "zh-HK", "客诉单号_hk", "客诉单号（冗余字段，便于查询）"),

            // entity.customercomplainthandling.complaintitemid
            new TranslationSeedItem("entity.customercomplainthandling.complaintitemid", "en-US", "客诉明细ID_us", "客诉明细ID（可选，关联到具体不良项目，序列化为string以避免Javascript精度问题）"),
            // entity.customercomplainthandling.complaintitemid
            new TranslationSeedItem("entity.customercomplainthandling.complaintitemid", "ja-JP", "客诉明细ID_jp", "客诉明细ID（可选，关联到具体不良项目，序列化为string以避免Javascript精度问题）"),
            // entity.customercomplainthandling.complaintitemid
            ...
            // entity.customercomplainthandling.complaintitemid
            new TranslationSeedItem("entity.customercomplainthandling.complaintitemid", "zh-HK", "客诉明细ID_hk", "客诉明细ID（可选，关联到具体不良项目，序列化为string以避免Javascript精度问题）"),

            // entity.customercomplainthandling.handlingstage
            new TranslationSeedItem("entity.customercomplainthandling.handlingstage", "en-US", "处理阶段_us", "处理阶段（0=初步响应，1=原因分析，2=改善对策，3=效果验证，4=结案）"),
            // entity.customercomplainthandling.handlingstage
            new TranslationSeedItem("entity.customercomplainthandling.handlingstage", "ja-JP", "处理阶段_jp", "处理阶段（0=初步响应，1=原因分析，2=改善对策，3=效果验证，4=结案）"),
            // entity.customercomplainthandling.handlingstage
            new TranslationSeedItem("entity.customercomplainthandling.handlingstage", "zh-CN", "处理阶段", "处理阶段（0=初步响应，1=原因分析，2=改善对策，3=效果验证，4=结案）"),
            // entity.customercomplainthandling.handlingstage
            new TranslationSeedItem("entity.customercomplainthandling.handlingstage", "zh-HK", "处理阶段_hk", "处理阶段（0=初步响应，1=原因分析，2=改善对策，3=效果验证，4=结案）"),

            // entity.customercomplainthandling.handlingmethod
            new TranslationSeedItem("entity.customercomplainthandling.handlingmethod", "en-US", "处理方式_us", "处理方式（0=返工，1=返修，2=补货，3=退货，4=退款，5=折扣，6=其他）"),
            // entity.customercomplainthandling.handlingmethod
            new TranslationSeedItem("entity.customercomplainthandling.handlingmethod", "ja-JP", "处理方式_jp", "处理方式（0=返工，1=返修，2=补货，3=退货，4=退款，5=折扣，6=其他）"),
            // entity.customercomplainthandling.handlingmethod
            ...
            // entity.customercomplainthandling.handlingmethod
            new TranslationSeedItem("entity.customercomplainthandling.handlingmethod", "zh-HK", "处理方式_hk", "处理方式（0=返工，1=返修，2=补货，3=退货，4=退款，5=折扣，6=其他）"),
            ...
            new TranslationSeedItem("entity.customercomplainthandling.responsibledept", "en-US", "责任部门_us", "责任部门"),
            // entity.customercomplainthandling.responsibledept
            new TranslationSeedItem("entity.customercomplainthandling.responsibledept", "ja-JP", "责任部门_jp", "责任部门"),
            // entity.customercomplainthandling.responsibledept
            new TranslationSeedItem("entity.customercomplainthandling.responsibledept", "zh-CN", "责任部门", "责任部门"),
            // entity.customercomplainthandling.responsibledept
            new TranslationSeedItem("entity.customercomplainthandling.responsibledept", "zh-HK", "责任部门_hk", "责任部门"),

            // entity.customercomplainthandling.responsibleby
            new TranslationSeedItem("entity.customercomplainthandling.responsibleby", "en-US", "责任人_us", "责任人（人员代码）"),
            // entity.customercomplainthandling.responsibleby
            new TranslationSeedItem("entity.customercomplainthandling.responsibleby", "ja-JP", "责任人_jp", "责任人（人员代码）"),
            // entity.customercomplainthandling.responsibleby
            new TranslationSeedItem("entity.customercomplainthandling.responsibleby", "zh-CN", "责任人", "责任人（人员代码）"),
            // entity.customercomplainthandling.responsibleby
            new TranslationSeedItem("entity.customercomplainthandling.responsibleby", "zh-HK", "责任人_hk", "责任人（人员代码）"),

            // entity.customercomplainthandling.handlerby
            new TranslationSeedItem("entity.customercomplainthandling.handlerby", "en-US", "处理人_us", "处理人（人员代码）"),
            // entity.customercomplainthandling.handlerby
            new TranslationSeedItem("entity.customercomplainthandling.handlerby", "ja-JP", "处理人_jp", "处理人（人员代码）"),
            // entity.customercomplainthandling.handlerby
            new TranslationSeedItem("entity.customercomplainthandling.handlerby", "zh-CN", "处理人", "处理人（人员代码）"),
            // entity.customercomplainthandling.handlerby
            new TranslationSeedItem("entity.customercomplainthandling.handlerby", "zh-HK", "处理人_hk", "处理人（人员代码）"),
            ...
            new TranslationSeedItem("entity.customercomplainthandling.handlingstatus", "en-US", "处理状态_us", "处理状态（0=待处理，1=处理中，2=已完成，3=已关闭，4=已驳回）"),
            // entity.customercomplainthandling.handlingstatus
            new TranslationSeedItem("entity.customercomplainthandling.handlingstatus", "ja-JP", "处理状态_jp", "处理状态（0=待处理，1=处理中，2=已完成，3=已关闭，4=已驳回）"),
            // entity.customercomplainthandling.handlingstatus
            new TranslationSeedItem("entity.customercomplainthandling.handlingstatus", "zh-CN", "处理状态", "处理状态（0=待处理，1=处理中，2=已完成，3=已关闭，4=已驳回）"),
            // entity.customercomplainthandling.handlingstatus
            new TranslationSeedItem("entity.customercomplainthandling.handlingstatus", "zh-HK", "处理状态_hk", "处理状态（0=待处理，1=处理中，2=已完成，3=已关闭，4=已驳回）"),
            ...
            new TranslationSeedItem("entity.customercomplainthandling.customersatisfaction", "en-US", "客户满意度_us", "客户满意度（0=不满意，1=一般，2=满意，3=非常满意）"),
            // entity.customercomplainthandling.customersatisfaction
            new TranslationSeedItem("entity.customercomplainthandling.customersatisfaction", "ja-JP", "客户满意度_jp", "客户满意度（0=不满意，1=一般，2=满意，3=非常满意）"),
            // entity.customercomplainthandling.customersatisfaction
            new TranslationSeedItem("entity.customercomplainthandling.customersatisfaction", "zh-CN", "客户满意度", "客户满意度（0=不满意，1=一般，2=满意，3=非常满意）"),
            // entity.customercomplainthandling.customersatisfaction
            new TranslationSeedItem("entity.customercomplainthandling.customersatisfaction", "zh-HK", "客户满意度_hk", "客户满意度（0=不满意，1=一般，2=满意，3=非常满意）"),
