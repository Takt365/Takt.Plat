...
public class TaktQualityFailurePcbaReworkI18nSeedData : ITaktSeedDataCoordinator
{
    ...
    /// I18nKey：entity.qualityFailurePcbaRework._self / entity.qualityFailurePcbaRework.{{field}}；ResourceGroup=TaktModule.Logistics；ResourceType=TaktAppSide.Frontend
    /// </summary>
