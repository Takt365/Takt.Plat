...
public class TaktQualityIncidentItemI18nSeedData : ITaktSeedDataCoordinator
{
    ...
    private static List<TranslationSeedItem> GetQualityIncidentItemTranslations()
    {
        return new List<TranslationSeedItem>
        {
            ...
            new TranslationSeedItem("entity.qualityincidentitem.materialdescription", "en-US", "物料描述_us", "物料描述（回填：随物料）"),
            // entity.qualityincidentitem.materialdescription
            new TranslationSeedItem("entity.qualityincidentitem.materialdescription", "ja-JP", "物料描述_jp", "物料描述（回填：随物料）"),
            // entity.qualityincidentitem.materialdescription
            new TranslationSeedItem("entity.qualityincidentitem.materialdescription", "zh-CN", "物料描述", "物料描述（回填：随物料）"),
            // entity.qualityincidentitem.materialdescription
            new TranslationSeedItem("entity.qualityincidentitem.materialdescription", "zh-HK", "物料描述_hk", "物料描述（回填：随物料）"),
