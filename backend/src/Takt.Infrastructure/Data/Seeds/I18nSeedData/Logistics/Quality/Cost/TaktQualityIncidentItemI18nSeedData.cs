...
public class TaktQualityIncidentItemI18nSeedData : ITaktSeedDataCoordinator
{
    ...
    private static List<TranslationSeedItem> GetQualityIncidentItemTranslations()
    {
        return new List<TranslationSeedItem>
        {
            ...
            // entity.qualityincidentitem.materialname
            new TranslationSeedItem("entity.qualityincidentitem.materialname", "ja-JP", "物料名称_jp", "物料名称（回填：随物料）"),
            // entity.qualityincidentitem.materialname
            new TranslationSeedItem("entity.qualityincidentitem.materialname", "zh-CN", "物料名称", "物料名称（回填：随物料）"),
            // entity.qualityincidentitem.materialname
            new TranslationSeedItem("entity.qualityincidentitem.materialname", "zh-HK", "物料名称_hk", "物料名称（回填：随物料）"),
