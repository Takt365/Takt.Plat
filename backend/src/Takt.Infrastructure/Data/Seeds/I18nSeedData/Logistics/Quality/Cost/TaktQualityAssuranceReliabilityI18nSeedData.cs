...
public class TaktQualityAssuranceReliabilityI18nSeedData : ITaktSeedDataCoordinator
{
    ...
    private static List<TranslationSeedItem> GetQualityAssuranceReliabilityTranslations()
    {
        return new List<TranslationSeedItem>
        {
            ...
            new TranslationSeedItem("entity.qualityassurancereliability.qualityassuranceid", "en-US", "品质业务主表ID_us", "品质业务主表 ID（关联 TaktQualityAssurance.Id，选项 TaktQualityAssurances/options）"),
            // entity.qualityassurancereliability.qualityassuranceid
            new TranslationSeedItem("entity.qualityassurancereliability.qualityassuranceid", "ja-JP", "品质业务主表ID_jp", "品质业务主表 ID（关联 TaktQualityAssurance.Id，选项 TaktQualityAssurances/options）"),
            // entity.qualityassurancereliability.qualityassuranceid
            new TranslationSeedItem("entity.qualityassurancereliability.qualityassuranceid", "zh-CN", "品质业务主表ID", "品质业务主表 ID（关联 TaktQualityAssurance.Id，选项 TaktQualityAssurances/options）"),
            // entity.qualityassurancereliability.qualityassuranceid
            new TranslationSeedItem("entity.qualityassurancereliability.qualityassuranceid", "zh-HK", "品质业务主表ID_hk", "品质业务主表 ID（关联 TaktQualityAssurance.Id，选项 TaktQualityAssurances/options）"),
            ...
            new TranslationSeedItem("entity.qualityassurancereliability.isobsolete", "en-US", "是否作废_us", "是否作废（字典 sys_yes_no_type，0=否 1=是；编辑移除子行时标记作废）"),
            // entity.qualityassurancereliability.isobsolete
            new TranslationSeedItem("entity.qualityassurancereliability.isobsolete", "ja-JP", "是否作废_jp", "是否作废（字典 sys_yes_no_type，0=否 1=是；编辑移除子行时标记作废）"),
            // entity.qualityassurancereliability.isobsolete
            new TranslationSeedItem("entity.qualityassurancereliability.isobsolete", "zh-CN", "是否作废", "是否作废（字典 sys_yes_no_type，0=否 1=是；编辑移除子行时标记作废）"),
            // entity.qualityassurancereliability.isobsolete
            new TranslationSeedItem("entity.qualityassurancereliability.isobsolete", "zh-HK", "是否作废_hk", "是否作废（字典 sys_yes_no_type，0=否 1=是；编辑移除子行时标记作废）"),
