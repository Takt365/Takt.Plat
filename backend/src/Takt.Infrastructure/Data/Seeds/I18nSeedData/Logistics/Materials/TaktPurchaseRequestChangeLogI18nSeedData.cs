...
public class TaktPurchaseRequestChangeLogI18nSeedData : ITaktSeedDataCoordinator
{
    ...
    /// I18nKey：entity.purchaseRequestChangeLog._self / entity.purchaseRequestChangeLog.{{field}}；ResourceGroup=TaktModule.Logistics；ResourceType=TaktAppSide.Frontend
    /// </summary>
