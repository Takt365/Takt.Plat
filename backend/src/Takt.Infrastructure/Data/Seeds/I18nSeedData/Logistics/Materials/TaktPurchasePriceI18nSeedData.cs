...
public class TaktPurchasePriceI18nSeedData : ITaktSeedDataCoordinator
{
    ...
    private static List<TranslationSeedItem> GetPurchasePriceTranslations()
    {
        return new List<TranslationSeedItem>
        {
            ...
            new TranslationSeedItem("entity.purchasePrice.items", "en-US", "物料价格明细列表", "物料价格明细列表（主子表关系，一个供应商价格可以有多个物料价格）"),
            // entity.purchasePrice.items
            new TranslationSeedItem("entity.purchasePrice.items", "ja-JP", "物料价格明细列表", "物料价格明细列表（主子表关系，一个供应商价格可以有多个物料价格）"),
            // entity.purchasePrice.items
            new TranslationSeedItem("entity.purchasePrice.items", "zh-CN", "物料价格明细列表", "物料价格明细列表（主子表关系，一个供应商价格可以有多个物料价格）"),
            // entity.purchasePrice.items
            new TranslationSeedItem("entity.purchasePrice.items", "zh-HK", "物料价格明细列表", "物料价格明细列表（主子表关系，一个供应商价格可以有多个物料价格）"),

            // entity.purchasePrice.changelogs
            new TranslationSeedItem("entity.purchasePrice.changelogs", "en-US", "采购价格变更记录列表", "采购价格变更记录列表（外键在子表 <see cref=\"TaktPurchasePriceChangeLog.PriceId\"/>）"),
            // entity.purchasePrice.changelogs
            new TranslationSeedItem("entity.purchasePrice.changelogs", "ja-JP", "采购价格变更记录列表", "采购价格变更记录列表（外键在子表 <see cref=\"TaktPurchasePriceChangeLog.PriceId\"/>）"),
            // entity.purchasePrice.changelogs
            new TranslationSeedItem("entity.purchasePrice.changelogs", "zh-CN", "采购价格变更记录列表", "采购价格变更记录列表（外键在子表 <see cref=\"TaktPurchasePriceChangeLog.PriceId\"/>）"),
            // entity.purchasePrice.changelogs
            new TranslationSeedItem("entity.purchasePrice.changelogs", "zh-HK", "采购价格变更记录列表", "采购价格变更记录列表（外键在子表 <see cref=\"TaktPurchasePriceChangeLog.PriceId\"/>）"),
        };
    }
