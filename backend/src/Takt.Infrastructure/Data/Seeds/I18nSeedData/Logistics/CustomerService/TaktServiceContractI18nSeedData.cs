...
public class TaktServiceContractI18nSeedData : ITaktSeedDataCoordinator
{
    ...
    /// I18nKey：entity.servicecontract._self / entity.servicecontract.{{field}}；ResourceGroup=4；ResourceType=0
    /// </summary>
    private static List<TranslationSeedItem> GetServiceContractTranslations()
    {
        return new List<TranslationSeedItem>
        {
            ...
            new TranslationSeedItem("entity.servicecontract.serviceorders", "en-US", "服务订单列表", "服务订单列表（外键在子表 TaktServiceOrder.ServiceContractId）"),
            // entity.servicecontract.serviceorders
            new TranslationSeedItem("entity.servicecontract.serviceorders", "ja-JP", "服务订单列表", "服务订单列表（外键在子表 TaktServiceOrder.ServiceContractId）"),
            // entity.servicecontract.serviceorders
            ...
            // entity.servicecontract.serviceorders
            new TranslationSeedItem("entity.servicecontract.serviceorders", "zh-HK", "服务订单列表", "服务订单列表（外键在子表 TaktServiceOrder.ServiceContractId）"),

            // entity.servicecontract.servicerequests
            new TranslationSeedItem("entity.servicecontract.servicerequests", "en-US", "服务请求列表", "服务请求列表（外键在子表 TaktServiceRequest.ServiceContractId）"),
            // entity.servicecontract.servicerequests
            new TranslationSeedItem("entity.servicecontract.servicerequests", "ja-JP", "服务请求列表", "服务请求列表（外键在子表 TaktServiceRequest.ServiceContractId）"),
            // entity.servicecontract.servicerequests
            ...
            // entity.servicecontract.servicerequests
            new TranslationSeedItem("entity.servicecontract.servicerequests", "zh-HK", "服务请求列表", "服务请求列表（外键在子表 TaktServiceRequest.ServiceContractId）"),
        };
    }
