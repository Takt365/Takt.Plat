...
public class TaktMenuI18nSeedData : ITaktSeedDataCoordinator
{
    ...
    /// I18nKey：entity.menu._self / entity.menu.{{field}}；ResourceGroup=TaktModule.Identity；ResourceType=TaktAppSide.Frontend
    /// </summary>
    private static List<TranslationSeedItem> GetMenuTranslations()
    {
        return new List<TranslationSeedItem>
        {
            ...
            // entity.menu.type
            new TranslationSeedItem("entity.menu.type", "en-US", "菜单类型", "菜单类型（与 <see cref=\"Takt.Shared.Enums.TaktMenuType\"/> 一致：0=目录，1=页面菜单，2=按钮）"),
            // entity.menu.type
            new TranslationSeedItem("entity.menu.type", "ja-JP", "菜单类型", "菜单类型（与 <see cref=\"Takt.Shared.Enums.TaktMenuType\"/> 一致：0=目录，1=页面菜单，2=按钮）"),
            // entity.menu.type
            new TranslationSeedItem("entity.menu.type", "zh-CN", "菜单类型", "菜单类型（与 <see cref=\"Takt.Shared.Enums.TaktMenuType\"/> 一致：0=目录，1=页面菜单，2=按钮）"),
            // entity.menu.type
            new TranslationSeedItem("entity.menu.type", "zh-HK", "菜单类型", "菜单类型（与 <see cref=\"Takt.Shared.Enums.TaktMenuType\"/> 一致：0=目录，1=页面菜单，2=按钮）"),
