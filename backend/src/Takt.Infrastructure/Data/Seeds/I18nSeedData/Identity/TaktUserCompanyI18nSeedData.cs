...
public class TaktUserCompanyI18nSeedData : ITaktSeedDataCoordinator
{
    ...
    private static List<TranslationSeedItem> GetUserCompanyTranslations()
    {
        return new List<TranslationSeedItem>
        {
            ...
            new TranslationSeedItem("entity.usercompany.isdefault", "en-US", "默认公司_us", "是否默认登录公司（字典 sys_is_default_type；1=是 0=否） 同一用户在同一租户下仅应有一条为 1；登录时由 TaktAuthService 按 IsDefault=1 解析默认公司 演示种子 TaktUserCompanySeedData 为所有用户关联全部公司，默认登录公司为 <c>2300</c>"),
            // entity.usercompany.isdefault
            new TranslationSeedItem("entity.usercompany.isdefault", "ja-JP", "默认公司_jp", "是否默认登录公司（字典 sys_is_default_type；1=是 0=否） 同一用户在同一租户下仅应有一条为 1；登录时由 TaktAuthService 按 IsDefault=1 解析默认公司 演示种子 TaktUserCompanySeedData 为所有用户关联全部公司，默认登录公司为 <c>2300</c>"),
            // entity.usercompany.isdefault
            new TranslationSeedItem("entity.usercompany.isdefault", "zh-CN", "默认公司", "是否默认登录公司（字典 sys_is_default_type；1=是 0=否） 同一用户在同一租户下仅应有一条为 1；登录时由 TaktAuthService 按 IsDefault=1 解析默认公司 演示种子 TaktUserCompanySeedData 为所有用户关联全部公司，默认登录公司为 <c>2300</c>"),
            // entity.usercompany.isdefault
            new TranslationSeedItem("entity.usercompany.isdefault", "zh-HK", "默认公司_hk", "是否默认登录公司（字典 sys_is_default_type；1=是 0=否） 同一用户在同一租户下仅应有一条为 1；登录时由 TaktAuthService 按 IsDefault=1 解析默认公司 演示种子 TaktUserCompanySeedData 为所有用户关联全部公司，默认登录公司为 <c>2300</c>"),
