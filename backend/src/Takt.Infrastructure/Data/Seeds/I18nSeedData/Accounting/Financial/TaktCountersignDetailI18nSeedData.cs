...
public class TaktCountersignDetailI18nSeedData : ITaktSeedDataCoordinator
{
    ...
    private static List<TranslationSeedItem> GetCountersignDetailTranslations()
    {
        return new List<TranslationSeedItem>
        {
            ...
            new TranslationSeedItem("entity.countersigndetail.accounttitle", "en-US", "会计科目_us", "会计科目（关联 TaktAccountTitle.AccountTitleCode，选项 TaktAccountTitles/options）"),
            // entity.countersigndetail.accounttitle
            new TranslationSeedItem("entity.countersigndetail.accounttitle", "ja-JP", "会计科目_jp", "会计科目（关联 TaktAccountTitle.AccountTitleCode，选项 TaktAccountTitles/options）"),
            // entity.countersigndetail.accounttitle
            new TranslationSeedItem("entity.countersigndetail.accounttitle", "zh-CN", "会计科目", "会计科目（关联 TaktAccountTitle.AccountTitleCode，选项 TaktAccountTitles/options）"),
            // entity.countersigndetail.accounttitle
            new TranslationSeedItem("entity.countersigndetail.accounttitle", "zh-HK", "会计科目_hk", "会计科目（关联 TaktAccountTitle.AccountTitleCode，选项 TaktAccountTitles/options）"),
