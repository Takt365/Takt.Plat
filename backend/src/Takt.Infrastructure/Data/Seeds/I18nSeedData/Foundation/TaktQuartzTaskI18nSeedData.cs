...
public class TaktQuartzTaskI18nSeedData : ITaktSeedDataCoordinator
{
    ...
    /// I18nKey：entity.quartztask._self / entity.quartztask.{{field}}；ResourceGroup=8；ResourceType=0
    /// </summary>
    private static List<TranslationSeedItem> GetQuartzTaskTranslations()
    {
        return new List<TranslationSeedItem>
        {
            ...
            new TranslationSeedItem("entity.quartztask.taskstatus", "en-US", "任务状态", "任务状态（0=正常 1=暂停）"),
            // entity.quartztask.taskstatus
            new TranslationSeedItem("entity.quartztask.taskstatus", "ja-JP", "任务状态", "任务状态（0=正常 1=暂停）"),
            // entity.quartztask.taskstatus
            new TranslationSeedItem("entity.quartztask.taskstatus", "zh-CN", "任务状态", "任务状态（0=正常 1=暂停）"),
            // entity.quartztask.taskstatus
            new TranslationSeedItem("entity.quartztask.taskstatus", "zh-HK", "任务状态", "任务状态（0=正常 1=暂停）"),

            // entity.quartztask.concurrent
            new TranslationSeedItem("entity.quartztask.concurrent", "en-US", "是否并发", "是否允许并发执行（字典 sys_yes_no；0=否 1=是）"),
            // entity.quartztask.concurrent
            new TranslationSeedItem("entity.quartztask.concurrent", "ja-JP", "是否并发", "是否允许并发执行（字典 sys_yes_no；0=否 1=是）"),
            // entity.quartztask.concurrent
            new TranslationSeedItem("entity.quartztask.concurrent", "zh-CN", "是否并发", "是否允许并发执行（字典 sys_yes_no；0=否 1=是）"),
            // entity.quartztask.concurrent
            new TranslationSeedItem("entity.quartztask.concurrent", "zh-HK", "是否并发", "是否允许并发执行（字典 sys_yes_no；0=否 1=是）"),

            // entity.quartztask.misfirepolicy
            new TranslationSeedItem("entity.quartztask.misfirepolicy", "en-US", "Misfire策略", "Misfire 策略（0=默认 1=忽略 2=立即触发 3=不触发）"),
            // entity.quartztask.misfirepolicy
            new TranslationSeedItem("entity.quartztask.misfirepolicy", "ja-JP", "Misfire策略", "Misfire 策略（0=默认 1=忽略 2=立即触发 3=不触发）"),
            // entity.quartztask.misfirepolicy
            new TranslationSeedItem("entity.quartztask.misfirepolicy", "zh-CN", "Misfire策略", "Misfire 策略（0=默认 1=忽略 2=立即触发 3=不触发）"),
            // entity.quartztask.misfirepolicy
            new TranslationSeedItem("entity.quartztask.misfirepolicy", "zh-HK", "Misfire策略", "Misfire 策略（0=默认 1=忽略 2=立即触发 3=不触发）"),
