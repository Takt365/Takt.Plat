...
public class TaktSettingI18nSeedData : ITaktSeedDataCoordinator
{
    ...
    private static List<TranslationSeedItem> GetSettingTranslations()
    {
        return new List<TranslationSeedItem>
        {
            ...
            new TranslationSeedItem("entity.setting._self", "en-US", "Setting Information", "实体名称"),
            // entity.setting._self
            new TranslationSeedItem("entity.setting._self", "ja-JP", "系统设置信息", "实体名称"),
            // entity.setting._self
            new TranslationSeedItem("entity.setting._self", "zh-CN", "系统设置信息", "实体名称"),
            // entity.setting._self
            new TranslationSeedItem("entity.setting._self", "zh-HK", "系统设置信息", "实体名称"),

            // entity.setting.key
            new TranslationSeedItem("entity.setting.key", "en-US", "设置键", "设置键（唯一索引：租户+公司内唯一，见 ix_setting_key_unique；如 system.siteName, upload.maxSize）"),
            // entity.setting.key
            new TranslationSeedItem("entity.setting.key", "ja-JP", "设置键", "设置键（唯一索引：租户+公司内唯一，见 ix_setting_key_unique；如 system.siteName, upload.maxSize）"),
            // entity.setting.key
            ...
            // entity.setting.key
            new TranslationSeedItem("entity.setting.key", "zh-HK", "设置键", "设置键（唯一索引：租户+公司内唯一，见 ix_setting_key_unique；如 system.siteName, upload.maxSize）"),

            // entity.setting.value
            new TranslationSeedItem("entity.setting.value", "en-US", "设置值", "设置值（字符串形式，复杂对象用JSON）"),
            // entity.setting.value
            new TranslationSeedItem("entity.setting.value", "ja-JP", "设置值", "设置值（字符串形式，复杂对象用JSON）"),
            // entity.setting.value
            new TranslationSeedItem("entity.setting.value", "zh-CN", "设置值", "设置值（字符串形式，复杂对象用JSON）"),
            // entity.setting.value
            new TranslationSeedItem("entity.setting.value", "zh-HK", "设置值", "设置值（字符串形式，复杂对象用JSON）"),

            // entity.setting.name
            new TranslationSeedItem("entity.setting.name", "en-US", "设置名称", "设置名称（显示名称，如：站点名称、最大上传大小）"),
            // entity.setting.name
            new TranslationSeedItem("entity.setting.name", "ja-JP", "设置名称", "设置名称（显示名称，如：站点名称、最大上传大小）"),
            // entity.setting.name
            new TranslationSeedItem("entity.setting.name", "zh-CN", "设置名称", "设置名称（显示名称，如：站点名称、最大上传大小）"),
            // entity.setting.name
            new TranslationSeedItem("entity.setting.name", "zh-HK", "设置名称", "设置名称（显示名称，如：站点名称、最大上传大小）"),

            // entity.setting.description
            new TranslationSeedItem("entity.setting.description", "en-US", "设置描述", "设置描述"),
            // entity.setting.description
            new TranslationSeedItem("entity.setting.description", "ja-JP", "设置描述", "设置描述"),
            // entity.setting.description
            new TranslationSeedItem("entity.setting.description", "zh-CN", "设置描述", "设置描述"),
            // entity.setting.description
            new TranslationSeedItem("entity.setting.description", "zh-HK", "设置描述", "设置描述"),

            // entity.setting.group
            new TranslationSeedItem("entity.setting.group", "en-US", "设置类别", "设置类别（0=前端，1=后端）"),
            // entity.setting.group
            new TranslationSeedItem("entity.setting.group", "ja-JP", "设置类别", "设置类别（0=前端，1=后端）"),
            // entity.setting.group
            new TranslationSeedItem("entity.setting.group", "zh-CN", "设置类别", "设置类别（0=前端，1=后端）"),
            // entity.setting.group
            new TranslationSeedItem("entity.setting.group", "zh-HK", "设置类别", "设置类别（0=前端，1=后端）"),

            // entity.setting.valuetype
            new TranslationSeedItem("entity.setting.valuetype", "en-US", "值类型", "值类型（用于前端渲染不同的输入控件）"),
            // entity.setting.valuetype
            new TranslationSeedItem("entity.setting.valuetype", "ja-JP", "值类型", "值类型（用于前端渲染不同的输入控件）"),
            // entity.setting.valuetype
            ...
            // entity.setting.sortorder
            new TranslationSeedItem("entity.setting.sortorder", "ja-JP", "排序号", "排序号"),
            // entity.setting.sortorder
            new TranslationSeedItem("entity.setting.sortorder", "zh-CN", "排序号", "排序号"),
            // entity.setting.sortorder
            new TranslationSeedItem("entity.setting.sortorder", "zh-HK", "排序号", "排序号"),
        };
    }
