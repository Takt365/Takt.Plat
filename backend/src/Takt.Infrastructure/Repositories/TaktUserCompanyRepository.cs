...
// 文件名称：TaktUserCompanyRepository.cs
// 创建时间：2026-05-29
// 创建人：Takt365(Cursor AI)
// 功能描述：用户-公司关联仓储（仅租户隔离；行内 CompanyCode 为关联目标，非会话公司过滤）
//
...
/// <summary>
/// 用户-公司关联仓储（不按会话租户/公司过滤；TenantCode、CompanyCode 均由业务查询显式指定）
/// </summary>
public class TaktUserCompanyRepository : TaktCompanyRepository<TaktUserCompany>
{
    /// <summary>
    /// 关联表不按当前会话租户过滤
    /// </summary>
    ...
    public TaktUserCompanyRepository(
        ...
        : base(dbContext, userContext, primaryKeyTypeOptions)
    {
    }
}
