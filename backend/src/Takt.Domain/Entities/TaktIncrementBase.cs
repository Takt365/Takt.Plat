...
// 功能描述：库自增 bigint IDENTITY 主键 × 三种隔离；CodeFirst：Id=-2、RelatedPlant|PlantCode=-1（先于业务列默认 0，再先于 Scope≥100）
//
...
/// <summary>
/// 租户级实体基类（库自增主键）
/// CodeFirst 列序：id → related_plant → 业务列 → tenant_code …
/// </summary>
public abstract class TaktTenantEntityIncrementBase : TaktTenantEntityScopeBase
{
    /// <summary>
    /// 主键 ID（库自增）
    /// </summary>
