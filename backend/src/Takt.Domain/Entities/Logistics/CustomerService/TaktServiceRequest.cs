...
/// 服务请求实体
/// </summary>
[SugarTable("takt_logistics_service_request", "服务请求表")]
[SugarIndex("ix_service_request_tenant", nameof(TenantCode), OrderByType.Asc, nameof(CompanyCode), OrderByType.Asc, false)]
[SugarIndex("ix_service_request_is_deleted", nameof(TenantCode), OrderByType.Asc, nameof(CompanyCode), OrderByType.Asc, nameof(IsDeleted), OrderByType.Asc, false)]
[SugarIndex("ix_takt_logistics_service_request_code_unique", nameof(TenantCode), OrderByType.Asc, nameof(CompanyCode), OrderByType.Asc, nameof(PlantCode), OrderByType.Asc, nameof(ServiceRequestCode), OrderByType.Asc, true)]
[SugarIndex("ix_takt_logistics_service_request_client_id", nameof(TenantCode), OrderByType.Asc, nameof(CompanyCode), OrderByType.Asc, nameof(ClientId), OrderByType.Asc, false)]
[SugarIndex("ix_takt_logistics_service_request_status", nameof(TenantCode), OrderByType.Asc, nameof(CompanyCode), OrderByType.Asc, nameof(RequestStatus), OrderByType.Asc, false)]
[SugarIndex("ix_takt_logistics_service_request_date", nameof(TenantCode), OrderByType.Asc, nameof(CompanyCode), OrderByType.Asc, nameof(RequestDate), OrderByType.Desc, false)]
public class TaktServiceRequest : TaktCompanyEntityBase
{
    /// <summary>
    /// 工厂代码
    /// </summary>
