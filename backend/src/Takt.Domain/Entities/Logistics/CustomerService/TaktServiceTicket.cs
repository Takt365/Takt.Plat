...
/// 服务工单实体
/// </summary>
[SugarTable("takt_logistics_service_ticket", "服务工单表")]
[SugarIndex("ix_service_ticket_tenant", nameof(TenantCode), OrderByType.Asc, nameof(CompanyCode), OrderByType.Asc, false)]
[SugarIndex("ix_service_ticket_is_deleted", nameof(TenantCode), OrderByType.Asc, nameof(CompanyCode), OrderByType.Asc, nameof(IsDeleted), OrderByType.Asc, false)]
[SugarIndex("ix_takt_logistics_service_ticket_code_unique", nameof(TenantCode), OrderByType.Asc, nameof(CompanyCode), OrderByType.Asc, nameof(PlantCode), OrderByType.Asc, nameof(ServiceTicketCode), OrderByType.Asc, true)]
[SugarIndex("ix_takt_logistics_service_ticket_request_id", nameof(TenantCode), OrderByType.Asc, nameof(CompanyCode), OrderByType.Asc, nameof(ServiceRequestId), OrderByType.Asc, false)]
[SugarIndex("ix_takt_logistics_service_ticket_order_id", nameof(TenantCode), OrderByType.Asc, nameof(CompanyCode), OrderByType.Asc, nameof(ServiceOrderId), OrderByType.Asc, false)]
[SugarIndex("ix_takt_logistics_service_ticket_status", nameof(TenantCode), OrderByType.Asc, nameof(CompanyCode), OrderByType.Asc, nameof(TicketStatus), OrderByType.Asc, false)]
public class TaktServiceTicket : TaktCompanyEntityBase
{
    /// <summary>
    /// 工厂代码
    /// </summary>
    ...
    public TaktServiceOrder? ServiceOrder { get; set; }
