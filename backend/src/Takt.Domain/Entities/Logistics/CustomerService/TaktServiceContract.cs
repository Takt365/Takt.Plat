...
[SugarIndex("ix_service_contract_tenant", nameof(TenantCode), OrderByType.Asc, nameof(CompanyCode), OrderByType.Asc, false)]
[SugarIndex("ix_service_contract_is_deleted", nameof(TenantCode), OrderByType.Asc, nameof(CompanyCode), OrderByType.Asc, nameof(IsDeleted), OrderByType.Asc, false)]
[SugarIndex("ix_takt_logistics_service_contract_code_unique", nameof(TenantCode), OrderByType.Asc, nameof(CompanyCode), OrderByType.Asc, nameof(PlantCode), OrderByType.Asc, nameof(ServiceContractCode), OrderByType.Asc, true)]
[SugarIndex("ix_takt_logistics_service_contract_client_id", nameof(TenantCode), OrderByType.Asc, nameof(CompanyCode), OrderByType.Asc, nameof(ClientId), OrderByType.Asc, false)]
[SugarIndex("ix_takt_logistics_service_contract_status", nameof(TenantCode), OrderByType.Asc, nameof(CompanyCode), OrderByType.Asc, nameof(ContractStatus), OrderByType.Asc, false)]
[SugarIndex("ix_takt_logistics_service_contract_effective_date", nameof(TenantCode), OrderByType.Asc, nameof(CompanyCode), OrderByType.Asc, nameof(EffectiveDate), OrderByType.Desc, false)]
public class TaktServiceContract : TaktCompanyEntityBase
{
    /// <summary>
    /// 工厂代码
    /// </summary>
