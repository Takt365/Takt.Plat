...
// 功能描述：Takt销售价格数量等级实体（SAP KONM：定价记录号/条件序列号/行号/等级数量/金额）
//
...
[SugarIndex("ix_takt_logistics_sales_price_scale_quantity_line_unique", nameof(TenantCode), OrderByType.Asc, nameof(CompanyCode), OrderByType.Asc, nameof(SalesPriceItemId), OrderByType.Asc, nameof(LineNumber), OrderByType.Asc, true)]
