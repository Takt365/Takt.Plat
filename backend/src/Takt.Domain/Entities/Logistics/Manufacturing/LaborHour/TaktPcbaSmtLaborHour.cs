...
[SugarIndex("ix_takt_logistics_manufacturing_labor_hour_pcba_smt_unique", nameof(TenantCode), OrderByType.Asc, nameof(CompanyCode), OrderByType.Asc, nameof(ProdDate), OrderByType.Asc, nameof(ProdTeam), OrderByType.Asc, nameof(ShiftNo), OrderByType.Asc, true)]
...
[SugarIndex("ix_takt_logistics_manufacturing_labor_hour_pcba_smt_prod_team", nameof(TenantCode), OrderByType.Asc, nameof(CompanyCode), OrderByType.Asc, nameof(ProdTeam), OrderByType.Asc, false)]
