...
// 文件名称：TaktPcbaRepairLaborHours.cs
// 创建时间：2026-07-08
// 创建人：Takt365(Cursor AI)
// 功能描述：PCBA改修工数统计实体，按生产日期、班组、班次汇总 TaktPcbaOutput / TaktPcbaOutputDetail（改修工作中心）工时与产量
//
...
/// PCBA改修工数统计实体
/// </summary>
[SugarTable("takt_logistics_manufacturing_labor_hour_pcba_repair", "PCBA改修工数统计表")]
[SugarIndex("ix_pcba_repair_labor_hours_tenant", nameof(TenantCode), OrderByType.Asc, nameof(CompanyCode), OrderByType.Asc, false)]
[SugarIndex("ix_pcba_repair_labor_hours_is_deleted", nameof(TenantCode), OrderByType.Asc, nameof(CompanyCode), OrderByType.Asc, nameof(IsDeleted), OrderByType.Asc, false)]
[SugarIndex("ix_takt_logistics_manufacturing_labor_hour_pcba_repair_unique", nameof(TenantCode), OrderByType.Asc, nameof(CompanyCode), OrderByType.Asc, nameof(PlantCode), OrderByType.Asc, nameof(ProdDate), OrderByType.Asc, nameof(TeamCode), OrderByType.Asc, nameof(ShiftNo), OrderByType.Asc, true)]
[SugarIndex("ix_takt_logistics_manufacturing_labor_hour_pcba_repair_plant_code", nameof(TenantCode), OrderByType.Asc, nameof(CompanyCode), OrderByType.Asc, nameof(PlantCode), OrderByType.Asc, false)]
[SugarIndex("ix_takt_logistics_manufacturing_labor_hour_pcba_repair_prod_date", nameof(TenantCode), OrderByType.Asc, nameof(CompanyCode), OrderByType.Asc, nameof(ProdDate), OrderByType.Asc, false)]
[SugarIndex("ix_takt_logistics_manufacturing_labor_hour_pcba_repair_team_code", nameof(TenantCode), OrderByType.Asc, nameof(CompanyCode), OrderByType.Asc, nameof(TeamCode), OrderByType.Asc, false)]
public class TaktPcbaRepairLaborHour : TaktCompanyEntityBase
{
