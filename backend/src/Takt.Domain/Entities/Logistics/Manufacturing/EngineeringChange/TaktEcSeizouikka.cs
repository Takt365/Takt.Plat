...
// 功能描述：设变制造1课部门执行表（按设变明细ID+完成品唯一）
//
...
/// <summary>
/// 设变制造1课（D0610）部门执行表（按设变明细 + 完成品唯一）
/// </summary>
...
[SugarIndex("ix_takt_logistics_manufacturing_ec_seizouikka_unique", nameof(TenantCode), OrderByType.Asc, nameof(CompanyCode), OrderByType.Asc, nameof(EcDetailId), OrderByType.Asc, nameof(EcFinishedGoods), OrderByType.Asc, true)]
