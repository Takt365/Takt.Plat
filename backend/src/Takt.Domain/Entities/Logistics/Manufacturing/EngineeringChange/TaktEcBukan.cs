...
[SugarIndex("ix_takt_logistics_manufacturing_ec_bukan_unique", nameof(TenantCode), OrderByType.Asc, nameof(CompanyCode), OrderByType.Asc, nameof(EcnDetailId), OrderByType.Asc, true)]
