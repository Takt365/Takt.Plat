...
[SugarIndex("ix_changeover_tenant", nameof(TenantCode), OrderByType.Asc, nameof(CompanyCode), OrderByType.Asc, false)]
[SugarIndex("ix_changeover_is_deleted", nameof(TenantCode), OrderByType.Asc, nameof(CompanyCode), OrderByType.Asc, nameof(IsDeleted), OrderByType.Asc, false)]
[SugarIndex("ix_takt_logistics_manufacturing_output_changeover_unique", nameof(TenantCode), OrderByType.Asc, nameof(CompanyCode), OrderByType.Asc, nameof(PlantCode), OrderByType.Asc, nameof(ProductionCategory), OrderByType.Asc, nameof(ProductionDate), OrderByType.Asc, nameof(ProductionLine), OrderByType.Asc, true)]
public class TaktChangeover : TaktCompanyEntityBase
{
    /// <summary>
    /// 生产工厂
    /// </summary>
