...
// 文件名称：TaktProductionOrderChangeLog.cs
// 功能描述：生产工单变更记录实体（变更记录表，非历史表）
//
...
/// 生产工单变更记录实体
/// </summary>
[SugarTable("takt_logistics_manufacturing_output_production_order_change_log", "生产工单变更记录表")]
[SugarIndex("ix_production_order_change_log_tenant", nameof(TenantCode), OrderByType.Asc, nameof(CompanyCode), OrderByType.Asc, false)]
[SugarIndex("ix_production_order_change_log_is_deleted", nameof(TenantCode), OrderByType.Asc, nameof(CompanyCode), OrderByType.Asc, nameof(IsDeleted), OrderByType.Asc, false)]
[SugarIndex("ix_takt_logistics_manufacturing_output_production_order_change_log_change_time", nameof(TenantCode), OrderByType.Asc, nameof(CompanyCode), OrderByType.Asc, nameof(ChangeTime), OrderByType.Desc, false)]
public class TaktProductionOrderChangeLog : TaktCompanyEntityBase
{
    /// <summary>
    ...
    public TaktProductionOrder? ProductionOrder { get; set; }
}
