...
// 功能描述：Takt生产计划实体，MRP 主生产计划层（销售计划 → 生产计划 → 采购计划）
//
...
/// <summary>
/// Takt生产计划实体（公司级；承接销售需求，可下达生产工单或采购计划）
/// </summary>
...
[SugarIndex("ix_takt_logistics_manufacturing_planning_production_plan_sales_plan", nameof(TenantCode), OrderByType.Asc, nameof(CompanyCode), OrderByType.Asc, nameof(SalesPlanId), OrderByType.Asc, false)]
public class TaktProductionPlan : TaktApprovalEntityBase
{
    ...
    /// <summary>
    /// 来源销售计划ID（MRP 上游，序列化为 string 以避免 Javascript 精度问题）
    /// </summary>
