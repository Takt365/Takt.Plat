...
// 文件名称：TaktBillOfMaterialChangeLog.cs
// 功能描述：BOM变更记录实体（变更记录表，非历史表）
//
...
/// BOM变更记录实体
/// </summary>
[SugarTable("takt_logistics_manufacturing_bom_change_log", "BOM变更记录表")]
[SugarIndex("ix_bill_of_material_change_log_tenant", nameof(TenantCode), OrderByType.Asc, nameof(CompanyCode), OrderByType.Asc, false)]
[SugarIndex("ix_bill_of_material_change_log_is_deleted", nameof(TenantCode), OrderByType.Asc, nameof(CompanyCode), OrderByType.Asc, nameof(IsDeleted), OrderByType.Asc, false)]
[SugarIndex("ix_takt_logistics_manufacturing_bom_change_log_bill_of_material_id", nameof(TenantCode), OrderByType.Asc, nameof(CompanyCode), OrderByType.Asc, nameof(BillOfMaterialId), OrderByType.Asc, false)]
public class TaktBillOfMaterialChangeLog : TaktCompanyEntityBase
{
    /// <summary>
