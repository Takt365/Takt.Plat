...
[SugarIndex("ix_takt_logistics_manufacturing_sop_call_workstation", nameof(TenantCode), OrderByType.Asc, nameof(CompanyCode), OrderByType.Asc, nameof(WorkstationId), OrderByType.Asc, false)]
