...
/// IPQC制程检验单明细实体
/// </summary>
[SugarTable("takt_logistics_quality_ipqc_order_item", "制程检验单明细表")]
[SugarIndex("ix_ipqc_order_item_tenant", nameof(TenantCode), OrderByType.Asc, nameof(CompanyCode), OrderByType.Asc, false)]
[SugarIndex("ix_ipqc_order_item_is_deleted", nameof(TenantCode), OrderByType.Asc, nameof(CompanyCode), OrderByType.Asc, nameof(IsDeleted), OrderByType.Asc, false)]
[SugarIndex("ix_takt_logistics_quality_ipqc_order_item_order_line_unique", nameof(TenantCode), OrderByType.Asc, nameof(CompanyCode), OrderByType.Asc, nameof(IpqcOrderId), OrderByType.Asc, nameof(LineNumber), OrderByType.Asc, true)]
...
{    /// <summary>
    ...
    /// 不良处理记录列表（主子表关系）
    /// </summary>
    [Navigate(NavigateType.OneToMany, nameof(TaktIpqcDefectHandling.IpqcOrderItemId))]
    public List<TaktIpqcDefectHandling>? DefectHandlings { get; set; }
}
