...
// 文件名称：TaktIqcDefectHandling.cs
// 功能描述：IQC进货检验不良处理记录实体
//
...
[SugarIndex("ix_iqc_defect_handling_tenant", nameof(TenantCode), OrderByType.Asc, nameof(CompanyCode), OrderByType.Asc, false)]
[SugarIndex("ix_iqc_defect_handling_is_deleted", nameof(TenantCode), OrderByType.Asc, nameof(CompanyCode), OrderByType.Asc, nameof(IsDeleted), OrderByType.Asc, false)]
[SugarIndex("ix_takt_logistics_quality_iqc_defect_handling_unique", nameof(TenantCode), OrderByType.Asc, nameof(CompanyCode), OrderByType.Asc, nameof(IqcOrderItemId), OrderByType.Asc, nameof(DefectCode), OrderByType.Asc, nameof(HandlingMethod), OrderByType.Asc, true)]
[SugarIndex("ix_takt_logistics_quality_iqc_defect_handling_defect_type", nameof(TenantCode), OrderByType.Asc, nameof(CompanyCode), OrderByType.Asc, nameof(DefectType), OrderByType.Asc, false)]
public class TaktIqcDefectHandling : TaktCompanyEntityBase
{    /// <summary>
    /// IQC不良处理编码
    /// </summary>
    ...
    /// </summary>
    [SugarColumn(ColumnName = "iqc_order_item_id", ColumnDescription = "IQC检验单明细ID", ColumnDataType = "bigint", IsNullable = false)]
    [JsonConverter(typeof(ValueToStringConverter))]
    public long IqcOrderItemId { get; set; }
    /// <summary>
    /// IQC检验单编码（冗余：按对应 Id 取主数据名称联动）
    /// </summary>
    ...
    /// IQC检验单明细（主表）
    /// </summary>
    [Navigate(NavigateType.ManyToOne, nameof(IqcOrderItemId))]
    public TaktIqcOrderItem? OrderItem { get; set; }
}
