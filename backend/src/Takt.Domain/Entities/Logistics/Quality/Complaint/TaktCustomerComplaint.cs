...
[SugarIndex("ix_takt_logistics_quality_customer_complaint_complaint_unique", nameof(TenantCode), OrderByType.Asc, nameof(CompanyCode), OrderByType.Asc, nameof(CustomerComplaintCode), OrderByType.Asc, true)]
