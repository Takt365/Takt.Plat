...
[SugarIndex("ix_takt_logistics_quality_supplier_evaluation_evaluation_unique", nameof(TenantCode), OrderByType.Asc, nameof(CompanyCode), OrderByType.Asc, nameof(SupplierEvaluationCode), OrderByType.Asc, true)]
