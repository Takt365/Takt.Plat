...
// 文件名称:TaktQualityFailureAssyRework.cs
// 创建时间:2026-05-07
...
/// </summary>
[SugarTable("takt_logistics_quality_failure_assy_rework", "质量问题组装不良改修费用明细表")]
[SugarIndex("ix_quality_failure_assy_rework_tenant", nameof(TenantCode), OrderByType.Asc, nameof(CompanyCode), OrderByType.Asc, false)]
[SugarIndex("ix_quality_failure_assy_rework_is_deleted", nameof(TenantCode), OrderByType.Asc, nameof(CompanyCode), OrderByType.Asc, nameof(IsDeleted), OrderByType.Asc, false)]
[SugarIndex("ix_takt_logistics_quality_failure_assy_rework_line_unique", nameof(TenantCode), OrderByType.Asc, nameof(CompanyCode), OrderByType.Asc, nameof(QualityFailureId), OrderByType.Asc, nameof(LineNumber), OrderByType.Asc, true)]
[SugarIndex("ix_takt_logistics_quality_failure_assy_rework_line_number", nameof(TenantCode), OrderByType.Asc, nameof(CompanyCode), OrderByType.Asc, nameof(LineNumber), OrderByType.Asc, false)]
public class TaktQualityFailureAssyRework : TaktCompanyEntityBase
{
    /// <summary>
