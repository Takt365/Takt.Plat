...
[SugarIndex("ix_takt_logistics_quality_issue_qi_unique", nameof(TenantCode), OrderByType.Asc, nameof(CompanyCode), OrderByType.Asc, nameof(PlantCode), OrderByType.Asc, nameof(QualityIssueCode), OrderByType.Asc, nameof(IssueDate), OrderByType.Asc, true)]
