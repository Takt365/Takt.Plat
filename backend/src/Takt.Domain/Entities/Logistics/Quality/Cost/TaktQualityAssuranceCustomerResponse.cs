...
// 文件名称:TaktQualityAssuranceCustomerResponse.cs
// 创建时间:2026-05-08
...
/// 品质业务明细 - 顾客品质要求对应业务费用
/// </summary>
[SugarTable("takt_logistics_quality_assurance_customer_response", "品质业务顾客品质要求对应费用明细表")]
[SugarIndex("ix_quality_assurance_customer_response_tenant", nameof(TenantCode), OrderByType.Asc, nameof(CompanyCode), OrderByType.Asc, false)]
[SugarIndex("ix_quality_assurance_customer_response_is_deleted", nameof(TenantCode), OrderByType.Asc, nameof(CompanyCode), OrderByType.Asc, nameof(IsDeleted), OrderByType.Asc, false)]
[SugarIndex("ix_takt_logistics_quality_assurance_customer_response_line_unique", nameof(TenantCode), OrderByType.Asc, nameof(CompanyCode), OrderByType.Asc, nameof(QualityAssuranceId), OrderByType.Asc, nameof(LineNumber), OrderByType.Asc, true)]
[SugarIndex("ix_takt_logistics_quality_assurance_customer_response_line_number", nameof(TenantCode), OrderByType.Asc, nameof(CompanyCode), OrderByType.Asc, nameof(LineNumber), OrderByType.Asc, false)]
public class TaktQualityAssuranceCustomerResponse : TaktCompanyEntityBase
{
    /// <summary>
