...
[SugarIndex("ix_product_serial_outbound_tenant", nameof(TenantCode), OrderByType.Asc, nameof(CompanyCode), OrderByType.Asc, false)]
[SugarIndex("ix_product_serial_outbound_is_deleted", nameof(TenantCode), OrderByType.Asc, nameof(CompanyCode), OrderByType.Asc, nameof(IsDeleted), OrderByType.Asc, false)]
[SugarIndex("ix_takt_logistics_product_serial_outbound_outbound_unique", nameof(TenantCode), OrderByType.Asc, nameof(CompanyCode), OrderByType.Asc, nameof(PlantCode), OrderByType.Asc, nameof(OutboundNo), OrderByType.Asc, true)]
[SugarIndex("ix_takt_logistics_product_serial_outbound_outbound_date", nameof(TenantCode), OrderByType.Asc, nameof(CompanyCode), OrderByType.Asc, nameof(OutboundDate), OrderByType.Asc, false)]
public class TaktProductSerialOutbound : TaktCompanyEntityBase
{
    /// <summary>
    /// 工厂代码(4位字母数字组合)
    /// </summary>
