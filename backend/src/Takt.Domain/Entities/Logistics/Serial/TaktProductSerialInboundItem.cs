...
[SugarIndex("ix_product_serial_inbound_item_tenant", nameof(TenantCode), OrderByType.Asc, nameof(CompanyCode), OrderByType.Asc, false)]
[SugarIndex("ix_product_serial_inbound_item_is_deleted", nameof(TenantCode), OrderByType.Asc, nameof(CompanyCode), OrderByType.Asc, nameof(IsDeleted), OrderByType.Asc, false)]
[SugarIndex("ix_takt_logistics_product_serial_inbound_item_inbound_serial_no_unique", nameof(TenantCode), OrderByType.Asc, nameof(CompanyCode), OrderByType.Asc, nameof(InboundSerialNo), OrderByType.Asc, true)]
public class TaktProductSerialInboundItem : TaktCompanyEntityBase
{
    /// <summary>
