...
[SugarIndex("ix_product_serial_inbound_tenant", nameof(TenantCode), OrderByType.Asc, nameof(CompanyCode), OrderByType.Asc, false)]
[SugarIndex("ix_product_serial_inbound_is_deleted", nameof(TenantCode), OrderByType.Asc, nameof(CompanyCode), OrderByType.Asc, nameof(IsDeleted), OrderByType.Asc, false)]
[SugarIndex("ix_takt_logistics_product_serial_inbound_inbound_unique", nameof(TenantCode), OrderByType.Asc, nameof(CompanyCode), OrderByType.Asc, nameof(PlantCode), OrderByType.Asc, nameof(InboundNo), OrderByType.Asc, true)]
[SugarIndex("ix_takt_logistics_product_serial_inbound_inbound_date", nameof(TenantCode), OrderByType.Asc, nameof(CompanyCode), OrderByType.Asc, nameof(InboundDate), OrderByType.Asc, false)]
public class TaktProductSerialInbound : TaktCompanyEntityBase
{
    /// <summary>
    /// 工厂代码(4位字母数字组合)
    /// </summary>
