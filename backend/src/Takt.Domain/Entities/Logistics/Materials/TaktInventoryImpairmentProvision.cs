...
// 文件名称：TaktInventoryImpairmentProvision.cs
// 创建时间：2026-07-18
...
/// </summary>
[SugarTable("takt_logistics_materials_inventory_impairment_provision", "存货跌价准备表")]
[SugarIndex("ix_inventory_impairment_provision_tenant", nameof(TenantCode), OrderByType.Asc, nameof(CompanyCode), OrderByType.Asc, false)]
[SugarIndex("ix_inventory_impairment_provision_is_deleted", nameof(TenantCode), OrderByType.Asc, nameof(CompanyCode), OrderByType.Asc, nameof(IsDeleted), OrderByType.Asc, false)]
[SugarIndex("ix_inventory_impairment_provision_unique", nameof(TenantCode), OrderByType.Asc, nameof(CompanyCode), OrderByType.Asc, nameof(PlantCode), OrderByType.Asc, nameof(PeriodDate), OrderByType.Asc, nameof(MaterialCode), OrderByType.Asc, nameof(Valuation), OrderByType.Asc, true)]
[SugarIndex("ix_inventory_impairment_provision_plant", nameof(TenantCode), OrderByType.Asc, nameof(CompanyCode), OrderByType.Asc, nameof(PlantCode), OrderByType.Asc, false)]
[SugarIndex("ix_inventory_impairment_provision_period", nameof(TenantCode), OrderByType.Asc, nameof(CompanyCode), OrderByType.Asc, nameof(PeriodDate), OrderByType.Asc, false)]
[SugarIndex("ix_inventory_impairment_provision_material", nameof(TenantCode), OrderByType.Asc, nameof(CompanyCode), OrderByType.Asc, nameof(MaterialCode), OrderByType.Asc, false)]
