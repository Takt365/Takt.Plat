...
// 文件名称：TaktMaterialChangeLog.cs
// 创建时间：2026-06-20
// 创建人：Takt365(Cursor AI)
// 功能描述：全局物料变更记录实体（变更记录表，非历史表）
//
...
/// 全局物料变更记录实体
/// </summary>
[SugarTable("takt_logistics_materials_material_change_log", "全局物料变更记录表")]
[SugarIndex("ix_material_change_log_tenant", nameof(TenantCode), OrderByType.Asc, false)]
[SugarIndex("ix_material_change_log_is_deleted", nameof(TenantCode), OrderByType.Asc, nameof(IsDeleted), OrderByType.Asc, false)]
[SugarIndex("ix_takt_logistics_materials_material_change_log_change_time", nameof(TenantCode), OrderByType.Asc, nameof(ChangeTime), OrderByType.Desc, false)]
