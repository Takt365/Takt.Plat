...
[SugarIndex("ix_takt_logistics_procurement_purchase_group_unique", nameof(TenantCode), OrderByType.Asc, nameof(CompanyCode), OrderByType.Asc, nameof(PurchaseGroupCode), OrderByType.Asc, true)]
public class TaktPurchaseGroup : TaktCompanyEntityBase
{
    ...
    /// </summary>
    [SugarColumn(ColumnName = "purchase_group_code", ColumnDescription = "采购组编码", ColumnDataType = "nvarchar", Length = 50, IsNullable = false)]
