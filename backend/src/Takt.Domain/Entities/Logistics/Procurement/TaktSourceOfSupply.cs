...
public class TaktSourceOfSupply : TaktCompanyEntityBase
{
    ...
    /// </summary>
    [SugarColumn(ColumnName = "is_fixed", ColumnDescription = "是否固定", ColumnDataType = "int", IsNullable = false, DefaultValue = "0")]
    public int IsFixed { get; set; } = 0;

    /// <summary>
    /// 是否冻结（字典 sys_yes_no_type；1=是，0=否；冻结后禁止新建采购订单引用）
    /// </summary>
    [SugarColumn(ColumnName = "is_blocked", ColumnDescription = "是否冻结", ColumnDataType = "int", IsNullable = false, DefaultValue = "0")]
