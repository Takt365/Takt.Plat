...
/// 采购价格变更记录实体
/// </summary>
[SugarTable("takt_logistics_materials_purchase_price_change_log", "采购价格变更记录表")]
[SugarIndex("ix_purchase_price_change_log_tenant", nameof(TenantCode), OrderByType.Asc, nameof(CompanyCode), OrderByType.Asc, false)]
[SugarIndex("ix_purchase_price_change_log_is_deleted", nameof(TenantCode), OrderByType.Asc, nameof(CompanyCode), OrderByType.Asc, nameof(IsDeleted), OrderByType.Asc, false)]
[SugarIndex("ix_takt_logistics_materials_purchase_price_change_log_change_time", nameof(TenantCode), OrderByType.Asc, nameof(CompanyCode), OrderByType.Asc, nameof(ChangeTime), OrderByType.Desc, false)]
public class TaktPurchasePriceChangeLog : TaktCompanyEntityBase
{
    /// <summary>
