...
// 功能描述：Takt采购价格价值等级实体（SAP KONW：定价记录号/条件序列号/行号/等级值/金额）
//
...
[SugarIndex("ix_takt_logistics_materials_purchase_price_scale_value_line_unique", nameof(TenantCode), OrderByType.Asc, nameof(CompanyCode), OrderByType.Asc, nameof(PurchasePriceItemId), OrderByType.Asc, nameof(LineNumber), OrderByType.Asc, true)]
