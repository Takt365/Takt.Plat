...
[SugarIndex("ix_takt_logistics_materials_purchase_price_code_unique", nameof(TenantCode), OrderByType.Asc, nameof(CompanyCode), OrderByType.Asc, nameof(PurchasePriceCode), OrderByType.Asc, true)]
