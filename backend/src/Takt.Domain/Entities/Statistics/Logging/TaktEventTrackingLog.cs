...
/// </remarks>
[SugarTable("takt_statistics_logging_event_tracking_log", "交互日志表")]
[SugarIndex("ix_event_tracking_log_tenant", nameof(TenantCode), OrderByType.Asc, nameof(CompanyCode), OrderByType.Asc, false)]
[SugarIndex("ix_event_tracking_log_is_deleted", nameof(TenantCode), OrderByType.Asc, nameof(CompanyCode), OrderByType.Asc, nameof(IsDeleted), OrderByType.Asc, false)]
[SugarIndex("ix_takt_statistics_logging_event_tracking_log_user_name", nameof(TenantCode), OrderByType.Asc, nameof(CompanyCode), OrderByType.Asc, nameof(UserName), OrderByType.Asc, false)]
[SugarIndex("ix_takt_statistics_logging_event_tracking_log_event_time", nameof(TenantCode), OrderByType.Asc, nameof(CompanyCode), OrderByType.Asc, nameof(EventTime), OrderByType.Desc, false)]
[SugarIndex("ix_takt_statistics_logging_event_tracking_log_duration_ms", nameof(TenantCode), OrderByType.Asc, nameof(CompanyCode), OrderByType.Asc, nameof(DurationMs), OrderByType.Desc, false)]
[SugarIndex("ix_takt_statistics_logging_event_tracking_log_tracking_level", nameof(TenantCode), OrderByType.Asc, nameof(CompanyCode), OrderByType.Asc, nameof(TrackingLevel), OrderByType.Asc, false)]
[SugarIndex("ix_takt_statistics_logging_event_tracking_log_event_tracking_type", nameof(TenantCode), OrderByType.Asc, nameof(CompanyCode), OrderByType.Asc, nameof(EventTrackingType), OrderByType.Asc, false)]
public class TaktEventTrackingLog : TaktCompanyEntityBase
{
    /// <summary>
