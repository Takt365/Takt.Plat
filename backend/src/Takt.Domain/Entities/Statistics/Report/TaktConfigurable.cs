...
{
    /// <summary>
    /// 报表编码（租户+公司内唯一；前端表单选择编码规则后自动通过 TaktNumbering 报表编码规则生成并展示，非手输；单据类型菜单：SQVI报表）
    /// </summary>
    ...
    /// <summary>
    /// 报表业务域（TaktModule；0=仪表盘 1=身份认证 2=日常事务 3=财务核算 4=后勤管理 5=人力资源 6=工作流 7=代码管理 8=基础设置 9=统计看板 10=实体；与一级菜单映射）
    /// </summary>
    ...
    /// <summary>
    /// 报表状态（字典 sys_normal_disable；0=禁用 1=启用 2=锁定）
    /// </summary>
