...
public class TaktFile : TaktCompanyEntityBase
{
    ...
    /// 文件 MIME 类型
    /// </summary>
    [SugarColumn(ColumnName = "file_type", ColumnDescription = "文件MIME类型", ColumnDataType = "nvarchar", Length = 100, IsNullable = false, DefaultValue = "''")]
    public string FileType { get; set; } = string.Empty;

    /// <summary>
    /// 文件扩展名
    /// </summary>
    [SugarColumn(ColumnName = "file_extension", ColumnDescription = "文件扩展名", ColumnDataType = "varchar", Length = 20, IsNullable = false, DefaultValue = "''")]
    public string FileExtension { get; set; } = string.Empty;

    /// <summary>
    /// 文件哈希值（MD5 或 SHA256，用于去重与校验）
    /// </summary>
    [SugarColumn(ColumnName = "file_hash", ColumnDescription = "文件哈希值", ColumnDataType = "varchar", Length = 64, IsNullable = false, DefaultValue = "''")]
