...
// 文件名称：TaktAssessment.cs
// 创建时间：2026-06-06
// 创建人：Takt365(Cursor AI)
// 功能描述：绩效考核评估实体，对应菜单 performance/assessment
//
...
/// 员工绩效考核评估
/// </summary>
[SugarTable("takt_human_resource_performance_assessment", "绩效考核表")]
[SugarIndex("ix_assessment_tenant", nameof(TenantCode), OrderByType.Asc, nameof(CompanyCode), OrderByType.Asc, false)]
[SugarIndex("ix_assessment_is_deleted", nameof(TenantCode), OrderByType.Asc, nameof(CompanyCode), OrderByType.Asc, nameof(IsDeleted), OrderByType.Asc, false)]
[SugarIndex("ix_assessment_employee_period", nameof(TenantCode), OrderByType.Asc, nameof(CompanyCode), OrderByType.Asc, nameof(EmployeeId), OrderByType.Asc, nameof(AssessmentPeriod), OrderByType.Asc, false)]
public class TaktAssessment : TaktCompanyEntityBase
{
    /// <summary>
    /// 员工 ID
    /// </summary>
