...
// 文件名称：TaktSchemeMetric.cs
// 创建时间：2026-06-06
// 创建人：Takt365(Cursor AI)
// 功能描述：绩效方案指标实体（方案+指标），对应菜单 performance/scheme-metric
//
...
/// </summary>
[SugarTable("takt_human_resource_performance_scheme_metric", "绩效方案指标表")]
[SugarIndex("ix_scheme_metric_tenant", nameof(TenantCode), OrderByType.Asc, nameof(CompanyCode), OrderByType.Asc, false)]
[SugarIndex("ix_scheme_metric_is_deleted", nameof(TenantCode), OrderByType.Asc, nameof(CompanyCode), OrderByType.Asc, nameof(IsDeleted), OrderByType.Asc, false)]
[SugarIndex("ix_scheme_metric_code_unique", nameof(TenantCode), OrderByType.Asc, nameof(CompanyCode), OrderByType.Asc, nameof(SchemeCode), OrderByType.Asc, nameof(MetricCode), OrderByType.Asc, true)]
public class TaktSchemeMetric : TaktCompanyEntityBase
{
    /// <summary>
    /// 方案编码
    /// </summary>
