...
// 文件名称：TaktObjective.cs
// 创建时间：2026-06-06
// 创建人：Takt365(Cursor AI)
// 功能描述：绩效目标实体，对应菜单 performance/objective
//
...
/// 员工绩效目标
/// </summary>
[SugarTable("takt_human_resource_performance_objective", "绩效目标表")]
[SugarIndex("ix_objective_tenant", nameof(TenantCode), OrderByType.Asc, nameof(CompanyCode), OrderByType.Asc, false)]
[SugarIndex("ix_objective_is_deleted", nameof(TenantCode), OrderByType.Asc, nameof(CompanyCode), OrderByType.Asc, nameof(IsDeleted), OrderByType.Asc, false)]
[SugarIndex("ix_objective_employee_period", nameof(TenantCode), OrderByType.Asc, nameof(CompanyCode), OrderByType.Asc, nameof(EmployeeId), OrderByType.Asc, nameof(ObjectivePeriod), OrderByType.Asc, false)]
public class TaktObjective : TaktApprovalEntityBase
{
    /// <summary>
    /// 员工 ID
    /// </summary>
