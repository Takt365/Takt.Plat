...
// 功能描述：培训课程实体，对应菜单 training-development/course
//
...
/// 培训课程定义
/// </summary>
[SugarTable("takt_human_resource_training_development_course", "培训课程表")]
...
public class TaktTrainingCourse : TaktCompanyEntityBase
{
    ...
    /// 课程编码（租户+公司内唯一）
    /// </summary>
    [SugarColumn(ColumnName = "course_code", ColumnDescription = "课程编码", ColumnDataType = "nvarchar", Length = 64, IsNullable = false)]
    public string CourseCode { get; set; } = string.Empty;
    /// <summary>
    /// 课程名称
    /// </summary>
    [SugarColumn(ColumnName = "course_name", ColumnDescription = "课程名称", ColumnDataType = "nvarchar", Length = 200, IsNullable = false)]
