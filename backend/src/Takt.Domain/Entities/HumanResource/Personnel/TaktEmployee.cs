...

{
    ...
    /// 籍贯（字典 hr_native_place_code；列存 6 位 GB 行政区划代码，人事档案必填）
    ...
    /// 最高学历摘要（字典 hr_education_level_category；1=高中及以下 2=大专 3=本科 4=硕士 5=博士；明细见 EmployeeEducations）
    ...
    /// 离职类型（字典 hr_resignation_category；投影字段，由离职审批通过后回写；0=主动辞职 1=公司辞退 2=合同到期 3=退休 9=其他）
    ...
    /// 当前主部门（关联 TaktDept.Id，选项 TaktDepts/tree-options；任职投影快照，未上岗可空）
