...
public class TaktDept : TaktCompanyEntityBase
{
    ...
    /// 成本中心编码（关联财务成本中心）
    /// </summary>
    [SugarColumn(ColumnName = "cost_center_code", ColumnDescription = "成本中心编码", ColumnDataType = "varchar", Length = 20, IsNullable = false, DefaultValue = "")]
    ...
    /// 部门描述
    /// </summary>
    [SugarColumn(ColumnName = "description", ColumnDescription = "部门描述", ColumnDataType = "nvarchar", Length = 500, IsNullable = false, DefaultValue = "")]
