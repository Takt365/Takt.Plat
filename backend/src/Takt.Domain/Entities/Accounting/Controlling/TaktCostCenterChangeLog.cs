...
// 文件名称：TaktCostCenterChangeLog.cs
// 创建时间：2025-01-20
...
/// 成本中心变更记录实体
/// </summary>
[SugarTable("takt_accounting_controlling_cost_center_change_log", "成本中心变更记录表")]
[SugarIndex("ix_cost_center_change_log_tenant", nameof(TenantCode), OrderByType.Asc, nameof(CompanyCode), OrderByType.Asc, false)]
[SugarIndex("ix_cost_center_change_log_cost_center", nameof(TenantCode), OrderByType.Asc, nameof(CompanyCode), OrderByType.Asc, nameof(CostCenterId), OrderByType.Asc, false)]
[SugarIndex("ix_cost_center_change_log_change_time", nameof(TenantCode), OrderByType.Asc, nameof(CompanyCode), OrderByType.Asc, nameof(ChangeTime), OrderByType.Desc, false)]
public class TaktCostCenterChangeLog : TaktCompanyEntityBase
{
    /// <summary>
    ...
    /// 成本中心主表
    /// </summary>
    [Navigate(NavigateType.ManyToOne, nameof(CostCenterId))]
