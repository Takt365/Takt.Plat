...
// 文件名称：TaktExpenseDetail.cs
// 创建时间：2026-06-24
// 创建人：Takt365(Cursor AI)
// 功能描述：费用单明细实体（主子表从表，外键 ExpenseId）
//
...
/// 费用单明细实体
/// </summary>
[SugarTable("takt_accounting_financial_expense_detail", "费用单明细表")]
[SugarIndex("ix_expense_detail_tenant", nameof(TenantCode), OrderByType.Asc, nameof(CompanyCode), OrderByType.Asc, false)]
[SugarIndex("ix_expense_detail_is_deleted", nameof(TenantCode), OrderByType.Asc, nameof(CompanyCode), OrderByType.Asc, nameof(IsDeleted), OrderByType.Asc, false)]
[SugarIndex("ix_expense_detail_line_unique", nameof(TenantCode), OrderByType.Asc, nameof(CompanyCode), OrderByType.Asc, nameof(ExpenseId), OrderByType.Asc, nameof(LineNumber), OrderByType.Asc, true)]
[SugarIndex("ix_expense_detail_expense_code", nameof(TenantCode), OrderByType.Asc, nameof(CompanyCode), OrderByType.Asc, nameof(ExpenseCode), OrderByType.Asc, false)]
public class TaktExpenseDetail : TaktCompanyEntityBase
{
    /// <summary>
    /// 费用单 ID（主子表关系）
    /// </summary>
    [SugarColumn(ColumnName = "expense_id", ColumnDescription = "费用单ID", ColumnDataType = "bigint", IsNullable = false)]
    ...
    /// 费用发生日期
    /// </summary>
    [SugarColumn(ColumnName = "expense_detail_date", ColumnDescription = "费用发生日期", ColumnDataType = "datetime", IsNullable = true)]
